...
export function isTwoHandedWeapon(item) {
    ...
    // Check subtype for two-handed indicators (excluding ranged weapons already checked above)
    ...
    // Check name for two-handed indicators (excluding ranged weapons already checked above)
