...
const SHAPES = {
  ...
  // ---- Crusader ----
  XBLADES: { // two greatswords crossing at the heart of the tree
    0: [[0.5, 0], [2, 0], [3.5, 0]],
    1: [[1.25, 1.5], [2.75, 1.5]],
    2: [[2.25, 3], [1.75, 3]],
    3: [[2.75, 4.5], [1.25, 4.5]],
    4: [[3.25, 6], [0.75, 6]],
    5: [[3.5, 7], [2, 7], [0.5, 7]],
    6: [[4, 8], [3, 8], [2, 8], [1, 8], [0, 8]],
  },
  RAMPART: { // keep at the crown widening into a fortress foundation
    0: [[1.5, 0], [2, 0], [2.5, 0]],
    1: [[1, 1.5], [3, 1.5]],
    2: [[0.75, 3], [3.25, 3]],
    3: [[0.5, 4.5], [3.5, 4.5]],
    4: [[0.5, 6], [3.5, 6]],
    5: [[0.5, 7], [2, 7], [3.5, 7]],
    6: [[2, 8], [0, 8], [1, 8], [3, 8], [4, 8]],
  },
  TUNINGFORK: { // central handle opening into a resonance lens
    0: [[2, 0], [1.5, 0.5], [2.5, 0.5]],
    1: [[0.75, 2], [3.25, 2]],
    2: [[0.5, 3.5], [3.5, 3.5]],
    3: [[0.75, 5], [3.25, 5]],
    4: [[1.25, 6.5], [2.75, 6.5]],
    5: [[1, 7], [2, 7], [3, 7]],
    6: [[2, 8], [1, 8], [3, 8], [3.5, 8], [4, 8]],
  },
};
...
const TREE_SHAPES = {
  ...
  CRUSADER_SOLAR_JUSTICIAR: 'XBLADES',
  CRUSADER_DAWN_BASTION: 'RAMPART',
  CRUSADER_HARMONIC_INQUISITOR: 'TUNINGFORK',
};
