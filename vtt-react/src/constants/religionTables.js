...
export const RELIGION_TABLES = {
 ...
 religion_untrained_d6: {
  ...
  requiredRank: 'UNTRAINED',
  table: [
   { roll: [1, 1], result: 'You attribute power to the wrong spirit, insult followers', type: 'failure' },
 ...
 religion_untrained_d10: {
  ...
  table: [
   ...
   { roll: [7, 7], result: 'You sense sacred presence but cannot identify it', type: 'normal' },
 ...
 religion_untrained_d12: {
  ...
  table: [
   ...
   { roll: [6, 7], result: 'You mistake sacred symbols for arcane runes', type: 'failure' },
 ...
 religion_untrained_d20: {
  ...
  table: [
   ...
   { roll: [6, 8], result: 'You mistake sacred law for mortal custom', type: 'failure' },
 ...
 religion_novice_d20: {
  ...
  table: [
   ...
   { roll: [6, 8], result: 'You mistake sacred symbols for arcane marks', type: 'failure' },
 ...
 religion_trained_d20: {
  ...
  table: [
   ...
   { roll: [5, 7], result: 'You mistake sacred symbols for mortal marks', type: 'failure' },
   { roll: [8, 10], result: 'You are challenged by the complexity', type: 'normal' },
   { roll: [11, 12], result: 'You identify the tradition ', type: 'normal' },
   ...
   { roll: [18, 18], result: 'You trace sacred lineage accurately', type: 'success' },
 ...
 religion_apprentice_d20: {
  ...
  table: [
   ...
   { roll: [4, 5], result: 'You mistake sacred for mortal', type: 'failure' },
   ...
   { roll: [17, 17], result: 'You trace sacred ancestry', type: 'success' },
   ...
   { roll: [20, 20], result: 'You sense sacred influence at work', type: 'critical' }
  ]
 },
 ...
 religion_adept_d8: {
  ...
  requiredRank: 'ADEPT',
  table: [
   { roll: [1, 1], result: 'You miss a complex distinction', type: 'failure' },
 ...
 religion_adept_d12: {
  ...
  table: [
   ...
   { roll: [12, 12], result: 'You sense sacred patterns', type: 'critical' }
  ]
 },
 religion_adept_d20: {
  ...
  table: [
   ...
   { roll: [3, 4], result: 'You mistake sacred for mortal', type: 'normal' },
   ...
   { roll: [13, 13], result: 'You trace sacred ancestry', type: 'success' },
   ...
   { roll: [16, 16], result: 'You sense sacred influence at work', type: 'critical' },
   { roll: [17, 18], result: 'You predict faith behavior', type: 'critical' },
   { roll: [19, 20], result: 'You uncover lost sacred knowledge', type: 'critical' }
  ]
 },
 ...
 religion_expert_d12: {
  ...
  table: [
   ...
   { roll: [11, 11], result: 'You sense sacred patterns clearly', type: 'critical' },
   { roll: [12, 12], result: 'You trace sacred ancestry precisely', type: 'critical' }
  ]
 },
 religion_expert_d20: {
  ...
  table: [
   ...
   { roll: [11, 11], result: 'You trace sacred ancestry', type: 'critical' },
   ...
   { roll: [14, 14], result: 'You sense sacred influence at work', type: 'critical' },
   { roll: [15, 16], result: 'You predict faith behavior accurately', type: 'critical' },
   { roll: [17, 18], result: 'You uncover lost sacred knowledge', type: 'critical' },
   { roll: [19, 20], result: 'You comprehend the sacred mystery', type: 'critical' }
  ]
 },
 ...
 religion_master_d10: {
  ...
  table: [
   ...
   { roll: [10, 10], result: 'You sense sacred influence clearly', type: 'critical' }
  ]
 },
 religion_master_d12: {
  ...
  table: [
   ...
   { roll: [10, 10], result: 'You sense sacred patterns perfectly', type: 'critical' },
   { roll: [11, 11], result: 'You trace sacred ancestry completely', type: 'critical' },
   { roll: [12, 12], result: 'You comprehend the sacred plan', type: 'critical' }
  ]
 },
 religion_master_d20: {
  ...
  table: [
   ...
   { roll: [6, 6], result: 'You trace sacred ancestry', type: 'critical' },
   { roll: [7, 7], result: 'You understand cosmic principles', type: 'critical' },
   { roll: [8, 8], result: 'You grasp primordial truths', type: 'critical' },
   { roll: [9, 9], result: 'You sense sacred influence at work', type: 'critical' },
   { roll: [10, 10], result: 'You predict faith behavior perfectly', type: 'critical' },
   { roll: [11, 11], result: 'You uncover lost sacred knowledge', type: 'critical' },
   { roll: [12, 12], result: 'You comprehend the sacred mystery', type: 'critical' },
   { roll: [13, 14], result: 'You reveal the cosmic order', type: 'critical' },
   { roll: [15, 16], result: 'You understand the sacred hierarchy', type: 'critical' },
