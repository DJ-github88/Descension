...
export const ROLLABLE_TABLES = {
  ...
  persuasion_adept_d6: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You build deep trust, target becomes loyal follower', type: 'success' },
  ...
  deception_adept_d6: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You build deep false trust, target becomes loyal to your lie', type: 'success' },
