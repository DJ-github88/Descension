...
export const LORE_PLACEHOLDERS = {
    ...
    flaws: 'Your weakness or blind spot. E.g. "Greedy near treasure; freeze up at the sound of the Wyrd\'s howl."',
    goals: 'What drives you forward. E.g. "Find my missing mentor; earn a seat in the Canopy-Ledger."',
...
/**
 * Plain-language D&D equivalents shown as a subtitle beneath the
 * Mythrill-flavored lore labels, so players know what to write.
 */
export const LORE_FIELD_HINTS = {
    backstory: 'Backstory',
