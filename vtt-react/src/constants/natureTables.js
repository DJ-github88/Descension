...
export const NATURE_TABLES = {
    ...
    nature_untrained_d6: {
        ...
        requiredRank: 'UNTRAINED',
        table: [
            { roll: [1, 1], result: 'You misidentify species completely', type: 'failure' },
    ...
    nature_untrained_d20: {
        ...
        requiredRank: 'UNTRAINED',
        table: [
            { roll: [1, 1], result: 'You cause ecological disaster, 4d6 damage to all', type: 'failure' },
            { roll: [2, 3], result: 'You destroy critical ecosystem balance', type: 'failure' },
            { roll: [4, 5], result: 'You misidentify everything catastrophically', type: 'failure' },
            { roll: [6, 7], result: 'You fail to understand any natural process', type: 'failure' },
            { roll: [8, 9], result: 'You cannot read terrain at all', type: 'failure' },
            { roll: [10, 11], result: 'You see patterns but understand nothing', type: 'failure' },
            { roll: [12, 13], result: 'You rely on pure superstition', type: 'failure' },
