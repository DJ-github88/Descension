...
export const NATURE_TABLES = {
  ...
  nature_untrained_d10: {
    ...
    table: [
      ...
      { roll: [6, 6], result: 'You recognize substrate but not details', type: 'normal' },
  ...
  nature_untrained_d20: {
    ...
    table: [
      ...
      { roll: [2, 3], result: 'You destroy critical substrate balance, triggering chain reaction that endangers entire region', type: 'total-failure' },
  ...
  nature_novice_d8: {
    ...
    table: [
      ...
      { roll: [4, 4], result: 'You understand substrate basics', type: 'normal' },
  ...
  nature_novice_d10: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You overlook critical substrate link', type: 'failure' },
  ...
  nature_novice_d12: {
    ...
    table: [
      ...
      { roll: [12, 12], result: 'You discover unique substrate trait', type: 'critical' }
    ]
  },
  nature_novice_d20: {
    ...
    requiredRank: 'NOVICE',
    table: [
      { roll: [1, 1], result: 'You completely misunderstand substrate', type: 'failure' },
  ...
  nature_trained_d8: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate thoroughly', type: 'normal' },
  ...
  nature_trained_d10: {
    ...
    table: [
      ...
      { roll: [9, 9], result: 'You discover hidden substrate service', type: 'success' },
  ...
  nature_trained_d12: {
    ...
    table: [
      ...
      { roll: [9, 9], result: 'You identify all substrate niches', type: 'success' },
  ...
  nature_trained_d20: {
    ...
    requiredRank: 'TRAINED',
    table: [
      { roll: [1, 1], result: 'You face completely unknown substrate', type: 'failure' },
      ...
      { roll: [12, 13], result: 'You piece together substrate', type: 'normal' },
  ...
  nature_apprentice_d6: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate role fully', type: 'success' },
  ...
  nature_apprentice_d10: {
    ...
    table: [
      ...
      { roll: [4, 4], result: 'You understand substrate dynamics', type: 'normal' },
  ...
  nature_apprentice_d12: {
    ...
    table: [
      ...
      { roll: [9, 9], result: 'You identify all substrate roles', type: 'success' },
  ...
  nature_apprentice_d20: {
    ...
    requiredRank: 'APPRENTICE',
    table: [
      { roll: [1, 1], result: 'You face completely alien substrate', type: 'failure' },
  ...
  nature_adept_d6: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate perfectly', type: 'success' },
  ...
  nature_adept_d10: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate fully', type: 'normal' },
  ...
  nature_adept_d12: {
    ...
    table: [
      ...
      { roll: [12, 12], result: 'You master substrate knowledge', type: 'critical' }
    ]
  },
  nature_adept_d20: {
    ...
    requiredRank: 'ADEPT',
    table: [
      { roll: [1, 1], result: 'You face truly alien substrate', type: 'failure' },
      { roll: [2, 3], result: 'You cannot identify exotic species', type: 'failure' },
      ...
      { roll: [10, 11], result: 'You piece together substrate', type: 'normal' },
      ...
      { roll: [20, 20], result: 'You master alien substrate', type: 'critical' }
    ]
  },
  ...
  nature_expert_d6: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate perfectly', type: 'critical' },
      { roll: [4, 4], result: 'You predict all patterns', type: 'critical' },
  ...
  nature_expert_d10: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate fully', type: 'success' },
  ...
  nature_expert_d12: {
    ...
    table: [
      ...
      { roll: [11, 11], result: 'You master substrate knowledge', type: 'critical' },
  ...
  nature_expert_d20: {
    ...
    requiredRank: 'EXPERT',
    table: [
      { roll: [1, 1], result: 'You face unprecedented substrate', type: 'failure' },
      ...
      { roll: [8, 9], result: 'You piece together substrate', type: 'success' },
      ...
      { roll: [19, 19], result: 'You master alien substrate', type: 'critical' },
  ...
  nature_master_d10: {
    ...
    table: [
      ...
      { roll: [3, 3], result: 'You understand substrate fully', type: 'critical' },
  ...
  nature_master_d20: {
    ...
    table: [
      ...
      { roll: [8, 9], result: 'You piece together substrate', type: 'critical' },
