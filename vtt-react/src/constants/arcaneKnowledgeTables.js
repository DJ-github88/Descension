...
export const ARCANE_KNOWLEDGE_TABLES = {
  ...
  arcaneknowledge_apprentice_d20: {
    ...
    table: [
      ...
      { roll: [16, 17], result: 'You notice extraplanar or sacred influence', type: 'critical' },
  ...
  arcaneknowledge_adept_d20: {
    ...
    table: [
      ...
      { roll: [15, 15], result: 'You recognize a rare magical framework', type: 'critical' },
      { roll: [16, 17], result: 'You notice sacred or cosmic influence', type: 'critical' },
  ...
  arcaneknowledge_expert_d20: {
    ...
    table: [
      ...
      { roll: [18, 20], result: 'You comprehend a pattern-shifting technique', type: 'critical' }
    ]
  },
  ...
  arcaneknowledge_master_d12: {
    ...
    table: [
      ...
      { roll: [9, 9], result: 'You identify a pattern-shifting approach', type: 'critical' },
  ...
  arcaneknowledge_master_d20: {
    ...
    table: [
      ...
      { roll: [16, 17], result: 'You notice primordial or sacred influence', type: 'critical' },
