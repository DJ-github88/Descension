...
export const SKILL_QUESTS = {
  ...
  nature: [
    ...
    },
    {
      ...
      name: 'substrate Understanding',
      description: 'Understand complex substrate relationships',
      icon: 'Nature/Nature Natural 11',
      rank: 'ADEPT',
      completed: false,
  ...
  religion: [
    ...
    {
      id: 'identify_symbol',
      name: 'Identify Sacred Symbol',
      description: 'Identify a patron or faith from their symbols',
      icon: 'Heritage',
      rank: 'NOVICE',
      completed: false,
    ...
    },
    {
      id: 'planar_beings',
      name: 'Planar Beings',
      description: 'Identify and understand astral or wyrd-touched beings',
      icon: 'Radiant/Radiant Light 5',
      rank: 'ADEPT',
      completed: false,
