...
export const SKILL_CATEGORIES = {
  ...
  ARCANE: {
    ...
    description: 'search into magical mysteries and forbidden knowledge'
  }
};
...
export const SKILL_DEFINITIONS = {
  ...
  religion: {
    ...
    primaryStat: 'intelligence',
    secondaryStat: 'spirit',
    description: 'Study and interpretation of sacred entities, faith traditions, and sacred doctrine',
    icon: 'Radiant/Radiant Light 5',
    rollableTables: {
      UNTRAINED: {
