...
export const HISTORY_TABLES = {
 ...
 history_apprentice_d6: {
  ...
  table: [
   { roll: [1, 1], result: 'Minor failure, brief complication', type: 'failure' },
   { roll: [2, 2], result: 'You remember complete account with context', type: 'success' },
 ...
 history_apprentice_d8: {
  ...
  table: [
   ...
   { roll: [3, 4], result: 'You recall complete account with context', type: 'success' },
 ...
 history_adept_d6: {
  ...
  table: [
   { roll: [1, 1], result: 'Minor failure, brief complication', type: 'failure' },
   { roll: [2, 2], result: 'You remember complete details and context', type: 'success' },
   { roll: [3, 4], result: 'You understand all motivations and consequences', type: 'success' },
   { roll: [5, 5], result: 'You identify repeating patterns across eras', type: 'critical' },
   { roll: [6, 6], result: 'You draw deep insights from historical parallels', type: 'critical' }
  ]
 },
 history_adept_d8: {
  ...
  table: [
   ...
   { roll: [2, 2], result: 'You remember complete timeline and context', type: 'normal' },
 ...
 history_adept_d10: {
  ...
  table: [
   ...
   { roll: [5, 6], result: 'You recall complete account with context', type: 'normal' },
 ...
 history_adept_d12: {
  ...
  table: [
   ...
   { roll: [12, 12], result: 'You draw deep insights from multiple perspectives', type: 'critical' }
  ]
 },
 history_adept_d20: {
  ...
  table: [
   ...
   { roll: [20, 20], result: 'You synthesize obscure sources into deep insight', type: 'critical' }
  ]
 },
 ...
 history_expert_d4: {
  ...
  table: [
   ...
   { roll: [4, 4], result: 'You draw deep political and moral insights', type: 'critical' }
  ]
 },
 history_expert_d6: {
 ...
 history_expert_d8: {
  ...
  table: [
   ...
   { roll: [7, 7], result: 'You draw deep insights from historical parallels', type: 'critical' },
 ...
 history_expert_d10: {
  ...
  requiredRank: 'EXPERT',
  table: [
   { roll: [1, 2], result: 'You recall complete facts but miss subtle connections', type: 'failure' },
   ...
   { roll: [10, 10], result: 'You draw deep insights from multiple civilizations', type: 'critical' }
  ]
 },
 history_expert_d12: {
  ...
  table: [
   ...
   { roll: [12, 12], result: 'You synthesize obscure sources into deep insight', type: 'critical' }
  ]
 },
 history_expert_d20: {
 ...
 history_master_d6: {
  ...
  table: [
   ...
   { roll: [6, 6], result: 'You draw deep insights that predict current behavior', type: 'critical' }
  ]
 },
 history_master_d8: {
 ...
 history_master_d10: {
  ...
  table: [
   ...
   { roll: [3, 4], result: 'You remember complete details and context', type: 'success' },
   ...
   { roll: [9, 9], result: 'You draw deep insights from multiple eras', type: 'critical' },
 ...
 history_master_d12: {
  ...
  requiredRank: 'MASTER',
  table: [
   { roll: [1, 2], result: 'You recall complete facts but miss subtle nuance', type: 'failure' },
   { roll: [3, 4], result: 'You remember detailed timeline and all participants', type: 'normal' },
   { roll: [5, 6], result: 'You understand complex motivations and context', type: 'success' },
 ...
 history_master_d20: {
  ...
  table: [
   ...
   { roll: [7, 9], result: 'You identify the culture and time period', type: 'normal' },
   { roll: [10, 12], result: 'You recall key events with context', type: 'normal' },
   { roll: [13, 15], result: 'You piece together complete account', type: 'normal' },
   { roll: [16, 17], result: 'You understand motivations and significance', type: 'success' },
