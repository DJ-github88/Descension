...
const TRADE_ROUTES = [
  ...
  { id: 'trade-iceheart-lanes', name: 'The Iceheart Storm-Lanes', origin: 'merrowport', destination: 'fjord-gate',
    via: ['spindrift-lagoon', 'brinehorse-cove'], cargo: 'Iceheart fish, whale-blubber, storm-glass, deep-sea curios → Nordhalla mammoth-furs, glacier-crystals, runic artifacts',
  ...
  { id: 'trade-north-south', name: 'The Hunger Road', origin: 'fjord-gate', destination: 'emberspire',
    via: ['skalvyrhold', 'frostmaw-holdfast', 'basalt-shyr'], cargo: 'Nordhalla mammoth-furs, runic artifacts → Sundale volcanic coal, forged arms',
