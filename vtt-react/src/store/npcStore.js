...
const NPC_DATA = {
  ...
  'vrael-forty-seventh': {
    ...
    personality: 'Weary, iron-willed, and morally compromised. Vrael leads because she was the forty-seventh remaining Inquisitor and the most senior willing. She has stopped recruiting because the oath now kills more initiates than it survives.',
      backstory: 'Last Commander of the Barbed Vow, Vrael commands forty-six remaining Inquisitors against a tripled incursion rate. The new deep-grove entities have no contracts to sever and no faces to bait, falling outside her entire art. In desperation she has begun training recruits in forbidden binding techniques — borrowing from the traditions the Inquisitors were founded to destroy. Vrael is the forty-seventh High-Severer of the Barbed Vow since the Inquisitor traditions merged in Year 380. Only 47 active Inquisitors remain — the lowest number since the order\'s founding. The Marching Dead and the Cult of Forgotten Shadow have pushed the Inquisition beyond its operational limits.',
    hooks: [
