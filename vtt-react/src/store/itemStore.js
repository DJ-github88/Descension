...
// Define complete categories for organizing items
...
// Function to categorize items with complete categories
...
const useItemStore = create(
  persist(
    (set, get) => ({
      ...
      categories: [...COMPREHENSIVE_CATEGORIES], // Initialize with complete categories
