...
const COMMON_LANGUAGES = [
    ...
    { name: 'Old Nord', icon: 'fa-mountain', category: 'racial', description: 'The ancestral language of the Hrym people, filled with tales of ice and honor.', sound: 'Bold and resonant, echoing with the strength of mountain winds and the clarity of winter air.', example: 'Frost-hold honor-keep', translation: 'Hold fast to honor in the cold' },
