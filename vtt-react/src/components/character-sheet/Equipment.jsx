                            ...
                            return (
                                ...
                                >
                                    <img
                                        ...
                                        onError={(e) => {
                                            console.error('âŒ Image load error for off-hand item:', {
                                                slotName,
                                                itemName: item?.name,
                                                iconId: item?.iconId,
                            ...
                            <div className="header-level" title="Click to adjust level">
                                ...
                                {showLevelControls && (
                                    <div className="header-level-popup">
                                        <button onClick={(e) => { e.stopPropagation(); updateCharacterInfo('level', Math.max(1, (level || 1) - 1)); }} disabled={(level || 1) <= 1}>âˆ’</button>
                                        <span>{level || 1}</span>
