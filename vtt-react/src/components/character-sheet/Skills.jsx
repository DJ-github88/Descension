...
export default function Skills() {
    ...
    const getAvailableQuests = (skillId) => {
        ...
        const baseList = skillQuests.filter(quest => {
            ...
            // Show completed quests and any quest at or below your current proficiency tier
            ...
            <div className="skill-detail-view">
                ...
                {isWeaponMastery && (
                    <div className="damage-type-section">
                        ...
                        {(() => {
                            const iconMap = {
                                sword: 'https://wow.zamimg.com/images/wow/icons/large/inv_sword_04.jpg',
                                axe: 'https://wow.zamimg.com/images/wow/icons/large/inv_axe_17.jpg',
                                mace: 'https://wow.zamimg.com/images/wow/icons/large/inv_mace_20.jpg',
                                dagger: 'https://wow.zamimg.com/images/wow/icons/large/inv_weapon_shortblade_15.jpg',
                                greatsword: 'https://wow.zamimg.com/images/wow/icons/large/inv_sword_34.jpg',
                                greataxe: 'https://wow.zamimg.com/images/wow/icons/large/inv_axe_09.jpg',
                                maul: 'https://wow.zamimg.com/images/wow/icons/large/inv_hammer_16.jpg',
                                polearm: 'https://wow.zamimg.com/images/wow/icons/large/inv_spear_05.jpg',
                                staff: 'https://wow.zamimg.com/images/wow/icons/large/inv_staff_20.jpg',
                                bow: 'https://wow.zamimg.com/images/wow/icons/large/inv_weapon_bow_07.jpg',
                                crossbow: 'https://wow.zamimg.com/images/wow/icons/large/inv_weapon_crossbow_02.jpg',
                                thrown: 'https://wow.zamimg.com/images/wow/icons/large/inv_throwingaxe_03.jpg',
                                wand: 'https://wow.zamimg.com/images/wow/icons/large/inv_wand_11.jpg',
                                unarmed: 'https://wow.zamimg.com/images/wow/icons/large/ability_monk_tigerpalm.jpg'
                            };
                            const hintMap = {
                                sword: 'Balanced strikes',
                                axe: 'Hefty cleaves',
                                mace: 'Blunt impacts',
                                dagger: 'Quick stabs',
                                greatsword: 'Two-handed arcs',
                                greataxe: 'Massive chops',
                                maul: 'Crushing swings',
                                polearm: 'Hooks and reach',
                                staff: 'Sweeps and control',
                                bow: 'Arcing shots',
                                crossbow: 'Precise bolts',
                                thrown: 'Knives, axes, javelins',
                                wand: 'Channel magic',
                                unarmed: 'Fists, knees, elbows'
                            };
                            return (
                                <div className="damage-type-grid weapon-type-grid">
                                    {Object.keys(iconMap).map(w => (
                                        (() => {
                                            const weaponRank = getWeaponTypeRank(w);
                                            const weaponRankStyleVars = buildWeaponRankStyles(weaponRank.color);
                                            return (
                                        <div
                                            key={w}
                                            className={`damage-type-option weapon-type-option ${selectedWeaponType === w ? 'selected' : ''}`}
                                            onClick={() => setSelectedWeaponType(w)}
                                            role="button"
                                            tabIndex={0}
                                            title={`${w.charAt(0).toUpperCase() + w.slice(1)} — ${hintMap[w]}`}
                                            onKeyPress={(e) => (e.key === 'Enter' || e.key === ' ') && setSelectedWeaponType(w)}
                                            style={weaponRankStyleVars}
                                        >
                                                <span className="weapon-rank-chip">{weaponRank.name}</span>
                                                <img src={iconMap[w]} alt={w} className="damage-type-icon weapon-type-icon" />
                                            </div>
                                            );
                                        })()
                                    ))}
