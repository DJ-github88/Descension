...
const CharacterManagement = ({ user }) => {
 ...
 const getClassIcon = (characterClass) => {
  ...
  const classIcons = {
   ...
   'Arcanoneer': 'Ar', 'Berserker': 'Be', 'Shaper': 'Sh', 'Harbinger': 'Ha',

   'Chronarch': 'Ch',    'Inquisitor': 'In', 'Revenant': 'Rv', // 'Dreadnaught' removed (absorbed into Martyr as Ironclad specialization)

   'False Prophet': 'FP', 'Gambit': 'Ga',

   'Lunarch': 'Lu', 'Martyr': 'Ma', 'Minstrel': 'Mi',

   'Plaguebringer': 'Pl', 'Animist': 'An', 'Pyrofiend': 'Py', 'Spellguard': 'Sg',
      ...
      {filteredAndSortedCharacters.map((character) => (
       ...
       <div key={character.id} className={`character-card ${currentCharacterId === character.id ? 'active-character' : ''}`}>
        ...
        <div className="character-card-body">
         ...
         {/* Enhanced Character Details - Show more complete info */}
