...
const generateCombatStats = (type, subtype, quality, powerScale) => {
    ...
    if (type === 'weapon') {
        ...
        if (quality !== 'poor' && quality !== 'common') {
            const resistanceTypes = ['fire', 'cold', 'lightning', 'acid', 'force', 'necrotic', 'radiant', 'poison', 'psychic', 'thunder', 'chaos'];
...
const generateWeaponStats = (subtype, quality, powerScale) => {
    ...
    if (quality !== 'poor' && quality !== 'common') {
        ...
        if (quality !== 'uncommon') {
            const damageTypes = ['fire', 'cold', 'lightning', 'acid', 'force', 'necrotic', 'radiant', 'poison', 'psychic', 'thunder', 'chaos'];
...
const generateCurrencyForContainer = (containerQuality, powerScale) => {
    ...
    return {
        ...
        imageUrl: `getIconUrl('${currencyInfo.icon}', 'items')`,
        ...
        if (type === 'miscellaneous') {
            ...
            if (itemSubtype === 'QUEST') {
                ...
                return {
                    ...
                    subtype: itemSubtype,
                    iconId: iconId,
                    imageUrl: `getIconUrl('${iconId}.jpg`,
                    value: value,
                    width: dimensions.width,
                    height: dimensions.height,
                    rotation: 0,
