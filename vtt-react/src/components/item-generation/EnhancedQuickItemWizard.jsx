...
const generateItemDescription = (type, subtype, quality) => {
  const descriptions = {
    weapon: [
      ...
      'The craftsmanship of this weapon is remarkable, with complex details along its surface.'
    ],
    armor: [
...
const EnhancedQuickItemWizard = ({ onComplete, onCancel, initialData, onRarityChange }) => {
  ...
  const generateContainerItems = useCallback((containerOpts) => {
    ...
    for (let i = 0; i < itemsToGenerate; i++) {
      ...
      if (randomType === 'weapon') {
        ...
        const armorSubtypes = ['LEATHER', 'MAIL', 'PLATE', 'CLOTH'];
  ...
  // Helper function to get random icon for item type using local icons
  const getRandomIconForType = (type, subtype) => {
    // Map item types and subtypes to local icon paths
    const iconMaps = {
      weapon: {
        SWORD: [
          'Weapons/Swords/sword-basic-straight-beige-blade-brown-hilt',
          'Weapons/Swords/sword-curved-sabre-orange-hilt',
          'Weapons/Swords/sword-straight-blue-blade-golden-hilt',
          'Weapons/Swords/sword-broad-blade-brown-handle'
        ],
        AXE: [
          'Weapons/Axe/axe-brown-handle-beige-blade',
          'Weapons/Axe/axe-brown-handle-yellow-head',
          'Weapons/Axe/simple-axe-beige-textured-handle',
          'Weapons/Axe/rustic-axe-beige-blade'
        ],
        MACE: [
          'Weapons/Mace/mace-brown-handle-spiked-head',
          'Weapons/Mace/mace-golden-head-brown-handle',
          'Weapons/Mace/mace-simple-brown-handle'
        ],
        DAGGER: [
          'Weapons/Swords/sword-small-dagger-brown-handle',
          'Weapons/Throwing Knife/throwing-knife-brown-handle-beige-blade'
        ],
        STAFF: [
          'Weapons/Staff/staff-wooden-brown-simple',
          'Weapons/Staff/staff-gnarled-wooden-brown',
          'Weapons/Staff/staff-ornate-golden-top'
        ],
        BOW: [
          'Weapons/Bows/bow-simple-brown-tan-grip',
          'Weapons/Bows/bow-brown-limb-tips-recurve',
          'Weapons/Bows/bow-simple-brown-wrapped-grip'
        ],
        CROSSBOW: [
          'Weapons/Crossbow/crossbow-reddish-brown-loaded',
          'Weapons/Crossbow/crossbow-brown-wooden-simple'
        ],
        WAND: [
          'Weapons/Wand/wand-basic-bow-curved-light-beige-simple',
          'Weapons/Wand/wand-wooden-brown-simple',
          'Weapons/Wand/wand-golden-tip-brown-handle'
        ],
        POLEARM: [
          'Weapons/Polearm/polearm-spear-brown-shaft',
          'Weapons/Polearm/polearm-halberd-brown-handle'
        ],
        THROWN: [
          'Weapons/Throwing Axe/throwing-axe-brown-handle-beige-blade-standard',
          'Weapons/Throwing Knife/throwing-knife-brown-handle-beige-blade'
        ]
      },
      armor: {
        CLOTH: [
          'Armor/Chest/barbarian-leather-tunic',
          'Armor/Chest/textured-beige-tunic',
          'Armor/Chest/belted-brown-tunic'
        ],
        LEATHER: [
          'Armor/Chest/leather-padded-chestplate',
          'Armor/Chest/studded-leather-vest',
          'Armor/Chest/reinforced-leather-cuirass'
        ],
        MAIL: [
          'Armor/Chest/bronze-cuirass',
          'Armor/Chest/bronze-breastplate',
          'Armor/Chest/segmented-bronze-cuirass'
        ],
        PLATE: [
          'Armor/Chest/magical-stone-breastplate',
          'Armor/Chest/golden-emerald-breastplate',
          'Armor/Chest/phoenix-winged-steel-breastplate'
        ],
        SHIELD: [
          'Weapons/Shields/shield-round-brown-wooden',
          'Weapons/Shields/shield-kite-brown-leather',
          'Weapons/Shields/shield-heater-brown-wooden'
        ]
      },
      accessory: {
        RING: [
          'Armor/Finger/finger-ancient-bronze-ring',
          'Armor/Finger/finger-golden-ring-simple',
          'Armor/Finger/finger-silver-ring-ornate'
        ],
        NECKLACE: [
          'Armor/Neck/neck-golden-pendant-simple',
          'Armor/Neck/neck-silver-chain-pendant',
          'Armor/Neck/neck-bronze-amulet'
        ],
        TRINKET: [
          'Misc/Books/book-brown-teal-question-mark',
          'Misc/Quest/quest-scroll-brown-sealed',
          'Misc/Gems/gem-red-ruby-simple'
        ],
        CLOAK: [
          'Armor/Cloak/cloak-brown-woolen-simple',
          'Armor/Cloak/cloak-red-velvet-ornate',
          'Armor/Cloak/cloak-blue-silk-elegant'
        ],
        BELT: [
          'Armor/Waist/waist-leather-belt-brown-simple',
          'Armor/Waist/waist-studded-belt-brown',
          'Armor/Waist/waist-golden-buckle-belt'
        ]
      },
      consumable: {
        POTION: [
          'Misc/Profession Resources/Alchemy/Red/red-potion-angular-flask-base',
          'Misc/Profession Resources/Alchemy/Blue/blue-potion-round-flask',
          'Misc/Profession Resources/Alchemy/Dark Green/dark-green-potion-bottle-bulbous-rounded-beige-glass',
          'Misc/Profession Resources/Alchemy/Yellow/yellow-potion-bottle'
        ],
        SCROLL: [
          'Misc/Books/scroll-brown-parchment',
          'Misc/Books/scroll-sealed-brown',
          'Misc/Books/scroll-magical-glow'
        ],
        FOOD: [
          'Misc/Profession Resources/Cooking/Food/Fruit/red-apple',
          'Misc/Profession Resources/Cooking/Food/Other/bread-loaf-rustic-artisan-slashes',
          'Misc/Profession Resources/Cooking/Food/Vegetables/carrot-orange-ridged-textured'
        ],
        ELIXIR: [
          'Misc/Profession Resources/Alchemy/Purple/purple-potion-vial',
          'Misc/Profession Resources/Alchemy/Orange/orange-potion-flask'
        ],
        BANDAGE: [
          'Misc/Medical/bandage-white-cloth',
          'Misc/Medical/healing-salve-jar'
        ]
      },
      miscellaneous: {
        QUEST: [
          'Misc/Books/book-brown-teal-question-mark',
          'Misc/Quest/quest-scroll-brown-sealed',
          'Misc/Quest/quest-item-golden-seal'
        ],
        REAGENT: [
          'Nature/herb-green-leaf-simple',
          'Nature/mushroom-brown-cap',
          'Nature/flower-red-petal'
        ],
        CRAFTING: [
          'Misc/Materials/leather-strip-brown',
          'Misc/Materials/iron-ore-chunk',
          'Misc/Materials/wood-log-brown'
        ],
        TRADE_GOODS: [
          'Misc/Trade/silk-cloth-roll',
          'Misc/Trade/gem-pouch-brown',
          'Misc/Trade/spice-jar-brown'
        ],
        KEY: [
          'Misc/Keys/key-bronze-simple',
          'Misc/Keys/key-iron-rusty',
          'Misc/Keys/key-golden-ornate'
        ],
        JUNK: [
          'Misc/Junk/broken-sword-hilt',
          'Misc/Junk/rusty-nail',
          'Misc/Junk/torn-cloth-scrap'
        ]
      },
      currency: {
        HANDFUL_OF_COINS: ['Currency/coin-gold-simple', 'Currency/coin-silver-simple'],
        SMALL_POUCH: ['Container/Pouch/pouch-brown-leather-small'],
        MODEST_SUM: ['Currency/coin-pile-gold-silver'],
        COIN_PURSE: ['Container/Pouch/pouch-brown-leather-medium'],
        HEAVY_PURSE: ['Container/Pouch/pouch-brown-leather-large'],
        TREASURE_HOARD: ['Currency/treasure-chest-gold']
      },
      container: {
        CHEST: ['Container/Chest/chest-wooden-brown-simple'],
        BAG: ['Container/Bag/brown-backpack-simple', 'Container/Bag/bag-leather-brown'],
        POUCH: ['Container/Pouch/pouch-brown-leather-small'],
        BARREL: ['Container/Crate/barrel-wooden-brown'],
        CRATE: ['Container/Crate/crate-wooden-brown'],
        SACK: ['Container/Bag/sack-burlap-brown']
      }
    };

    // Try to get subtype-specific icons first
    if (iconMaps[type] && iconMaps[type][subtype] && iconMaps[type][subtype].length > 0) {
      const icons = iconMaps[type][subtype];
      return icons[getRandomInt(0, icons.length - 1)];
    }

    // Fallback to type-specific icons
    if (iconMaps[type]) {
      const typeIcons = Object.values(iconMaps[type]).flat();
      if (typeIcons.length > 0) {
        return typeIcons[getRandomInt(0, typeIcons.length - 1)];
      }
    }
