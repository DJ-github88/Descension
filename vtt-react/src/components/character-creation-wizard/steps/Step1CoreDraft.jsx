...
const CLASS_GROUPS = {
    MARTIALS: ['Berserker', 'Bladedancer', 'Dreadnaught', 'Spellguard', 'Warden', 'Titan', 'Huntress', 'Primalist'],
    CASTERS: ['Arcanoneer', 'Chaos Weaver', 'Chronarch', 'Deathcaller', 'Lichborne', 'Toxicologist', 'Inscriptor', 'Formbender'],
    ZEALOTS: ['Exorcist', 'False Prophet', 'Lunarch', 'Martyr', 'Doomsayer', 'Covenbane'],
    SPECIALISTS: ['Minstrel', 'Oracle', 'Plaguebringer', 'Pyrofiend', 'Witch Doctor', 'Augur', 'Gambler', 'Fate Weaver']
};
...
const ALLOWED_CLASSES_BY_RACE = {
    myrathil: ['Bladedancer', 'Spellguard', 'Chronarch', 'Inscriptor', 'Lunarch', 'Minstrel', 'Oracle'],
    mimir: ['Dreadnaught', 'Arcanoneer', 'Chronarch', 'Toxicologist', 'Doomsayer', 'Oracle', 'Fate Weaver'],
    briaran: ['Huntress', 'Primalist', 'Formbender', 'Lunarch', 'Witch Doctor', 'Warden'],
    groven: ['Dreadnaught', 'Warden', 'Inscriptor', 'Martyr', 'Oracle'],
    emberth: ['Berserker', 'Titan', 'Chaos Weaver', 'Martyr', 'Pyrofiend'],
    vreken: ['Bladedancer', 'Huntress', 'Deathcaller', 'Toxicologist', 'False Prophet', 'Plaguebringer', 'Gambler', 'Covenbane'],
    morthel: ['Dreadnaught', 'Deathcaller', 'Lichborne', 'Doomsayer', 'Plaguebringer'],
    astril: ['Spellguard', 'Chronarch', 'Lunarch', 'Exorcist', 'Augur', 'Fate Weaver'],
    fexrick: ['Berserker', 'Primalist', 'Formbender', 'Martyr', 'Witch Doctor'],
    human: ['Berserker', 'Bladedancer', 'Dreadnaught', 'Warden', 'Spellguard', 'Arcanoneer', 'Chaos Weaver', 'Exorcist', 'Martyr', 'Minstrel', 'Gambler']
};

const ALLOWED_CLASSES_BY_SUBRACE = {
    // Myrathil
    breaker_myrathil: ['Bladedancer', 'Minstrel', 'Oracle', 'Spellguard', 'Chronarch', 'Lunarch'],
    deep_myrathil: ['Chronarch', 'Oracle', 'Inscriptor', 'Spellguard', 'Lunarch', 'Bladedancer'],
    river_myrathil: ['Bladedancer', 'Inscriptor', 'Lunarch', 'Minstrel', 'Oracle', 'Chronarch'],
    // Briaran
    unshorn_briaran: ['Primalist', 'Formbender', 'Witch Doctor', 'Huntress', 'Warden'],
    smoothskinned_briaran: ['Huntress', 'Lunarch', 'Witch Doctor', 'Formbender', 'Warden'],
    // Emberth
    korr_emberth: ['Berserker', 'Titan', 'Pyrofiend', 'Chaos Weaver', 'Martyr'],
    thrask_emberth: ['Berserker', 'Chaos Weaver', 'Martyr', 'Titan', 'Pyrofiend'],
    // Fexrick
    kethrin_fexric: ['Primalist', 'Formbender', 'Witch Doctor', 'Berserker', 'Martyr'],
    drall_fexric: ['Berserker', 'Martyr', 'Witch Doctor', 'Primalist', 'Formbender'],
    // Groven
    morgh_groven: ['Dreadnaught', 'Martyr', 'Oracle', 'Warden', 'Inscriptor'],
    ithran_groven: ['Warden', 'Inscriptor', 'Oracle', 'Dreadnaught', 'Martyr'],
    // Mimir
    maskborne_mimir: ['Arcanoneer', 'Toxicologist', 'Fate Weaver', 'Chronarch', 'Doomsayer', 'Oracle'],
    mistwoven_mimir: ['Chronarch', 'Oracle', 'Fate Weaver', 'Arcanoneer', 'Doomsayer', 'Toxicologist'],
    unwoven_mimir: ['Dreadnaught', 'Doomsayer', 'Oracle', 'Chronarch', 'Toxicologist', 'Fate Weaver', 'Arcanoneer'],
    // Morthel
    velun_morthel: ['Deathcaller', 'Lichborne', 'Doomsayer', 'Dreadnaught', 'Plaguebringer'],
    kessen_morthel: ['Dreadnaught', 'Plaguebringer', 'Doomsayer', 'Deathcaller', 'Lichborne'],
    drun_morthel: ['Dreadnaught', 'Lichborne', 'Deathcaller', 'Doomsayer', 'Plaguebringer'],
    // Astril
    sylen_astril: ['Chronarch', 'Augur', 'Fate Weaver', 'Lunarch', 'Spellguard', 'Exorcist'],
    muren_astril: ['Spellguard', 'Exorcist', 'Augur', 'Chronarch', 'Fate Weaver', 'Lunarch'],
    // Vreken
    clean_vreken: ['Bladedancer', 'Huntress', 'Gambler', 'Toxicologist', 'False Prophet', 'Covenbane'],
    marked_vreken: ['Deathcaller', 'Toxicologist', 'False Prophet', 'Plaguebringer', 'Covenbane', 'Gambler', 'Bladedancer'],
    // Human
    thalren_human: ['Berserker', 'Dreadnaught', 'Warden', 'Martyr', 'Minstrel', 'Exorcist'],
    skald_human: ['Berserker', 'Minstrel', 'Martyr', 'Warden', 'Bladedancer', 'Gambler'],
    tessen_human: ['Spellguard', 'Arcanoneer', 'Chaos Weaver', 'Exorcist', 'Dreadnaught'],
    solvarn_human: ['Exorcist', 'Martyr', 'Spellguard', 'Warden', 'Arcanoneer'],
    merryn_human: ['Bladedancer', 'Gambler', 'Minstrel', 'Warden', 'Chaos Weaver'],
    ordan_human: ['Warden', 'Bladedancer', 'Gambler', 'Martyr', 'Minstrel'],
    morren_human: ['Bladedancer', 'Chaos Weaver', 'Gambler', 'Arcanoneer', 'Spellguard']
};
...
const getClassRestrictionMessage = (className) => {
    if (className === 'Titan') return 'Titan requires Korr Emberth heritage.';
    if (className === 'Covenbane') return 'Covenbane requires Marked Vreken heritage.';
