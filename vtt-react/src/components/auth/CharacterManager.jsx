...
const CharacterManager = ({ isOpen, onClose, onCreateCharacter }) => {
  ...
  const classIcons = {
    ...
    'Arcanoneer': '🔮', 'Berserker': '🪓', 'Shaper': '☯️', 'Harbinger': '⏳',



    'Chronarch': '⏳',     'Inquisitor': '⚖️', 'Revenant': '💀', // 'Dreadnaught' removed (absorbed into Martyr as Ironclad specialization)




 'False Prophet': '👁️', 'Gambit': '🧵',
    ...
    'Lunarch': '🌙', 'Martyr': '🛡️', 'Minstrel': '🎵',



    'Plaguebringer': '☠️', 'Animist': '🌿', 'Pyrofiend': '🔥', 'Spellguard': '🛡️',
