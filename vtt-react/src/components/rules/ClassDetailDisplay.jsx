...
const ClassDetailDisplay = ({ classData, onBack }) => {
 ...
 const renderOverview = () => {
  ...
  const classFallbacks = {
   arcanoneer: { url: '/assets/images/classes/arcanoneer_illustration.png', caption: 'A Velun Neth Vault Custodian Arcanoneer with a heavy pig-iron forearm graft.' },
   berserker: { url: '/assets/images/classes/berserker_illustration.png', caption: 'A Skald Human Iceheart Outcast Berserker holding a massive blood-rusted axe.' },
   false_prophet: { url: '/assets/images/classes/false_prophet_illustration.png', caption: 'A Clean Vreken Herd-Watcher False Prophet preaching the cosmic void.' },
   shaper: { url: '/assets/images/classes/shaper_illustration.png', caption: 'A Morgh Groven Bone-Reader Shaper reshaping bone and sinew.' },
   revenant: { url: '/assets/images/classes/revenant_illustration.png', caption: 'A Marked Vreken Peat-Bog Graverobber Revenant harvesting souls in the Bryngloom.' },
   ...
   inquisitor: { url: '/assets/images/classes/inquisitor_illustration.png', caption: 'A Solvarn Human Barbed-Vow Inquisitor wreathed in cold iron chains.' },
   ...
   chronarch: { url: '/assets/images/classes/chronarch_illustration.png', caption: 'A Sylen Astril Starlight Astrologer Chronarch utilizing time-sand.' },
   ...
   harbinger: { url: '/assets/images/classes/harbinger_illustration.png', caption: 'An Unwoven Mimir Sump Archivist Harbinger channeling entropic friction.' },
