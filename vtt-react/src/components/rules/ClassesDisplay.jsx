...
const CLASS_DATA = [
    ...
    { name: 'Dreadnaught', imageIcon: '/assets/icons/classes/dreadnaught.png', icon: faShield, role: 'Tank', resource: 'Siege Mode', playstyle: 'Be the immovable object. Clad yourself in impenetrable iron and transform into a living fortress that protects allies and crushes all who dare to approach', roleColor: '#3498db', damageTypes: ['necrotic', 'poison', 'psychic'] },
    { name: 'Exorcist', imageIcon: '/assets/icons/classes/exorcist.png', icon: faCross, role: 'Support / Damage', resource: 'Divine Favor', playstyle: 'A beacon of holy fire in a world of shadows. Banish spirits and purge the wicked with radiant light, calling upon divine favor to cleanse the earth', roleColor: '#f1c40f', damageTypes: ['radiant', 'force'] },
    { name: 'False Prophet', imageIcon: '/assets/icons/classes/false_prophet.png', icon: faEye, role: 'Control', resource: 'Deception', playstyle: 'Master the tongue of lies. Corrupt the minds of your enemies with maddening whispers and deceptive visions, turning their own strength against them', roleColor: '#9b59b6', damageTypes: ['psychic', 'void', 'necrotic'] },
    ...
    { name: 'Lichborne', imageIcon: '/assets/icons/classes/lichborne.png', icon: faSkull, role: 'Damage / Control', resource: 'Eternal Frost Aura', playstyle: 'Embrace the cold embrace of the grave. Wield the freezing powers of the undead to drain the warmth from your enemies while you remain eternally resilient', roleColor: '#e67e22', damageTypes: ['necrotic', 'frost'] },
    ...
    { name: 'Martyr', imageIcon: '/assets/icons/classes/martyr.png', icon: faCross, role: 'Tank / Support', resource: 'Pain Points', playstyle: 'Find power in suffering. Absorb damage meant for your allies and transform that pain into a righteous fury that burns hotter than any sun', roleColor: '#3498db', damageTypes: ['radiant', 'fire'] },
