...
const CLASS_DATA = [
    ...
    { name: 'Warden', imageIcon: '/assets/icons/classes/warden.png', icon: faGavel, role: 'Damage / Control', resource: 'Vengeance Points', playstyle: 'Secure the mountain keeps of Nordhalla, carrying a frozen soul and iron veins that shatter if you leave the high passes.', roleColor: '#e67e22', damageTypes: ['physical', 'storm', 'primal'] },
