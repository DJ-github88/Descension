...
const E = [
 {
  ...
  dmOverview: 'This era establishes the cosmic framework. The Deepening cycle is the foundational law of the universe: every star dies and is reborn. Use this era to seed ancient mysteries: Morvane\'s true nature, Mareth\'s agenda, Aex\'s fate before the binding. Players exploring primordial ruins might find records of this age.',
  events: [
   { date: 'Unknown', title: 'The First Ignition', narrative: 'The first stars ignite across the Silence, and each one establishes the **Deepening** (the ancient, cosmic death-rebirth cycle that governs all celestial bodies. This is not a myth. It is a fundamental law of existence, older than any deity, crueler than any scripture. Every star that has ever burned has entered the Deepening, shedding its exhausted light and rekindling from within, surrounded by starless space. Every star has successfully emerged from its slumber) until Sol. This cosmic rule ensures that a star\'s vulnerability is also its ultimate furnace, but the dimming phase acts as a universal broadcast, signaling across the Silence to entities that feed on fading light.', dmHook: 'A pre-Deepening artifact, older than any known civilization, surfaces in the Cragjaw Peaks. The Fexrick claim it predates their oldest holdfasts by millennia. It hums at a frequency that makes Astril heritage weep.' },
 ...
 },
 {
  ...
  events: [
   { date: 'Year 89, Dimming', title: 'The Stasis of Aldren Thalreth the Elder', narrative: 'Fearing the total loss of his memory to the creeping Frostwood fog, High Confessor **Aldren Thalreth the Elder** (ancestor of the line that still rules Greymark) journeys to Nordhalla and seals himself in meditative stasis inside a block of warm, glowing ice within the Frozen Archive. Scribe-Sentinels stand watch eternally to record any telepathic whispers from the frozen saint.', dmHook: 'The Elder\'s stasis chamber is radiating accelerated heat. If the ice melts, his return will trigger a massive theological crisis, as his last journals contradict the Church\'s official scriptures regarding the Breach.' },
   ...
   { date: '~650 BP', title: 'The Neth Bargain for Immortality', narrative: 'A dying, memory-starved clan of human scribes walks into the dark boundary where the Bryngloom\'s ancient ironwood meets the preserving bog. Rather than offering prayers, they present the **Morvane** with a calculated legal argument for their own survival, formatted as a contract. Morvane, bound by its own cosmic drive for order, accepts the terms. The **Neth** rise from the peat-bog with stilled breath, pure-pale skin, and a contract written in blood. Death becomes a clause to renegotiate rather than an ending. In exchange, every contract written by the **Velun Neth** carries Morvane\'s absolute authority, and every broken contract is enforced by the entity that preserves them, while the **Drun** undergo a painful ritual to sever their names from the First Ledger, living debt-free but legally non-existent.', dmHook: 'The original First Contract is preserved in the heartwood of Atropolis. It is a living document (it grows, it changes, and it remembers every Neth who has ever signed it. A Neth character who touches the First Contract sees every ancestor\'s signature glowing beneath their own) and realizes that one signature, near the bottom, has been deliberately burned away. Someone was erased from the contract. The Drun know who it was. They are not answering.' },
    { date: 'Year 150, Dimming', title: 'The Unlit Veil Reach Synod Hold', narrative: 'The first **Unlit Veil** couriers arrive at Synod Hold, offering "trade consultation services" and navigation charts. This marks the beginning of their slow intelligence infiltration of the Sundrift Vale, positioning advisors at every Ordavan minister\'s elbow. The Veil are Astril who have learned to suppress their markings, the only Astril who can lie without their skin betraying them, making them the perfect spies.', dmHook: 'An Unlit Veil memory-crystal from this first contact is locked in the Synod vault. It contains the names of House Ordavan nobles who traded grazing rights for Vecross secrets: and the First Liar still holds those names as exploit.' },
    { date: '~600 BP', title: 'The Astril Are Born', narrative: 'The fragments of Lumia\'s biosphere, the living memory of a world that died before Mythrill\'s sky went dark, realize they cannot survive in the starless Silence. They descend to Mythrill, finding sanctuary in willing human herders and throat-singers of the Sundrift Vale. The **Astril** are born: mortals whose skin bears shimmering, luminous patterns that ebb and flow with faith and emotion. They are not passengers; they are refugees carrying the memories of a world that once held light. The Astril elders govern the community as a loose council of the oldest bloodlines, though the singers watch in silent despair as the oldest memories fade one by one.', dmHook: 'One fragment of Lumia refused to enter a vessel. It remains in the Silence above Mythrill (the last light visible in the starless sky. The Astril call it "the Remnant." It has been growing brighter for the past decade. The Astril elders refuse to acknowledge this. An Astril Oracle who looks directly at the Remnant receives visions that no other Oracle can access) but the heritage within them screams the entire time.' },
   ...
   { date: 'Year 500, Dimming', title: 'The Mounds Fall Silent', narrative: 'Nomadic clans of the Sundrift Vale report that three major ancestral burial mounds have fallen completely silent. The low-frequency hum that guided migrations for centuries vanishes, causing herders to lose their way in the starless steppes.', dmHook: 'The mounds didn\'t fall silent naturally. The Unlit Veil excavated their cores, siphoning the ancestral resonance into memory-crystals for sale in the south. The First Liar now possesses three hundred years of stolen Ordan ancestor-voices: and is listening.' },
   { date: '~300 BP', title: 'The Erasure of House Viridane', narrative: 'Determined to justify their own survival, the six capitulating noble houses spend three centuries systematically erasing every record of **House Viridane**\'s existence (the house that said *no*, the house that chose flight over sacrifice. Official histories are rewritten, libraries are burned, and lineages are forged. The lie holds in all human capitals: there were always only seven houses. The thorn-born **Briaran** become the only living archive of the eighth house\'s existence, their oral tradition and migrating briar-scars keeping the memory of the refusal alive in the deep fog.', dmHook: 'A hidden chamber beneath the oldest Briaran grove contains the Viridane family tree, grown from thorn-vine and preserved in moon-silver. It shows every descendant) and it shows that the bloodline did not die out. A living Viridane heir exists somewhere in the Frostwood Reach, unaware of their heritage. The Briaran Lunarchs know who it is. They have been protecting this person for generations.' },
       { date: 'Year 598, Dimming', title: 'First Contact with the Silence', narrative: 'The Cult of Forgotten Shadow\'s inner circle makes first contact with **The Silence Between Stars**-an amorphous silence entity that whispers from the dark sky, instructing shadow priests on the locations of the Monoliths.', dmHook: 'The contact was initiated by an Astril heretic who tried to bind their Lumia heritage with shadow magic, creating a permanent beacon for the Silence.' },
 ...
 },
 {
  ...
  events: [
       { date: 'Year 720, Dimming', title: 'Silence-Heat Engine Construction', narrative: 'A secret faction within the Frozen Archive, the **Cult of Forgotten Shadow**, begins clandestine construction of Silence-heat engines in the sealed lower vaults, attempting to melt the glaciers from within.', dmHook: 'The engines run on siphoned soul-warmth. Several missing Skald trackers\' bodies have been found drained of heat near the vents.' },
