...
const E = [
 ...
 },
 {
  ...
  events: [
   ...
   { date: 'Year 11, Deepening', title: 'The Myrathil Explosion', narrative: 'As the cataclysmic ash-cloud of Emberspire\'s eruption hits the freezing oceans, it triggers a global ecological event. The violent collision of superheated volcanic lava-flows and melting glacial runoff creates massive, miles-wide fields of warm oceanic foam along every coastline. These are the perfect, fertile conditions for the spawning of the **Myrathil**. In a single season of steam and storm, thousands of foam-born infants wash onto the beaches of the Iceheart Sea. The **sea mother**, the vast semi-conscious intelligence of the deep, watches her new children emerge with glowing bioluminescent veins and webbed fingers. She does not speak to them, but she guides the currents to protect them, shaping the **Breakers-Born** to navigate the floating ports, the **Deep-Born** to tend the oceanic trenches, and the **River-Fed** to explore the inland waters as her silent, watery eyes.', dmHook: 'The spawning explosion wasn\'t random. The sea mother deliberately created the conditions (a response to the breach, an immune reaction of the ocean itself. The Myrathil are her antibodies, grown to fight a spiritual infection. But the sea mother cannot tell them this directly. She can only send more storms, more foam, more children) and hope they figure out what they were born to do.' },
 ...
 },
 {
  ...
  events: [
   ...
   { date: 'Year 150, Dimming', title: 'The Unlit Veil Reach Synod Hold', narrative: 'The first **Unlit Veil** couriers arrive at Synod Hold, offering "trade consultation services" and navigation charts. This marks the beginning of their slow intelligence infiltration of the Sundrift Vale, positioning advisors at every Ordavan minister\'s elbow. The Unlit (Astril born without star-glow) are the only Astril who can lie without their skin betraying them, making them the perfect spies.', dmHook: 'An Unlit Veil memory-crystal from this first contact is locked in the Synod vault. It contains the names of House Ordavan nobles who traded grazing rights for Vecross secrets: and the First Liar still holds those names as exploit.' },
   { date: '~600 BP', title: 'The Astril Are Born', narrative: 'The constellation-spirits of Sol\'s celestial court (the stars Keth-Amar failed to consume) realize they cannot survive in the starless Silence. They descend to Mythrill, finding sanctuary in willing human herders and throat-singers of the Sundrift Vale. The **Astril** are born: mortals whose skin bears shimmering, luminous patterns that ebb and flow with faith and emotion. The spirits are not passengers; they are refugees carrying the memories of a sky that once held light. They establish the *Luminarchy*, a strict, light-inherited theocracy built around the star-bloodlines, though the singers watch in silent despair as the oldest constellations fade one by one from the northern sky.', dmHook: 'One constellation-spirit refused to enter a vessel. It remains in the Silence above Mythrill (the last star visible in the starless sky. The Astril call it "the Remnant." It has been growing brighter for the past decade. The Luminarchy refuses to acknowledge this. An Astril Oracle who looks directly at the Remnant receives visions that no other Oracle can access) but the spirit within them screams the entire time.' },
   ...
   { date: 'Year 500, Dimming', title: 'The Mounds Fall Silent', narrative: 'Nomadic clans of the Sundrift Vale report that three major ancestral burial mounds have fallen completely silent. The low-frequency hum that guided migrations for centuries vanishes, causing herders to lose their way in the starless steppes.', dmHook: 'The mounds didn\'t fall silent naturally. The Unlit Veil excavated their cores, siphoning the ancestral star-resonance into memory-crystals for sale in the south. The First Liar now possesses three hundred years of stolen Ordan ancestor-voices: and is listening.' },
   { date: '~300 BP', title: 'The Erasure of House Viridane', narrative: 'Determined to justify their own survival, the six capitulating noble houses spend three centuries systematically erasing every record of **House Viridane**\'s existence (the house that said *no*, the house that chose flight over sacrifice. Official histories are rewritten, libraries are burned, and lineages are forged. The lie holds in all human capitals: there were always only seven houses. The thorn-born **Briaran** become the only living archive of the eighth house\'s existence, their oral tradition and migrating briar-scars keeping the memory of the refusal alive in the deep fog.', dmHook: 'A hidden chamber beneath the oldest Briaran grove contains the Viridane family tree, grown from thorn-vine and preserved in moon-silver. It shows every descendant) and it shows that the bloodline did not die out. A living Viridane heir exists somewhere in the Frostwood Reach, unaware of their heritage. The Briaran Lunarchs know who it is. They have been protecting this person for generations.' },
       { date: 'Year 598, Dimming', title: 'First Contact with the Silence', narrative: 'The Cult of Forgotten Shadow\'s inner circle makes first contact with **The Silence Between Stars**-an amorphous silence entity that whispers from the dark sky, instructing shadow priests on the locations of the Monoliths.', dmHook: 'The contact was initiated by an Astril heretic who tried to bind their constellation-spirit with shadow magic, creating a permanent beacon for the Silence.' },
