...
const SettingsWindow = memo(function SettingsWindow({ activeTab: propActiveTab }) {
    ...
    // Handle short rest (GM only)
    const handleShortRest = () => {
        if (!isGMMode) return;
        takeShortRest();
    };

    // Handle long rest (GM only)
    ...
    const renderInterfaceTab = () => (
        <div className="settings-content-clean">
            <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
                ...
                {/* Offline & Performance Settings Section */}
                <div style={{
                    marginTop: '32px',
                    paddingTop: '24px',
                            ...
                            <div className="settings-group">
                                ...
                                <div className="control-group">
                                    ...
                                    <div className="control-help" style={{ marginTop: '16px' }}>
                                        <p><strong>Short Rest:</strong> Restores a portion of HP and Mana based on each character's Spirit stat. Recovery starts at 25% and increases by 5% per Spirit modifier (minimum 25%, maximum 75%). Action Points are fully restored. All temporary HP, Mana, and AP are removed.</p>
                                        <p style={{ marginTop: '12px' }}><strong>Long Rest:</strong> Fully restores HP, Mana, and Action Points to maximum for all party members. All temporary HP, Mana, and AP are removed. Typically represents 8 hours of rest.</p>
                                    </div>
                                </div>
                            </div>
                        )}
