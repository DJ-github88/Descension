...
const QuestReward = ({ reward, type, onRemove }) => {
        ...
        {gold > 0 && (
          <div className="quest-reward-currency-item">
            <img
              ...
              alt="Gold"
              className="quest-reward-currency-icon coin-gold"
              onError={(e) => {
        ...
        {silver > 0 && (
          <div className="quest-reward-currency-item">
            <img
              src={getIconUrl('Container/Coins/golden-coin-single-isometric', 'items')}
              alt="Silver"
              className="quest-reward-currency-icon coin-silver"
              onError={(e) => {
                e.target.onerror = null;
        ...
        {copper > 0 && (
          <div className="quest-reward-currency-item">
            <img
              src={getIconUrl('Container/Coins/golden-coin-single-isometric', 'items')}
              alt="Copper"
              className="quest-reward-currency-icon coin-copper"
              onError={(e) => {
                e.target.onerror = null;
  ...
  if (type === 'item') {
    ...
    const iconId = reward.iconId || 'Misc/Books/book-brown-teal-question-mark';
    const imageUrl = reward.imageUrl || getIconUrl(iconId, 'items');
        ...
        >
          ...
          >
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = getIconUrl('Misc/Gems/gem-red-ruby-simple', 'items');
              }}
            />
            {reward.count > 1 && (
