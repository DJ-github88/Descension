...
const DamageEffects = () => {
 ...
 const handleResolutionChange = (resolution) => {
  ...
  // Create a complete config update to avoid multiple state updates
  const configUpdate = {
 ...
 const getCharacterStatsByCategory = () => {
  return {
   'Primary Attributes': [
    ...
    { key: 'charisma', name: 'Charisma', description: 'Social influence, leadership, and sacred magic' }
   ],
   'Combat Stats': [
 ...
 const getDiceFormulaExamples = () => {
  return [
   ...
   { name: 'Radiant Wrath', formula: '5d8 + spirit + holyDamage + MAX(intelligence, spirit)', description: 'Massive sacred damage with stat synergy' },
