...
const MAGIC_DAMAGE_SUBTYPES = [
 ...
 { id: 'psychic_damage', name: 'wyrd', icon: 'Psychic/Mind Strike', description: 'Restrict psychic damage specifically.' },
  { id: 'radiant_damage', name: 'ember', icon: 'Radiant/Radiant Beam', description: 'Restrict radiant/sacred damage specifically.' },
...
const ControlEffects = ({ state, dispatch, actionCreators, getDefaultFormula, onChange }) => {
 ...
 const isInstantEffect = (controlType, effectId) => {
  // Forced movement effects are usually instant
  ...
  // Restriction effects are usually not instant (they have duration)
  if (controlType === 'restriction') {
   return false;
  }
