  ...
  const getResourceTypeDisplay = () => {
    if (baseType === 'restoration') {
      ...
      const iconMap = {
        ...
        mana: 'Arcane/Orb Manipulation',
        inferno: 'Fire/Fiery Skull',
        action_points: 'Utility/Utility',
        energy: 'Utility/Glowing Orb',
        rage: 'General/Sword',
        focus: 'Utility/Target Crosshair'
      };

      return (
        <>
          <img
            src={getAbilityIconUrl(iconMap[resourceType] || 'Utility/Utility', 'abilities')}
            alt={displayName}
            className="wow-element-icon"
            onError={(e) => {
              e.target.onerror = null;
                        ...
                        value={
                          <div className="creature-info">
                            <img
                              ...
                              onError={(e) => {
                                e.target.onerror = null;
                                e.target.src = getCreatureTokenIconUrl(null, null);
                              }}
                            />
