...
export const formatFormulaToPlainEnglish = (formula, type = 'damage') => {
 ...
 // Convert marks to spaces and handle camelCase
...
export const formatFormulaToReadableText = (formula, drawCount = 4) => {
 ...
 readableText = readableText.replace(/\b(holydamage|holyDamage)\b/gi, 'sacred mastery');
 ...
 // Technical variables to readable format - complete list
...
// complete function to ensure any string gets properly formatted
