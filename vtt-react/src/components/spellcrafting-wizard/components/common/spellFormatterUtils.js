...
const getThematicResistanceDescription = (resistanceLevel, damageType) => {
  const thematicDescriptions = {
    vampiric: {
      ...
      void: 'Silence Feast (heals for 200% of silence damage taken)',
    ...
    absorbing: {
      ...
      void: 'Silence Absorb (heals for 100% of silence damage taken)',
    ...
    draining: {
      ...
      void: 'Silence Sap (heals for 50% of silence damage taken)',
    ...
    siphoning: {
      ...
      void: 'Silence Siphon (heals for 25% of silence damage taken)',
    ...
    immune: {
      ...
      void: 'Silence Immunity (takes no silence damage)',
    ...
    resistant: {
      ...
      void: 'Silence Ward (takes half silence damage)',
    ...
    highly_resistant: {
      ...
      void: 'Silence Barrier (takes 25% silence damage)',
    ...
    guarded: {
      ...
      void: 'Silence Guard (takes 75% silence damage)',
    ...
    slight_reduction: {
      ...
      void: 'Silence Reduction (reduces silence resistance by 25%)',
    ...
    nullified: {
      ...
      void: 'Silence Nullification (removes all silence resistance)',
    ...
    susceptible: {
      ...
      void: 'Silence Weakness (takes 125% silence damage)',
    ...
    exposed: {
      ...
      void: 'Silence Exposure (takes 150% silence damage)',
    ...
    vulnerable: {
      ...
      void: 'Silence Curse (takes double silence damage)',
