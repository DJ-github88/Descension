          ...
          {Object.entries(selectedToxicTypes).length > 0 ? (
           Object.entries(selectedToxicTypes).map(([toxicId, count]) => {
            ...
            const toxicTypes = isChordSystem ? [
             ...
             { id: 'dominant', name: 'Dominant', color: '#55FFFF', wowIcon: 'Radiant/Radiant Aura', theory: 'The dominant is the fifth degree of the scale, creating strong tension that usually resolves to the tonic, driving harmonic progression.' },
