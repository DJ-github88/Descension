...
const STEP_MECHANICS_SYSTEMS = {
 ...
 CHORD_SYSTEM: {
  ...
  chordFunctions: [
   ...
   { id: 'dominant', name: 'Dominant', description: 'The fifth scale degree (V)', color: '#55FFFF', wowIcon: 'Radiant/Radiant Aura', theory: 'The dominant is the fifth degree of the scale, creating strong tension that usually resolves to the tonic, driving harmonic progression.' },
