...
const Step1BasicInfo = ({ onNext, onPrevious, stepNumber, totalSteps, isActive }) => {
  ...
  const allElements = [
    ...
    { id: 'sacred', name: 'Sacred', description: 'Sacred radiance that smites the unholy and blesses the faithful', iconPath: 'Radiant/Radiant Divinity', iconCategory: 'abilities', color: '#DAA520' },
  ];
