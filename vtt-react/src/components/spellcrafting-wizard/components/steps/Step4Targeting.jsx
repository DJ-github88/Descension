              ...
              {TARGET_SELECTION_METHODS.map(method => {
                ...
                return (
                  ...
                  >
                    <div className="targeting-option-header">
                      <img
                        src={getLocalIconUrl(method.icon)}
                        onError={(e) => {
                          e.target.onerror = null;
                          e.target.src = getCustomIconUrl('Utility/Utility', 'abilities');
                        }}
                    ...
                    <div className="targeting-options">
                      {TARGET_RESTRICTIONS.filter(r =>
                        ...
                        >
                          <div className="targeting-option-header">
                            <img
                              src={getLocalIconUrl(restriction.icon)}
                    ...
                    <div className="targeting-options">
                      {AOE_SHAPES
                        ...
                        >
                          <div className="targeting-option-header">
                            <img
                              src={getLocalIconUrl(shape.icon)}
                              alt={shape.name}
                              className="targeting-option-icon"
                              onError={(e) => {
                                e.target.onerror = null;
                      ...
                      <div className="targeting-options">
                        {PROPAGATION_BEHAVIORS[selectedPropagation].map(behavior => (
                          ...
                          >
                            <div className="targeting-option-header">
                              <img
                                src={getLocalIconUrl(behavior.icon)}
                                alt={behavior.name}
                                className="targeting-option-icon"
                                onError={(e) => {
                                  e.target.onerror = null;
