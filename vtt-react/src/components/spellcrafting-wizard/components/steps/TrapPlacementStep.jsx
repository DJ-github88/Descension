...
const TrapPlacementStep = ({ stepNumber, totalSteps, onNext, onPrevious, isActive }) => {
 ...
 const handleNext = () => {
  ...
  // Traps usually affect targets that trigger them or are in their vicinity
  ...
  >
   <div className="trap-placement-container">
    ...
    <div className="trap-detection-section">
     ...
     <p className="section-description">
      Configure how the trap can be detected and disarmed by characters. The trap's trigger area is usually the same as its size, but the spell effects may have a different area of effect when triggered.
     </p>
