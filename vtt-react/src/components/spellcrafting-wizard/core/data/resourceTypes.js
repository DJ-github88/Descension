...
export const STANDARD_RESOURCE_TYPES = [
  ...
  export const CLASS_RESOURCE_TYPES = [
    ...
    },
    {
      ...
      name: 'Focus',
      shortName: 'FC',
      description: 'Concentration used for Huntress abilities',
      color: '#e5a561',
      icon: 'ability_hunter_focusfire',
      defaultMax: 100,
      defaultRegen: 10,
      regenTrigger: 'passive',
      classRestriction: 'huntress',
    ...
    },
    {
      ...
      classRestriction: 'augur',
      affectedBy: ['specialization'],
      formula: 'Spec-dependent max: Auspex 10, Harbinger 5, Hierophant 15. Generated from even d20 results.',
      useVerb: 'spend',
      gainVerb: 'generate',
      vital: false,
      displayPriority: 3,
      subType: 'omen',
      pairedResource: 'malediction'
    },
    {
      id: 'malediction',
      name: 'Malediction',
      ...
      classRestriction: 'augur',
      affectedBy: ['specialization'],
      formula: 'Spec-dependent max: Auspex 10, Harbinger 15, Hierophant 5. Generated from odd d20 results.',
      useVerb: 'spend',
      gainVerb: 'generate',
      vital: false,
      displayPriority: 3,
      subType: 'omen',
      pairedResource: 'benediction'
    },
    {
      id: 'havoc',
      name: 'Havoc',
