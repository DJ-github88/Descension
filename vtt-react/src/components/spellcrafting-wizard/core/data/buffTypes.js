...
export const BUFF_CATEGORIES = [
 {
  ...
  stackingRule: 'Same stat bonuses from different sources stack, but identical buffs do not',
  duration: 'medium',
  dispellable: true,
 ...
 },
 {
  ...
  icon: faGauge,
  examples: ['Heroism', 'Dawn\'s Favor', 'Shield of Faith'],
