...
/**
 * Combined spell power metrics for complete evaluation
 */
 ...
 */
 ...
 /**
 * Generate a complete balance analysis and recommendations
 * @param {Object} spell - The spell to evaluate
 * @param {Object} context - Evaluation context
...
function calculateBuffStackingPotential(spell, context = {}) {
 ...
 // Check for buff types that stack well
 const buffTypes = getBuffTypes(spell);
...
function calculateBuffSynergyValue(spell, context = {}) {
 ...
 // Check for buff types that have good synergies
 const buffTypes = getBuffTypes(spell);
...
function calculateProactiveAlternativeValue(spell, context = {}) {
 ...
 // Proactive spells 20% more efficient than reactive
...
function calculateComboMultiplier(spell, comboRole, context = {}) {
 ...
 switch (comboRole) {
 case 'builder':
  multiplier = 0.8; // Builders weaker individually
  break;
 case 'spender':
  multiplier = 1.2; // Spenders stronger
  break;
 case 'setup':
