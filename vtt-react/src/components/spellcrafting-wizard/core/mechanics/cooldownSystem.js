...
export function reduceCooldown(spellId, amount, options = {}) {
 ...
 case 'short_rest':
 case 'long_rest':
  // These types don't support reduction unless explicitly enabled
 ...
 case 'dice_based':
  // Dice-based cooldowns would reset on a successful roll
 ...
 case 'encounter':
  // These don't support reduction unless explicitly enabled
...
export function refreshCooldown(spellId) {
 ...
 case 'charge_based':
  // For charge-based, refreshing means resetting the charge regeneration timer
  if (_cooldowns.charges[spellId]) {
...
export function calculateBaseCooldown(spell) {
 ...
 // This would come from a character or talent system
...
export function onCooldownStart(spellId) {
 ...
 // This would dispatch events to other systems
