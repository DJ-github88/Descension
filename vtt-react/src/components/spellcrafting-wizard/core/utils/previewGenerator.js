    ...
    case 'area':
     ...
     switch (config.targetingConfig.areaShape) {
      ...
      case 'sphere':
       ...
       break;
      case 'cone':
       results.targets = Math.ceil(areaSize / 8); // Cones hit fewer targets
       break;
      case 'line':
       results.targets = Math.ceil(areaSize / 10); // Lines hit fewer targets
       break;
      default:
  ...
  switch (primaryEffect) {
   case 'damage':
    if (spellConfig.effectConfig.damageConfig && spellConfig.effectConfig.damageConfig.damageTypes) {
     ...
     else if (damageType === 'sacred') iconClass = 'spell-icon-sacred';
     else if (damageType === 'ember' || damageType === 'ember') iconClass = 'spell-icon-sacred';
    }
    break;
   case 'healing':
