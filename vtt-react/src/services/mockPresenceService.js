...
// Note: Paths are the 9 custom paths (Mystic, Zealot, Trickster, Harrow, Arcanist, Hexer, Reaver, Mercenary, Sentinel)
// Backgrounds are standard D&D backgrounds (Acolyte, Sage, Criminal, etc.)
...
const MOCK_USERS = [
  {
    ...
    class: 'Titan',
    path: 'reaver',
    pathDisplayName: 'Reaver',
    background: 'soldier',
    backgroundDisplayName: 'Soldier',
    race: 'Grimheart',
    subrace: 'Mountain Dwarf',
    raceDisplayName: 'Mountain Dwarf',
    status: 'online',
  ...
  },
  {
    ...
    class: 'Lunarch',
    path: 'sentinel',
    pathDisplayName: 'Sentinel',
    background: 'sage',
    backgroundDisplayName: 'Sage',
    race: 'Thornkin',
    subrace: 'Courtly Thornkin',
    raceDisplayName: 'Courtly Thornkin',
    status: 'online',
    sessionType: 'multiplayer',
    roomId: 'room_dragons_lair',
    roomName: "Dragon's Lair",
  ...
  },
  {
    ...
    backgroundDisplayName: 'Outlander',
    race: 'Ashmark',
    subrace: 'War Orc',
    raceDisplayName: 'War Orc',
    status: 'online',
    sessionType: 'local',
    roomId: null,
    roomName: null,
  ...
  },
  {
    ...
    class: 'Pyrofiend',
    path: 'mystic',
    pathDisplayName: 'Mystic',
    background: 'acolyte',
    backgroundDisplayName: 'Acolyte',
    race: 'Nordmark',
    subrace: 'Berserker',
  ...
  },
  {
    ...
    class: 'Bladedancer',
    path: 'trickster',
    pathDisplayName: 'Trickster',
    background: 'criminal',
    backgroundDisplayName: 'Criminal',
    race: 'Wildkin',
    subrace: 'Lightfoot Halfling',
    raceDisplayName: 'Lightfoot Halfling',
    status: 'away',
    sessionType: 'local',
    roomId: null,
    roomName: null,
  ...
  },
  {
    ...
    class: 'Inscriptor',
    path: 'arcanist',
    pathDisplayName: 'Arcanist',
    background: 'sage',
    backgroundDisplayName: 'Sage',
    race: 'Nordmark',
    subrace: 'Skald',
    raceDisplayName: 'Skald Nordmark',
    status: 'online',
    sessionType: 'multiplayer',
    roomId: 'room_dragons_lair',
    roomName: "Dragon's Lair",
