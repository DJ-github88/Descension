...
export const GENERAL_SPELLS = [
 // Note: Attack spell has been removed - use shifting Attack (Unarmed) from weaponIntegration instead
];
...
export const GENERAL_SPELLS_CATEGORY = {
 ...
 description: 'Common craft taught in every holding from Merrowport to Greymark. Universal baseline spells and actions available to all classes',
...
export const GENERAL_REACTIONS_CATEGORY = {
 ...
 description: 'The instinct-flinch of a Frostwood Reach bog-treader. Reactive abilities available to all characters',
