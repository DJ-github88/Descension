...
export const UNIVERSAL_COMBAT_SPELLS = [
 ...
 },
 {
  ...
  name: 'Interpose',
  description: 'Combat magic is the oldest negotiation. when an ally within 10 ft. is attacked, push them 5 ft. to safety and take the hit. Make a Strength save using an easy difficulty die ( d6); on a miss the ally falls prone.',
  level: 1,
  spellType: 'REACTION',
  effectTypes: ['utility'],
  source: 'general',
 ...
 },
 {
  ...
  controlConfig: {
   ...
   effects: [{
    id: 'stun',
    name: 'Stun',
    description: 'Combat magic is the oldest negotiation. target is stunned until end of their next turn',
    config: {
 ...
 // ===== ADDITIONAL COMBAT ACTIONS =====
 {
  id: 'universal_move',
  name: 'Move',
  description: 'Move up to your movement speed ( 30 feet). This movement can be broken up between other actions.',
  level: 1,
  spellType: 'ACTION',
  effectTypes: ['utility'],
  source: 'general',
  ...
  utilityConfig: {
   ...
   selectedEffects: [{
    id: 'move',
    name: 'Move',
    description: 'Move up to your movement speed ( 30 feet)',
    distance: 30,
