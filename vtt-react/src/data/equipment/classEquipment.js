...
export const GAMBIT_ITEMS = [
    ...
    
    {
        ...
        subtype: 'TOOL',
        quality: 'uncommon',
        description: 'A deck of cards imbued with fate magic. Once per combat, draw a card for a random minor effect: +1d4 to your next attack, +2 to a saving throw, or gain 1 Fortune.',
...
// Inscriptor items removed (tradition folded into Animist)
// Witch Doctor and Arcanophage items removed (traditions folded into Animist)
...
// Primalist items removed (tradition folded into Animist)
...
export const APEX_ITEMS = [
    ...
    },
    {
        ...
        subtype: 'TRINKET',
        quality: 'uncommon',
        description: 'A trinket that enhances your ability to mark and track targets. Your Mark Quarry ability gains +1 additional Mark on use.',
        iconId: 'inv_misc_enggizmos_19',
        value: { platinum: 0, gold: 9, silver: 0, copper: 0 },
        weight: 0.5,
        width: 1,
