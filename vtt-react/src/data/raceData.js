...
**Ironfrost Nordmark**: The true children of winter, these survivors have been claimed by the endless cold, their flesh hardening like permafrost that never thaws. They walk paths where others perish, surviving on frost-rimed berries and the flesh of creatures frozen mid-stride. Their skin cracks and bleeds in summer's false warmth, revealing the blue-black ice beneath that betrays their true nature. Ironfrost speak of the Deep Frost, an ancient entity that offers survival at the cost of warmth itself. They serve as scouts and guardians in the deepest wastes, their presence a constant reminder that some Nordmark belong more to the storm than to their own kind. Many Ironfrost vanish into blizzards, their bodies eventually indistinguishable from the ice formations they so resemble.`,
