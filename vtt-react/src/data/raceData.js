...
export const RACE_DATA = {
    nordmark: {
        id: 'nordmark',
        name: 'Nordmark',
        description: 'Tall folk with pale skin scarred by wind and steel. Their breath freezes in the air even when it shouldn\'t. Hair braided with bone and iron, eyes like winter sky. Bloodlines old as the ice itself, tracing back to kings who carved their names in glacier stone.',
        icon: 'fas fa-mountain',
        overview: 'The Nordmark are a physically imposing people, typically standing six to seven feet tall with broad shoulders and powerful frames built for survival in the harshest climates. Their skin ranges from pale to ruddy, often marked by scars from battle and exposure, while their hair, most commonly shades of blonde, white, or dark brown, is kept long and braided in clan-specific patterns. Their eyes, usually blue, gray, or pale green, hold the hard light of those who have stared into endless blizzards and survived. Most distinctively, all Nordmark exhale visible frost even in temperate climates, their breath crystallizing in the air, a permanent mark of their bond with the cold. Their bloodlines trace back to warrior-kings who first dared to claim kingdoms from the endless white, and through generations shaped by cold that would shatter stone, they have become something more than merely human. The north does not merely test them. It remakes them, each winter breeding a harder people, each storm tempering resolve into something almost inhuman. Their culture is a web of ancient clans, each bound by blood oaths older than written history, each carrying feuds that have outlived kingdoms. The longhouses stand as monuments to survival, their walls echoing with sagas of glory and loss, whispered in tongues that predate the common speech. Here, honor is not taught. It is inherited, flowing through veins like the cold itself, manifesting differently in each bloodline. Some seek honor in battle-glory, others in preserved secrets, still others in mere endurance. But all Nordmark share one truth: in the north, winter claims what it will, and only those who embrace the cold may survive it.',
        culturalBackground: `Longhouses rise from the snow, timbers black with old smoke, runes carved deep by hands long cold. Inside, firelight casts shadows across faces carved by wind and blade. Clan bloodlines bind everything here. Not just who birthed you, but which ancestor your clan claims, what debts your blood owes, what feuds demand your death. Every clan traces back to some warrior-king who carved his name in ice with steel stained red. Those names live on in runestones marking burial mounds where the snow won't settle right. The old stories say those ancestors still watch. Spirits bound to the aurora, voices in the howl of blizzards, whispers in the crack of glacier ice. Children learn the clan web before they know their own names. Which bloodlines are bound by marriage-kin, which ones have spilled blood for generations, which debts must be paid before honor's satisfied. The longhouse fire doesn't warm. It shows who owes what, which stories must be told, what happens when the ancestors grow restless. Nordmark don't take land. They claim it. Clan banners mark territory won through blood and winter, marked by mounds where warriors sleep and stones that some say whisper if you listen right. Survival requires strength in the north. Respect requires honor. Honor's a debt that grows heavier each generation. Wrongs unavenged. Sagas left unfinished. Blood debts passed down like heirlooms. Clan marriages seal alliances until someone breaks them. Clan wars settle disputes older than written memory. Blood spilled echoes through the sagas until someone pays. The traditions outlive empires because they work. Winter kills the weak. Only harsh ways keep folk alive up here. When a Nordmark dies far from the longhouse fire, their spirit wanders the wastes seeking the light that leads to the ancestor halls. Break a clan oath and that light never comes. Just endless white, wandering until the ice takes your name from memory itself.`,
    ...
    emberth: {
        ...
        meaningfulTradeoffs: 'Emberth gain fire immunity and powerful offensive abilities but suffer from cold vulnerability and their inner heat can damage equipment and allies. They struggle in cold environments.',
        baseTraits: {
