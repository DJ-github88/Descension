const ROLLABLE_TABLES = {
  encounters: {
    ...
    description: 'Fog-bleeds and Wyrd-creatures of the Frostwood Reach. Generate random combat encounters',
    icon: '⚔️',
    die: 'd20',
    entries: [
  ...
  treasure: {
    id: 'treasure',
    name: 'Treasure Hoard',
    description: 'Ledger-coin and relics of forgotten houses. Discover what the chest contains',
    icon: '💰',
    die: 'd20',
    entries: [
  ...
  weather: {
    id: 'weather',
    name: 'Weather',
    description: 'The starless sky presses down on Mythrill\'s shattered world. Determine the day\'s conditions beneath the starless sky',
    icon: '🌫️',
    die: 'd20',
    entries: [
  ...
  npc_attitude: {
    id: 'npc_attitude',
    name: 'NPC Attitude',
    description: 'Houses, holdings, and bog-folk all keep their own ledgers of grudges. Determine an NPC\'s initial disposition',
    icon: '🎭',
    die: 'd20',
    entries: [
  ...
  dungeon_room: {
    id: 'dungeon_room',
    name: 'Dungeon Room',
    description: 'Barrow-halls and ruined vaults beneath the peat. Generate the next chamber',
    icon: '🏰',
    die: 'd20',
    entries: [
  ...
  wilderness: {
    ...
    description: 'The cold reaches beyond the holdings, where the Wyrd still walks free. What the party finds while exploring',
    icon: '🌲',
    die: 'd20',
    entries: [
  ...
  magic_effects: {
    id: 'magic_effects',
    name: 'Wyrd Surge',
    description: 'The Wyrd bleeds through reality\'s cracked seal. Something unpredictable bleeds through',
    icon: '✨',
    die: 'd20',
    entries: [
  ...
  tavern_drink: {
    ...
    description: 'Every holding\'s mead-hall brews against the perpetual cold. What\'s on tap at the local hold',
    icon: '🍺',
    die: 'd12',
    entries: [
      ...
      { min: 4, max: 4, result: 'Sundari ash-wine, 2 sp, dark as the caldera, traded by Solari caravans' },
      ...
      { min: 8, max: 8, result: 'Bog-peat whiskey, 4 sp, smokes eerily, distilled by the Vreken' },
  ...
  traps: {
    id: 'traps',
    name: 'Random Traps',
    description: 'Cold-iron and Wyrd-glyph ward the old places of Mythrill. What danger lurks in the corridor',
    icon: '🪤',
    die: 'd20',
    entries: [
  ...
  plot_hooks: {
    id: 'plot_hooks',
    name: 'Plot Hooks',
    description: 'Whispers from the Fog, the Archive, and the Sundered Monoliths. Inspire your next adventure',
    icon: '📜',
    die: 'd20',
    entries: [
      ...
      { min: 15, max: 15, result: 'A Vreken caravan arrives at the gate; all are deep in hush-trance and will not wake' },
