...
**6. The Founding of the Traditions — Years 60–600.** Necessity mothered the disciplines across five phases of the Dimming. The First Ebbing (Years 60–200) produced the early adaptation classes: Cassia read the Deepening's hour in elk-entrails at the Frozen Archive and founded the Augur art; Valerius drafted the Arcanoneers' First Contract; Selene bargained with fae for the Lunarch bloodline; Lyris sang the Iceheart calm and lost her voice to Minstrel tide-song; and independent animist traditions emerged across Nordhalla, the Sundrift Vale, and Bryngloom. The Contraction (Years 280–400) birthed the Chronarch, Gambit, Shaper, Inquisitor, Harbinger, and Toxicologist lines in response to organized Wyrd and thermal scarcity. The Squeeze (Years 480–600) weaponized the Wyrd itself in the Plaguebringer, Revenant, and False Prophet traditions. *Regions: all seven. Scar: every order's seat and founder-relic. Causes: the class orders spread across five warmth phases and their present succession crises.*
...
**The Corruption Chain.** Binding (1) → eight years of Keth-Amar's whispers (Years 3–11) → Breach (2) → the Wyrd → the Monoliths → the Waking (12). Keth-Amar never forced the betrayal — it waited until the nobles corroded themselves, and it has been waiting ever since.
        ...
        content: {
          ...
          sections: [
            ...
            },
            {
              ...
              content: '**Noun (Deity).** The sun-god of Mythrill, who was bound and entombed beneath Emberspire in <LoreLink termId="sundale">Sundale</LoreLink> during the Deepening by the seven noble families. Every twelve years Sol attempts to rekindle through the rebirth cycle; sixty-five windows have opened and sixty-five have failed. The buried star is now being slowly devoured by the cosmic hunger of <LoreLink termId="keth_amar">Keth-Amar</LoreLink>.'
            },
            {
