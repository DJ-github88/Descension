...
**One refused.** I felt the gap before I understood it, six bloodlines answered, yet seven monoliths rose. One of them does not sing like the others. I cannot see what substitution you buried in your own ritual, what name you carved where a true heir should be. But I feel it, a fracture within the fracture, a lie sealed in stone.
...
**The Dawn Vigil:** A militant faction has emerged among the Solvarn in the past two decades, the **Dawn Vigil** (originally a quietist monastic order founded in centuries into the Dimming, recently radicalized and militarized under Hierophant Aethelgard), who argue the vigil must become a hunt. Their doctrine holds that the seven Sundered Monoliths are not monuments but keys: if all seven can be reforged at the caldera, the binding seal can be restored, Sol can complete its Deepening, and the sun will rise again. Dawn Vigil expeditionary companies, small bands of Solvarn Martyrs, Pyrofiends, and Augurs, now range into every region seeking Monolith fragments. They clash with the conservative Korr Emberth and the heretical Scoured alike. Their sigil, a rising sun pierced by obsidian, is painted on banners and tattooed on young Solvarn forearms across the ashlands.`
 },
 {
...
**Where They Rest:**
- **[Frostwood Reach](world-lore/regions)**: Greymark lineage-record archive.
...
The Wyrd draws from Skald and Briaran traditions: the **Gref**, a face-trader that wears the stolen visages of its victims; the **Gambrel**, a creature born from broken oaths; and **the Revel**, a fae court whose celebration began before the sun died. 
...
To consolidate his rule, the newly crowned **King-Jarl Halvar Skalvyr (Jarn-Tand)** has constructed the **Sunder-Wall**, a titanic barrier of compacted glacier-ice and black granite spanning the tundra. While officially built to keep out Wyrd horrors like the [Skreika](file:///d:/VTT/vtt-react/src/data/rulesData.js#L315) and glacier-wyrms, the wall's garrisoned gates primarily control, tax, and restrict the movements of the nomadic outlands clans.

South of the Archive, **Skadi's Col** serves as a treacherous mountain pass winding between collapsed ice-sheets, now a vital smuggling corridor for those evading Jarn-Tand's taxes. High above the glacier line, the watchtower garrison of **Vargtor** rises from a basalt pillar, its signal-fires burning day and night to coordinate patrols. At the northernmost reach of the coastline, **Rook's Promontory** juts from the cliffs like a broken finger, a high, wind-scoured crag where the Corvani gather in murmuring congregations before dispersing to their glacier-eyries.
...
Carved into the sheer face of a titanic, mile-high glacier in the Valley of Rime sits **The Frozen Archive**, the ancient, flash-frozen capital of a long-dead, ancient pre-Binding civilization. Reclaimed by the Rime-Born three centuries ago, the Archive is not a traditional city of trade, but a massive library-fortress of prehistoric clockwork and runic machinery. 

Lately, the Archive has become a place of cultural eradication. In cooperation with southern arcanists, Jarn-Tand has established the **Runic Academies** within its brass-domed halls. Children displaying magical spark are taken by force from their tundra clans and brought here; their native, animistic folklore-magic is systematically suppressed in favor of "structured, controlled runic calculations" to fuel the Archive's heating grids.
...
The Wyrd draws from Briaran and pre-Binding maritime folklore: the **Spume of the Drowned**, a memory-colony formed from the final thoughts of drowning sailors; the **Brine**, a ghost-ferryman who offers passage for a price; and **the Writ of Passage**, a sentient contract that drifts on the currents.
...
Cragjaw's Wyrd draws from Tesshan folklore and the deep mountain traditions: the **Rime-Bride**, a frozen ghost who lures travelers into the abyss; the **Storm-Crows**, winged mountain spirits that steal voices; and **Sump-Scrabs**, feral heat-stealing pests that drain steam from pipe junctions.

This Wyrd is highly volatile due to the **Purging of the Rock-Speakers**. Backed by southern [Inquisitors](file:///d:/VTT/vtt-react/src/data/classes/inquisitorData.js), Tesshan forces systematically outlaw traditional mountain animism, venerating rock-spirits (**Rock-Speakers**) and geothermal springs (**Steam-Vents**), forcing keeps to venerate only the calcified ancestors of the Groven-bridges.
...
The economy is driven by exporting alchemical reagents under the **Steam-Line Cartel** monopoly, which demands heavy tribute from keeps in exchange for heat-flow. All trade is recorded on royal knotted cords. Taverns on the Spans are drafty wooden cages bolted directly to the bone bridges. Currency is rarely used on the heights; trade is conducted via barter of wool, bone tools, and climbing spurs.
...
As a Mimir, you wear a mask that someone died to carve. Whether you seek to restore the mother-flame, sell your face to the highest bidder, or simply outrun the Sovereign Ledger, it falls to you to carve your own path before the fog claims what remains of your name.`
  ...
  {
  title: 'The Emberth',
  content: `Long before the sun died, the volcanic forge-clans of the Emberth heard Sol's final warnings. Their Sun-Speakers, receiving whispers of heat and vision, foretold the coming of the Sun-Eater Keth-Amar. Desperate to survive the creeping ice, the Emberth excavated colossal geothermal tunnel networks beneath Sundale, retreats of fire and stone. They spent centuries in the deep, tending the Solbrand—a tiny, eternal ember believed to be the last conscious fragment of the star. Since Emberspire erupted, they have reclaimed the ashland surface, organized into forge-clans bound to volcanic calderas. Their culture is built around the vigil: waiting for Sol to speak again. The silence has lasted centuries.

Now, organized into proud forge-clans bound to the active calderas of Sundale, the Emberth watch the ash-choked skies. They have waited eight centuries for Sol to speak again, but the silence from the volcano-keeps remains absolute. While the elder priests urge patience and prayer, a younger generation of Thrask prospectors and miners has grown restless. They patrol the volcanic badlands, demanding tolls in blood-ore and alchemical reagents from those who seek the warmth of their geothermal vents. 

As an Emberth, you carry the heat of a dying star in your veins. It falls to you to guard the sacred embers of your ancestors, challenge the silent heavens, and prove that the flame of Sundale will not be extinguished by the encroaching cold.`
  },
  {
  title: 'The Fexrick',
...
As a Groven, you are a bridge-keeper between a brutal past and an uncertain future. Whether you stand as a Morgh Warden guarding the Ancestor-Spans, or an Ithran envoy negotiating with the houses of the valley, it falls to you to hold the line.`
  ...
  {
  title: 'The Thrumm',
  content: `Before the first human walked the world, the Thrumm inhabited the deepest chasms of the Cragjaw Peaks. They are a hulking, hunched race of stone-trolls, living in loose family packs and speaking in low, resonant grunts. They possess a brutish, instinctual intelligence and a deep, ancestral connection to the earth itself. The Thrumm view their smooth-scaled Groven cousins with superstitious dread, sensing the wrongness of the Fexric alchemy that transformed them. 

Though the Groven protect Thrumm territories from the margins, the two races can no longer live together. Meanwhile, the Fexric Deep Alchemists still hunt the low tunnels, capturing Thrumm broodlings to fuel their alchemical vats. Somewhere beneath the frost-shattered crags of Frostmaw, the Lost Brood—those Thrumm who were never rescued during the ancient revolt—remain trapped in the dark, their bodies warped by ongoing experimentation.

To encounter a Thrumm is to face the raw, unyielding stone of the peaks—a reminder of what the Groven were before the vats, and what the peaks will return to if the steam-lines fail.`
  },
  {
  title: 'The Myrathill',
...
As an Astril, you are a living temple of a forgotten sky. Whether you seek the celestial ascension of the Sylen, the disciplined mastery of the Muren, or the shadow-freedom of the Unlit, it falls to you to carry the light through the starless night.`
  ...
  {
  title: 'The Vreken',
  content: `Cultivating phosphorescent fungi in deep bog-caves long before the sun died, the Vreken are the native grave-lights of the Bryngloom Forest. They are a compact, lantern-eyed people whose glowing irises pierce the gloom of the deep woods. The Vreken possess the unique ability to perceive the trail—a residual path of light left by passage, death, and decay that remains invisible to all other races. Their gothic cathedrals are built within the bogs, illuminated by the bioluminescent shrouds of their entombed ancestors.

Their society is divided by their vulnerability to the Wyrd. The Clean, distinguished by rust-amber eyes, are immune to the fungal addictions that ravage their kin and occupy positions of leadership. The Marked, carrying silver-white eyes, possess extraordinary trail-sight but are highly susceptible to the Over-Lit epidemic, a horrific fungal transformation. To the humans of the timber-keeps, the Vreken are "grave-lights," lantern-eyed monks who arrive at the dying before anyone else knows death is coming.

As a Vreken, you walk the line between guidance and decay. Whether you trace the trails of the lost through the Bryngloom, lead your people from the gothic cathedral-holds, or seek a cure for the Over-Lit epidemic, it falls to you to guide the living through the shadows of the wood.`
  },
  {
  title: 'The Briaran',
...
As a Briaran, you are the living proof of a broken compact. Whether you hide among the humans of the Ledger, defend the deep groves from the Jarl's fire-teams, or seek to fulfill the ancient promises etched in your thorns, it falls to you to keep the memory of the eighth house alive.`
  ...
  content: `High above the fjord-keeps of Nordhalla, the Corvani carve their eyries into the sheer faces of the mile-high ice sheets. When House Skalvyr halted the glaciers at the price of eternal winter, a splinter group of highland survivors refused to descend. They climbed higher, into the frozen spires, and struck a fate-bond with the ancient Corvid Fate-Spirits, trading physical warmth and connection for absolute memory and destiny-sight.

The Corvani serve as messengers between the isolated holds, navigating whiteout blizzards that would freeze others to the bone. Their price is always a memory, freely given, which manifests as shifting, raven-like markings across their pale skin. To deal with a Corvani is to trade in the only currency they value: your own recollections. They are not a playable race, but their fate-sight and glacier-navigation make them unsettling, if invaluable, allies in the whiteout of the northern wastes.`
  }
 ]
 }
 }
...
**6. The Founding of the Traditions, across the long Dimming.** Necessity mothered the disciplines across five phases of the Dimming. The First Ebbing (across the Dimming) produced the early adaptation classes: Cassia read the Deepening's hour in elk-entrails at the Frozen Archive and founded the Augur art; Valerius drafted the Arcanoneers' First Contract; Selene bargained with fae for the Lunarch bloodline; Lyris sang the Iceheart calm and lost her voice to Minstrel tide-song; and independent animist traditions emerged across Nordhalla, the Sundrift Vale, and Bryngloom. The Contraction (across the Dimming) birthed the Chronarch, Gambit, Shaper, Inquisitor, Harbinger, and Toxicologist lines in response to organized Wyrd and thermal scarcity. The Squeeze (across the Dimming) weaponized the Wyrd itself in the Plaguebringer, Revenant, and False Prophet traditions. *Regions: all seven. Scar: every order's seat and founder-relic. Causes: the class orders spread across five warmth phases and their present succession crises.*

**7. The Erasure of the Silent Seventh, across the early and middle Dimming.** For Viridane's refusal, the remaining six houses elevated House Morrath to the seventh seat and spent three centuries striking the name Viridane from every record, ledger, and genealogy on the continent. The public came to speak of an "eighth house." *Regions: Frostwood (the Ledger), Bryngloom (Morrath's seat), all archives. Scar: the hidden Lunarch lineage, the Sovereign Ledger's power to define reality, the public's miscounted houses. Causes: the Scribe-Cartel's later authority and the Briaran resistance.*

**8. The Solvan Ascendancy & the Heir-Purge, the early through later centuries of the Dimming.** House Solvan, blood-stained by the flaying of Aex, ruled Sundale's ashlands as a militant theocracy, conscripting the willing and unwilling alike into the Martyr Brigades and reforging Monolith-fragments to (they believed) restart Sol. The Heir-Purge hardened the Martyr's Vow from grief into doctrine; the Dawn Vigil was founded in centuries into the Dimming to pursue Monolith-fragments across all seven regions. The Imperium's cruelty hollowed its legitimacy, and over centuries the house declined into a regency of Stewards who refuse the title "Lord" until the sun returns. *Regions: Sundale (+ Dawn Vigil expeditions everywhere). Scar: the Obsidian Citadels, the Dawn Vigil, the Steward-system. Causes: the present Martyr-conscription crisis and the Vigil's secret knowledge that reassembly would summon Keth-Amar, not Sol.*
...
**12. The Waking of the Monoliths, within living memory to the present.** The seven Sundered Monoliths began to hum. Chaos Pockets stabilized into permanence across the Sundrift Vale; the bog-graves of Bryngloom rose and marched on the Monoliths; unnamed entities emerged from the deep groves beyond the Inquisitors' art; and the Iceheart Sea fell silent, no tidesong, no deep-bass pulse. Every bargain is coming due at once. *Regions: all seven. Scar: the active Monoliths, the marching dead, the silent sea, the static mist. Causes: the campaign, every regional crisis is a facet of a single bill presented to a world that can no longer pay it.*`
 },
 {
...
**The Debt Chain (the spine).** Deepening (1) → eight years of whispered corrosion → Breach (2) → Seven Bargains (4) → regional scars → Dimming (11) → Waking (12). Every present crisis is interest compounding on the original choice to bury the sun and then break the seal.
...
- **Dusk:** An Emberth forge-tender who was cast out of the citadels for defacing her sacred sun-brands. She hunts for fragments of the shattered Sundered Monoliths in the badlands, seeking bodyguards for dangerous retrieval runs.
...
- **Expose the truth**: The Thrask and Scoured factions will rally to the party. The Korr will become enemies.
...
Three factions are fighting for control of Sundale: the Risen (old faith), the Sunderer (heretics), and the Scoured (seal the breach). Players can:
...
**Consequence:** The Cycle-Eater is tied to the Bryngloom's Wyrd-creatures. It consumes not just lives, but **every iteration of that soul across all its past and future existences**. Players who fail to stop it risk permanent death, not just for themselves, but for every version of themselves.`
 ...
 {
 title: 'shifting Events System',
 content: `Player actions trigger shifting events that evolve over time. These events are **not scripted**: they respond to player choices and create a living, breathing world.
...
- Introduce shifting events organically, don't force them.
...
- Use shifting events to create **moral dilemmas**: not every choice has a clear "right" answer. Sometimes helping one faction hurts another. Sometimes solving one problem creates another.`
 }
 ]
 }
 }
...
3. **The Consequence:** Returning to Timber-Post Nine with the coal saves the village, establishing the adventurers as local heroes and earning the trust of the logging guilds. Leaving Toma behind, however, leaves his ghost to haunt the trail, attracting a Gambrel that will stalk the party in future sessions.`
 ...
 content: '**Noun (Plural: Mimir).** A secretive, fluid race of misty face-shifters native to the <LoreLink termId="frostwood-reach">Frostwood Reach</LoreLink>. To navigate human paranoia, they wear a single beautifully carved unbroken heartwood or storm-glass mask that they never remove in public under the *Rite of Masks*, preventing the doppelganger shadow-parasites in their blood from overwhelming their mortal souls.'
 },
 {
 title: 'Emberth [Pronunciation: EM-berth]',
 content: '**Noun (Plural: Emberth).** Dense, powerful sun-reverent forge-clans of <LoreLink termId="sundale">Sundale</LoreLink>. They possess charcoal-textured black skin cross-hatched with glowing, scar-traced forge-marks and large, heat-sensitive eyes. Long before the sun\'s death, they dug vast subterranean vaults to preserve the *Solbrand*, believed to be the last conscious spark of the star Sol.'
 },
 {
 ...
 content: '**Noun (Region).** A vertical labyrinth of howling blizzards and razor ridges, buried in perpetual snow-veil since <LoreLink termId="house_tesshan">House Tesshan</LoreLink> traded visibility for concealment. Ruled by Jarl-Tesshan Oda Tesshan under the Knotted Decree, written language outlawed in favor of knotted knotted cord-cords, the region is governed through the Steam-Line Cartel and the Tesshan-Mit\'a forced-labor system, while Wyrd-kin stalk the cliffs.'
 },
 {
 ...
 content: '**Noun (Event).** The riots in the later centuries of the Dimming, when the 40th <LoreLink termId="rebirth-cycle">Rebirth Window</LoreLink> produced no visible warming. After nearly five centuries of priests promising Sol\'s return, the window opened and the eastern horizon stayed dead. The lie broke overnight: temples were torched, Augurs beaten in the streets, and <LoreLink termId="house_solvan">House Solvan</LoreLink>\'s Imperium collapsed. The <LoreLink termId="dawn_vigil">Dawn Vigil</LoreLink> militarized to fill the vacuum, and the Korr began hiding the <LoreLink termId="solbrand">Solbrand</LoreLink>\'s accelerating decline.'
 },
 {
 title: 'The First Thermal War [Pronunciation: thee THUR-mul]',
 content: '**Noun (Event).** The conflict in the first centuries of the Dimming in the <LoreLink termId="cragjaw-peaks">Cragjaw Peaks</LoreLink>, the first war fought explicitly over thermal resources rather than territory. As geothermal vents failed, <LoreLink termId="fexrick">Fexric</LoreLink> holdfasts, <LoreLink termId="skald">Skald</LoreLink> refugees, and <LoreLink termId="groven">Groven</LoreLink> toll-keepers converged on the same declining vent-system. Its true legacy was precedent: thermal scarcity produces corpses, not cooperation. Out of its chaos emerged the Steam-Line Cartel and the first Groven toll-treaties.'
 },
 {
 ...
 {
 title: 'Skadi\'s Col [Pronunciation: EE-meerz KAHL]',
...
That is all you need to know to start playing. The rest you will learn as you explore.`
 ...
 content: `You begin the **Frostwood Reach**, a continent of dense, fog-choked forests where warm volcanic air collides with creeping northern frost. The fog is not weather. It is permanent. It protects the forests from freezing, but it also eats memories. People here keep precise written records because the fog slowly steals their history.
...
**That is it.** The rest of the rules are reference material. Learn them as you play.`
 ...
 rows: [
 ['Dice Resolution', 'Player rolls d20 + modifiers vs. static DC set by DM.', 'GM sets Difficulty Die (d4 to d20). Player rolls that die + Skill Rank.', 'shifting checks; smaller difficulty dice make Critical Successes much more common (25% on d4).'],
 ...
 content: `Mythrill does not bind your heroic fate to static, lifeless numbers or flat, unyielding Difficulty Classes. Instead, the living world breathes through the **Ladder of Trials**, a shifting difficulty-dice system where the Game Master selects a die size reflecting the task's complexity, from a swift, minor d4 to a grueling, legendary d20. You roll that die, pitting your raw skill ranks, attribute modifiers, and situational fortune against the hazard. In combat, the rhythm of battle accelerates: weapon dice govern both the strike and the damage in a single, fluid roll. A hero's journey is not calculated by cold math, but felt through the heavy tumble of physical dice against the parchment.`
 },
 {
 ...
 content: `Mythrill is not a rigid cage of rules, but an open, modular framework. The core mechanics establish a solid foundation, while specialized modular systems allow each GM to customize the experience to match their table's specific desires:
...
Mix and match these systems to craft the exact tone of your campaign.`
 ...
 ['d12', 'Difficult', 'Demands deep expertise or massive exploit'],
...
- **Mechanical Onboarding**: Welcome players into the VTT substrate. Ensure all players understand the point-buy parameters, trained skills, and the unique resource management system associated with their selected paths from the **20 specialized classes**.
- **Group Synergy**: Ensure character concepts hold logical and narrative ties. A cohesive band of adventurers is far superior to a disjointed collective of lone wolves. Discuss how characters met, why they trust one another, and how their tactical roles complement each other in battle.`
 },
 {
  ...
  content: `A single session of play is a self-contained story, a chapter in an ongoing epic that spans between two and four hours. To maintain rhythm and ensure no narrative threads are lost to the sands of time, gameplay is structured into four distinct, organic phases:
...
- **Pyrofiend**: Fire horror. Swallows Wyrd-touched embers for explosive area damage.
...
- **Arcanoneer**: Elemental Building Block crafter. Combines elements for shifting spell effects.
- **Inquisitor**: Anti-magic hunter and Wyrd binder. Disrupts spellcasting, nullifies corruption, and commands bound fiends through sacred ritual.
...
**Still not sure?** Go to [Quick Start: Your First Session](getting-started/quick-start) for three recommended beginner builds.`
 ...
 rows: [
 ['Arcanoneer', 'Damage/Utility', 'Building Blocks & Combinations', 'Master of elemental Building Block combination with shifting spell crafting'],
 ...
 ['Inquisitor', 'Damage/Summoner/Controller', 'Righteous Authority', 'Anti-magic hunter and Wyrd binder who disrupts spellcasting and commands bound fiends through sacred ritual'],
 ...
 ['Pyrofiend', 'Damage', 'Inferno Veil', 'fire-wielding horror with corruption stages'],
...
- Focus: Freshwater adaptation, disguise, navigation, exploration`
 ...
 content: `Violent encounters in Mythrill are resolved through a shifting, high-stakes combat structure. Combat is divided into rounds, each representing roughly six seconds of split-second decisions and clashing iron. Rather than using rigid movement or traditional 'bonus actions' that bog down tactical flow, every combatant operates within a fluid, singular action economy fueled by Action Points (AP). During your turn, you are free to spend your AP in any sequence, moving, striking, casting, or parrying, creating an incredibly shifting and cinematic flow of battle where you are in complete control of your character's combat cadence.`
 },
 {
 title: 'Initiative',
 ...
 [{ spellId: 'universal_move' }, 'A', 'Move up to your movement speed ( 30 feet). This movement can be broken up between other actions.', '1 AP'],
...
- **Critical Hits Bypass DR**: Critical hits are so devastatingly precise that they ignore all armor damage reduction entirely, and they do not prompt the equipment to roll DR or take durability damage.`
 ...
 rows: [
 ['1', 'Catastrophic Failure: Weapon breaks/malfunctions (1 AP + quick Agility check with a moderate difficulty die, d8, to fix)'],
 ...
 content: `Not all flesh yields equally. A skeletal undead laughs at a piercing blade but shatters under a blessed mace. A Fire horror scoffs at flame but screams at cold iron. These truths are encoded in Mythrill's damage modifier system, a tiered framework that determines exactly how much punishment lands.\n\nModifiers always resolve in this fixed sequence:\n\n1. **Base Damage**: Roll dice and add attribute modifiers.\n2. **Damage Modifiers**: Apply vulnerability or resistance tiers (see tables below).\n3. **Conversion Effects**: Apply any Leech, Absorb, or Invert effects.\n4. **Final Damage**: Deliver what remains to the target.`
 }
 ],
 tables: [
 {
 ...
 {
  title: 'System Shock',
  content: `A single catastrophic strike can break a warrior's body without breaking their hit point total. When you take damage equal to or greater than **half your maximum HP** from a single source, make a **Constitution save** (easy die, d6). On a failure, your body reels from the trauma, you immediately gain **1 level of exhaustion**. This applies even if you are in full health.`
 },
 {
  title: 'Massive Damage',
  content: `Some blows are simply meant to kill. When you take damage equal to or greater than your **maximum HP** from a single source, make a **Constitution save** (difficult die, d12; the GM may escalate to d20 for truly apocalyptic strikes). On a **failure**, you die **instantly**: regardless of current hit points. On a **success**, you drop to 0 HP and enter the Dying state normally. This is the rule that makes legendary monsters terrifying.`
 }
 ]
 },
 {
...
**Resurrection Challenges:** Resurrection is not guaranteed and comes with challenges. The ritual requires special components, takes time to perform, and may fail entirely.`,
 ...
 tables: [
 {
  ...
  [{ spellId: 'universal_interpose' }, 'R', 'When an ally within 10 ft. is attacked, push them 5 ft. to safety and take the hit. Make a Strength save using an easy difficulty die ( d6); on a miss the ally falls prone.', '1 AP (+1 AP for each 10 ft. added)'],
 ...
 rows: [
  ...
  ['Religion', 'Dawn\'s Favor', 'A', '15 ft; Religion vs Spirit/Int save. Roll d4 boon: temp HP, damage reduction, attack bonus, or save advantage. You always gain the boon; allies gain if they fail the save.', '2 AP'],
  ...
  ['Survival', 'Trapping', 'A', 'Set a trap in a 5-ft tile within 5 ft; Survival starts d10 (step down with high INT). Pick: Pitfall (4 AP) 1d6/10 ft & restrains; Snare (3 AP) hoists, attacks adv; Tripwire (2 AP) prone, may drop items.', '1 AP']
 ]
 }
 ]
 }
 ...
 rows: [
 ['Standard Movement', '5 feet per tile', '1 AP per 30ft speed', 'None'],
 ['Difficult Terrain', '10 feet per tile', '1 AP per 15ft speed', 'Doubles distance cost'],
 ['Squeezing through crevice', '20 feet per tile', '1 AP per 5ft speed', 'Quadruples cost; disadvantage on physical checks'],
 ['Climbing / Swimming', '10 feet per tile', '1 AP per 15ft speed', 'Requires Athletics / Athletics check unless speed exists'],
 ...
 subcategories: [
 {
  ...
  content: {
  title: 'Weapons',
  description: 'Every attack rolls two dice at once: a Weapon Type d8 (which adds flavor and a tactical effect to the strike based on your weapon) plus your Weapon Damage die. An 8 triggers the weapon’s signature move. Switch between Standard and Advanced (full Weapon Mastery) rules.',
  sections: [
  {
  ...
  content: `When you attack you roll two dice together:
- **Weapon Type die (d8)** — a static d8 for every weapon. The result picks a unique outcome for your weapon type that ADDS to or RETRACTS from the attack (a 1 is a fumble, an 8 is the weapon’s signature tactical move).
- **Weapon Damage die** — varies by weapon type (d4–d12; see table). A 1 is a miss; the max explodes into a crit.

In Advanced Rules the Weapon Type die becomes a **d8** and ties into the full Weapon Mastery quest ladder.`
  },
  {
  title: 'Weapon Mastery Skill',
  content: `In Advanced Rules, weapon attacks also trigger a Weapon Mastery skill check (d8) for the equipped weapon type. Mastery gates special outcomes (disarms, cleaves, rebound mishaps) and advances through a per-weapon quest ladder that can step the mastery die down. Standard Rules use the same d8 outcomes without the progression.`
  },
  {
  title: 'How to Read Results',
  content: `Outcome lines are keyed by weapon type (e.g., "Sword:", "Greataxe:", "Bow:"). The rules browser lets you pick any weapon and see its unique outcomes, plus the archetype it uses if it shares a table.`
  }
  ],
 tables: [
 {
  title: 'Weapon Types & Dice',
  description: 'All weapon types available in the game, with their typical damage dice. Every weapon rolls a Weapon Type d8 alongside its damage die to add flavor and tactical effects.',
...
- **Unbalanced Spells**: If the spell's power exceeds its budget, the system will highlight the imbalance in red. The wizard provides shifting recommendations to bring it back in line (e.g., increasing Mana/AP cost, adding a cooldown, or scaling down the damage). This ensures fair play while leaving creative freedom in your hands.`
 ...
 content: {
 title: 'Travel Basics',
 description: 'complete travel mechanics, navigation, and journey structure',
 tabs: [
 {
 id: 'travel-pace',
 name: 'Travel Pace',
 ...
 content: {
 title: 'Exploration',
 description: 'complete exploration mechanics and discovery systems',
 tabs: [
 {
 ...
 tables: [
 {
  ...
  ['shifting Elements', 'Movement and life in the scene', '"Curtains flutter aggressively, suggesting sudden gusts or something sinister"'],
...
- **Severity 4 (Extreme)**: Dangerous. Shelter strongly recommended. Gear grants advantage, no auto-pass. Overmarching doubles exhaustion risk.`
 ...
 },
 {
  ...
  ['20', 'Underdark Collapse', '4', 'd20', 'd20', 'Advantage only', 'Tunnel cave-in, lava seep, or far world incursion']
  ]
 }
 ]
 },
...
- **Long Rest (8 hours):** done at camp after the travel day. Requires warmth/shade + rations + water. Recovers full HP, mana, and class resources, and removes 1 exhaustion level (if conditions met).
