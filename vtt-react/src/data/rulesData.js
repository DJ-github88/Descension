      ...
      },
      {
        ...
        content: {
          ...
          sections: [
            ...
            {
              title: 'The Fexric',
              content: `Deep gnome/goblinoid subterranean engineers who survived the deep freeze entirely underground by building complex gear-driven systems, machinery, and geothermal heat-pipelines. Their name emphasizes a quirky, mechanical, "fix-it" nature. A splinter guild known as the **Deep Alchemists** conducted forbidden experiments beneath the Cragjaw Peaks — capturing Thrumm broodlings and injecting them with serums designed to create intelligent servitors. The result was the Groven, who shattered their vats and escaped into the upper crags. The Fexric and Groven now share the peaks in cold, grinding tension — trade when necessary, violence when provoked, never trust.`
            },
            {
              title: 'The Ferrick',
              content: `The only Small race in the known world — compact, wiry scrap-folk standing between three and four feet, with quicksilver blood and forge-rust bones. They were never meant to exist. The Fexric Deep Alchemists, refining their Groven-serums in laboratories beneath the Cragjaw Peaks, poured centuries of failed reagents and discarded waste into the deep sumps — and something coalesced. The first Ferrick crawled out of the alchemical sludge three generations before the Groven rebellion, already building tools from the same waste that had birthed them. The Fexric classified them as vermin and ignored them. The Ferrick scattered through every crack, sewer, and trade route in the known world. Now they live in the scrap-heaps and undercarriages of every continent — the Vrenn bleeding quicksilver into their creations, the Grath hammering salvaged metal and ancestor-bones onto their own skeletons. Treated as pests by every surface-dwelling society, they are nonetheless the invisible infrastructure that keeps the world's machinery running. The Groven — their accidental siblings, both created by Fexric alchemy — refuse to publicly acknowledge they exist, but every Groven bridge-span has Ferrick-made components in its undercarriage.`
            },
            {
              title: 'The Neth',
