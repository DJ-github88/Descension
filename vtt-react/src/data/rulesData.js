...
The Frostwood Reach is a continent of dense, transitional fog where warm volcanic air from the south collides aggressively with the creeping northern frost. Ancient ironwood forests stretch beneath a perpetual grey canopy, their petrified trunks hardened by centuries of cold until the wood mimics iron. Settlements cluster along mist-choked trails, their inhabitants never quite certain what lies beyond the next bend, or whether they will remember it by the time they arrive. On the eastern border, where the fog pools into a permanent, drowning bog, lies **Wraithfen** — a fog-drowned fen where Unwoven Mimir who have shed their masks entirely wander in aimless, looping circuits, their identities long since dissolved into the mist.
...
Nordhalla is a brutalist cathedral of ice and stone, a blinding-white tundra sliced by towering black fjords where the temperature never rises above freezing. The glaciers were halted mid-advance by the dark bargain, frozen in place like a wave that will never break. The sky is a pale, washed-out grey that has not seen true sunlight in eight centuries. Wind-carved ice sculptures, the flash-frozen dead of a civilization that perished before the Rime-Born were a people, stand in silent streets beneath the glacier walls. South of the Archive, **Ymir's Col** — a treacherous mountain pass winding between collapsed ice-sheets — provides the only reliable overland route into the Valley of Ymir, though the ice shifts without warning and the wind has been known to freeze a traveler mid-stride. High above the glacier line, the watchtower garrison of **Vargtor** rises from a basalt pillar, its signal-fires burning day and night as a beacon for the few caravans brave enough to attempt the passage. At the northernmost reach of the coastline, **Rook's Promontory** juts from the cliffs like a broken finger, a high, wind-scoured crag where the Corvani gather in vast, murmuring congregations before dispersing to their glacier-eyries.
...
Commoners in Nordhalla survive on dried fjord-cod, salted mammoth fat, and lichen-mash. The local beverage is frost-mead, a heavy, fermented honey-drink brewed in deep geothermal caves where the cold cannot penetrate. The economy depends on exporting high-grade iron ore, whale blubber, and intricate runic carvings in exchange for southern grains, timber, salt, and spirits. All maritime trade funnels through **The Black Firth**, a narrow, obsidian-cliffed inlet where the black fjords meet the Iceheart Sea — the primary naval route for iron ore barges and whale-oil tankers navigating the treacherous coastal ice.
...
Sundale is a volcanic desert of ashfall, obsidian rivers, and smoldering badlands surrounding Emberspire, the world-heart volcano, the tomb and cradle of Sol itself. The air is thick with particulate, the sky a permanent rust-orange smear. Lava-flows cut through the landscape like slow, deliberate arteries. The **Shyr**, a ninety-mile scar of cooling basalt, serves as the Emberth's primary thoroughfare, a road of stone that walks itself as the lava cools and contracts into predictable fracture-patterns. Rising from the southern badlands, **Sol's Anvil Mesa** is a flat-topped mountain of volcanic basalt where Sun-Priests still hold solstice ceremonies, its summit polished mirror-smooth by centuries of prostrated worshippers. The continent's natural border is marked by **The Ashen Escarpment**, a sheer cliff-face of compacted volcanic ash layered like the pages of a compressed book, striated in shades of rust and bone. South of the Shyr, the landscape is punctuated by **Cinderhoodoo**, a cluster of fire-scorched rock spires that local herders swear moan when the wind shifts.
...
**The Dawn Vigil — Solvarn Active Agenda:** A militant faction has emerged among the Solvarn in the past two decades. The **Dawn Vigil** argues that the seven Sundered Monoliths are not monuments but keys: if all seven can be gathered and reforged at Emberspire's caldera, the binding seal can be restored and Sol can rise again. Dawn Vigil expeditionary companies — small bands of Martyrs, Pyrofiends, and Augurs — now range into every region seeking Monolith fragments. Their sigil, a rising sun pierced by obsidian, is increasingly visible across the ashlands, painted on banners and tattooed on the forearms of young Solvarn who have decided eight centuries of waiting is enough.
...
The Iceheart Sea is not a frozen wasteland, it is a violent, churning fury of freezing waves and thick, icy foam, where true sailors test their mettle against an ocean that never sleeps. Storms outnumber still days ten to one. Icebergs the size of cities drift through shipping lanes, calved from glaciers that groan and shift along northern coastlines. The sea is a living adversary, and the people who work it have learned to treat every voyage as a wager. In the southern reaches, sheltered from the worst of the storms, **Spindrift Lagoon** is a warm, coral-reef inlet that glows with bioluminescence at night, a surreal haven where the water is almost gentle and the fish swim close enough to touch. North of the shipping lanes, the **Deepwell Archipelago** stretches across the horizon, a chain of drifting ice-islands beneath which the Deep-Born Myrathil have carved entire underwater cities into the submerged rock, their luminous spires visible through the ice on clear days.
...
The Sundered Monolith of the Iceheart Sea rests at the bottom of the Treakous Oceanic Rift, thrumming a deep, low frequency that causes the teeth of every Deep-Born Myrathil within a hundred miles to ache. Its presence is visible from the surface. Sailors call it the **Shard-Window**: a permanent, perfectly circular storm-vortex, three miles wide, that has rotated above the rift for as long as anyone can remember. No cloud enters. No cloud leaves. The vortex spins with a low, rhythmic pulse that matches the thrumming the Deep-Born feel in their teeth. Beneath the vortex, the ocean surface is unnaturally still — no waves, just a glass-flat disc of water. At night, the still water glows with pale, blue-white bioluminescence tracing the contours of the rift below. Icebergs within fifty miles hum audibly — a mournful note called **Shard-Song** that has been growing louder for the past decade.
...
The Cragjaw Peaks are a vertical wilderness, razor mountain ridges and bottomless wind-gaps cloaked in perpetual, howling blizzard. The snow has not stopped falling since the dark bargain was sealed, burying every natural landmark, every ancient trail, every surface route under centuries of drift. The only visible shapes above the whiteout are the **Ancestor-Spans**: bridges grown from the calcified bodies of the Groven's willing dead, dark against the endless grey sky. The greatest of the chasms is **The Great Gorge**, a mile-wide canyon that splits the Peaks in two, bridged by seven Ancestor-Spans whose bone-arches are the oldest and largest ever grown.
...
**Frostmaw Holdfast** is a colossal, lightless subterranean vertical city of the Fexrick, descending thousands of feet around roaring geothermal chimneys. The city is a masterpiece of alchemical sumps and clockwork galleries, lit by volcanic soot-glow and the green hum of mineral furnaces. It is a hyper-industrial, paranoid fortress guarded by massive alchemical traps and subterranean gates. The Fexrick clans live in stratified tiers: the hereditary Kethrin guilds occupying the comfortable upper galleries, while the Clan-Free Drall salvage-folk live in the sumps below. Cut into the eastern wall of Frostmaw's outer chasm lies **Gearworks Gulch**, a Fexrick industrial settlement of foundries and machine-shops powered by the same geothermal vents that warm the Holdfast, its smoke-stacks rising like brass fingers through the snow-veil. Farther south, **Deepchasm Keep** is a fortress spanning a massive fissure in the mountain rock, its walls anchored to both sides of the divide by Groven bone-cable — a garrison that literally holds the mountain together.
...
They share the starless grasslands with the **Astril**, who are split by how they live with the constellation-spirits of Sol's celestial court nesting in their blood. The **Sylen Astril (The Open)** embrace the spirit within at the risk of being **Over-Sung** (consumed entirely by the cosmic mind). The **Muren Astril (The Bound)** suppress the spirit through strict meditation, containing the star-light behind mental walls, though they risk catastrophic physical explosions of light. Pushed to the margins of both are the **Unlit**: Astril born without a constellation, carrying no patterns, no whisper, and no star-glow. The Synod views them as cursed, but because they are the only Astril who can lie without their skin glowing to betray them, the Unlit are used as the Synod's eyes, ears, and spies across the steppe. When the Unlit gather to render their own secret judgments, they do so at **The Unlit Knoll**, a low, featureless hill indistinguishable from a hundred others — save that no star-light has ever touched it, even before the sky went dark.
...
Nomadic Ordan clans feed primarily on fermented mare's milk (kumis), dried mutton, and wild steppe-turnips harvested during migrations. The steppe economy runs on the export of wool, hides, steppe-horses, and dried meat, and the import of metal tools, salt, and spirits. The finest herds graze on the **Kumis Downs**, a stretch of rolling, wind-flattened hills in the central steppe where the Ordan mares grow thick-coated and swift on the deep-rooted grass.
...
**Atropolis** is the magnificent canopy-city of the silver-skinned Neth, constructed inside a cathedral-grove of living ironwoods coaxed into shape over a thousand years. The streets are suspended walkways of living branch and ghost-silk, lit by the pale, cold glow of memory-glass tablets. It is a city of lawyers, pact-mages, and merchants who view survival as a legal agreement. The air is quiet, smells of petrichor and old paper, and is governed by strict, silent contract protocols. Smaller Neth settlements dot the mid-canopy, none more renowned than **Aran-Glen**, where every structure — from bridges to granaries to sleeping chambers — is grown from living ironwood, coaxed over centuries into architectural forms that still breathe and shed leaves with the seasons.
