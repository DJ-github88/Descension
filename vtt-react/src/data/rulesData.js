...
**The Refusal:** There was an **eighth house**: House Viridane. When the other families marched their firstborn north, Viridane refused and fled south through the **Frostwood Reach**, making a counter-bargain with fae entities in the groves. The seven families spent centuries erasing every record of Viridane's existence. Their hidden descendants, the **Briaran**, carry the weight of that refusal through every generation, branded oathbreakers by a history written to justify capitulation.`
            }
          ]
        }
      },
...
**In the [Cragjaw Peaks](world-lore/regions)**: Ancestor-Spans crack. Subterranean machines fail. Chronarchs extend lifespans while Formbenders search for the Lost Brood.

**In the [Bryngloom](world-lore/regions)**: The **[Neth](world-lore/races-overview)** have filed seventeen petitions. The Keeper has not ruled. Over-Lit epidemic worsens. Covenbanes stretched to their limits.
...
**Briaran**, the hidden descendants of House Viridane, are the shadow beneath both. They live in the deepest moonlit groves where the protective fog thins and fae old laws still hold.
...
**The Dark Bargain:** House Ordavan traded **fertile soil for the endless migration**: the herds never stop, the grass always returns, no matter how many mouths feed upon it. The price: the sky went dark. The constellations were erased from the firmaint above them.
...
Operating from their living canopy-city of **Atropolis**: a cathedral-grove of ancient ironwood coaxed into shape over a thousand years, and the frozen dock-outpost of **Ironjaw Port** on the Iceheart Sea, the Neth control the major trade routes and preservation techniques needed by every warm-blooded survivor. Their memory-glass records, grown from crystallized tree-sap, form the oldest continuous archive in the known world. They share the Bryngloom with the Vreken in coldly functional coexistence: the Vreken worship the Keeper; the Neth negotiated with it. Neither defers to the other. Neither particularly wants to.`
            ...
            {
              title: 'The Corvani',
              content: `Raven-marked highlanders who dwell in the highest aeries of the Cragjaw Peaks, above the blizzard line where the fog of the Frostwood Reach meets the eternal snow. When House Tesshan sealed the snow-veil eight centuries ago, a splinter group of highland dwellers refused to descend into the buried keeps. They remained above the whiteout, and over generations became marked by the raven, a creature that navigates both fog and snow. Their raven-black markings shift and change with their moods and the fate-tides they sense. The Corvani serve as messengers and guides for those crossing the Peaks, trading information for memories. They are the only people who can navigate the space between the fog and the snow without the Ancestor-Spans, but the cost is their connection to the physical world grows thinner with each passing year. They are divided into two paths: the **Oracle Corvani** who peer deep into fate's threads, and the **Scout Corvani** who navigate the treacherous highland paths as swift messengers.`
            }
          ]
        }
      }
...
- **Wind-Singer Cora:** A Corvani Scout who dwells in the highest aeries. She can carry messages across the Peaks in three days. Her price is always a memory.
...
The Corvani (raven-marked highlanders) can carry messages across the Peaks in three days. Their price is always a memory. Players can:
...
**Consequence:** The Corvani are tied to the Cragjaw Peaks' lore, they dwell above the blizzard line where the fog meets the snow. Their memories are valuable. Players who trade with them gain access to unique knowledge.
...
- **Exploit the epidemic**: Sell hush to addicts. (Mechanical benefit: Gold, but the party gains a powerful enemy, the Covenbane.)
...
2. **Regional Crises**: When players ignore a problem, it worsens. Example: If players ignore the hush epidemic in Bryngloom, it spreads. More Marked Vreken become addicted. The Clean Vreken become more oppressive. The Covenbane become more aggressive.
...
- Use dynamic events to create **moral dilemmas**: not every choice has a clear "right" answer. Sometimes helping one faction hurts another. Sometimes solving one problem creates another.`
          ...
          sections: [
  {
    ...
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-fire\"><\/i> <h3 class=\"class-lore-name\">Pyrofiend<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The summoner does not command the flame; they submit their flesh to it. In the lightless badlands of Sundale, when the sun-god Sol was entombed, a cabal of Solvarn occultists gathered in an obsidian cavern beneath the Emberspire caldera. They did not pray for salvation; they drew a summoning circle in their own blood, using volcanic glass knives to carve the seven sigils of Scathrach, the Ashen Sovereign. They offered their marrow as kindling, inviting the Ninth Flame of the Burning Throne to nest in their bones.</p><p>When the ritual was completed, they swallowed demonic coals of pure, burning sulfur. The demonic embers did not destroy their flesh, but bound their capillaries in a permanent, glowing lattice of occult channels. Their blood became liquid fire, their bones seared black, and their eyes reflecting the lightless heat of the infernal mantle. They survived the freeze, but they emerged as the first Pyrofiends, living vessels for a parasitic demon-lord.</p><p>This occult covenant demands a terrible, escalating price. The sulfurous coal nesting in the host's chest slowly burns away their sanity, whispering forbidden secrets of destruction while demanding more blood, more ash, and more fuel. At the height of their ascension, the host's skin cracks open to reveal molten rock, and they have only minutes before their marrow turns to ash. The Sun-Speakers of the <LoreLink termId=\"harath_vault\">Harath-Vault</LoreLink> hunt them down with silver chains, viewing them not just as heretics, but as walking portals to the infernal deep.</p><p>Your marrow is the candle. Your blood is the wax. The Ashen Sovereign has written his name in your bones, and the interest is paid in flesh. Burn them before you burn yourself.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The pyrofiend's inferno veil was born in the volcanic desert of <LoreLink termId=\"sundale\">Sundale</LoreLink>. An Emberth forge-miner named **Ignis** bargained with a volcanic caldera fiend to secure a geothermal vent for his clan.</p><p>The price of this fiery pact was a sulfurous, burning ember nesting in his chest. As the veil rose, Ignis's capillaries seared, pulling his flesh closer to the fiend's absolute claim.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Pyrofiends are revered yet deeply feared in the <LoreLink termId=\"harath_vault\">Harath-Vault</LoreLink>, where their destructive potential is used to clear volcanic blockades.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the Thrask Emberth and hot-blooded Solvarn humans.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Ignis the First-Singed**: The Thrask miner who first welcomed the Sovereign to protect his deep caldera clan.\n* **Aethelgard the Seared**: A Solvarn occultist who led the Cabal of the Ninth Flame during the solar binding.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-skull\"><\/i> <h3 class=\"class-lore-name\">Berserker<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The world of Mythrill does not forgive weakness, and in the freezing wastes of Nordhalla, the line between survival and savagery was erased eight centuries ago. When the glaciers halted at the price of summer's return, the Skald were left in a land of absolute ice. In the darkest winter of the cataclysm, when starvation stalked the keeps of the Frozen Archive, the Skald did not pray for warmth, they prayed for endurance. The ancestors consumed their own fallen kin so the bloodline could persist, and that terrible act did not merely scar their history. It entered their very blood.</p><p>The Bloodhammer clans tell of the first Berserker, Grum the Iron-Smith, who did not choose the fury, the fury chose him. Trapped in a collapsing shaft beneath the badlands by a glacier-wyrm, Grum threw down his hammer and allowed the furnace's heat to occupy his marrow. His veins boiled with an adrenaline rush so violent his tendons snapped, yet he shattered the wyrm's frozen hide with his bare hands. The Skald recount the tale differently: they swear Grum was trapped by his own lords, sacrificed to the deep mantles to see if a man could burn and still stand.</p><p>Today, this physiological meltdown is known as the Blood-Heat. A Berserker-s muscles literally tear themselves from the bone to swing harder. Their heart is a ticking engine of self-destruction. In the civilized plazas of <LoreLink termId=\"atropolis\">Atropolis</LoreLink>, they are banned as rabid beasts. But in the arenas of the <LoreLink termId=\"harath_vault\">Harath-Vault</LoreLink>, they are celebrated as the ultimate survivors of a world that tried to freeze them.</p><p>As a Berserker of the Bloodhammer line, you carry the Hunger Pact in your veins. The world sees a savage. Your ancestors see a promise kept. Let your blood boil. Let the cold world watch you burn.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The berserker's calling was forged during the desperate defense of the volcanic caldera tunnels of <LoreLink termId=\"sundale\">Sundale</LoreLink>. When a colossal ice-wyrm burst into the lower miners' chambers, a blacksmith named <LoreLink termId=\"grum\">Grum</LoreLink> threw down his tools and surrendered entirely to the searing heat of the forge. Rather than burning away, Grum's veins boiled with a violent adrenaline surge, allowing him to single-handedly shatter the wyrm's glacial hide.</p><p>Yet, this power was an anatomical curse. The price of this survival instinct was a permanent physiological meltdown. His blood ran hotter than forge-steel, cooking his internal pathways and locking out all incoming restorative magic while the battle-fury burned.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Berserkers are completely outlawed within the silver law-chambers and administrative halls of <LoreLink termId=\"atropolis\">Atropolis</LoreLink>, where their volatile fury is viewed as a threat to public order. However, they are highly celebrated in the geothermal arenas of the <LoreLink termId=\"harath_vault\">Harath-Vault</LoreLink> and the frontier keeps of the Skald, where their high-stamina survival engine is viewed as a sacred gift.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the massive Skald and hot-headed <LoreLink termId=\"emberth\">Thrask Emberth</LoreLink> who defaced their imperial marks to embrace the wild fury of the caldera.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Grum the Iron-Smith**: The legendary smith who crushed a glacier-wyrm with bare hands while his marrow boiled.\n* **Torra Bloodhammer**: A chieftain who led the Bloodhammer clans down into the geothermal vaults.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-skull\"><\/i> <h3 class=\"class-lore-name\">Titan<\/h3> <\/div> <span class=\"class-lore-role-badge\">Gravitational Tank<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The sentinel Korr stood watch along the crumbling lava paths of Emberspire during the War of Thousand Screams, holding back the glacier-wyrms with a massive obsidian pillar. To stand against the freezing winds, he drew the volcanic gravity of the caldera directly into his bones.</p><p>The volcanic gravity deformed his muscle structure, cracking his skin like basalt. The Titan requires continuous proximity to geothermal heat to prevent freezing solid; if he stays in the cold for too long, his joints calcify into immovable stone, requiring constant shifts in the Harath-Vault.</p><p>Wield the mountain. You are the basalt anchor of the badlands, and the earth bends to your strength. Crush them before the frost claims you.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The titan's core pressure was forged in the volcanic throat of Emberspire in <LoreLink termId=\"sundale\">Sundale</LoreLink>. An Emberth sentinel named **Korr** stood sentinel along the molten pathways, absorbing the volcanic heat into his own skin. The price of this thermal sentinel was basalt-cracking skin. Korr's skin cracked like basalt, requiring continuous shifts near geothermal vents to keep from freezing solid.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Titans are highly celebrated as guardians of the great forge and the Solbrand in the <LoreLink termId=\"harath_vault\">Harath-Vault</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is exclusively practiced by the <LoreLink termId=\"emberth\">Korr Emberth</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Korr the Unyielding**: The first Titan who stood watch with an obsidian pillar for three days in the ashfall.\n* **Malkar the Obsidian Core**: First to master the gravitational stabilization of the caldera chambers.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-shield-alt\"><\/i> <h3 class=\"class-lore-name\">Spellguard<\/h3> <\/div> <span class=\"class-lore-role-badge\">Void-Scarred Aegis<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Damon the blacksmith blocked a solar flare with an alchemical tower shield during Sol's entombment, protecting the caravan at the cost of his own hands. The solar energy permanently scarred his flesh, leaving his veins humming with volatile, trapped mana that threatens to detonate his own marrow.</p><p>The Spellguard's hands are frozen in a rigid, shielding posture, and absorbing spells causes intense nerve pain. A single cracked barrier can detonate his own marrow. They weld heavy brass plates to their arms to channel the backdraft, standing as the ultimate shield against the arcane.</p><p>Stand as the shield. You are the iron wall against the arcane, and the backdraft is your burden. Block it until the end.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The spellguard's aetheric aegis was forged during the great hunt of Aex in the volcanic calderas of <LoreLink termId=\"sundale\">Sundale</LoreLink>. An arcanist named **Damon** absorbed the explosive backdraft to prevent his lords from being vaporized during the solar binding. The price of this high-risk shield was vascular scarring. Damon's hands blistered, and his veins hummed with volatile energy, leaving him raw to the touch.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Spellguards are given places of honor as elite guards in the Canopy-Ledger of Atropolis and the keep of <LoreLink termId=\"greymark_keep\">Greymark Keep</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"neth\">Velun Neth</LoreLink> and the Thalren humans.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Damon the Iron-Handed**: The legendary blacksmith whose shield absorbed the first flares of the dying sun.\n* **Elysia Silver-Vein**: A Velun Neth sentinel who stabilized the barrier chambers during the first Breach.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-cross\"><\/i> <h3 class=\"class-lore-name\">Martyr<\/h3> <\/div> <span class=\"class-lore-role-badge\">Tank/Support<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The Solvarn mother Sera refused to let her sacrificed child's name be erased by the noble houses' history-purge. She carved the name directly into her forearm with volcanic obsidian, swearing to bear the pain of the entire badlands to keep the memory alive.</p><p>Her devotion opened a channel of sympathetic pain. The Martyr carries the physical scars of all nearby wounds, her tissue burning with sympathetic heat whenever an ally is struck. She finds power only in her own suffering, converting blood to light, her skin cracking to reveal the solar embers of her vow.</p><p>Suffer for them. You are the shield of meat and bone, and your wounds are the only light left in the ash. Bleed until they are safe.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The martyr's devotion was born in the volcanic badlands of <LoreLink termId=\"sundale\">Sundale</LoreLink>. A Solvarn mother named <LoreLink termId=\"sera\">Sera</LoreLink> refused to let her sacrificed child's memory be erased by the houses' subsequent history-purge. The price of this memory was a glowing, sympathetic solar scar. Sera carved her child's name directly into her forearm with volcanic obsidian, establishing the path that absorbs the suffering of others.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Martyrs are highly respected as holy guardians in the frontier keeps and the geothermal arenas of the <LoreLink termId=\"harath_vault\">Harath-Vault</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the Solvarn humans and the <LoreLink termId=\"emberth\">Korr Emberth</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Sera the Devoted**: The founding mother of the Martyr's Vow who carved the history of the sacrificed children.\n* **Orak the Scarred**: A Korr monk who bore the sympathetic heat of thirty miners during a geothermal rupture.</div> </div><\/div> <\/div> <\/div>"
  },
  {
    "title": "Nordhalla (Frozen Vigil Callings)",
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-skull-crossbones\"><\/i> <h3 class=\"class-lore-name\">Augur<\/h3> <\/div> <span class=\"class-lore-role-badge\">Visceral Haruspex (Omen Reading, Flesh Mutilation & Preemptive Evasion)<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The future does not reveal itself to clean minds; it must be dragged, warm and steaming, from the belly of the dead. It is said that Cassia, the chief star-watcher of the Nordhalla Keeps, sat in the Frozen Archive when the star Solbound first darkened. With the astrolabes frozen solid, she did not look to the sky. Instead, she took a bronze scaling knife and opened the abdomen of a sacrificial glacier-elk, spilling its entrails across the icy stone. By tracing the steaming convolutions of the intestines and the purple mottling of the liver, she read the exact hour of the Deepening. She did not find a path to salvation, but a map of the deaths to come.</p><p>The price of peering through the stargate feedback loops of fate was immediate and cruel. As the future flooded her mind, the temporal feedback loop burned away her past. The memories of her husband-s face, the warmth of the hearth, and the names of her children were incinerated to clear space for the mathematically precise coordinate chains of cosmic doom. To maintain this sight, the Augur must invite physical trauma. When the air is still and the future grows dim, she must carve deep runes into her own forearms, using the warm flow of her own blood to re-establish the connection to the stars. The viscera of her enemies and the split-open hides of beasts are her only ledger.</p><p>Predict the end. The sky is dark, but the runes in the meat still burn. Read the gory scroll before the final memory of your own name fades into the ice.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The augur's foresight was born in the Frozen Archive of <LoreLink termId=\"nordhalla\">Nordhalla</LoreLink>. A Skald star-watcher named **Cassia** read the terrifying portents of Sol's Deepening, her runes burning with intense, blistering heat.</p><p>The price of this feedback loop was memory-loss. Cassia had to trade away her own personal memories to glimpse the future, leaving her runes scarred and her mind disoriented.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Augurs are highly revered as scholars and prophets in the <LoreLink termId=\"frozen_archive\">Frozen Archive</LoreLink> and the high halls of the <LoreLink termId=\"synod_hold\">Synod-Hold</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"skald\">Rune Keeper Skald</LoreLink> and the Astril.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Cassia the Star-Eyed**: The legendary seer of the <LoreLink termId=\"frozen_archive\">Frozen Archive</LoreLink> who predicted the solar eclipse at the cost of her past.\n* **Kaelen the Unseen**: An Astril priest who mapped the stellar decay from the Scribe's Tower.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-bolt\"><\/i> <h3 class=\"class-lore-name\">Doomsayer<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage/Control (Chaotic Prophecy & Living Bombs)<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>During the first solar eclipse of Sol's Deepening, the Skald archivist Malakor did not flee. He locked himself in the Scribe's Tower with thirty scrolls of star-arithmetic. By calculating the mass of the dying sun and the cooling rate of the mantle, he realized that the freeze was not temporary, it was mathematically absolute. The realization did not break his mind; it froze it.</p><p>The absolute certainty of the world's end left Malakor in a state of perpetual dread. The Doomsayer is chemically unable to feel joy, surprise, or physical warmth. His voice carries a subsonic frequency that induces minor panic attacks in nearby creatures, and his skin is cold and blue as fjord-ice.</p><p>Sound the bell of doom. The math is absolute, and the end is written in stone. Warn them before the final tally.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The doomsayer's apocalypse counting was born in the library-vaults of <LoreLink termId=\"nordhalla\">Nordhalla</LoreLink>. A Skald record-keeper named **Malakor** recorded the approaching doom of Sol's Deepening, calculating the exact arithmetic of coming deaths.</p><p>The price of this absolute calculation was a perpetual dread. Malakor became completely unable to feel joy or surprise, his voice carrying the solemn, mathematical certainty of doom.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Doomsayers are respected yet avoided in civilized cities, often acting as solemn record-keepers in the <LoreLink termId=\"frozen_archive\">Frozen Archive</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the Solvarn humans and the <LoreLink termId=\"skald\">Rune Keeper Skald</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Malakor the Grim**: The archivist who calculated the exact decline of the human keeps, losing his ability to feel warmth.\n* **Valeria the Grim**: A Solvarn priestess who prophesied the extinction of the surface cities during the Cold-Lock.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-scroll\"><\/i> <h3 class=\"class-lore-name\">Inscriptor<\/h3> <\/div> <span class=\"class-lore-role-badge\">Control/Support<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The Skald scholar Theron could not stand the thought of the Frozen Archive's clockwork songs fading into oblivion as the glacier-halt slowly claimed the keepers. Using memory-glass chisels, he carved the mathematical formulas of the ancient solar machines directly into his own skin, binding the clockwork syntax to his own nervous system.</p><p>The price of this absolute preservation was his own past. Theron traded away his personal recollections; he forgets his children's names and his mother's face to retain the math of the runes. Every rune he writes erases another memory, replacing his history with blank, gray stone.</p><p>Inscribe the stone. The page remembers what the mind forgets, and the runes are written in blood. Write until you are blank.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The inscriptor's memory-carving was born in the Frozen Archive of <LoreLink termId=\"nordhalla\">Nordhalla</LoreLink>. A Skald scholar named **Theron** sought to preserve the ancient clockwork songs and began carving the runes directly into his own skin. The price of this preservation was memory-loss. To carve the mathematical formulas of the Archive, Theron had to trade away his own personal memories, leaving his past as blank grey stone.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Inscriptors are highly respected as high scholars and archivists within the <LoreLink termId=\"frozen_archive\">Frozen Archive</LoreLink> and the Canopy-Ledger of Atropolis.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"skald\">Rune Keeper Skald</LoreLink> and the Velun Neth.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Theron the Skald Scholar**: The librarian who traded his children's names to preserve the Archive's clockwork songs.\n* **Aurelia the Scribe**: A Neth contract-weaver who codified the Runic Vault rules in the Frozen Archive.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-link\"><\/i> <h3 class=\"class-lore-name\">Warden<\/h3> <\/div> <span class=\"class-lore-role-badge\">Melee Lockdown / Heavy Sentinel<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Alaric the law-keeper bargained with the Cosmic Warden to secure the gates of a mountain keep during the glacier-halt, binding his soul to the cold stone walls. He swore an oath written in frost-runes, sacrificing his own mortal warmth to protect the passes.</p><p>The contract froze his soul. The Warden's veins run cold as iron, and he cannot leave the mountain passes without his blood turning to ice shards. He is permanently bound to defend the stone keeps of Nordhalla, his presence freezing the air around him.</p><p>Hold the gates. You are the cold sentinel of the keeps, and the ice is your armor. Defend the pass until the cold lock is broken.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The warden's cold iron seal was born in the brutal keeps of <LoreLink termId=\"nordhalla\">Nordhalla</LoreLink>. A Skald law-keeper named **Alaric** bargained with the Cosmic Warden to secure the gates of a mountain keep during the glacier-halt. The price of this legal bond was a frozen soul. Alaric's veins ran cold as iron, and his soul was permanently bound to the stone keeps he swore to defend.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Wardens are highly respected as high judges and sentinels in the <LoreLink termId=\"frozen_archive\">Frozen Archive</LoreLink> and the timber keeps of Nordhalla.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"skald\">Rune Keeper Skald</LoreLink> and the Velun Neth.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Alaric the Law-Keeper**: The first warden whose veins turned to cold iron to hold the mountain passes.\n* **Soren the Iron Wall**: A Skald sentinel who defended the Fjord-Gate for forty days without breaking stance.</div> </div><\/div> <\/div> <\/div>"
  },
  {
    "title": "Frostwood Reach (Fog-Memory Callings)",
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-moon\"><\/i> <h3 class=\"class-lore-name\">Huntress<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The ranger Sylas tracked the invisible spoor of Wyrd-creatures through the Frostwood Reach by tuning his senses to the silent, sub-vocal vibrations of the pine needles and the damp earth. In a fog-shrouded valley, he stalked a conceptual entity for seven days, breathing only when the wind blew, training his eyes to trace the faint disturbances in the fog-memory.</p><p>To achieve this absolute sensory focus, Sylas paid with his own hearing, becoming completely deaf to the voices of his kin. The Huntress lives in a silent, predatory world of scents and vibrations, unable to hear the warnings of allies or the screams of her prey. The forest is a map written in heat, odor, and kinetic tremors.</p><p>Draw the bow. Scent the spoor. The forest is silent, and you are its sharpest shadow. Strike before they know you are there.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The huntress's stalker focus was forged in the ancient ironwood forests of the <LoreLink termId=\"frostwood-reach\">Frostwood Reach</LoreLink>. A wood-ranger named **Sylas** tracked the invisible spoor of Wyrd-creatures, using the fog to mask his approach. The price of this perfect focus was a sensory numbness. Sylas became completely deaf to the voices of his kin, his mind permanently locked in the tracking of mist-spoor.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Huntresses are welcomed as essential guides and beast-slayers in every frontier keep, though they rarely speak or enter the civilian sectors.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"mimir\">Mist-Woven Mimir</LoreLink> and the Skald hunters.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Sylas the Silent**: The first ranger who tracked the invisible spoor of Wyrd-creatures through the Frostwood.\n* **Maeve of the Canopy**: A Mist-Woven Mimir scout who guided the first Thalren refugees through the memory-erasing fog.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-biohazard\"><\/i> <h3 class=\"class-lore-name\">Bladedancer<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The first bladedancers were not warriors but desperate wood-wardens of the Frostwood Reach. During the fog-ambush of the First Winter, when a patrol was cornered in the frozen briars by face-stealing horrors, Sylvain realized that traditional shields and heavy iron plates were nothing but anchors dragging them to the frozen peat. He threw down his heavy gear, stripped to a single leather jerkin, and synchronized his strikes with the erratic, whipping motion of the wind-swept ironwoods. He flowed through the mist like a falling leaf, his twin hand-axes carving a path of absolute kinetic momentum through the beasts.</p><p>This absolute speed demands a terrifying physical toll. To dance with Sylvain's grace, a practitioner must train their nervous system to exist in a state of permanent, high-velocity twitch. The constant contortion causes severe joint friction and myelin sheath decay. When the dance stops, the kinetic engine stalls instantly, locking their limbs in agonizing stiffness and leaving their physical senses temporarily dulled, as if they are trapped in a freezing vacuum.</p><p>The wind does not tire. Your speed is your only shield, and the blade is your voice. Let the steel sing until the dance is done.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The bladedancer's fluid grace was first manifested in the mist-shrouded canopy of the <LoreLink termId=\"frostwood-reach\">Frostwood Reach</LoreLink>. A wood-warden named <LoreLink termId=\"sylvain\">Sylvain</LoreLink>, cornered by a pack of face-stealing horrors, abandoned his heavy stance and synchronized his strikes with the swaying ironwood branches. By letting his movements flow with the wind-swept mist, he cleared the pack in a blur of kinetic sweeps.</p><p>The price of this perfect physical momentum was absolute exhaustion. When the dance stopped, the kinetic strain locked his joints in agonizing fatigue, and his physical senses were temporarily dulled to the rest of the world.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Bladedancers are highly celebrated as protectors and scouts across the frontier keeps of <LoreLink termId=\"frostwood-reach\">Frostwood Reach</LoreLink> and the canopy avenues of <LoreLink termId=\"atropolis\">Atropolis</LoreLink>. They are treated with caution in settled towns like <LoreLink termId=\"merrowport\">Merrowport</LoreLink>, where their high-velocity agility is viewed as unpredictable, volatile, and lethal.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"mimir\">Mist-Woven Mimir</LoreLink> and agile humans who have trained their bodies to flow through the fog-memory trees.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Sylvain the Wood-Warden**: The sentinel who saved his squad from face-stealing horrors by dancing through the branches.\n* **Kaelen the Swift**: A Mask-Borne Mimir aristocrat who adapted the canopy dance into a lethal style to clear the Shallows.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-moon\"><\/i> <h3 class=\"class-lore-name\">Lunarch<\/h3> <\/div> <span class=\"class-lore-role-badge\">Control/Support<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Selene, a sister of the forgotten House Viridane, bargained with the wildwood fae in the moonlit groves of the Frostwood, seeking the light of the dead moon to guide her family's escape from the northern vigil keeps. She bound a lunar parasite to her bones, letting its starlight veins wrap around her marrow.</p><p>The fae granted the light, but they took the warmth from her blood. The Lunarch carries a permanent chill in her marrow, unable to feel heat even when standing in forge-fire. Her power fluctuates erratically with the lunar cycles, leaving her weak during the new moon, her skin glowing with a pale silver aura.</p><p>Shine in the dark. The moon's light is cold, but it is the only guide left in a frozen world. Guide them before the shadows close in.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The lunarch's crescent aura was born in the moonlit groves of the <LoreLink termId=\"frostwood-reach\">Frostwood Reach</LoreLink>. A sister of House Viridane named **Selene** fled the noble armies and bargained with the wildwood fae to capture the moon's light. The price of this celestial aura was a permanent chill in her bones. Selene could never feel warmth again, even next to volcanic vents, her flesh glowing with a pale, sympathetic silver.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Lunarchs are celebrated as spiritual leaders among the Briaran, but they are hunted as heretics by the noble houses of the north.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is exclusively practiced by the <LoreLink termId=\"briaran\">Briaran</LoreLink> descendants of House Viridane.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Selene of House Viridane**: The founding sister of the Lunarch order who led her house's escape from the north.\n* **Eldrin the Moon-Touched**: A Briaran elder who established the first moonlit sanctuaries in the Frostwood Reach.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-cross\"><\/i> <h3 class=\"class-lore-name\">Exorcist<\/h3> <\/div> <span class=\"class-lore-role-badge\">Iron Inquisitor / Sin-Eater<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Traditional blades and steel-clad shields are useless against the conceptual horrors born from the Frostwood Reach's mist. In the second century after the solar bind, Elias the salt-scarred healer realized that these entity-incursions could not be destroyed by force of arms; they had to be lured into a living vessel and physically anchored within a human vascular system. By using rusted bells tuned to sub-vocal hums and bathing his arms in alchemical null-salts, Elias became the first prison.</p><p>This righteous burden permanently scarred Elias's blood vessels, leaving his veins humming with trapped, thrashing spirits. The Exorcist lives in constant, agonizing proximity to the damned, hearing the claws of bound entities scratching inside his skin, whispering heresy to his marrow. To prevent the conceptual rot from leaking out, they must regularly apply brand-seals and carry heavy, brass bell-harnesses.</p><p>Ring the bell. Clear the fog. You are the living prison for the dark, and your blood is the lock. Keep them bound until you break.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The exorcist's purification rites were born in the fog-shrouded groves of the <LoreLink termId=\"frostwood-reach\">Frostwood Reach</LoreLink>. A human salt-scarred healer named <LoreLink termId=\"elias\">Elias</LoreLink> realized that conceptual, face-stealing horrors could only be bound by pinning their forms with rusted iron and bog-salt. The price of this spiritual sealing was biological. Elias had to open his own veins to draw the Wyrd into himself, leaving his vascular system permanently scarred and raw to the touch.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Exorcists are welcomed in every timber keep and frontier settlement of the Reach, serving as the essential shields against the Wyrd's conceptual infestations. They are given a wide berth in Atropolis, where citizens fear the whispering voices emanating from the exorcists' skin.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the Thalren humans and the <LoreLink termId=\"mimir\">Unwoven Mimir</LoreLink> who live on the forest floor.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Elias the Salt-Scarred**: The healer who first drew the Gref face-traders into his own blood to bind them.\n* **Vaelen the Sin-Eater**: An Unwoven Mimir who opened his own veins to trap a face-stealing horror under <LoreLink termId=\"greymark_keep\">Greymark Keep</LoreLink>.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-flask\"><\/i> <h3 class=\"class-lore-name\">Toxicologist<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage/Support<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Varis the alchemist extracted raw venom from the fog-predators of the Frostwood, seeking a chemical defense against the face-stealing horrors that cornered his scout patrols. He spent years in the ironwood canopies, distilling toxic moss and acidic secretions.</p><p>The constant exposure to toxic fumes caused chronic tremors in his hands, burning away his sense of taste and leaving his fingers permanently stained with acid runoff. The Toxicologist cannot handle delicate tools without intense pain, their catalysts trailing corrosive fumes.</p><p>Brew the end. The vial is filled with your own decay, and the vapor is your shroud. Let them choke.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The toxicologist's chemical catalysts were born in the ironwood forests of the <LoreLink termId=\"frostwood-reach\">Frostwood Reach</LoreLink>. An alchemist named **Varis** extracted raw venom from the fog-predators to create specialized combat catalysts. The price of this alchemical synthesis was chronic tremors. Varis's hands developed chronic tremors, and his fingers were permanently stained with chemical runoff, dulling his sense of taste.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Toxicologists are viewed with extreme caution in <LoreLink termId=\"greymark_keep\">Greymark Keep</LoreLink>, but their services are highly valued by scouts and hunters in the Reach.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the Thalren humans and the <LoreLink termId=\"mimir\">Unwoven Mimir</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Varis the Alchemist**: The chemist whose hands shook but whose poison cleared the Shallows of Gref.\n* **Lyra the Poison-Weaver**: An Unwoven Mimir who synthesized the first combat catalysts used in the Shallows black markets.</div> </div><\/div> <\/div> <\/div>"
  },
  {
    "title": "Bryngloom Forest (Pact-Bog Callings)",
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-crosshairs\"><\/i> <h3 class=\"class-lore-name\">Covenbane<\/h3> <\/div> <span class=\"class-lore-role-badge\">Anti-Magic Hunter<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The Bryngloom Forest is a landscape of moss and peat-bogs where the line between life and death is a legal clause written in silver and heartwood. The Vreken, native to these crepuscular caves, carry the Ghost-Mycelium in their blood, granting them the trail-sight to track the residual light of the dead. But the volatile fungus is a double-edged sword, carrying the highly addictive, euphoric \"hush\" that leads to the Over-Lit epidemic.</p><p>In the fifth century, a beloved Marked Veil-Speaker named Aedris succumbed to the hush, her eyes burning with a blinding silver light that bleached the peat-stone. Blinded by her own glow, she began draining the lifeforce of her acolytes. Her brother, Orven the Still-Handed, refused to let the crypt-council debate. He forged a blade of cold bog-iron, wrapped his hands in salted leather, and tracked his sister into the deepest bogs. He ended her suffering and swore the Barbed Vow: to execute any kinsman lost to the mycelial hush.</p><p>Orven's sacrifice birthed the order of the Covenbane. To carry the cold iron and alchemical null-salts is to become a sterile void for magic. The silver deposits in their marrow make their bones brittle, and their tracking seals isolate them from the very Spire they protect. The Clean Vreken crypt-councils tolerate them at the margins, relying on their blades but banning them from the high archives.</p><p>You are the Covenbane. The trail-sight shows you every kinsman who has fallen to the hush. You hunt them because no one else can. You hunt them alone because no one else should have to.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The covenbane's specialized tracking was born in the deep, damp bogs of the <LoreLink termId=\"bryngloom-forest\">Bryngloom Forest</LoreLink>. A Vreken hunter named <LoreLink termId=\"orven\">Orven</LoreLink>, whose sister had succumbed to the mycelial spore-hush, swore the Barbed Vow to track and execute his own corrupted kinsmen.</p><p>The price of this tracking efficiency was complete social isolation. By training his trail-sight to detect the fungal-hush, Orven permanently scarred his mental pathways, leaving him blind to warmth and locked in a sterile, silent hunt.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Covenbanes are feared, respected, and deeply isolated. They are tolerated at the margins of <LoreLink termId=\"sunken_spire\">The Sunken Spire</LoreLink> and Atropolis, but they never find a permanent home within the civilian sectors.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is exclusively practiced by the <LoreLink termId=\"vreken\">Marked Vreken</LoreLink> who carry the volatile Ghost-Mycelium strain.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Orven the Still-Handed**: The founder of the Barbed Vow who tracked his own sister into the sinking bogs.\n* **Aedris the Blind**: A Marked Vreken hunter who tracked heretics through the bogs using only the thrum of the mycelium.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon Necrotic/Necrotic Skull\"><\/i> <h3 class=\"class-lore-name\">Deathcaller<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage/Support<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Kora, the first human debtor to the Neth, could not bear the silence of the peat-bogs. She walked into the marsh-depths of the Bryngloom and bargained with the Root-Veil, offering her own life force to keep the ancestral lights of thirty generations burning.</p><p>The price of this necrotic link was absolute. Kora was cursed to hear the overlapping, non-stop screams of the deceased, reducing her spoken voice to a dry, raspy whisper. Every necrotic thread she spins drains her own blood, slowly decaying her skin to a waxy, pale frost.</p><p>Walk between life and the peat. The ancestors demand a voice, and you are the channel. Call them down before they call you home.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The deathcaller's vocal resonance was born in the sunken cathedrals of the <LoreLink termId=\"bryngloom-forest\">Bryngloom Forest</LoreLink>. A Vreken Veil-Speaker named **Kora** sought to maintain the light of thirty generations of ancestors and began singing the names of the dead with absolute vocal volume.</p><p>The price of this spiritual connection was hearing the continuous, overlapping screams of the deceased. The necrotic feedback permanently scarred her vocal cords, forcing her to speak in tattered whispers and spit blood when shouting her dirges.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Deathcallers are respected as vital spiritual caretakers within the catacombs of the <LoreLink termId=\"sunken_spire\">Sunken Spire</LoreLink>, but their presence in surface cities is viewed as a dark omen.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"vreken\">Clean Vreken</LoreLink> and the foam-born Myrathil who listen to the ocean rifts.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Kora the Veil-Speaker**: The first caller whose voice turned to tattered whispers to keep the crypt-lights burning.\n* **Neth-Veil Valerius**: A Neth pact-lord who established the necrotic covenant linking bog-graves to Atropolis.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-skull\"><\/i> <h3 class=\"class-lore-name\">Witch Doctor<\/h3> <\/div> <span class=\"class-lore-role-badge\">Support/Control<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Nesta the Vreken herbalist bargained with the ancient loa of the Bryngloom marsh to heal the spore-hush that ravaged her family's cave-keeps. She offered her own mind as a playground for the spirits, inhaling the green spore-dust of the bioluminescent groves.</p><p>The spirits healed her kin, but they left Nesta in a state of permanent mental confusion. The Witch Doctor suffers constant hallucinations, hearing the whispering voices of the bog-loa and struggling to separate reality from the spirit world.</p><p>Curse the living. The loa demand blood, and your bone flask is empty. Brew the curse.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The witch doctor's root-weave was born in the lightless groves of the <LoreLink termId=\"bryngloom-forest\">Bryngloom Forest</LoreLink>. A Vreken botanist named **Nesta** sought to cultivate the bioluminescent mushrooms and accidentally absorbed their spore-dust. The price of this botanical bond was a persistent mental confusion. Nesta suffered from the spore-hush, her eyes reflecting the pale green of bog-lanterns.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Witch Doctors are respected as vital healers in the <LoreLink termId=\"sunken_spire\">Sunken Spire</LoreLink> and the Morren villages, though their treatments are viewed as terrifying.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"vreken\">Clean Vreken</LoreLink> and the Morren humans.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Nesta the Herbalist**: The botanist who first allowed the bog-loa to speak through her hallucinations.\n* **Karr the Spirit-Talker**: A Morren healer who bargained with the bog-loa to cure the lung-rot epidemic.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-biohazard\"><\/i> <h3 class=\"class-lore-name\">Plaguebringer<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage/Control<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Vespera the Vreken alchemist bonded with the bog-rot of the Bryngloom to synthesize a cure for the spore-hush that ravaged her family's cave-keeps. She gathered the decaying moss of the Sunken Spire, injecting its alchemical bile directly into her veins to act as a counter-toxin.</p><p>She cured the hush, but her body became a permanent host for active decay. The Plaguebringer's skin is waxy, pale, and cold, and she must constantly cultivate new diseases within her own tissue to prevent the rot from consuming her own internal organs, transforming her body into a living laboratory.</p><p>Sicken the world. You are the flask of pestilence, and the rot is your only strength. Spread the seed before you dissolve.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The plaguebringer's rot-vessel was born in the peat-bog sinks of the <LoreLink termId=\"bryngloom-forest\">Bryngloom Forest</LoreLink>. An alchemist named **Vespera** sought to synthesize a cure for the mycelial spore-hush and accidentally bonded with the bog's decay. The price of this alchemical synthesis was waxy, cold skin and warty growths. Vespera lived in perpetual symbiosis with the rot, her skin turning waxy, pale, and cold to the touch.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Plaguebringers are feared and outlawed in every civilized city, forced to reside in the Over-Shanties or the forest sumps.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"neth\">Drun Neth</LoreLink> and the Morren outcasts.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Vespera the Rot-Vessel**: The alchemist who saved her family from the spore-hush at the price of hosting active decay.\n* **Malakor the Bile-Lord**: A Drun Neth outcast who weaponized the mycelial rot against canopy patrols.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-skull\"><\/i> <h3 class=\"class-lore-name\">Lichborne<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage/Control<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The Neth archivist Vesper, dying of the sumps' lung-rot in the Bryngloom, performed the forbidden Rite of the Cold Hearth. He bound his soul to a basalt phylactery and invited the bog's freezing decay to halt his mortal heart, swapping his failing mortal organs for the moss-preserved stasis of the peat.</p><p>He achieved immortality, but his body is a cold, rotting tomb. His heart beats once an hour, his flesh is cold as bog-iron, and he must constantly harvest life force to prevent his skeleton from dissolving. Restoring his form requires the raw combustion of death, leaving him in a state of perpetual, ravenous hunger.</p><p>The tomb is empty. Rise. You are the bone-weaver, and death is your fuel. Reclaim your flesh.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The lichborne's necrotic stasis was born in the deep peat-bog sinks of the <LoreLink termId=\"bryngloom-forest\">Bryngloom Forest</LoreLink>. A dying human scribe named **Vesper** walked into the deep woods and bargained with the Root-Veil to halt his decaying flesh. The price of this survival was a slow, cold death. Vesper's heart beat once an hour, his extremities grew waxy and cold, and his joints required constant moss preservation to keep from locking.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Lichbornes are viewed with profound dread throughout the sunless world, often forced to reside in the Over-Shanties or the deepest subterranean sumps.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is practiced by the <LoreLink termId=\"neth\">Drun Neth</LoreLink> and desperate human Morren.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Vesper the Scribe**: The dying scholar who first bound his soul to a basalt phylactery to halt his lung-rot.\n* **Karr Bloodhammer**: The legendary Skald warlock who performed the first stasis ritual to combat the Milk-Grief.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-atom\"><\/i> <h3 class=\"class-lore-name\">Arcanoneer<\/h3> <\/div> <span class=\"class-lore-role-badge\">Magi-ballistic Mutilator (Damage/Utility -- Zero Healing)<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>In the first drafting of the First Contract with the Keeper of the Last Threshold, the high Neth archivist Valerius sought to capture the raw, volatile magic of the Bryngloom Forest without succumbing to its decay. By structuring incantations as strict legal syntax and balanced clauses, he bypassed the chaotic feedback of traditional spellcasting.</p><p>Yet, the Keeper demanded a physical toll. The price of this absolute structured clarity was that his blood crystallized into volatile, multicolored shards that had to be physically siphoned through a massive pig-iron cylinder forearm graft. Firing these shards anchors the limbs to the earth in a freezing lock, fractures the ribs from recoil, and seals the voice against any falsehood.</p><p>You are the contract's executioner. The Keeper has written the syntax in your bones, and your forearm cylinder is the chamber. Pull the trigger.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The arcanoneer's calling was born in the deep scriptorium vaults of <LoreLink termId=\"atropolis\">Atropolis</LoreLink> within the <LoreLink termId=\"bryngloom-forest\">Bryngloom Forest</LoreLink>. During the first drafting of the First Contract with the Keeper of the Last Threshold, a Neth archivist named <LoreLink termId=\"valerius\">Valerius</LoreLink> sought a way to capture the raw, volatile magic of the forest without succumbing to its decay. By structuring incantations as strict, balanced legal syntax, he bypassed the chaotic feedback of traditional spellcasting.</p><p>Yet, the magic demanded a heavy physical toll. The price of this absolute structured clarity was that his blood crystallized into volatile, multicolored shards that had to be physically chambered and siphoned through pig-iron sleeves grafted directly to the forearm. Firing these shards anchored his limbs to the earth in a freezing lock, drained his physical stamina, and permanently sealed his voice against any falsehood.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Arcanoneers are the most politically powerful and highly respected citizens within <LoreLink termId=\"atropolis\">Atropolis</LoreLink>. They occupy the highest seats of the Canopy-Ledger, serving as the judges, administrators, and high diplomats of the Neth empire. They are also welcomed within <LoreLink termId=\"ironjaw_port\">Ironjaw Port</LoreLink>, where their contract-based spellcraft ensures the safety of the dock-complex.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is almost exclusively practiced by the <LoreLink termId=\"neth\">Velun Neth</LoreLink>, whose biology (being unable to lie) provides the absolute honesty required to submit contracts to the Keeper without triggering a catastrophic, soul-fading breach of terms.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Valerius the Scriptor**: First Neth archivist to graft the pig-iron sleeve to channel crystallized blood-shards.\n* **Kaelen the Unbroken**: A Neth arcanoneer who held the docks of <LoreLink termId=\"ironjaw_port\">Ironjaw Port</LoreLink> against a tide of glacier-wyrms.</div> </div><\/div> <\/div> <\/div>"
  },
  {
    "title": "Cragjaw Peaks (Span-Bound Callings)",
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-shield-alt\"><\/i> <h3 class=\"class-lore-name\">Dreadnaught<\/h3> <\/div> <span class=\"class-lore-role-badge\">Tank<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The vertical bridges of the Cragjaw Peaks are spans of bone and rope, hanging over blizzards that swallow both sound and direction. When the smoothing plague first swept through the Fexric vats, the Groven troll-kin broke their alchemical chains and claimed these bridges as their sanctuary. Yet, during the War of Thousand Screams, the blue-fleshed Skreika descended from the northern fjords, threatening to sweep the refugees into the bottomless rifts of the Peaks.</p><p>In that hour of ruin, a Skald blacksmith named Vaelen Bloodhammer took the heavy brass plates of the Frozen Archive's heating pipes and welded them directly onto the skin of his frontliners. He mounted alchemical steam-pistons to their limbs, powered by alchemical coal-boilers mounted to their spines. These warriors marched back into the blizzard, belching black soot and superheated steam, shrugging off the Skreika's icy claws to anchor themselves to the crumbling spans.</p><p>This was the birth of the Dreadnaught, a calling that transforms the body into a steam-powered tomb. The constant heat of the combustion engine blisters the skin, and the crushing weight of the iron plates causes severe skeletal fatigue, slowing the wearer to a methodical, unstoppable advance.</p><p>You are the iron wall between your kin and the freezing dark. Let the storm howl and the enemy strike. You are the shield of the Peaks, and your resolve is welded to the stone.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The dreadnaught's immovable defense was forged on the precipitous bridges of the <LoreLink termId=\"cragjaw-peaks\">Cragjaw Peaks</LoreLink>. A heavy-scaled Groven warrior named **Vance** anchored himself to a crumbling span during a blizzard, shielding a refugee caravan from a howling wind-gap.</p><p>The price of this absolute resilience was severe skeletal fatigue. By forcing his muscles to calcify into dense plates, Vance's joints grew rigid, permanently reducing his speed and rendering him vulnerable to sudden kinetic impacts.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Dreadnaughts are given places of honor as sentinels along the <LoreLink termId=\"cragjaw-peaks\">Ancestor-Spans</LoreLink> and the gates of Greymark Keep.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"groven\">Morgh Groven</LoreLink> and the armored human defenders of the north.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Vance the Immovable**: The troll-kin who became a living furnace-shield to protect the refugee spans.\n* **Vaelen the Welded**: A Fexric guild-engineer who created the steam-piston armor to defend the vertical gates.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-paw\"><\/i> <h3 class=\"class-lore-name\">Formbender<\/h3> <\/div> <span class=\"class-lore-role-badge\">Hybrid (Tank/Damage/Support)<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The Morgh Groven laborer Torin was trapped in a deep mine-sump beneath the Cragjaw Peaks when a structural support snapped. Rather than allowing the mountain to crush his kin, he drank a draft of raw alchemical sulfur-clay and forced his own skeleton to calcify and expand, mimicking the basalt pillars to hold up the ceiling. The alchemical calcification cracked his bones, leaving his frame rigid and rough as slate.</p><p>The desperate adaptation saved the miners, but it permanently locked Torin in a state of continuous skeletal mutation. The Formbender's bones are in constant, grinding friction; their calcified skin is rigid and rough as slate, making their movement slow and highly vulnerable to sudden kinetic impacts that crack their bone-plates.</p><p>Shatter the stone. Shift the bone. Your body is a mountain in miniature, and the rock does not yield. Hold the line.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The formbender's alchemical physical adaptation was forged in the deep sumps of <LoreLink termId=\"frostmaw_holdfast\">Frostmaw Holdfast</LoreLink>. A troll-kin laborer named **Torin** sought to survive a structural collapse and forced his skeleton to calcify and expand under the grinding stone. The price of this biological molding was continuous skeletal agony. The alchemical calcification cracked his bones, leaving his frame rigid and vulnerable to sudden kinetic stress.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Formbenders are highly respected as elite laborers and combatants along the spans, though they are viewed as volatile alchemical anomalies by the Fexric guilds.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the heavy-scaled <LoreLink termId=\"groven\">Morgh Groven</LoreLink> and the Fexric Drall.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Torin the Troll-Kin**: The miner whose slate-plates held up a mile of collapsing mountain to save his clan.\n* **Durn the Scrap-Molder**: A Fexric Drall who used alchemical runoff to mold his own limbs into ironwood-hard forms.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-skull\"><\/i> <h3 class=\"class-lore-name\">Fate Weaver<\/h3> <\/div> <span class=\"class-lore-role-badge\">Cartomancer Sovereign<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>In the vertical canyons of the Cragjaw Peaks, the Neth probability-watcher Lyra saw her trade-caravan cornered by a sudden, massive rockslide. Rather than trying to outrun the stone, she used her cards to pluck the threads of alternate timelines, finding the single reality where her companions survived. She pulled that timeline into the present, swapping the falling boulders with empty air.</p><p>The psychic recoil of experiencing all alternate deaths of her friends in a single second permanently fractured Lyra's consciousness. The Fate Weaver's mind remains split across multiple timelines; she suffers from constant hallucinations, visual tremors, and panic attacks as she witnesses her companions die in dozens of ways every second.</p><p>Deal the cards. Reweaver the thread. The tapestry of fate is frayed, and you are the needle. Stitch it before the final thread snaps.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The fate weaver's probability manipulation was born in the vertical canyons of the <LoreLink termId=\"cragjaw-peaks\">Cragjaw Peaks</LoreLink>. A Kessen Neth probability-watcher named **Lyra** sought to calculate the exact structural failure of a rope-bridge and began weaving the threads of alternative timelines. The price of this vision was psychic trauma. By severing her own connection to native timelines, Lyra experienced the visceral shock of alternate deaths, leaving her mind permanently fractured.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Fate Weavers are highly valued in the canopy-libraries of Atropolis, serving as the high strategists and trade arbiters of the Neth guilds.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the <LoreLink termId=\"neth\">Kessen Neth</LoreLink> and the fine-scaled Ithran Groven.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Lyra the Probability-Watcher**: The cartomancer who witnessed her friends die in a hundred ways to find the one path where they lived.\n* **Ordan the Cartomancer**: A steppe nomad who mapped the constellation shifts by weaving probability threads.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-clock\"><\/i> <h3 class=\"class-lore-name\">Chronarch<\/h3> <\/div> <span class=\"class-lore-role-badge\">Control<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>During the War of Thousand Screams, when a collapsing glacier threatened to crush the Frostmaw Holdfast, the Fexric engineer Nesta realized that physical struts could not hold back the grinding weight of the ice. She built a prototype time-dilation engine using volcanic glass and alchemical gears. In her desperation to freeze the falling stone, she hooked the engine's temporal loop directly into her own chest, trapping her timeline in a temporal feedback loop.</p><p>Nesta held the span, but the temporal feedback loop incinerated her past. The Chronarch carries no personal memories of childhood or family; she lives in a perpetual, agonizing present, her past constantly erased to make space for the calculations of time manipulation. Furthermore, every second she bends causes severe skeletal decay, her bones calcifying like ancient fossilized stone under the strain of chronal friction.</p><p>Command the ticking of the gears. You are the clockwork sentinel, and the timeline is yours to wind. Wind it before the gears grind to a halt.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The chronarch's temporal manipulation was first manifested in the high passes of the <LoreLink termId=\"cragjaw-peaks\">Cragjaw Peaks</LoreLink>. A Fexric clockwork engineer named **Nesta** sought to repair an alchemical engine and accidentally trapped her own timeline in a feedback loop of temporal friction.</p><p>The price of this chronal mastery was rapid localized aging and memory displacement. Every time she manipulated time to prolong an ally's lifespan or delay a threat, her own personal history decayed, leaving her past as blank grey stone.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Chronarchs are highly respected and given places of honor in the library-cathedrals of the <LoreLink termId=\"frozen_archive\">Frozen Archive</LoreLink> and the guild chambers of <LoreLink termId=\"frostmaw_holdfast\">Frostmaw Holdfast</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the guild-bound <LoreLink termId=\"fexrick\">Kethrin Fexrick</LoreLink> and long-limbed Groven diplomats who oversee the Ancestor-Spans.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Nesta the Clockwork Engineer**: The Fexric builder who halted a glacier's advance by trapping herself in a temporal loop.\n* **Chronos the Blind**: A prehistoric Fexric master who built the clockwork galleries in <LoreLink termId=\"frostmaw_holdfast\">Frostmaw Holdfast</LoreLink>.</div> </div><\/div> <\/div> <\/div>"
  },
  {
    "title": "Iceheart Sea (Gale-Rider Callings)",
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-dice\"><\/i> <h3 class=\"class-lore-name\">Gambler<\/h3> <\/div> <span class=\"class-lore-role-badge\">Damage / Utility<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The pirate captain Jax wagered his own lifeline in a game of dice against a freezing storm-spirit of the Iceheart Sea, seeking a wind that would blow his ice-locked vessel out of the grinding floes. He rolled three sixes, claiming the wind, but the spirit did not leave empty-handed; it claimed the warmth of his blood, synchronizing his pulse with the deep rifts.</p><p>The gambler's heartbeat was permanently synchronized with the ocean's tides, preventing him from ever finding sleep unless his head is submerged in freezing saltwater. If he remains on dry land for too long, his blood begins to clot and stagnate, and his mind slips into a state of wild, risk-seeking paranoia, mapping his fortunes on his tattooed skin.</p><p>Flip the coin. Bet it all. Fortune is a fickle mistress, and she demands your life as the stake. Roll the dice before the tide turns.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The gambler's risk-based magic was born in the floating alleys of <LoreLink termId=\"merrowport\">Merrowport</LoreLink>. A Merryn pirate captain named **Jax** wagered his own lifeline to navigate a vessel through a perpetual storm-cycle. The price of this luck-manipulation was perpetual insomnia. His heartbeat was permanently synchronized with the churning of the freezing waves, preventing him from ever finding rest.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Gamblers are highly celebrated in the tavern-decks of Merrowport, but they are viewed with clinical contempt by the Neth pact-lords of <LoreLink termId=\"ironjaw_port\">Ironjaw Port</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is almost exclusively practiced by the Merryn humans and the <LoreLink termId=\"myrathil\">Breakers-Born Myrathil</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Jax the Storm-Wagerer**: The pirate who gambled his soul for a gale and lost his sleep to the ocean's tides.\n* **Elysia the Gilded Die**: A notorious high roller who won the charter of <LoreLink termId=\"merrowport\">Merrowport</LoreLink> in a high-stakes dice game against a sea-spirit.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-music\"><\/i> <h3 class=\"class-lore-name\">Minstrel<\/h3> <\/div> <span class=\"class-lore-role-badge\">Support<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>The Merryn sailor Lyris sang a sacred sea-symphony to the churning gales of the Iceheart Sea, calming the waves so her ice-locked vessel could dock at Merrowport. The song was beautiful, but it was a transaction with the deep tides, drawing the freezing currents into her lungs.</p><p>The ocean mother accepted the song, but she stole Lyris's spoken voice. The Minstrel can only communicate through melodic whispers or the strings of her lute. Attempting to scream or speak normally causes her throat to bleed and her lungs to fill with salt-water, her melodies carrying the physical weight of the gales.</p><p>Let the chorus rise. The sea has taken your voice, but your song can still shatter the glaciers. Sing until the world listens.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The minstrel's auditory resonance was born on the storm-lashed decks of <LoreLink termId=\"merrowport\">Merrowport</LoreLink>. A Merryn sailor named **Lyris** sang to the churning gales, using the sea's own frequency to steady her vessel. The price of this musical balance was her spoken voice. The sea-gales stole her spoken speech, leaving her able to communicate only in melodic whispers that crumbled when she tried to scream.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Minstrels are highly celebrated in the floating taverns of <LoreLink termId=\"merrowport\">Merrowport</LoreLink> and the nomadic yurt-camps of the steppe.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the Merryn humans and the <LoreLink termId=\"myrathil\">Breakers-Born Myrathil</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Lyris the Tide-Singer**: The sailor whose melodies calmed the Iceheart Sea but left her throat bleeding if she tried to speak.\n* **Aurelius the Tide-Singer**: A Myrathil bard whose songs could resonate with the deep rifts, opening safe passages between drift-ice.</div> </div><\/div> <\/div> <\/div>"
  },
  {
    "title": "Sundrift Vale (Steppe Nomadic Callings)",
    "content": "<div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-eye\"><\/i> <h3 class=\"class-lore-name\">Oracle<\/h3> <\/div> <span class=\"class-lore-role-badge\">Support/Utility (Foresight & Fate Manipulation)<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Vala, the Astril star-watcher of the Sundrift Vale, stared into the black sky during Keth-Amar's descent and received a blinding vision of the stars' destruction. The constellation-spirits flooded her mind, searing her optical nerves and leaving her in a state of permanent temporal displacement.</p><p>The weight of this celestial foresight left her blind to the immediate present. The Oracle can see tomorrow's battles with perfect clarity, but she cannot see the stones at her feet, requiring allies to guide her steps through the physical world, her body wracked by warning seizures.</p><p>Glimpse the light. The future is written in starlight, and you are the lens. Read the thread before it burns away.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The oracle's warning flashes were born in the starless steppe of the <LoreLink termId=\"sundrift-vale\">Sundrift Vale</LoreLink>. An Astril star-watcher named **Vala** stared into the starless dark and received a vision of the stars' destruction. The price of this foresight was physical seizure. The warning flashes induced minor physical seizures, leaving her blind to the immediate present to see the future.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Oracles are highly revered as vital spiritual guides in the yurt-camps of the steppe and the high halls of the <LoreLink termId=\"synod_hold\">Synod-Hold</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the crystal-skinned <LoreLink termId=\"astril\">Sylen Astril</LoreLink> and nomadic humans.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Vala the Star-Eyed**: The Astril seer whose warning flashes left her blind to the dirt but clear to the future.\n* **Micah the Seer**: A nomad who mapped the starless sky by tracing the echoes of dead constellations.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-leaf\"><\/i> <h3 class=\"class-lore-name\">Primalist<\/h3> <\/div> <span class=\"class-lore-role-badge\">Support / Crowd Control / Defender (Atavistic Horror)<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Kael the herd-ranger ran with the woolly-herds across the starless grasslands of the Sundrift Vale, tuning his spirit to the elemental totems of the steppe. He sat in the grass for three seasons without moving, letting the dust settle on his skin until the wind-spirits welcomed him as kin.</p><p>This absolute wilderness alignment eroded his humanity. The Primalist periodically slips into a feral silence, losing the ability to speak or comprehend language when the totemic energy surges, his mind reverting to the simple, brutal instinct of the beast.</p><p>Call the wild. The earth speaks through you, and the pack is waiting. Run with them.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The primalist's wild aspect was born in the starless grasslands of the <LoreLink termId=\"sundrift-vale\">Sundrift Vale</LoreLink>. A human herd-ranger named **Kael** ran with the woolly-herds, letting his posture and breath adapt to the wilderness. The price of this wilderness alignment was a feral silence. Kael lost his civil speech, his mind periodically slipping into animalistic silence.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Primalists are viewed with caution in settled kingdoms, but they are highly respected as essential scouts in the nomadic camps of the steppe.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the nomadic Ordan humans and the <LoreLink termId=\"astril\">Sylen Astril</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Kael the Herd-Runner**: The ranger who lived as a wolf for ten years, forgetting how to speak human tongue.\n* **Maeve the Wolf-Mother**: An Astril primalist who led the steppe packs against the Gref invaders.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-dice\"><\/i> <h3 class=\"class-lore-name\">Chaos Weaver<\/h3> <\/div> <span class=\"class-lore-role-badge\">Entropic Vector / Timeline Fracturer<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>Reality is a woven tapestry, but the nomad Xyris did not see beauty in the threads; she saw a cage. Splicing a thread of raw temporal friction directly into her own veins, she sought to tear open the veil and draw power from the gravity anomalies left behind by the Breach. She gathered fragments of the Sundrift Monolith, fusing them into her own blood to thin the planar anchor that binds her to this world.</p><p>The price of this entropic friction is molecular instability. Her physical form is vulnerable to sudden, localized dissolution, her marrow humming with erratic void energy that threatens to tear her apart. Her spells are wild, unpredictable swings, risking catastrophic feedback loops that can consume her own flesh or damage allies as easily as enemies.</p><p>Embrace the void's friction. The lines of reality are fraying, and your hands are on the loom. Spin the madness before it unravels you.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The chaos weaver's volatile planar manipulation was first manifested in the starless steppe of the <LoreLink termId=\"sundrift-vale\">Sundrift Vale</LoreLink>. A nomadic star-watcher named **Xyris** sought to capture the energy of the dying constellations and accidentally spliced a thread of temporal friction directly into her blood.</p><p>The price of this planar thinning was severe molecular instability. By step-stepping through dimensional seams, Xyris permanently thinned her planar anchor, leaving her physical form vulnerable to sudden dissolution and requiring intense mental stamina to maintain stability.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>Chaos Weavers are viewed with intense suspicion and fear throughout the settled kingdoms, often forced to practice their volatile arts in the nomadic yurt-camps of the <LoreLink termId=\"sundrift-vale\">Sundrift Vale</LoreLink> or the deep subterranean sumps of <LoreLink termId=\"frostmaw_holdfast\">Frostmaw Holdfast</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is heavily practiced by the crystal-skinned <LoreLink termId=\"astril\">Sylen Astril</LoreLink> who seek absolute symbiosis with their nesting spirits.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Xyris the Rift-Spanner**: The nomad who thinned her planar anchor to step through reality, risking physical dissolution.\n* **Zarek the Unstable**: An Astril chaos-weaver whose skin blazed with the light of three colliding stars.</div> </div><\/div> <\/div> <\/div><div class=\"class-lore-card\"> <div class=\"class-lore-card-header\"> <div class=\"class-lore-card-title-group\"> <i class=\"class-lore-icon fas fa-eye\"><\/i> <h3 class=\"class-lore-name\">False Prophet<\/h3> <\/div> <span class=\"class-lore-role-badge\">Caster/Controller<\/span> <\/div> <div class=\"class-lore-card-content\"> <div class=\"class-lore-myth\"> <h4 class=\"class-lore-section-title\"><i class=\"fas fa-scroll\"><\/i> The Myth &amp; The Toll<\/h4> <div class=\"class-lore-paragraphs\"><p>In the starless grasslands of the Sundrift Vale, a nomadic herd-watcher named Micah followed a falling meteor into a deep, crystalline crater. He did not find a metal shard, but an ancient, sundered monolith humming with a black, empty vacuum. When he looked directly into the void where the sun-god Sol once shone, he did not see light; he saw the gospel of the cosmic void. The vacuum spoke not in words, but in the terrifying, silent architecture of the stars' demise.</p><p>Micah returned with blank, white eyes and a mind permanently shattered by the competing voices of dead stars. The False Prophet is physically blind, his skin pale and cracked, and his heart beating in erratic, asynchronous patterns. His words carry a hypnotic madness that drains the stamina of listeners, forcing them to see the phantom embers of dead stars.</p><p>Speak the void's gospel. The stars are dead, and the vacuum is the only truth left. Lead them into the dark.</p><\/div> <\/div> <div class=\"class-lore-details\"><h4 class=\"class-lore-section-title\"><i class=\"fas fa-theater-masks\"><\/i> Roleplay Identity<\/h4><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">HISTORY: THE GENESIS</div> <div class=\"class-lore-detail-value\"><p>The false prophet's blinding fervor was born in the starless steppe of the <LoreLink termId=\"sundrift-vale\">Sundrift Vale</LoreLink>. A nomadic herd-watcher named **Micah** stared into the empty, starless sky and surrendered his vision to the phantom lights of the steppe. The price of this revelation was physical blindness. Micah gouged his own physical sight to perceive the guiding embers, leaving his eyes blank and his mind permanently disoriented.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">CITIES &amp; CIVIL RECEPTION</div> <div class=\"class-lore-detail-value\"><p>False Prophets are viewed with profound suspicion in civilized kingdoms, often treated as dangerous heretics, though they lead small, devoted followings among the steppe nomads.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">RACES &amp; CULTURAL AFFILIATION</div> <div class=\"class-lore-detail-value\"><p>The class is practiced by desperate humans and the constellationless <LoreLink termId=\"astril\">Unlit Astril</LoreLink>.</p></div> </div><div class=\"class-lore-detail-block\"> <div class=\"class-lore-detail-label\">NOTABLE FIGURES</div> <div class=\"class-lore-detail-value\">**Notable Figures**\n* **Micah the Blind Prophet**: The herd-watcher who gouged his eyes to see the void's dead constellations.\n* **Seraphina the Silent**: An Unlit Astril who led a small cult of starless heretics across the steppe.</div> </div><\/div> <\/div> <\/div>"
  }
  ]
        }
      },
    ...
    subcategories: [
      {
        ...
        summary: [
          ...
          'The system features 30 unique classes, 10+ races, and a custom spellcrafting wizard.',
...
This quest introduces you to the core themes of Mythrill: memory, identity, and the cost of survival. It also teaches you the basic mechanics: skill checks, social encounters, and exploration.`
            },
            {
              ...
              content: `If you are new to Mythrill and do not want to parse 30 classes, 11 races, and 15 backgrounds, here is a safe, fun starting build:

**The Fog Hunter**
- **Race:** Human (Thalren), You are from Greymark. You know the city, the fog, and the people.
- **Class:** Huntress, You track Wyrd-creatures through the fog. You are deaf to human voices but can read the forest's vibrations.
- **Background:** Hunter, You know the trails, the beasts, and the dangers of the Reach.

**Why this works:**
- The Huntress is straightforward: mark targets, strike with precision, pursue relentlessly.
...
- **The Masked Stranger:** Mimir (Unwoven subrace), Bladedancer class. You are an outcast who fights with speed and deception.
          ...
          tables: [
            {
              ...
              rows: [
                ...
                ['Character Setup', 'Single Class choosing a subclass at level 1-3.', '30 unique classes with distinct resource systems.', 'Find your archetype without multiclassing.'],
    ...
    subcategories: [
      {
        ...
        theme: 'narrative',
        summary: ['30 unique classes with flexible character building', '5-step guided creation process', 'Independent choices for race, class, and background'],
        content: {
...
1. **Hero Draft** - Ink your character's name, claim your ancestral heritage with **Race & Subrace**, select your combat role and resource system from **30 distinct classes**, allocate base stats using a tactile point-buy system, and (if your class wields magic) choose your starting spells.
...
5. **Final Summary** - Review your completed ledger, seal your character's sheet, and prepare to step into the virtual tabletop.`
            ...
            },
            {
              ...
              content: `The beauty of the Mythrill system lies in its limitless custom combinations. By separating race, class, and background, you can combine elements to create completely unique characters, such as a Lichborne with an Urchin background, a Titan with a Soldier background, or a Toxicologist with a Scholar background. These combinations are designed to feel distinct and provide exciting tactical and roleplaying opportunities at the table.`
            }
          ]
        }
      },
...
- **Dreadnaught**: Steam-powered iron juggernaut. Converts damage taken into power.
...
- **Titan**: Gravity manipulator. Colossal strength and area control.
...
- **Bladedancer**: Finesse fighter. Zero armor, all speed and precision.
...
- **Huntress**: Tracker. Marks priority targets, strikes with precision.
- **Pyrofiend**: Fire demon. Swallows demonic embers for explosive area damage.
- **Chaos Weaver**: High-risk magic. Unpredictable, devastating, volatile.
...
- **Inscriptor**: Rune master. Carves mathematical boundaries onto the battlefield.
- **Augur**: Omen reader. Even/odd dice results fuel blessings and curses.
- **Doomsayer**: Prophet of catastrophe. Places living bomb prophecies.
...
- **Oracle**: Seer. Foresight and divination to guide the party.
- **Fate Weaver**: Destiny manipulator. Turns failures into power with card-based mechanics.
- **Lunarch**: Lunar mage. Phase-based energy cycles for support and control.
- **Primalist**: Totem master. Creates powerful synergies through sacred totems.
- **Witch Doctor**: Voodoo practitioner. Invokes Loa spirits through curses and rituals.
...
- **Covenbane**: Anti-magic hunter. Disrupts spellcasting and nullifies corruption.
- **Deathcaller**: Blood mage. Sacrifices health for forbidden necrotic power.
- **Exorcist**: Demon binder. Commands bound fiends through sacred ritual.
- **Formbender**: Shapeshifter. Masters four primal forms with adaptive combat.
- **Gambler**: Risk-taker. Manipulates luck and probability with Fortune Points.
- **Lichborne**: Frost undead. Life-draining aura and resurrection mechanics.
              ...
              tables: [
                {
                  ...
                  rows: [
                    ...
                    ['Corvani', 'Raven-marked people from mist-shrouded highlands.', '2 (Oracle, Scout)', 'Prophecy, fate manipulation, mist walking'],
