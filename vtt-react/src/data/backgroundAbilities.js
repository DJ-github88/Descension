...
export const BACKGROUND_ABILITIES = {
  mystic: [
    {
      ...
      type: 'Active',
      usage: '1/Long Rest',
      description: 'The Wyrd pools behind your sternum like a held breath. Enter a Mana Surge state for 1 minute, reducing spell costs and casting one spell for free.',
    ...
    },
    {
      ...
      type: 'Passive',
      usage: '1/Day',
      description: 'Every element in Mythrill remembers the sun it lost. Attune to an elemental type once per day, gaining resistance and bonus damage.',
  ...
  arcanist: [
    {
      ...
      type: 'Passive',
      usage: 'Always Active',
      description: 'The crystal-lattice archives taught you to read resonance the way a scribe reads ink. Cast Detect Magic at will and gain advantage on checks to identify spells and magical effects.',
    ...
    },
    {
      ...
      type: 'Active',
      usage: '1/Short Rest',
      description: 'A Neth contract-lawyer rewrites clauses; you rewrite spells. Modify a spell by changing its damage type, range, targets, or duration.',
  ...
  trickster: [
    {
      ...
      type: 'Active',
      usage: '3/Long Rest',
      description: 'The Luck-Ledger inquisitors audit every sailor\'s skin for unpaid shares; you audit fate itself. Force a reroll on any d20 roll made by you or an ally within 30 feet.',
    ...
    },
    {
      ...
      type: 'Passive',
      usage: '1/Long Rest',
      description: 'The Over-Shanty teaches you how to fall. Once per long rest, remain at 1 hit point instead of being reduced to 0.',
  ...
  harrow: [
    ...
    },
    {
      ...
      type: 'Active',
      usage: 'At Will',
      description: 'The Wyrd-trails left by the dead are visible to those who survived them. See invisible creatures and into the Ethereal Plane for 1 minute.',
  ...
  hexer: [
    {
      ...
      type: 'Passive',
      usage: 'Always Active',
      description: 'The Root-Veil hums beneath the bog, and the old groves remember every name. Communicate with beasts and plants, and gain advantage on Survival checks.',
    ...
    },
    {
      ...
      type: 'Active',
      usage: '1/Long Rest',
      description: 'The animist old ways bind flesh to spirit in ways the Runic Academies outlawed. Transform part of your body to gain bestial benefits for 10 minutes.',
  ...
  reaver: [
    ...
    },
    {
      ...
      type: 'Active',
      usage: '1/Short Rest',
      description: 'A Skald sump-veteran hits like the glacier that raised them. Add your Strength modifier to damage again and potentially knock the target prone.',
  ...
  mercenary: [
    {
      ...
      type: 'Passive',
      usage: 'Always Active',
      description: 'The Toll-Dike crossings and sump-skirmishes school the survivors. Gain proficiency with three weapons of your choice or +1 to attack rolls with already proficient weapons.',
    ...
    },
    {
      ...
      type: 'Active',
      usage: 'At Will',
      description: 'A veteran reads the opponent before the first blow lands. Assess a creature to learn its Armor, hit point percentage, and one damage vulnerability, resistance, or immunity.',
    ...
    },
    {
      ...
      type: 'Active',
      usage: '1/Short Rest',
      description: 'The rope-bridges of the Over-Shanty do not teach clean fighting. Force a target to make a Constitution save or be blinded or immobilized until the end of your next turn.',
  ...
  sentinel: [
    {
      ...
      type: 'Passive',
      usage: 'Always Active',
      description: 'The Tapestry-Wards hold where the Wyrd presses hardest. Grant allies within 10 feet a +1 bonus to Armor and potentially increase it further as a reaction.',
    ...
    },
    {
      ...
      type: 'Active',
      usage: '1/Long Rest',
      description: 'The Aegis tradition builds walls from resonance alone. Create a 15-foot-radius ward that grants allies resistance to one damage type and damages enemies.',
