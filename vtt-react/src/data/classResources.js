...
export const CLASS_RESOURCE_TYPES = {
 ...
 'Pyrofiend': {
  ...
  tooltip: {
   ...
   description: 'The Sundered Caldera\'s heat rises through each infernal circle, each level grants +1 ember damage but inflicts severe drawbacks based on circles of the deep',
   showLevel: true,
   showBonuses: true,
   showDrawbacks: true
  }
 ...
 'Minstrel': {
   ...
   notes: [
    {
     ...
     color: '#DC143C',
     glow: '#FF6B6B',
     description: 'The root-note of Revel Sylvan\'s ancient songs anchors the fey melody. Stability and home',
    ...
    },
    {
     ...
     color: '#FF8C00',
     glow: '#FFA500',
     description: 'Dissonance is the shadow that gives the Old Revel\'s harmony its shape. Creates dissonance',
    ...
    },
    {
     ...
     color: '#FFD700',
     glow: '#FFED4E',
     description: 'The fey music colors emotion with hues beyond mortal sight. Emotional depth',
    ...
    },
    {
     ...
     color: '#32CD32',
     glow: '#90EE90',
     description: 'Revel Sylvan\'s melodies flow forward like a river of woven sound. Forward motion',
    ...
    },
    {
     ...
     color: '#4169E1',
     glow: '#6495ED',
     description: 'Every harmony woven demands its resolution, as the Old Revel demands. Demands resolution',
    ...
    },
    {
     ...
     color: '#8B008B',
     glow: '#BA55D3',
     description: 'The minor hues of fey music carry sorrow from the deepest groves. Melancholy and depth',
    ...
    },
    {
     ...
     color: '#9400D3',
     glow: '#DA70D6',
     description: 'The Old Revel\'s final pull, dragging every melody home. Pulls to tonic',
  ...
  sharedPassive: {
   ...
   description: 'Revel Sylvan\'s harmony-weavers learned to gift their resonance to allies. When you complete a 4-note cadence, all allies within 30 feet gain +1d4 to their next attack or spell. This bonus stacks up to 3 times.'
  },
  specPassives: {
   battlechoir: {
    name: 'War Anthem',
    description: 'The war songs of Revel Sylvan stir blood and sharpen blades. Your offensive cadences (Circle of Fifths, Phrygian Cadence, Neapolitan Sixth) grant all affected allies +2 to attack rolls for 2 turns. and, when an ally scores a critical hit while affected by your buffs, you generate 1 random musical note.'
   },
   soulsinger: {
    name: 'Soothing Melody',
    description: 'The soulsingers of the Old Revel channel healing through ancient melodies. Your healing cadences (Authentic Cadence, Picardy Third) heal for an additional 1d6 HP. and, whenever you heal an ally, you generate 1 Tonic (I) note. When using a Lute or Harp, healing is increased by an additional +2.'
   },
   dissonance: {
    name: 'Cacophony',
    description: 'When fey music turns to dissonance, reality itself begins to warp. Your control cadences (Deceptive Cadence, Tritone Substitution) have their save DC increased by 2. and, when an enemy fails a save against your cadence, all enemies within 10 feet must make a Wisdom save (DC 13) or become frightened for 1 turn. Dissonant sounds echo unpredictably.'
   }
  }
 },
 ...
 'Chronarch': {
  ...
  visual: {
   ...
   temporalStrain: {
    max: 10,
    baseColor: '#424242',
    // shifting colors based on strain level
    strainColors: {
  ...
  tooltip: {
   ...
   paradox: {
    ...
    description: 'Every temporal paradox echoes through the Frozen Hours of Sundrift. Build Time Shards (power) by casting spells, but spending them on Temporal Flux adds Temporal Strain (risk). Balance power and safety by letting Strain decay between bursts of temporal manipulation.'
   }
  }
 },
 ...
 'Gambit (Threads)': {
  ...
  shortName: 'Threads',
  type: 'threads',
  description: 'Fortune\'s wheel spins fate into threads that can be grasped and woven. Every failure is fuel. Every thread is a weapon. Woven from fate\'s disruptions to manipulate destiny.',
  deckRules: {
   deckSize: 52,
  ...
  threadLevels: [
   ...
   { min: 7, max: 9, name: 'Wyrd-Weave', color: '#FFD700' },
  ...
  visual: {
   ...
   specializations: {
    'probability_savant': {
     ...
     color: '#2980b9',
     icon: 'fas fa-brain',
     description: 'Some read the contract-deck as a ledger, balancing probability with cold precision. Mathematical foresight - incremental roll manipulation',
...
// DIVINE PATH
  ...
  specializations: {
   redemption: {
    ...
    uniquePassive: {
     ...
     description: 'The Redemption path channels the Sun-That-Was\'s mercy into healing grace. Martyr\'s Intervene heals protected ally for 2d6 HP. All healing spells +10 ft range'
    }
   },
   zealot: {
    name: 'Zealot',
 ...
 'False Prophet': {
  ...
  visual: {
   ...
   segmentBorder: '#2d1b4e',
   icon: 'fas fa-eye',
   effects: ['madness', 'Wyrd-touched', 'void']
  },
  mechanics: {
 ...
 'Plaguebringer': {
  ...
  sharedPassive: {
   name: 'Plague Mastery',
   description: 'Where the Blooming Plague takes root, contagion lingers and festers. Afflictions last 2 additional rounds and resist dispel (5-6 on 1d6). Gain 1d4 mana when afflicted target dies.'
  },
  specPassives: {
   virulentSpreader: {
    name: 'Epidemic Mastery',
    description: 'The Blooming Plague\'s contagion jumps from victim to victim like seeds on the wind. Base afflictions apply to 2 adjacent targets. Stage 2+ afflictions auto-spread. +1 spread target per 25 Virulence.'
   },
   tormentWeaver: {
    name: 'Wyrd Resonance',
    description: 'Afflictions woven together fester in harmony, each feeding the others. Same affliction on multiple targets creates Wyrd Links. Cultivating one cultivates all. +1 link per 25 Virulence.'
   },
   decayHarbinger: {
    name: 'Accelerated Decay',
    description: 'When the contagion refuses to bloom, it simply festers forever. No final form. Post-Stage 3 adds permanent stacks (max 15/target). +1d6 blight per stack per 25 Virulence. Stacks above 10 require concentration.'
   }
  }
 },
...
export const initializeClassResource = (className, characterStats) => {
 ...
 if (className === 'Revenant') {
  ...
  baseResource.maxBenediction = config.visual?.specOverrides?.auspex?.benedictionMax || 10;
  baseResource.maxMalediction = config.visual?.specOverrides?.auspex?.maledictionMax || 10;
  baseResource.omenDebt = 0;
  baseResource.specialization = 'auspex';
  baseResource.max = baseResource.maxBenediction;
 } else if (className === 'Toxicologist') {
  const intMod = Math.floor(((characterStats.intelligence ?? 10) - 10) / 2);
  baseResource.toxinVials = 4;
  baseResource.toxinVialsMax = Math.max(4, intMod + 3);
  baseResource.contraptionParts = 5;
  baseResource.contraptionPartsMax = 5;
  baseResource.max = baseResource.toxinVialsMax;
 } else if (className === 'Martyr') {
  baseResource.damage = config.mechanics?.damage || 0;
...
CLASS_RESOURCE_TYPES['Spellguard'] = {
 ...
 tooltip: {
  ...
  description: 'Every counter-spell feeds the Spellguard\'s arcane reservoir. Energy absorbed from magical damage. Spend on shields, reflections, and strikes.',
  showAEP: true,
  showAbsorption: true,
  showDecay: true
 }
...
CLASS_RESOURCE_TYPES['Arcanoneer'] = {
 ...
 shortName: 'Spheres',
 type: 'spheres',
 description: 'The iron sleeve channels raw elements through a combination matrix of formula synthesis. Roll 4d8 each turn to generate elemental spheres. Combine any two to produce a formulation from the 36-combination matrix.',
 visual: {
 ...
 tooltip: {
  ...
  description: 'Each roll of the combination matrix feeds the iron sleeve with new formulae. Roll 4d8 each turn to generate elemental spheres. Combine any two to produce a formulation.',
  showSpheres: true,
  showBreakdown: true,
...
CLASS_RESOURCE_TYPES['Berserker'] = {
 ...
 mechanics: {
  ...
  overheat: {
   ...
   damage: '2d6',
   resetTo: 0,
   description: 'When rage exceeds its breaking point, the body overheats and burns itself clean. If Rage exceeds 101 and is not spent within one round, take 2d6 damage and reset to 0'
  },
  generation: {
   attacking: '1d6',
   criticalHit: '2d6',
 ...
 tooltip: {
  ...
  description: 'From Smoldering to Apocalypse, every state of fury carries its own price. Escalating fury with six Rage States. Overheat at 101+. Use the button to +10, -10, or Set a value.',
  showRage: true,
  showState: true,
...
CLASS_RESOURCE_TYPES['Lunarch'] = {
 ...
 shortName: 'Phase',
 type: 'lunar_cycle',
 description: 'The moon turns through its cyclical phases, waxing from new to full and waning back to dark. Cyclical moon phases that grant different bonuses and alter spell effects',
 visual: {
  type: 'lunar-phases',
 ...
 tooltip: {
  title: 'Lunar Phases',
  description: 'Each lunar phase, new, waxing, full, waning, reshapes the magic that flows beneath it. Cyclical moon phases that grant different bonuses. Phases naturally cycle every 3 rounds or can be manually shifted for 8 mana. Spells with selfDamage advance the phase timer by +1 round.'
 }
};
...
CLASS_RESOURCE_TYPES['Augur'] = {
 ...
 shortName: 'B/M',
 type: 'dual-omen',
 description: 'Every die roll carries an omen, and the Augur reads them all. Read the signs in every die roll, even results generate Benediction, odd results generate Malediction. Spend Benediction on boons and blessings, Malediction on curses and debuffs. Only applies to rolls by creatures within 60ft that you can see and are aware of.',
 visual: {
  type: 'dual-omen',
  benediction: {
   max: 10,
 ...
 tooltip: {
  ...
  description: 'Divination turns even and odd into a language of benediction and malediction. Even d20 rolls → Benediction. Odd d20 rolls → Malediction. Only applies to visible creatures within 60ft. Advantage/disadvantage: both rolls generate. At max: overflow is lost. Unused resources at long rest cause Omen Debt (-1 per point to all rolls next day, cap -10). Short rest resets to 0 with no debt.',
  showGeneration: true,
  showSpending: true,
  showSpecPassive: true,
  showOmenDebt: true
