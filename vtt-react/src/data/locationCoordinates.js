 ...
 *
 * Pixel coordinates for the canonical 82 zones on the
 * 4096x3072 world map (viewBox space; the 8K master art renders into this box).
 ...
 * This builtin set was restored 2026-08-05 from the canonical July set
 * (commit fa839c63), with 7 zone ids remapped to current zoneData.js names.
 */
...
export const LOCATION_COORDINATES = {
  ...
  // ========================================================
  'black-firth': { x: 1120, y: 440, pinType: 'wilderness', regionId: 'nordhalla', source: 'world' },
  ...
  'ymirs-hold': { x: 1120, y: 200, pinType: 'wilderness', regionId: 'nordhalla', source: 'world' },
  ...
  'cinder-strait': { x: 2250, y: 870, pinType: 'wilderness', regionId: 'sundale', source: 'world' },
  'cinderhoodoo-spires': { x: 1950, y: 1550, pinType: 'wilderness', regionId: 'sundale', source: 'world' },
  ...
  'scrap-sump': { x: 3700, y: 1930, pinType: 'wilderness', regionId: 'cragjaw-peaks', source: 'world' },
  ...
  'novas-heath': { x: 3700, y: 2950, pinType: 'wilderness', regionId: 'sundrift-vale', source: 'world' },
