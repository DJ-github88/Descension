...
'scathrach': {
 ...
 summary: 'A secretive, shape-shifting people of the Frostwood Reach who wear heartwood, storm-glass, or pine masks.',
  fullEntry: 'The Mimir are the mask-wearers of the Frostwood canopy, and they have never shown their faces to outsiders. They were made by Sereth, the dead creator-deity of perfection and form, whose shame at his imperfect creation drove him to hide his people from the world itself. Sereth gave them the power to shift their shapes — to be anything except what they were. But the fog that saved the Reach from freezing also devours memory. After generations in the mist, a Mimir can forget their own face. So they carve masks from heartwood or storm-glass, and the mask becomes the only thing holding them together — a blank canvas for an identity they can no longer remember.\n\nThe Masked rule the canopy-holds as aristocrats. The Woven keep watch from the high aeries, maintaining a living mask-craft tradition through storm-glass forging. The Unwoven, born without masks or the ability to shapeshift, drift the valley floor carrying cracked heirlooms no one remembers how to repair. At the heart of Masked territory lies Mirror Mere, a lake so still it returns a Mimir\'s true face even when they can no longer recall it.\n\nThe original art of carving masks was lost when the inquisitors burned the birthing chambers during the Mimir Purge. The Woven\'s living craft preserves fragments of the old knowledge, but the technique that created the first masks died with Sereth. The Hunters pay fortunes for Mimir masks on the black market. And every year, the fog grows a little thicker.',
 ...
 type: 'race',
 region: 'bryngloom-forest',
  summary: 'A people bound by iron contracts to the forest entity that gave them immortality — the Velun carry the pact\'s authority, while the Kessen and Drun walk different paths.',
  fullEntry: 'For eight centuries, the Neth have kept a contract with the forest entity other races only fear. The terms are simple: Morvane preserves their bodies, and the Neth write down everything it consumes. The Velun, bound most directly to the pact, speak with Morvane\'s authority — their words are enforceable contracts, but every commitment made aloud is a potential obligation. The Kessen perceive the obligation-web and manipulate it, but every thread tugged snaps elsewhere. The Drun burned their names from the Contract entirely — they are magic-resistant, debt-null, and legally do not exist. The alternative for anyone who breaches the terms is the silence.\n\nThey rose from the bog with pale skin and stilled breath, descended from a dying scribe-clan that negotiated survival out of Morvane\'s mouth. Now they rule Atropolis and divide into three: the pale-skinned Velun pact-lords who govern the canopy, the Kessen weavers who work the forest floor, and the leaden-grey Drun, outcasts who burned their names from the Contract and legally do not exist.\n\nBeyond the city, the Vel-Keth Bayou, "the water that remembers," supplies the memory-glass that Kessen weavers harvest from its bed. The living-ironwood settlement of Aran-Glen shows what the Neth can build when they have centuries and a forest willing to be shaped.',
 ...
 type: 'race',
 region: 'sundrift-vale',
  summary: 'Alien refugees of the Sundrift Vale, descended from settlers of the dead world Lumia whose bloodlines still carry the echo of Lumia\'s lost biosphere.',
  fullEntry: 'The Astril are not native to Mythrill. They are the descendants of refugees who fled a dying world they call Lumia, carrying fragments of Lumia\'s biosphere in their blood. When Keth-Amar devoured Lumia, the Astril\'s original sun, the survivors brought the echo of their homeworld\'s life with them across the void. That echo lives in their bloodlines — pale blue-tinged skin, reptilian slit-pupil eyes, and unique crystalline body markings that trace each Astril\'s heritage. They are farmers and ritual-tenders, not mystics — a practical people carrying an extraordinary burden.\n\nThey are divided into two bloodlines. The Vashir carry Lumia\'s reptilian heritage: scaled forearms, claw-like nails, cooler body temperature, the grounded patience of farmers and hunters who work the soil of a world they inadvertently doomed. The Silath carry Lumia\'s consciousness: the stellar memory, the star-reading gift, the nocturnal calling that drives the Selunis-ritual every night beneath the moon. Every Astril makes pilgrimage to Starfall Vale, where shards from Lumia\'s destruction still strike the earth, and the memory of a dead world can be heard in the crystalline resonance of trapped light.',
 relatedTerms: ['ancestor_mounds', 'ancestor_wold', 'astril', 'false_prophet', 'grass_tundra', 'harbinger', 'house_ordavan', 'kumis_downs', 'lien_stalked_grazes', 'morrens_bogpost', 'mound_camps', 'nova_heath', 'starfall_vale', 'synod_hold', 'the_long_steppe', 'the_unlit_knoll', 'animist', 'xyris', 'kael', 'sera-three-scars', 'mor-vereth', 'loras-ordavan', 'li-wei', 'triune-founders']
  },
...
'the_breach': {
 ...
 relatedTerms: ['house_skalvyr', 'hunger_glaciers', 'nordhalla', 'rime_born', 'rimors_hearth', 'skadis_col']
  ...
  type: 'entity',
  region: 'sundale',
  summary: 'The ancient, impartial cosmic balance that is the cost of every bargain struck in Mythrill.',
  fullEntry: 'Aethil is no spirit, no ancestor, no force of nature, no will. It is the universe\'s mechanism of consequence: the rule that every exchange has a price, and the price simply *is*.\n\nIts hand is on the founding of the world. When Sol entered the Deepening, the binding houses came to Aethil with a proposal to entomb the dying star beneath Sundale, and the price was named: Aex, Sol\'s own firstborn, willing, whose living hide was flayed to weave the binding seal. Aethil did not choose this price — it is the exchange rate for caging a star. Afterward each house returned to strike its own compact. Thalreth traded clarity for fog. Skalvyr traded summer for halted glaciers. Each exchange was accepted because a price existed for it.\n\nThe Dark Bargains, the capitulation to Keth-Amar and the sacrifice of the firstborn heirs, were struck with Keth-Amar directly. Aethil had no part in them. Confusion arises because both entities deal in exchange, but they are not the same. Aethil is the rule. Keth-Amar devours. Those who have encountered what they believe to be Aethil describe only a sensation: the certainty that a debt has just been recognized.',
 relatedTerms: ['aex', 'house_skalvyr', 'house_solvan', 'house_thalreth', 'keth_amar', 'nordhalla', 'silent_seventh', 'the_breach', 'the_deepening', 'the_still_crag', 'titan', 'warden']
  ...
  'keth_amar': {
   ...
   'the_wyrd': {
    ...
    type: 'entity',
    region: 'sundale',
    summary: 'Keth-Amar\'s corruption, the living wrongness bleeding through the Breach cracks into the air the living breathe.',
    fullEntry: 'The Wyrd is not a creature and not a place. It is Keth-Amar\'s corruption made ambient: the residue of the Sun-Eater\'s hunger leaking through the cracked seal into the world. When the Breach split Sol\'s tomb, the Wyrd bled into the volcanic air the living breathe, and it has been reshaping flesh, memory, and intention ever since. It is patient and contagious. It does not rage; it corrodes, offering warmth for blood and power for surrender until the vessel no longer remembers it was ever whole. The Wyrd is what the Deep Alchemists refine, what the Barbed Vow cuts, and what the Watcher in the Mist holds at bay by forgetting. Where the fog thins and the groves ring with the dead moon, the Wyrd runs deepest.',
    relatedTerms: ['keth_amar', 'the_breach', 'the_warden', 'the_watcher', 'lunarch', 'inquisitor', 'deep_alchemists']
   },
   ...
   'the_watcher': {
    ...
    type: 'entity',
    region: 'frostwood-reach',
    summary: 'The impartial cosmic boundary entity between life, death, memory, and oblivion, known as Morvane in the Bryngloom.',
    fullEntry: 'The Watcher in the Mist (called Morvane by the Neth) is the world\'s memory and conscience — the boundary between life and death, memory and oblivion. Older than Keth-Amar\'s intrusion, it is a personality woven into the world\'s fabric: impartial, all-knowing, and fundamentally quiescent. It does not serve Aethil. It is not answerable to Keth-Amar. Its role is to watch, remember, weigh, and rarely act.\n\nThe Watcher did not choose Viridane. Viridane\'s desperation during the Breach reached the boundary, and the Watcher answered because total imbalance is the one thing it cannot permit. It offered the memory-fog to hide them from Keth-Amar\'s sight, folding the false Monolith into a pocket of forgotten memory at the same moment. The erasure worked too well. Now the Watcher cannot find the false Monolith either — a splinter lodged in its own territory that it cannot extract without unmaking itself.\n\nIts attention is strained. Keth-Amar\'s presence presses against the boundary, and the Watcher is fracturing under the pressure. If it fractures, death and memory disappear as categories entirely. The fog that eats memory is both the Watcher\'s protection and the first symptom of its collapse. The Watcher is dying, and everything else is downstream of that death.',
...
'sol': {
 ...
 type: 'race',
 region: 'nordhalla',
  summary: 'Born from the Hunger Pact, every Rime-Born child kills its mother at birth — a glacial curse that exacts Keth-Amar\'s tithe in warmth and life with each new generation.',
 ...
 type: 'location',
 region: 'sundrift-vale',
  summary: 'The crystal-lattice archive of the Astril Synod, where the Astril elders preserve the heritage of Lumia and adjudicate disputes between the Vashir and Silath.',
  fullEntry: 'The Astril built their seat from resonant crystal-lattice in the Sundrift Vale, and the hum of trapped starlight hasn\'t stopped since. The Synod Hold is where the Astril elders study the Lumian heritage carried in their blood, adjudicate disputes between the Vashir and the Silath, and keep the most complete records of their lost homeworld left in the world. The Synod is also where False Prophets are tried and banished, their deceptive light recognized as a toxic forgery of true Lumian resonance. Enter the Synod Hold and the starlight hum will press against your teeth; the Astril say the lattice remembers every echo of Lumia it has ever trapped, and it is still singing them.',
 ...
 type: 'race',
 region: 'iceheart-sea',
 summary: 'A bioluminescent sea-born people spawned from volcanic foam, with webbed fingers and ocean-blue eyes, divided into the shore-dwelling Shore, the abyssal Deep, and the inland Brook.',
 fullEntry: 'When Emberspire erupted and bled fire into the frozen sea, the ocean answered with foam. The Myrathil crawled out of that foam: bioluminescent, web-fingered, their eyes the deep blue of the trenches they left behind. Their skin still shifts color with mood, flushing silver when they rage and going dark when they grieve.\n\nThe Shore keep the coast, working the docks and the diplomatic tables where the Board of Trade decides who sails and who sinks. The Deep descend to the abyssal pressure-forges where no light reaches, crafting things the surface world doesn\'t see. And the Brook swim inland, trading saltwater for the freshwater rivers that thread the continent, carrying news and goods to places no ship can reach.',
 ...
 fullEntry: 'The Still Crag is a cliff face where no wind blows, no sound carries, and the ice sculptures of unknown figures stand frozen in attitudes of supplication. The Rime-Born believe the crag is where Aethil\'s breath physically touched the mountain during the Glacier Bargain, freezing everything it touched into permanent, silent witness. Within the crag lies Frostcirque, a natural glacial amphitheater where the ice walls are covered in runic script. Here, the Rime-Born perform their Memory-Freezing rites, preserving their most important experiences in blocks of glacier ice stored in the walls for eternity. Stand on the Still Crag and you\'ll feel the silence press against your ears; Aethil\'s breath froze this place mid-word, and the word has never been spoken since.',
 ...
 fullEntry: 'The Deepwell Archipelago is the Deep Myrathil\'s hidden civilization, a chain of ice-islands stretching forty miles, each one concealing underwater cave-cities beneath its frozen surface. The Deep maintain a culture entirely separate from the surface world, emerging only to trade and to conduct their Drowning Rites, rituals that surface-dwellers are not permitted to witness. The archipelago is connected by submerged tunnels that only the Myrathil can navigate. Sail the forty-mile chain and you\'ll see only ice; the cities are beneath it, and the Deep decide whether you ever see them, because the tunnels answer to them and the ice doesn\'t answer to anyone.',
 ...
 fullEntry: 'Spindrift Lagoon is the most beautiful settlement in the Iceheart Sea, a warm-water anomaly where coral survived the Deepening, sheltered by volcanic thermal dynamics. The Shore Myrathil have tended the reef for centuries, cultivating bioluminescent organisms that illuminate the entire lagoon in shades of blue-green. Merryn traders dock at the surface platforms while Myrathil artisans work in underwater markets grown from living coral. The lagoon is visible for miles across the frozen sea, a beacon of warmth and light in the endless dark. Dock at Spindrift and you\'ll see the only color the Iceheart has left; the Myrathil grew it on purpose, because someone had to remember what light looked like.',
 relatedTerms: ['house_mereval', 'iceheart-sea', 'myrathil']
  },
 ...
 type: 'location',
 region: 'sundrift-vale',
  summary: 'A deep valley carpeted with crystalline shards of trapped starlight, the site where the Astril refugees\' Lumia-borne fragments first struck the earth.',
  fullEntry: 'Starfall Vale is the most sacred site in the Sundrift Vale, a crater where the physical residue of the Astril arrival, fragments of Lumia\'s biosphere that survived the crossing, impacted the earth. Thousands of crystalline shards carpet the valley floor, glowing with trapped starlight and producing harmonic tones that the Vashir Astril call the Memory of Lumia. The vale is a place of pilgrimage for every Astril and a source of prophecy through the Star-Oracle who tends the First Shard. Walk the Starfall floor and you\'ll hear Lumia\'s echo sing from the shards; the Vashir say the starlight remembers what it was before their world died, and the Star-Oracle is the only one who can translate it.',
 ...
 type: 'location',
 region: 'sundrift-vale',
  summary: 'A small, lightless hill where the Unlit Veil hold secret judgments, a place where fire refuses to burn and no Lumian glow can persist.',
  fullEntry: 'The Unlit Knoll is the Unlit Veil\'s most closely guarded site, a small, rounded hill where fire refuses to burn and no light persists. The Veil has shaped this quality into a tool: their secret judgments, dead-drops, and intelligence operations all center on a place that Astril whose Lumian markings still burn cannot approach without their glow guttering out. It is a hole in the light of the world, and the Unlit Veil has made it their headquarters. Stand on the Unlit Knoll and no starlight will touch you; for the Veil, that is the point, and for every Astril who carries Lumia\'s echo openly, that is the warning.',
 ...
 type: 'location',
 region: 'sundrift-vale',
  summary: 'Open heathland lit by Astril beacon-fires of crystalline Lien-wood, a gathering ground for solstice observances across all Astril communities.',
  fullEntry: 'Nova Heath is the Sundrift Vale\'s brightest landmark, open heathland where the Silath Astril maintain great pyres of crystalline Lien-wood that burn with pale, cold light visible for miles across the starless steppe. The beacons serve as gathering points for Astril of every community during solstice observances, and the Silath use coded fire-patterns to transmit messages across the vast distances of the Vale. It is the closest thing the Astril have to a shared home, a place where Vashir and Silath alike gather under light that none of them can take for granted.',
 ...
 region: 'atropolis',
 summary: 'The Arcanoneer signatory who arbitrates contract-magic from Atropolis Heart-Vault, now facing clauses Morvane itself rejects.',
 fullEntry: 'Vel-Otharen arbitrates contract-magic from the Heart-Vault of Atropolis, Senior Signatory of the Canopy-Ledger and heir to Valerius, who drafted the First Contract with Morvane. He now faces a crisis the Arcanoneers have no precedent for: Morvane is rejecting clauses it once accepted, and the Velun Contingency Protocol, the legal mechanism designed for exactly such scenarios, cannot resolve entities Morvane refuses to acknowledge. Draft a clause in Atropolis and you may find Morvane reading it differently than every prior precedent, and Vel-Otharen is the one who has to tell you whether your contract still holds.',
 ...
 region: 'iceheart-sea',
 summary: 'Keeper of the Silent Frequency at Merrowport, as the sea itself goes silent and the Deep flee something in the abyss.',
 fullEntry: 'Mer-Lyrisa leads the Tide-Choir at Merrowport, holding the cadence-tradition founded by Lyris the Tide-Singer, who calmed the sea-gales at the cost of her spoken voice. The Iceheart Sea has fallen silent. The tides still move, but the deep-current songs that guided Merryn sailors for centuries have ceased entirely, and the Deep Myrathil, the abyssal pressure-forgers, have begun fleeing the ocean trench. When asked what they heard, they will only say it sang back. Sail the Iceheart with Mer-Lyrisa\'s choir and you\'ll hear the silence for yourself; the sea that always sang is holding its breath, and whatever it\'s listening for is listening back.',
 relatedTerms: ['merrowport', 'iceheart-sea', 'merryn', 'house_mereval'],
 worldFriction: 'The sea is silent. The Deep fled. Something in the abyss sang back.'
  },
 ...
 type: 'character',
 role: 'Speaker of the Trueborn Briaran',
 region: 'frostwood-reach',
 summary: 'The elected voice of the Trueborn Briaran, whose forearms bristle with living barbs. They reject the Fog Compact as surrender, and every word they speak is a thorn.',
 fullEntry: 'The Trueborn Briaran live in the Frostwood\'s deepest groves, their forearms bristling with living barbs that are the physical mark of an ancient fae-contract, and the Thorn-Speaker is the voice they elected to speak for them. The Trueborn reject the Fog Compact entirely. Where House Thalreth traded the Reach\'s clarity for protective mist, the Briaran believe the fog itself is the enemy, slowly erasing everything that made the forest sacred. The Thorn-Speaker\'s voice carries the weight of the groves, and every word is a thorn. Walk the deep groves with thorns on your arms and the Trueborn will hear you. Walk them without, and the fog will reach you before they do.',
 ...
 fullEntry: 'The Steward of the Seventh Seat has governed House Morrath from Atropolis for over three centuries, a Velun Neth appointed as a placeholder when the last Morrath descendant failed to present themselves. The position was meant to be temporary. No Morrath has appeared in living memory. The Steward administers the Morrath contract-debt, the family\'s hereditary obligation to Morvane, as though the seat\'s true owners might walk through the door tomorrow. Every year that passes without them makes the fiction harder to maintain, but Morvane has not acknowledged any breach, and a Velun Neth cannot voluntarily abandon a contract they signed. Sign a contract in Atropolis and you may wait a long time for the seat\'s real owner to relieve you of it; the Steward has been waiting three centuries, and the door still hasn\'t opened.',
 ...
 region: 'atropolis',
 summary: 'The Neth who drafted the First Contract with Morvane, binding spoken word to legal consequence.',
 fullEntry: 'Valerius drafted the First Contract with Morvane in the early generations of the Dimming, and every Arcanoneer spell cast since descends from that negotiation. He didn\'t invent the Neth\'s inability to lie. He weaponized it. A Velun Neth who structures an incantation like a filing cannot default on the syntax, and Morvane enforces every clause in blood. The pale skin and stilled breath that mark the Velun are not side-effects of the craft; they are its prerequisite. A non-Neth attempting Arcanoneer work is a litigant who has already defaulted.',
...
'the_partial_seal': {
  ...
  fullEntry: 'The Wyrd is not magic. It is the raw, entropic substance of unmaking, the blood of Keth-Amar that bled through the fractures in Sol\'s binding seal when the Breach shattered the vault. Where magic builds, the Wyrd unbuilds. Where magic names, the Wyrd unnames.\n\nThe Wyrd grows in four tiers, each more dangerous than the last. At the first and most passive level, Wyrd-Taint, the corruption seeps into the land itself: blackened flora, wrong-colored water, crops that taste of ash. A region exposed long enough develops Wyrd-taint in the soil before any creature manifests. At the second tier, Wyrd-Wisp, enough shared fear within a tainted region condenses the Wyrd into visible phenomena — moving shadows, whispers in wind, shapes at the edge of vision. Not yet animated, but felt. At the third tier, Wyrd-Spawn, a fear with sufficient psychic weight is given a body. These are the monsters born from what the local people dread most: the Gref, the Gambrel, the Stel. At the fourth and highest tier, Wyrd-Channel, a Wyrd-Spawn that has grown powerful enough becomes a conduit for Keth-Amar\'s direct attention — boss-tier entities through which the Sun-Eater can perceive, whisper, and direct. Most Wyrd-Spawns never reach this level. Those that do are the Wyrd-priests, Monolith guardians, and cult leaders who have fully surrendered.\n\nThe Wyrd answers to mortal consciousness, and what it answers to first is fear. Keth-Amar does not personally create most Wyrd-Spawns. It seeds the soil (Wyrd-Taint) and waits for fear to do the rest. The Wyrd is Keth-Amar\'s agriculture.\n\nWyrd concentration was first confined to the Emberspire caldera. Through the Contraction phase of the early and middle Diming centuries, the seal-cracks widened under geothermal pressure and Wyrd-miasma spread across the continent. In the Squeeze that followed, the mid-to-late Diming, Wyrd-density reached epidemic levels. Entire settlements were abandoned to Wyrd-manifestations. The Inquisitor order was founded specifically to hunt and sever Wyrd-creatures, and the cold-iron blade became the only reliable answer.\n\nThe Wyrd is not diminishing. It is accelerating.\n\nStand in the wrong grove at the wrong hour and the Wyrd will learn what you fear. The Inquisitors can teach you to cut it. They cannot teach you to unlearn it. The next shape it wears may already be yours.',
...
'sundered_monoliths': {
 ...
 type: 'entity',
 region: 'frostwood-reach',
 summary: 'A dormant star — an ancient, sleeping deity whose shattered fragments became the lunar parasites.',
 fullEntry: 'The dead moon is not a moon, and it was never a moon. It is a dormant star — an ancient, sleeping deity, unconscious for eons. Its awareness withdrew so deep that only the shell remained. What sent it into this slumber is unknown; it was not Keth-Amar, who arrived far later, drawn to Sol\'s Deepening, and found a corpse-star already waiting.\n\nWhen it shattered — whether by age, internal pressure, or the same cosmic hunger that stalks Sol — its fragments fell across the Frostwood Reach. The fae of the moonlit groves gathered the largest pieces and nurtured them. From those fragments emerged the lunar parasites: void-adapted organisms that feed on memory, sensation, and vitality. They are the only living traces of the sleeping star\'s inner ecology.\n\nSome Lunarch theologians call the moon an "egg," a metaphor for the discovery that the parasites are not singular entities but siblings — children of the same dormant star, now communicating across hosts. The old belief that it was a dead celestial body was the prevailing scholarly consensus; the truth is stranger and older than any corpse.\n\nLook up on a clear night in the Frostwood Reach and you\'ll see where the dead moon used to hang, a dark socket in a sky that has no stars. The fragments are below. The parasites are awake. And the elder parasites, bonded to the first Lunarchs, are beginning to synchronize toward something no living scholar understands.',
 relatedTerms: ['watcher_in_the_mist', 'lunarch', 'briaran', 'frostwood-reach', 'keth_amar']
  },
