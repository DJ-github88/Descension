...
export const LORE_DICTIONARY = {
  ...
  'silent_seventh': {
    ...
    fullEntry: 'Among the seven noble houses that officially struck the Binding Compact, one stands silent — its entry in every ledger and contract-hall reduced to a blank line where a name should be. The six surviving houses (Thalreth, Skalvyr, Tesshan, Solvan, Mereval, Ordavan) plus Morrath are publicly recorded, but Morrath\'s records are conspicuously sparse. The reason is now known: House Viridane was the original seventh binding house. When something reached Viridane before Keth-Amar could claim them, they fled south — and the remaining six houses, unable to complete the ritual with a gap, elevated a minor family called House Morrath as a substitute signatory. But the erasure that followed was not merely political. Keth-Amar hunts through knowledge; to carry the memory of Viridane was to hold a thread the Sun-Eater could follow. The fog that swallowed their name was a protection as much as a punishment. Morrath\'s records are sparse because they were written to replace a history that predated them — and because the details of what happened to the seventh house are safest when they are not known at all. Six houses suspect this truth. None will confirm it. Scribe-Sentinels who research the matter have a habit of disappearing into the fog.',
