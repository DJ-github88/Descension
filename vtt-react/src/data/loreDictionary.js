...
export const LORE_DICTIONARY = {
 ...
 fullEntry: 'Aex was Sol\'s firstborn: not a spirit, not an ancestor, but a living entity of pure stellar radiance that had protected the sun through every Deepening since the first star learned to burn. When the binding houses chose to entomb Sol beneath Sundale, the Warden named its price, and the price was Aex, willing. House Solvan wielded the knife. They flayed Aex\'s living hide and wove the binding seal from it.\n\nWhether Aex offered itself freely or was compelled by loyalty to the star it protected is the oldest dispute in Sundale, and it isn\'t settled. The Dawn Vigil holds that the sacrifice was willing. The Augurs at the Frozen Archive read the seal\'s resonance and find evidence of coercion. The knife, a blade of crystallized starlight, shattered in the act, and its fragments were divided among the binding houses as relics and as reminders of what the Warden charges for a star.',
