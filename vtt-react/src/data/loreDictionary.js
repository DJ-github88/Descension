...
export const LORE_DICTIONARY = {
 ...
 type: 'historical_figure',
 region: 'sundale',
 summary: 'A parasitic Wyrd-entity-intelligence from the deepest volcanic furnace of Emberspire, who binds with Pyrofiends as a patron.',
 fullEntry: 'Something nests in the molten vents beneath Emberspire, and the Emberth have a name for it: Scathrach, the Ashen Sovereign. It is older than the Binding and patient as cooling stone. Scathrach feeds on despair and answers petitions the only way it knows how, with combustion that does not stop until the supplicant has burned to white-hot bone. The Pyrofiends call it patron. They swallow its coals in the obsidian cavern and trade their flesh for fire, watching their own hands crack into char-vessels of magma year by year. The Ashen Sovereign always collects. Every Pyrofiend ends in the furnace, and the next bargain is already being struck.',
 ...
 fullEntry: 'Every star is supposed to die and be reborn. That is the Deepening: the rhythm by which a star sheds its exhausted light and rekindles its fire from within. Sol entered that vulnerable state and drew the eye of Keth-Amar, the cosmic predator that hunts dying light. To keep the star from being consumed, the binding houses entombed it beneath Sundale, and in doing so they broke the cycle of the heavens.\n\nEach Deepening opens a twelve-year window in which the dying star must reignite or go dark forever. Sol has entered that window sixty-five times since the Binding and hasn\'t caught once. Keth-Amar consumes each rebirth before the fire can take. The Augurs at the Frozen Archive have measured the decline across all sixty-five cycles, from a forty-percent chance of rekindling in the first window to none at all in the most recent. The months of First Thaw and False Dawn are all that remains of the old hope, preserved in ritual long after the hope behind it withered.',
 ...
 fullEntry: 'Every civilization that named Keth-Amar in writing was destroyed before the word could spread. That\'s why it has no name in any living language older than eight centuries. It hunts stars in their Deepening, the vulnerable death-rebirth window, and consumes them before they can rekindle. When Sol entered its Deepening, Keth-Amar followed, and the binding houses chose to entomb the star beneath the world rather than surrender it.\n\nFor eight years after the Binding, Keth-Amar whispered to the houses from the dark beyond the vault. Dreams, bargains, the slow poison of dread. Six of the houses broke. They marched their firstborn to the peaks, and Keth-Amar took them as tribute, and in consuming them cracked the seal and triggered the Breach. Since then it has eaten every one of Sol\'s sixty-five rebirth attempts, extinguishing each twelve-year window before the star could catch.\n\nWithin living memory, the thing called the Voice, which scholars believe to be an emissary of Keth-Amar, has spoken through the Cult of Forgotten Shadow, a heresy that worships the star-eater as a necessary purge. Whether Keth-Amar is satisfied or merely delayed is the question every court mage in Mythrill has been arguing since Emberspire erupted.',
...
'aex': {
 ...
 type: 'entity',
 region: 'sundale',
 summary: 'Sol\'s firstborn, a living entity of pure stellar radiance whose living hide was flayed to weave the binding seal that entombs the dying star.',
 fullEntry: 'Aex was Sol\'s firstborn: not a spirit, not an ancestor, but a living entity of pure stellar radiance that had protected the sun through every Deepening since the first star learned to burn. It was the sun\'s child in the oldest sense, a being woven from the same fusion-fire that lit the system, sentient light given form and will.\n\nWhen the Deepening began and Keth-Amar arrived to feed, the binding houses faced an impossible choice. To entomb Sol was to cage a star, and no cage could hold a star unless it was made from the star\'s own substance. The Warden, that ancient mechanism of cosmic consequence, named its price: Aex. The firstborn, flayed alive, its living tissue woven into a seal that could pass through Sol\'s outer radiance and grip the star at its core. There was no other way.\n\nHouse Solvan wielded the knife. The blade was a shard of crystallized starlight, the only edge that could cut a being of pure radiance. They flayed Aex\'s living hide in a single unbroken sheet, and the firstborn did not scream. It sang. The song was Sol\'s own frequency, a harmonic that matched the star\'s death-throes, and the houses wove that singing hide into the seal while Aex bled stellar plasma onto the ritual ground. The knife shattered the moment the seal was complete, its fragments scattered among the seven houses as relics and as warnings of what the Warden charges for a star.\n\nWhether Aex offered itself freely or was compelled by the loyalty that had bound it to Sol across infinite Deepenings is the oldest unresolved dispute in Sundale. The Dawn Vigil insists the sacrifice was willing: Aex knew the seal would fail without its consent, that a coerced binding could not hold the metaphysical weight of a god. The Augurs at the Frozen Archive read the seal\'s residual resonance and find evidence of struggle, a harmonic signature in the weave that suggests the hide fought the needle. The fragments of the knife, still held by the houses, are said to tremble when brought within a mile of each other, and the Augurs interpret the trembling differently depending on which house pays for the reading.\n\nAex is not dead. Aex is woven. Every thread of the binding seal that entombs Sol is Aex\'s flayed hide, stretched across the vault. When the seal was shattered into the seven Sundered Monoliths, Aex\'s tissue became the Monoliths\' living surface, and the Monoliths hum with what some Augurs swear is the firstborn\'s continued awareness. The frozen at the Frozen Archive have logged instances of the Monoliths weeping stellar plasma in synchrony with Sol\'s failed rebirth windows, and they have never been able to explain why the weeping accelerates as the window approaches.\n\nStand at the Emberspire caldera and feel the heat rising through the basalt. That warmth passes through Aex. The firstborn is between you and the star it was meant to protect, stretched across a wound, still singing.',
 ...
 fullEntry: 'Thrak-Damos commands the Aegis, the Spellguard order at Emberspire\'s forge-keeps, enforcing the method Damon the Emberth forged when he blocked a solar flare with an alchemical tower shield. His heirs refined that interception into a discipline of identifying, containing, and deflecting hostile magic. The world\'s background magic is rising, and every Spellguard\'s Void Resonance, the measure of absorbed and unpurged energy, fills faster than it can be discharged. Thrak-Damos oversees a generation of defenders who are drowning in the magic they absorb. Raise a shield with the Aegis and you\'ll feel the Resonance climbing; Thrak-Damos is the one who decides when a defender has held too much, and the decision is usually too late.',
 ...
 region: 'sundrift-vale',
 summary: 'The Ordan visionary who looked into the void where Sol once shone and saw a presence that was never there. Centuries later, it began speaking back.',
 fullEntry: 'Li Wei looked into the void where Sol used to shine and saw something that was never there. The Ordan nomad preached a faith built on the absence itself, a presence in the empty socket where the star had been, and the faith took root across the Sundrift Vale because people wanted to believe the dark wasn\'t empty. Li Wei died. Centuries later, the thing he had imagined started talking back. The Voice speaks directly now, with instructions, and something has moved into the space Li Wei first pointed at, using his followers to arrange its arrival.',
 ...
 type: 'event',
 region: 'sundale',
 summary: 'The eight years between the Entombment and the Breach, when Keth-Amar wove whispers through the fears of every region, weaponizing rumor, hunger, and desperation to turn the houses against themselves.',
 fullEntry: 'The Binding held. The Sun-Eater could not reach Sol. But Keth-Amar had not come to this system to be denied. It had come to feed, and it had eight years to learn how to make the houses feed it themselves.\n\nKeth-Amar did not rage against the seal. It did not batter the vault with cosmic force. It whispered. Not into the grand halls of the noble houses, but into the kitchens, the nurseries, the night-watches. Into the dreams of fathers who had signed the Binding. Into the ears of mothers watching their children freeze. The Sun-Eater learned what each region feared most and distilled that fear into a voice that sounded like reason.\n\n**Frostwood Reach (House Thalreth) — The Fog\'s First Hunger**\n\nThe fog was already rising, a side-effect of the Deepening\'s thermal collapse, but it was thin and patchy. Keth-Amar breathed into the Reach\'s dreams: the preservation of what remained depended on forgetting what was lost. It whispered to Thalreth archivists that the fog was a shield, that the clarity they had traded away was a weakness, that those who remembered too much would find their memories stolen by the cold anyway. The first Scribe-Sentinels were founded in the aftermath of these whispers, but the fog had already begun to accelerate. House Thalreth, believing they were choosing protection, traded spatial clarity for the insulating mist. The fog would not merely insulate. It would erase.\n\n**Nordhalla — The Glacier\'s Advance and the Starvation.**\n\nIn Nordhalla, the glaciers had not halted. They advanced, grinding mountain keeps into gravel, forcing the Skald clans higher and higher into passes that could not support them. Keth-Amar\'s whispers came as practicality. "The ice will not stop. You cannot outrun it. But you can bargain with it." It showed House Skalvyr\'s sleepers the same dream: a world frozen in place, the glaciers stilled, the fjords preserved, eternal winter. Skalvyr\'s bargain froze the glaciers permanently. Summer never returned to the north. The Frost-Tithe was born. And when the Hunger Winter followed, three years of absolute starvation in which Skald ancestors consumed their own dead, Keth-Amar\'s whisper sounded satisfied.\n\n**Sundale — The Weight of the Knife.**\n\nHouse Solvan had wielded the knife that flayed Aex. They had been the hand of the Binding, and Keth-Amar reminded them every night. "You killed Sol\'s child. You held the blade. The houses trusted you with the cut, and the cut is all they will remember. When the seal fails, and it will fail, whose name will the world curse?" Solvan\'s nightmare was not starvation or freezing. It was legacy. They had bound the star, and the star was dying, and the name "Solvan" would be the last word on the world\'s lips when the warmth ran out. The whisper did not drive them to bargain. It drove them to silence: to watch the other houses break first, and to be ready to claim they had known the cost all along.\n\n**Iceheart Sea — The Storms That Would Not Calm.**\n\nHouse Mereval ruled the sea, and the sea was dying. Not freezing, but churning into chaos, currents collapsing, storms rising from still water. Keth-Amar whispered to the harbormasters and the admirals that the storm-wall was permanent, that the only way to sail at all was to trade calm seas for a guarantee: certain channels that never freeze, certain currents that always flow, in exchange for perpetual storm-everywhere-else. The whisper was a navigational chart that showed only one route. Mereval took it. The iceheart has never slept since.\n\n**Cragjaw Peaks — The Hunger Below.**\n\nHouse Tesshan\'s mountain keeps sat above the deep alchemist sumps, where the Fexric vats had been breeding and boiling for millennia. Keth-Amar whispered that the lowlanders would find them, that the starving masses pressing north from Sundale would discover the Cragjaw\'s geothermal infrastructure and strip it clean. "Hide. Hide behind a veil of snow that no starving army can penetrate. Let the blizzard be your wall." Tesshan traded visibility for the eternal blizzard-veil. Their keeps survived. Their landmarks vanished. They have not seen the sky in thirty generations, and they no longer know whether anyone outside the veil is still alive to find them.\n\n**Sundrift Vale — The Stars Go Dark.**\n\nHouse Ordavan watched the constellation-spirits flee the slaughter as Sol\'s celestial court scattered across the sky. Without the stars, the Vale\'s migration routes would fail. The herds would wander. The people would freeze. Keth-Amar whispered that the soil itself could be traded, that the fertility of the Vale\'s grasslands was the only currency the Warden would accept in exchange for keeping the migration alive. Ordavan traded the soil. The grass always returns. The migration never ends. But the sky went dark, and the constellation-spirits that fled now live in Astril blood instead of the heavens.\n\n**Bryngloom Forest — The Only House That Did Not Breach.**\n\nThe Bryngloom was not governed by a noble house at the time of the Binding. Its people were scattered clans and the remnant scribe-clan of the Neth. Keth-Amar did not whisper to a ruling family in the Bryngloom. It whispered to everyone, in every voice, in every dialect, and found no single authority to break. The Neth, a dying scribe-clan with no noble bloodline to corrupt, simply walked into the deepest bog and made their own bargain with the Keeper of the Last Threshold before Keth-Amar could finish its work. They rose from that bog with silver skin, stilled breath, and a First Contract that no whisper could touch. The Bryngloom was the one region Keth-Amar could not turn.\n\n**The Eighth Year.**\n\nBy Year 11, six houses had heard the same offer so many times it no longer sounded like a choice. The whispers had not compelled them. They had corroded them. The houses believed they were making pragmatic decisions, survival choices, bargains in their own interest. Every bargain served Keth-Amar. Every deal widened a crack in the seal. By the time the heirs marched north, the vault was already breaking. House Viridane alone heard a different voice in the mist, older than Keth-Amar\'s hunger and more patient, and they turned south while the other six turned north. The Wyrd, the entropic blood of Keth-Amar that now bleeds through the Breach, learned its shapes during these eight years. Every Gref, every Gambrel, every frozen Stel, every horror that now walks the world is a memory of the fear Keth-Amar learned to speak during the Corruption Years.',
 ...
 type: 'concept',
 region: 'sundale',
 summary: 'When House Viridane refused Keth-Amar and was erased from the records, their replacement by House Morrath created a seal that was ever so slightly incomplete, which is why Keth-Amar could breach but not consume Sol whole.',
 fullEntry: 'Seven signatures sealed Sol\'s binding. Seven bloodlines wove the shroud from Aex\'s flayed hide. Seven houses held the seal in place. When Keth-Amar\'s corruption broke six of those houses and they marched their firstborn to the northern peaks, the seal was meant to fall entirely. The Sun-Eater was meant to enter the vault, consume Sol whole, and move on to the next star.\n\nIt did not happen that way. House Viridane refused.\n\nWhen the other six houses capitulated and marched their children north, Viridane turned south instead. Something had reached them before Keth-Amar\'s whispers could take hold: a presence in the mist, watching from the moonlit groves, older than the Sun-Eater\'s hunger and more patient. They struck a counter-bargain with the fae entities of the Frostwood and fled into the fog. The seal should have fallen completely. Six signatures on a Blood-sealed binding that required seven was failure. The Sun-Eater should have gorged itself full and moved on.\n\nBut the six houses could not admit failure. They could not tell the world that the Binding had been broken. So they did not tell the world. They erased House Viridane from every record, struck their name from every ledger, and elevated a minor Bryngloom family, House Morrath, as a substitute signatory. Morrath\'s blood could not replace Viridane\'s. The seal remained broken. But the six houses pretended otherwise, and the power of that pretense, backed by eight centuries of institutional denial, held the seal in a state of permanent fracture.\n\nThe result was the Partial Seal: a binding that was neither whole nor wholly broken. Keth-Amar could enter the vault, but not fully. It could feed on Sol\'s embers, but not consume the star entirely. It could drink the energy of each failed rebirth window, but it could not crack the shell and swallow the yolk. The Breach was a wound, not a demolition. The Monoliths were splinters, not dust.\n\nFor eight centuries, this has been the world\'s cruelest paradox. The houses that broke the seal spent every generation pretending it was still whole. The house that saved the seal spent every generation erased from the record. The fog rose not merely due to the Thermal Compact, but because the world needed to forget what it had done and what it had lost, and forgetting was the only way to keep Keth-Amar from following the thread of memory back to the truth.\n\n**Why Keth-Amar Cannot Find Viridane.**\n\nKeth-Amar hunts through knowledge. It finds its prey by following the threads of memory, record, and thought that connect a being to its existence. When the six houses erased Viridane from every ledger, burned every portrait, and sealed every archive mentioning the name, they did not merely punish Viridane. They erased the thread that Keth-Amar would have used to find the eighth house. The fog that rose around the Frostwood Reach completed the protection: physical memory decay for those who had known Viridane, acute amnesia for those who sought to learn.\n\nKeth-Amar knows, in the abstract sense, that something is missing. The seal refused to break. The vault will not open to its full appetite. But it cannot see the gap. It cannot name the house that ran. To know Viridane is to leave a trail, and the trail was cut before the Breach finished bleeding.\n\nThe Briaran carry Viridane\'s cont in their thorns, their fae-pact blood hidden from Keth-Amar\'s awareness by the same fog that hides the Reach. The Watcher in the Mist that made the counter-bargain is older than Keth-Amar\'s hunger and exists in a register the Sun-Eater cannot perceive. The partial seal holds. Sol is being eaten slowly, not gulped. And an entire house lives somewhere the eyes of a star-devourer cannot reach.\n\nWalk the moonlit groves and the thorns on your arms are proof that someone said no. Keth-Amar cannot see you. The seal cannot be mended. But it was never meant to hold forever. The Monoliths are waking, and when they resume their original positions, the Partial Seal will either snap shut or fall open. Viridane may have kept Keth-Amar from eating Sol whole, but they could not keep the world from cooling.',
 ...
 type: 'concept',
 region: 'sundale',
 summary: 'Seven fragments of Sol\'s binding seal, scattered across the continent when Keth-Amar cracked the vault. After eight centuries of silence, all seven are waking at once.',
 fullEntry: 'When Keth-Amar consumed the firstborn heirs and shattered Sol\'s vault at the Breach, the binding seal, woven from the flayed lifeblood of Aex, fractured into seven fragments. These Sundered Monoliths were hurled across the continent and buried themselves in the geography of every region. For nearly eight centuries they lay dormant: inert stone monuments whose only significance was their origin.\n\nThen, within living memory, all seven began to wake simultaneously.\n\nThe Treakous Rift Monolith, sunk beneath the Iceheart Sea, now broadcasts a low-frequency command signal that certain Wyrd-creatures obey without deviation. The Cragjaw Subterranean Vault Monolith, buried in the deep sumps beneath Frostmaw, has begun warming: its ambient temperature rises by measurable degrees each year, and the Groven who mine nearby are afraid. The Shard-Window Monolith, lodged in the storm-wall above the Sundrift Vale, has intensified its surrounding vortex to hurricane force. Approach is no longer possible.\n\nThe Dawn Vigil publicly claims that reassembling the Monoliths will restart Sol. Their inner council has calculated it will summon Keth-Amar instead. They continue the expeditions not for restoration, but to ensure no one else assembles them first.\n\nThe seven stones are waking. Someone will reach them first. The question is whether that someone carries Sol\'s restoration or Keth-Amar\'s summons, and the Monoliths themselves are not saying which.',
