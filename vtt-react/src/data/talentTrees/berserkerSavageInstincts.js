// ============================================
// berserkerSavageInstincts (v4: Canonical 50-Point Economy & Balanced)
// ============================================
...
export const BERSERKER_SAVAGE_INSTINCTS = [
  {
    ...
    "rankUpgrades": [
      {
        "description": "Allies also gain +1 to hit the Quarry, and bonus damage increases to +1d6 slicing.",
        "primaryDamage": {
          "dice": "1d6",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 2d6 slicing damage and completely roots the target for 1 round.",
        "primaryDamage": {
          "dice": "2d6",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 2d8 slicing damage, roots the target, and exposes their flank (+2 to hit for all allies).",
        "primaryDamage": {
          "dice": "2d8",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 2d8 slicing damage; deals +1d8 bonus damage if attacking from stealth or flank.",
        "primaryDamage": {
          "dice": "2d8",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 3d6 slicing damage, Pins the target for 1 round, and allows an adjacent ally to make an immediate free attack.",
        "primaryDamage": {
          "dice": "3d6",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "requires": [
      "svi_t3_ambush_strike",
      "svi_t3_pack_coordination"
    ],
    "spell": {
      "name": "Spirit Wolf Pack",
    ...
    "rankUpgrades": [
      {
        "description": "Spirit Wolf Pack gains +1d6 bonus damage and refunds 1 AP on critical hits."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 3d10 damage and ally attacks deal +1d6 bonus damage.",
        "primaryDamage": {
          "dice": "3d10",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 4d8 damage, ally attacks deal +1d8 bonus damage, and stuns target for 1 round if all attacks hit.",
        "primaryDamage": {
          "dice": "4d8",
          "flat": 0,
          "procChance": 100
  ...
  {
    "id": "svi_t4_mastery_focus",
    "name": "Spirit Wolf Pack Resonance",
    "icon": "ability_hunter_beastwithin",
    "maxRanks": 3,
    "position": {
      "x": 3,
    ...
    "requires": "svi_t3_pack_coordination",
    "spell": {
      "name": "Spirit Wolf Pack Resonance",
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Relentless Tracker rank 2: resource generation +1 and +5ft speed."
      },
      {
        "description": "Relentless Tracker rank 3: resource generation +2 and +1 to hit."
      }
    ]
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Alpha's Call rank 2: +2 Damage Reduction and +10 max HP."
      },
      {
        "description": "Alpha's Call rank 3: +2 Damage Reduction, +15 max HP, and immunity to prone."
      }
    ]
  },
  {
    "id": "svi_t7_capstone_gamma",
