// ============================================
// berserkerPrimalRage (v4: Canonical 50-Point Economy & Balanced)
// ============================================
...
export const BERSERKER_PRIMAL_RAGE = [
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 2d6 smashing damage and slows target movement by 10 feet for 1 round.",
        "primaryDamage": {
          "dice": "2d6",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 2d8 smashing damage and knocks target Prone on a failed Strength save.",
        "primaryDamage": {
          "dice": "2d8",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 2d10 slicing damage and sunders 2 Armor.",
        "primaryDamage": {
          "dice": "2d10",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 3d8 slicing damage, sunders 2 Armor, and grants you +1 DR for 1 round per enemy hit.",
        "primaryDamage": {
          "dice": "3d8",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "requires": [
      "prg_t3_carnage_cleave",
      "prg_t3_unyielding_fury"
    ],
    "spell": {
      "name": "Cataclysmic Blow",
    ...
    "rankUpgrades": [
      {
        "description": "Cataclysmic Blow gains +1d6 bonus damage and refunds 1 AP on critical hits."
      }
    ]
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 2d8 sonic damage and forces spellcasters to lose concentration.",
        "primaryDamage": {
          "dice": "2d8",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 3d6 sonic damage, Stuns enemies for 1 round on a failed Fortitude save.",
        "primaryDamage": {
          "dice": "3d6",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 4d10 smashing damage and stuns the target for 1 round if slammed into a wall.",
        "primaryDamage": {
          "dice": "4d10",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 5d8 smashing damage and creates a 15-foot shockwave dealing 2d6 damage to all nearby foes.",
        "primaryDamage": {
          "dice": "5d8",
          "flat": 0,
          "procChance": 100
  ...
  {
    "id": "prg_t4_mastery_focus",
    "name": "Cataclysmic Blow Resonance",
    "icon": "ability_warrior_groundslam",
    "maxRanks": 3,
    "position": {
      "x": 3,
    ...
    "requires": "prg_t3_unyielding_fury",
    "spell": {
      "name": "Cataclysmic Blow Resonance",
  ...
  },
  {
    ...
    "requires": "prg_t5_unbreakable_stance",
    "spell": {
      "name": "Unyielding Resolve",
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Titan Heart rank 2: resource generation +1 and +5ft speed."
      },
      {
        "description": "Titan Heart rank 3: resource generation +2 and +1 to hit."
      }
    ]
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Earthshaker Impact rank 2: +2 Damage Reduction and +10 max HP."
      },
      {
        "description": "Earthshaker Impact rank 3: +2 Damage Reduction, +15 max HP, and immunity to prone."
      }
    ]
  },
  {
    "id": "prg_t7_capstone_gamma",
