// ============================================
// martyrRedemption (v4: Canonical 50-Point Economy & Balanced)
// ============================================
...
export const MARTYR_REDEMPTION = [
  {
    ...
    "rankUpgrades": [
      {
        "description": "Restores 2d6 Hit Points.",
        "healing": {
          "dice": "2d6",
          "flat": 0
        }
      ...
      {
        "description": "Restores 2d8 Hit Points, and overhealing becomes temporary Hit Points (up to 4 temp HP).",
        "healing": {
          "dice": "2d8",
          "flat": 0
        }
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Restores 2d6+2 Hit Points.",
        "healing": {
          "dice": "2d6",
          "flat": 2
        }
      ...
      {
        "description": "Restores 2d8+3 Hit Points and removes 1 bleed effect.",
        "healing": {
          "dice": "2d8",
          "flat": 3
        }
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Heals all allies in the radius for 2d6 Hit Points.",
        "healing": {
          "dice": "2d6",
          "flat": 0
        }
      ...
      {
        "description": "Heals all allies for 2d8 Hit Points and grants them +1 Armor for 1 round.",
        "healing": {
          "dice": "2d8",
          "flat": 0
        }
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Sacrifice 4 HP: Restores 3d6 Hit Points to the ally.",
        "healing": {
          "dice": "3d6",
          "flat": 0
        }
      ...
      {
        "description": "Sacrifice 4 HP: Restores 3d8 Hit Points and grants the ally +2 Damage Reduction for 1 round.",
        "healing": {
          "dice": "3d8",
          "flat": 0
        }
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Sol's Intervention gains +1d6 bonus damage and refunds 1 AP on critical hits."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "requires": [
      "rdm_t5_aura_of_grace",
      "rdm_t5_channel_radiance"
    ],
    "spell": {
      "name": "Resplendent Dawn",
    ...
    "rankUpgrades": [
      {
        "description": "Heals allies for 3d10 Hit Points and deals 2d10 sacred damage to enemies.",
        "healing": {
          "dice": "3d10",
          "flat": 0
        },
      ...
      {
        "description": "Heals allies for 4d8 Hit Points, deals 3d8 sacred damage, and grants all allies +2 Armor for 2 rounds.",
        "healing": {
          "dice": "4d8",
          "flat": 0
        },
  ...
  },
  {
    ...
    "requires": "rdm_t3_martyrs_sacrifice",
    "spell": {
      "name": "Sol's Intervention Resonance",
  ...
  },
  {
    ...
    "requires": "rdm_t5_channel_radiance",
    "spell": {
      "name": "Unyielding Resolve",
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Saintly Ascension rank 2: resource generation +1 and +5ft speed."
      },
      {
        "description": "Saintly Ascension rank 3: resource generation +2 and +1 to hit."
      }
    ]
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Boundless Compassion rank 2: +2 Damage Reduction and +10 max HP."
      },
      {
        "description": "Boundless Compassion rank 3: +2 Damage Reduction, +15 max HP, and immunity to prone."
      }
    ]
  },
  {
