...
export const PYROFIEND_WILDFIRE = [
  ...
  },
  {
    ...
    name: 'Chain Reaction',
    description: 'Emberspire's volcanic heart beats in every inferno. when a burning enemy dies, roll 1d6. On 4+: ignite a nearby enemy.',
    icon: 'spell_fire_flare',
    maxRanks: 3,
    position: { x: 2, y: 1 },
    requires: 'wildfire_t0_spread',
  ...
  // Tier 3 - Right branch expansion (Asymmetric growth)
  {
    ...
    name: 'Burn Out',
    description: 'Emberspire's volcanic heart beats in every inferno. when fire DoT effects expire, roll 1d6. On 5+: explode dealing 2d6 fire damage to the target.',
    icon: 'spell_fire_burnout',
    maxRanks: 3,
    position: { x: 3, y: 3 },
...
export const PYROFIEND_HELLFIRE = [
  ...
  },
  {
    ...
    maxRanks: 3,
    position: { x: 2, y: 4 },
    requires: 'hellfire_t3_life_steal',
  },
  {
  ...
  },
  {
    ...
    maxRanks: 3,
    position: { x: 2, y: 5 },
    requires: ['hellfire_t4_abyssal_summoning', 'hellfire_t4_hellish_aura'],
    requiresAll: false,
  },
  {
    ...
    maxRanks: 3,
    position: { x: 4, y: 5 },
    requires: 'hellfire_t4_abyssal_summoning',
  },
  ...
  // Tier 6 - Hell's Embrace (Ultimate binding)
  {
    ...
    maxRanks: 1,
    position: { x: 2, y: 6 },
    requires: ['hellfire_t5_soul_harvest', 'hellfire_t5_demonic_dominion', 'hellfire_t5_eternal_torment'],
    requiresAll: true,
  }
];
