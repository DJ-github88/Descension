// ============================================
// pyrofiendInferno (v4: Canonical 50-Point Economy & Balanced)
// ============================================
...
export const PYROFIEND_INFERNO = [
  ...
  },
  {
    ...
    "rankUpgrades": [
      ...
      {
        "description": "Reduces Inferno Level by 2, deals 2d6 ember damage, and pushes the target 5 feet back.",
        "primaryDamage": {
          "dice": "2d6",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 2d6 ember damage and shreds 2 points of Armor.",
        "primaryDamage": {
          "dice": "2d6",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 2d8 ember damage, shreds 2 points of Armor, and inflicts Burning (1d4/rd for 2 rounds).",
        "primaryDamage": {
          "dice": "2d8",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Area expands to 15 feet and deals 1d8 ember damage.",
        "primaryDamage": {
          "dice": "1d8",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Area deals 2d6 ember damage and slows enemy movement by 10 feet.",
        "primaryDamage": {
          "dice": "2d6",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Combustion Spear gains +1d6 bonus damage and refunds 1 AP on critical hits."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Deals 3d10 ember damage and melts 3 points of Armor from all hit enemies.",
        "primaryDamage": {
          "dice": "3d10",
          "flat": 0,
          "procChance": 100
      ...
      {
        "description": "Deals 4d8 ember damage, melts 3 Armor, and knocks targets Prone.",
        "primaryDamage": {
          "dice": "4d8",
          "flat": 0,
          "procChance": 100
  ...
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Unquenchable Core rank 2: resource generation +1 and +5ft speed."
      },
      {
        "description": "Unquenchable Core rank 3: resource generation +2 and +1 to hit."
      }
    ]
  },
  {
    ...
    "rankUpgrades": [
      {
        "description": "Thermal Fission rank 2: +2 Damage Reduction and +10 max HP."
      },
      {
        "description": "Thermal Fission rank 3: +2 Damage Reduction, +15 max HP, and immunity to prone."
      }
    ]
  },
  {
