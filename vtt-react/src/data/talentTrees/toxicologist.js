...
export const TOXICOLOGIST_GADGETEER = [
 // Mechanical Core: The central gear mechanism
 {
  ...
  description: 'Your body houses complex machinery. Gain proficiency with all tools and advantage on checks to repair or modify mechanical devices. You can spend 1 action point to deploy a simple contraption.',
