...
export const MARTYR_REDEMPTION = [
  ...
  // Tier 1 - Inner healing circle
  {
    id: 'redmp_t1_sacred_barrier',
    name: 'Sacred Barrier',
    description: 'Create sacred barriers that block enemy movement. 10ft walls per rank, armor 18.',
    icon: 'spell_holy_devotionaura',
    maxRanks: 3,
    position: { x: 1, y: 1 },
    requires: 'redmp_t0_divine_shield',
  },
  {
    id: 'redmp_t1_protective_aura',
  ...
  // Tier 5 - Citadel center
  {
    ...
    maxRanks: 1,
    position: { x: 2, y: 5 },
    requires: ['redmp_t4_divine_bulwark', 'redmp_t4_eternal_guardian', 'redmp_t2_warding_circle'],
    requiresAll: true,
  }
];

export const MARTYR_ZEALOT = [
  // Tier 0 - Central flame of vengeance
  {
    id: 'zeal_t0_lay_on_hands',
    name: 'Lay on Hands',
  ...
  // Tier 4 - Divine flames
  {
    ...
    maxRanks: 1,
    position: { x: 0, y: 3 },
    requires: 'zeal_t3_greater_restoration',
  },
  {
    id: 'zeal_t4_resurrection',
    name: 'Resurrection',
...
export const MARTYR_ASCETIC = [
  ...
  // Tier 5 - Blade point (piercing judgment)
  {
    ...
    maxRanks: 3,
    position: { x: 1, y: 4 },
    requires: 'asct_t4_sword_of_justice',
  },
  {
    id: 'asct_t5_apocalypse',
    name: 'Apocalypse',
    description: 'Unleash apocalypse. 60ft radius deals 8d6 radiant damage. Creatures reduced to 0 HP are destroyed.',
    icon: 'spell_holy_sealofwrath',
    maxRanks: 1,
    position: { x: 2, y: 4 },
    requires: ['asct_t4_wrath_of_heaven', 'asct_t4_sword_of_justice', 'asct_t4_final_judgment'],
    requiresAll: true,
  }
];
