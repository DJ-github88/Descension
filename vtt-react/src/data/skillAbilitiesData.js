...
export const SKILL_ABILITIES = [
 ...
 // Deception - Misdirect
 {
  ...
  debuffConfig: {
   ...
   durationType: 'rounds',
   durationUnit: 'rounds',
   saveDC: 0, // shifting based on target intelligence
