...
export const BACKGROUND_DATA = {
  ...
  bloodlineHeir: {
    ...
    classHooks: [
      ...
      { classId: 'false_prophet', bridge: 'Vreken and Astril heirs can wield house authority as the seed of a manufactured congregation.' }
    ],
    tensionPairings: [
  ...
  monolithHunter: {
    ...
    name: 'Relic Hunter',
    description: 'For centuries, the seven Sundered Monoliths stood silent: six true fragments of the binding seal and one hollow echo where a seventh signature was never made. The Devouring broke them: when the false Aelden unmasked itself and consumed the six sacrificed heirs of the noble houses, the binding cracked and the fragments scattered across every region. They hummed quietly for generations. No one bothered to listen. Now they are waking. All seven at once, their resonance rising, and the song is getting louder. You track that resonance across the frozen world with cold iron stakes to ground the Wyrd-echoes (supernatural magical residue) and a journal of fragment-locations that certain powers would kill to possess. The monoliths were silent for the better part of a century and a half. Whatever changed, it changed recently, and it is still changing. You carry the only map that tracks all seven fragments, and the powers who want it do not negotiate. Reach the next Monolith first. The choice of whether the waking is hastened, halted, or understood only stays yours while you are the one standing at its base.',
