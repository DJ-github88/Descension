...
export const SUBREGIONS = {
  ...
  'sundale-green-rim': {
    ...
    primaryFactions: ['Dawn Vigil (nominal)', 'Smuggler captains', 'Sun-Worship revival cults'],
  ...
  'iceheart-saltmaw': {
    ...
    regionId: 'iceheart-sea',
    description: 'The southernmost reach of the Iceheart Sea, where a glacial river from the Bryngloom meets the salt water. The estuary is a vast marshland of half-fresh, half-salt water; the Saltmaw Bog is a place of smugglers, exiled Neth, and forgotten gods.',
