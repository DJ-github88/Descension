...
export const SUBREGIONS = {
  ...
  'nordhalla-glacier-heart': {
    ...
    primaryRaces: ['Skald', 'Nethien', 'Nethien', 'Corvani', 'Fexric refugees', 'Rime-Touched'],
    primaryFactions: ['House Skalvyr', 'The Hungríd Cult', 'Nethien of Saltgrinn', 'Corvani Flocks', 'Skald Berserkers'],
    zoneIds: [
      'snowcall-city',
      'hvalhavn',
      'svalghjartas-keep',
  ...
  'nordhalla-fjord-coast': {
    ...
    zoneIds: [
      ...
      'vargtower-beacon',
      'cod-drying-racks',
      'frost-tithe-cradle-camp',
      'jaarn-tand-cairn-line',
      'sunder-wall-gates',
  ...
  'iceheart-merrow-archipelago': {
    ...
    primaryRaces: ['Merryn humans', 'Nethien (at Ironjaw Port)', 'Smugglers and pirates'],
  ...
  'iceheart-western-isles': {
    ...
    primaryRaces: ['Merryn pirates', 'Exiled Nethien', 'Tide-Speakers (animist holdouts)'],
  ...
  'iceheart-saltmaw': {
    ...
    primaryRaces: ['Merryn smugglers', 'Nethien (exiles)', 'Vreken (in the deeper pools)'],
    primaryFactions: ['Saltmaw Free-Port', 'Nethien exile community', 'Forgotten-Cult of the Mawed Sea'],
  ...
  'iceheart-waters-of-eziara': {
    ...
    primaryRaces: ['Merryn traders', 'Nethien diplomats', 'Siren Queens'],
  ...
  'sundrift-bogpost-march': {
    ...
    dominantTerrain: 'Marshy steppe, peat-edges, river-crossings',
     primaryRaces: ['Ordan humans', 'Vreken', 'Bryngloom Nethien (travelers)'],
  ...
  'bryngloom-canopy-heart': {
    ...
    dominantTerrain: 'Living ironwood cathedral-grove, central lake, peat-bog, hanging slums',
     primaryRaces: ['Nethien (Nethien, Veldun, Withered)', 'Vreken', 'Vreken (in the deep)'],
    primaryFactions: ['House Morrath', 'Nethien Pact-Lords', 'Over-Shanty syndicates'],
  ...
  'bryngloom-sunken-basin': {
    ...
    primaryRaces: ['Vreken (Clean, Marked, Over-Lit)', 'Nethien (rare visitors)'],
  ...
  'bryngloom-western-bayous': {
    ...
    dominantTerrain: 'Ironwood bayous, river-cliffs, ancient fae-contracts carved into bark',
     primaryRaces: ['Nethien Veldun (weavers)', 'Vreken fishermen', 'Covenbane inquisitors'],
    primaryFactions: ['Veldun Loom-Council', 'Covenbane Inquisition', 'Drowned-Dingle smugglers'],
  ...
  'bryngloom-great-mere': {
    ...
    primaryRaces: ['Nethien (lake-dwelling)', 'Merryn (lake-traders)', 'Vreken (island hermits)'],
    primaryFactions: ['Lake-Council (joint Nethien/Merryn)', 'Monks of the Sunken Stone'],
  ...
  'bryngloom-root-veil': {
    ...
    primaryRaces: ['Morvane (entity)', 'Veldun Weavers (deep)'],
