export const TOKEN_TEMPLATES = {
  ...
  inquisitor: [
    {
      id: 'inquisitor_cinder_sprite',
      name: 'Cinder-Sprite',
      description: 'Cold-iron wards ring as the binding-rite drags the cinder-sprite forth. From the smoldering depths of Emberspire, this tiny fiend cackles with malevolent cunning. A small, cunning horror with fire bolt, flight, and invisibility.',
      level: 2,
      spellId: null,
      creature: {
        name: 'Cinder-Sprite',
    ...
    {
      id: 'inquisitor_cinder_lord',
      name: 'Cinder-Lord',
      description: 'Only the weight of the binding-seal bends a lord of the seventh circle. A lord of Emberspire\'s seventh circle, commanding legions with a flick of its claw. A powerful fiend lord with 2 actions per turn.',
      level: 6,
      spellId: null,
      creature: {
        name: 'Cinder-Lord',
    ...
    {
      id: 'inquisitor_cinder_legionnaire',
      name: 'Cinder-Legionnaire',
      description: 'The binding-circle ruptures, and the lower pits bleed through. The teeming legions of Emberspire\'s lower pits spill through the rupture. A squad of cinder-legionnaires from the infernal legion.',
      level: 8,
      spellId: null,
      creature: {
        name: 'Cinder-Legionnaire',
    ...
    {
      id: 'inquisitor_ash_herald',
      name: 'Ash-Herald',
      description: 'Even heralds of ash must obey the seal that names them. Emberspire\'s most devastating heralds descend, heralding an age of ash. Devastating ash-heralds with 2 actions per turn.',
      level: 9,
      spellId: null,
      creature: {
        name: 'Ash-Herald',
    ...
    {
      id: 'inquisitor_cinder_sovereign',
  ...
  toxicologist: [
    {
      ...
      creature: {
        ...
        abilities: ['2d6 blight damage', '-10ft movement for 2 rounds', '5ft trigger radius'],
      },
      quantity: 1,
      duration: { value: 10, unit: 'minutes' },
      controlType: 'autonomous',
    ...
    },
    {
      ...
      creature: {
        ...
        abilities: ['3d6 stabbing damage', 'Immobilized 1 round (DC 14 DEX save)', '5ft trigger radius'],
      },
      quantity: 1,
      duration: { value: 10, unit: 'minutes' },
      controlType: 'autonomous',
    ...
    },
    {
      ...
      creature: {
        ...
        abilities: ['2d8 blight damage', '-3 DR for 3 rounds', '5ft cone trigger'],
      },
      quantity: 1,
      duration: { value: 10, unit: 'minutes' },
      controlType: 'autonomous',
  ...
  chronarch: [
    {
      ...
      creature: {
        ...
        abilities: [
          '2d6 arcane damage to enemies in 15ft per round',
  ...
  revenant: [
    ...
    },
    {
      ...
      creature: {
        ...
        abilities: ['Ranged attack (2d6 stabbing damage)'],
      },
      quantity: 2,
      duration: { value: 5, unit: 'rounds' },
      controlType: 'mental',
