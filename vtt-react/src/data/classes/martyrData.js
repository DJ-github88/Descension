...
**Weaknesses**:
- **Devotion Collapse (Fatal Flaw)**: If you go 1 round without taking damage or sacrificing HP, you lose 1 Devotion Level. The faith that is not tested decays immediately. If you lose 3 Devotion Levels through decay in a single combat, you become Faithless for 2 rounds: all healing you deal is halved, and you cannot use Intervene. The sacred does not reward fair-weather believers. Recover by sacrificing at least 15 HP in a single round
...
*You stand among the horror corpses, bleeding but victorious. Your wounds glow with fading golden light.*
...
5. **Layered Passive Protection**: Your passives provided constant value,Level 1 resistance halved the horror lord's 30-damage hit to 15, Level 2 regen restored 17 HP across four turns, Suffering's Gift buffered your allies with temp HP, and Level 4 resistance protected the Mage from an 8-damage hit entirely.
  ...
  cards: [
   {
    ...
    details:
     "The foundation of endurance. Your faith is a guttering candle in a cathedral of bones. At these levels, your devotion provides nothing more than the personal survival needed to keep absorbing punishment. You are not sacred. You are meat that refuses to stop bleeding.",
   },
   {
   ...
   { id : "redemption",
    ...
    passiveAbilities: [
     ...
     },
     {
      ...
      description:
       "Whenever you use Martyr's Intervene, you heal the protected ally for 2d6 HP. and, all healing spells you cast have their range increased by 10 feet.",
      uniqueTo: "Redemption",
     },
    ],
...
Born from the Dreadnaught tradition of the Groven troll-kin, Ironclad Martyrs represent a heretical synthesis: instead of the Dreadnaught's passive absorption of punishment, the Ironclad chooses to suffer, channeling the Martyr's active self-sacrifice through furnace mechanics. Where a Dreadnaught is struck and endures, an Ironclad Martyr throws themselves into the blow and thanks the sacred for the coal.`,
 ...
 spells: [
  ...
  { id: "martyr_restorative_prayer",
   ...
   description:
    "Channel sacred energy through prayer to heal an ally. Scales with Spirit and can be amplified with Devotion.",
   level: 1,
   spellType: "ACTION",
   ...
   resourceCost: {
    ...
    somaticText:
     "Hands clasped in prayer, golden light emanating from your fingers as sacred energy flows through you",
   },
   ...
   healingConfig: {
    ...
    hasHotEffect: false,
    description:
     "The restorative prayer mends wounds with gentle sacred energy. Cuts close, bruises fade, and the target feels their pain ease as vitality is restored. The healing is accompanied by a sense of peace and comfort, as if the sacred itself is watching over them.",
   },
  ...
  { id: "martyr_blood_pact",
   ...
   description:
    "Forge a sacred covenant with allies. All party members share damage equally through sacred bonds.",
   level: 5,
   spellType: "ACTION",
   icon: "Radiant/Radiant Golden Shield",
  ...
  { id: "martyr_divine_retribution",
   ...
   description:
    "When you take damage, store it as consecrated energy. Release it all as a burst of ember damage.",
   level: 5,
   spellType: "ACTION",
   icon: "Radiant/Radiant Golden Shield",
   ...
   specialMechanics: {
    storedDamage: {
     description:
      "The spell channels all the pain and suffering you've endured since your last rest, converting it into sacred retribution. The more you've suffered, the more devastating the strike becomes, though there is a limit to how much pain can be channeled.",
     cap: 50,
    },
   },
  ...
  { id: "martyr_sanctified_ground",
   ...
   effectTargeting: {
    ...
    damage: {
     ...
     aoeShape: "circle",
     aoeParameters: { radius: 20 },
     targetRestrictions: ["undead", "horror"],
     description:
   ...
   utilityConfig: {
    ...
    selectedEffects: [
     { id: "sanctified_ground_zone",
      name: "Sanctified Ground",
      description: "A 20-foot circle of sacred ground persists for 5 rounds, healing allies and burning undead and demons standing upon it."
     },
    ],
    duration: 5,
    durationUnit: "rounds",
  ...
  { id: "martyr_willing_vessel",
   name: "Willing Vessel",
   description:
    "Become a vessel for sacred energy. Redirect all ally damage to yourself and gain 50% damage reduction for 3 rounds.",
   level: 6,
   spellType: "ACTION",
  ...
  { id: "martyr_mass_resurrection",
   ...
   description:
    "Channel sacred energy to restore all fallen allies to consciousness with partial health.",
   level: 7,
   spellType: "ACTION",
  ...
  { id: "martyr_guardian_spirit",
   ...
   resourceCost: {
    ...
    somaticText: "Draw messenger sigil",
   },
  ...
  { id: "martyr_holy_wrath",
   ...
   specialMechanics: {
    devotionSpend: {
     description:
      "Consumes all accumulated Devotion, channeling every moment of suffering into devastating sacred power. The more Devotion you've built through sacrifice, the more devastating the strike becomes, though a minimum threshold must be reached.",
     minimum: 5,
    },
   },
  ...
  { id: "martyr_shared_agony",
   ...
   description:
    "Link an enemy to yourself through sacred retribution. When you take damage, they take the same amount as ember damage.",
   level: 8,
   spellType: "ACTION",
   icon: "Radiant/Radiant Beam",
  ...
  { id: "martyr_judgment_day",
   name: "Judgment Day",
   description:
    "Call down sacred judgment. Heal all allies to full and deal 12d10 + twice your Spirit ember damage to all enemies within 40 feet (DC 20 Spirit save for half).",
   level: 9,
   spellType: "ACTION",
