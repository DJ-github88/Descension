...
Draw the bow. Scent the spoor. The forest is silent, and you are its sharpest shadow. Strike before they know you are there.`,
    ...
    quickOverview: {
      ...
      content: `**What You Need to Know**: The Huntress is an agile melee damage dealer who builds Quarry Marks through coordinated attacks with her beast companion â€” NOT from individual hits. Your glaive is deadly alone, but your true power comes from the pack.

**Core Mechanic**: Coordinate with companion â†’ Generate Quarry Marks from companion synergy (coordinated strikes, companion commands, pack tactics) â†’ Spend marks on companion buffs, glaive chain extensions, or ultimate abilities

**Resource**: Quarry Marks (0â€“5 scale, max +3 generated per turn, +4 for Beastmaster)
...
4. **Spend marks** to extend chains, buff companion, or save for a devastating ultimate`,
    ...
    description: `The Huntress is a master of close-range combat who wields the legendary Shadow Glaive, a weapon capable of chaining deadly strikes between multiple enemies. Accompanied by a loyal beast companion, the Huntress excels at hit-and-run tactics, weaving through enemy lines with deadly grace. Through the Quarry Marks system, she builds power through the bond with her companion â€” Quarry Marks represent pack coordination, not individual prowess. Glaive hits alone generate no marks; it is the synchronized rhythm of hunter and beast that fills the reservoir. This dynamic class rewards tactical positioning, companion management, and the synergy between hunter and beast.`,
...
The key to mastering the Huntress is generating and spending Quarry Marks efficiently. Marks are NOT generated by hitting enemies â€” they represent the bond between you and your companion. Generate marks through pack coordination:
...
- **You Hit Alone**: +0 QM â€” solo glaive hits generate NOTHING
...
**Turn 1 â€” The Opening Chain (QM: 2 â†’ 5)**

*Five bandits stand in a tight group, weapons drawn. You grip your Shadow Glaiveâ€”a crescent-bladed polearm that hums with dark energy. Fang growls beside you, ready to strike.*

**Bandit #5's Turn** (initiative 16): Charges toward you but is still 20ft away â€” no attack this turn.
...
- **Chain Mechanic**: Glaive chains to all enemies within 5 feet of primary target
  ...
  - **Chain Attack #1 (Bandit #2)**: 1d8+4 â†’ [6] + 4 = **10 damage**
  - **Chain Attack #2 (Bandit #3)**: 1d8+4 â†’ [7] + 4 = **11 damage**
  - **Chain Attack #3 (Bandit #4)**: 1d8+4 â†’ [5] + 4 = **9 damage**
...
**End of Turn 1 â€” QM: 5/5 | 4 bandits remaining (all wounded)**

---

**Turn 2 â€” Extending the Chain (QM: 5 â†’ 3 â†’ 5)**
...
- **Chain Mechanic**: Extended chain reaches Bandits #3, #4, and #5 (3 enemies within extended range)
  ...
  - **Chain Attack #2 (Bandit #4)**: 1d8+4 â†’ [8] + 4 = **12 damage** â†’ Bandit #4 **DEAD** (was already wounded)
  - **Chain Attack #3 (Bandit #5)**: 1d8+4 â†’ [5] + 4 = **9 damage**
...
**End of Turn 2 â€” QM: 5/5 | 2 bandits remaining | Your armor: 16**

---

**Turn 3 â€” Companion Empowerment (QM: 5 â†’ 4 â†’ 5)**
...
- **QM Generated**: +1 (Fang hit, within turn cap). 4 + 1 = **5 QM** (banked for next fight â€” decay begins in 1 minute)
...
You're not a single-target damage dealer. You're a CHAIN ATTACKER. When enemies group up, your Shadow Glaive becomes a weapon of mass destruction. One swing, four hits. And with Quarry Marks, you can extend chains even further, empower your companion, or unleash ultimate abilities. The key is positioningâ€”get enemies close together, then watch the shadow energy arc between them. And Fang isn't just a petâ€”he's a tactical asset. Attack when you need damage, Defend when you need protection. Together, you're unstoppable.`,
  ...
  resourceSystem: {
    ...
    description: `The Huntress is a master of focus and coordination. Your core resource is **Quarry Marks** (0-5), silver-blue moonlight energy built through the bond between you and your beast companion. Solo glaive hits generate NOTHING â€” Quarry Marks are earned through pack coordination, not individual prowess. While your Shadow Glaive clears the field, your Quarry Marks are what turn your loyal companion from a pet into a lethal extension of your own will.`,
    ...
    cards: [
      {
        ...
        stats: "Cap: 5 Marks",
        details:
          "Build marks through companion synergy â€” coordinated strikes, companion hits, and pack tactics. Solo glaive hits generate NO marks.",
      },
      {
    ...
    generationTable: {
      ...
      rows: [
        ["Coordinated Strike (you + companion hit same target same turn)", "+2 QM", "The heart of the pack â€” hunt together or not at all"],
        ...
        ["Glaive Hit (Solo, no companion)", "+0 QM", "Solo hits generate NOTHING â€” you need the pack"],
    ...
    usage: {
      ...
      flourish:
        "âš ï¸ The Over-Hunt: If you hit 5 QM, don't sit on them. You generate marks so fast that any unspent marks are effectively wasted power. âš ï¸ WITHOUT YOUR COMPANION: You generate ZERO marks. Keep your beast alive at all costs.",
    },
        ...
        passiveAbilities: [
          {
            ...
            description:
              "Your Shadow Glaive can chain to +1 additional target (total of 5 targets: 1d8 â†’ 1d6 â†’ 1d6 â†’ 1d6 â†’ 1d6). This does not cost Quarry Marks. Chain damage floor is raised to 1d6 at all levels.",
          },
          {
            name: "Momentum",
    ...
    // BLADESTORM - Multi-Target Glaive Attacks
    {
      ...
      specialMechanics: {
        ...
        chainMechanic: {
          ...
          maxTargets: 4,
          damageReduction:
            "Chain damage: 1d8 (primary) â†’ 1d6 â†’ 1d6 â†’ 1d4. At L5+, all chains deal at least 1d6. At L8+, all chains deal at least 1d8.",
        },
        bladestormPassive: {
          description:
...

    {
      ...
      specialMechanics: {
        quarryMarks: {
          ...
          description:
            "Automatically generate 1 Quarry Mark per round. Costs 1 QM per round to sustain the passive â€” if you cannot pay, the effect ends and must be reactivated with 5 QM.",
        },
        companionSynergy: {
          description:
    ...
    // LEVEL 10 (needs 3)
    {
      ...
      effects: {
        damage: {
          ...
          type: "force",
          description:
            "Deals 12d6 + agility Ã— 1.5 force damage that ignores resistances",
        },
        execute: {
          description:
...

    {
      ...
      specialMechanics: {
        quarryMarks: {
          ...
          costReduction: 1,
          description:
            "All QM abilities cost 1 less (min 0). Costs 1 QM per round to sustain â€” if you cannot pay, the effect ends and must be reactivated with 5 QM.",
        },
        companionSynergy: {
