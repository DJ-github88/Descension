...
export const GAMBIT_DATA = {
  ...
  drall_fexric: {
    ...
    reframe: `Gambles in salvage, not gold. Rigged dice, weighted cards, scrap-built dealing machines. Every game in the <LoreLink termId="fexrick">Sump-Markets</LoreLink> is fixed, and the Caustic Fexric Gambit is the one fixing it. The Karmic Debt builds differently  â€”  not from cosmic balance but from the accumulated resentment of every mark they have ever hustled. When the debt comes due, it comes from below.`,
    signatureAbility: {
      name: 'Sump-Rig',
      description: `Fortune Points are generated by rigging the game rather than gambling it; the Caustic Fexric Gambit's dice, cards, and dealing machines are all fixed in advance, building Karmic Debt from the resentment of hustled marks rather than cosmic balance. The debt is personal, and when it comes due, the marks come to collect.`
    },
    currentCrisisAngle: `The Sump-Markets have grown wise to the hustlers, and the Caustic Fexric Gambits are running out of fresh marks. Some have begun to gamble against each other  â€”  hustler versus hustler, both knowing the game is rigged but neither knowing how. The Sump-Hustler tradition is eating itself, and the resentment-debt is compounding.

The Caustic Fexric did not adopt Merryn gambling  â€”  they independently discovered probability manipulation through salvage. But the first Caustic Fexric Gambit, a sump-hustler named **Gear-Rat Jix**, did encounter a Merryn Gambit at Ironjaw Port during the Toll Wars and recognized the shared language. Jix is the reason Caustic Fexric Gambits use cards  â€”  she stole a Merryn deck, replaced the salt-coral dice with weighted gear-teeth, and never looked back.`,
    signatureQuote: {
...
The first was Jax, a Merryn pirate captain who wagered his lifeline against a freezing storm-spirit in Merrowport. He rolled three sixes on salt-coral dice and claimed the wind, but lost his blood's warmth in the bargain. The second was Lyra, a Kessen Neth probability-watcher who severed alternate timelines to save her caravan during a Cragjaw avalanche, experiencing every companion's alternate death in a single second and permanently fracturing her consciousness. Their paths crossed in Year 310 of the Dimming, when Jax's ship, the Last Wager, docked at Ironjaw Port during the Toll Wars. Lyra was there as a probability-consultant for Groven bridge-engineers calculating span-failure risks. Both were manipulating the same fundamental force through different systems.
...
* Lyra the Probability-Watcher: The cartomancer who witnessed her friends die in a hundred ways to find the one path where they lived. Now leads the radical Deck-Burners faction, seeking to destroy the Fates themselves.`
    ...
    currentCrisis: `The Gambit tradition faces a dual crisis. Jax is missing. His ship, the Last Wager, vanished from its berth in Merrowport. His first mate reports he was seen walking into the Iceheart Sea at midnight, fully clothed, with a smile on his face and a loaded die in his hand. The Gambits of Merrowport have formed a search party but suspect the truth: Jax walked into the sea to clear his debt with the storm-spirit in one final game. The storm-spirit has not been heard since the night Jax walked into the sea. Sailors who cross the strait where Jax made his final wager report hearing two voices in the wind  â€”  one that matches the old storm-gale, and a second, lower one, laughing. The Merryn say Jax did not lose. They say the game is still being played, and the sea is the table.
...
The Karmic Debt is collected by an entity Lyra calls the Debtor  â€”  not a god, not a Wyrd-lord, but something older than both. It may be the same thing Morvane answers to when it enforces the First Contract. It may be a natural law that woke up. The Deck-Burners do not know. They intend to find out by forcing it to show itself.`,
...
**Weaknesses**:
- Dual Collapse: you can die from two directions at once  â€”  Fortune hitting 0 triggers Cosmic Bankruptcy (2d10 blight + 100% spirit/shadow vulnerability for 2 rounds); Karmic Debt hitting 13 triggers Wyrd Collapse (6d10 irreducible wyrd, 1-round incapacitation, Fortune emptied, -5 max HP).
- Calculated Risk: every Fortune Point you spend to nudge a roll costs 1d4 wyrd (irreducible)  â€”  forcing fate burns the mind, and hoarding Fortune risks Cosmic Bankruptcy.
- Debt Amplifies Incoming Damage: as Karmic Debt stacks, your vulnerability to all damage climbs  â€”  the more you override fate, the harder reality hits back.
...
- Squishy Ledger-Keeper: low HP and light armor  â€”  caught with empty reserves, you fold to a stiff breeze.
...
**Free Generation**: You bank 2 Fortune Points  â€”  generating them costs nothing. The toll comes only when you spend them (Calculated Risk) or override a roll (Karmic Debt).
  ...
  resourceSystem: {
    ...
    cards: [
      ...
      },
      {
        ...
        details: "Generating Fortune Points costs NO health  â€”  only spending them (Calculated Risk) and overriding rolls (Karmic Debt) exact a toll. Your flesh is no longer the price; your mind and your debt-ledger are.",
      },
      {
    ...
    usage: {
      ...
      flourish: "Calculated Risk applies without exception  â€”  it cannot be reduced, prevented, or mitigated. Karmic Debt vulnerability stacks multiplicatively with other vulnerability sources.",
    },
  ...
  spells: [
    ...
    { id: "gambler_lucky_strike",
      ...
      specialMechanics: {
        fortunePoints: {
          generates: "variable",
          description: "Generates FP on matching dice  â€”  free to bank; the toll comes when you spend them.",
        },
        gamblingGame: {
          gameType: "yahtzee",
    ...
    { id: "gambler_lucky_toss",
      name: "Lucky Toss",
      description: "Flick a weighted steel coin. Heads: target takes 1d10 + spirit storm damage. Tails: the coin floats, granting the target a shimmering barrier absorbing 10 damage for 1 round. Generates 1 Fortune Point, inflicting 1 immediate HP damage as your body channels the debt.",
      level: 1,
      spellType: "ACTION",
      icon: "Social/Dice Roll",
      typeConfig: {
      ...
      specialMechanics: {
        coinFlip: {
          heads: { effect: "deal_damage", description: "Deals 1d10 + spirit storm damage." },
        ...
        gamblingGame: {
          ...
          rules: { flipCount: 1 },
          outcomeTiers: [
            { condition: "heads", name: "Heads", damage: "1d10 + SPI force", fpGain: 1, fpCost: 1 },
    ...
    { id: "gambler_double_or_nothing",
      ...
      description: "Make an all-or-nothing gamble on your physical limits. Make a Unified Strike roll against an enemy. On a hit: it becomes an automatic critical hit dealing double damage (4d10 + spirit force). On a miss: you suffer the kinetic recoil yourself, taking the damage instead. If this reduces you to 0 HP, you immediately plunge into Cosmic Bankruptcy. Spend Fortune Points to nudge the strike roll (1d4 wyrd damage per point spent).",
      level: 4,
      spellType: "ACTION",
      ...
      specialMechanics: {
        ...
        gamblingGame: {
          ...
          outcomeTiers: [
            { condition: "hit", name: "Double (Double Damage)", damage: "4d10 + SPI force", fpGain: 2, fpCost: 2 },
            { condition: "miss", name: "Nothing (Self-inflicted)", selfDamage: "2d10 + SPI force", fpGain: 0 },
          ],
        },
      },
      triggerConfig: {
    ...
    { id: "gambler_high_roller",
      name: "High Roller",
      description: "Wager everything on a single throw. Roll a d20. On a 15+, deal 18d6 + spirit storm damage to a single enemy. On a 6-14, deal half damage. On a 1-5, the probability violently backfires, dealing the full 18d6 + spirit storm damage to yourself. Spend Fortune Points to adjust the roll (1d4 wyrd damage per point spent).",
      level: 9,
      spellType: "ACTION",
      icon: "Social/Dice Roll",
      typeConfig: {
      ...
      specialMechanics: {
        ...
        gamblingGame: {
          ...
          outcomeTiers: [
            { condition: "15+", name: "High Card Success", damage: "18d6 + SPI force", fpGain: 3, fpCost: 3 },
            { condition: "6-14", name: "Neutral Push", damage: "9d6 + SPI/2 force (half)", fpGain: 1, fpCost: 1 },
            { condition: "1-5", name: "Low Card Failure", selfDamage: "18d6 + SPI force", fpGain: 0 },
          ],
        },
      },
      triggerConfig: {
      triggers: [
        ...
        name: "Karmic Reckoning",
        triggerType: "on_miss",
        action: "On a d20 roll of 1-5, the probability violently backfires and the caster takes the full 18d6 + spirit storm damage."
        }
      ]
      },
    ...
    { id: "war-of-wills",
      ...
      effectTypes: ["damage"],
      damageConfig: {
        formula: "Card Value ï¿½ -  2 + Intelligence",
        damageTypes: ["wyrd"],
        resolution: "CARDS",
        cardConfig: {
          drawCount: 1,
    ...
    { id: "fate_weaver_dealers_choice",
      ...
      damageConfig: {
        formula: "Card Value ï¿½ -  2 + Intelligence (Spades)",
        damageTypes: ["wyrd"],
        resolution: "CARDS"
      },
      healingConfig: {
        formula: "Card Value ï¿½ -  2 + Spirit (Hearts)",
        healingType: "direct",
        resolution: "CARDS"
      },
      buffConfig: {
    ...
    { id: "fate_weaver_fold_reality",
      name: "Fold Reality",
      description: "Reaction to smashing damage: teleport 30 ft, leaving an afterimage that detonates for 3d8 blight to adjacent creatures. Generates 2 Karmic Debt.",
      level: 6,
      spellType: "REACTION",
    ...
    { id: "fate_weaver_all_in",
      ...
      effectTypes: ["damage"],
      damageConfig: {
        formula: "Card Value ï¿½ -  3 per expended card",
        damageTypes: ["blight"],
        resolution: "CARDS",
        cardConfig: {
          drawCount: 1,
    ...
    { id: "fate_weaver_the_jokers_hand",
      ...
      damageConfig: {
        formula: "Card Value ï¿½ -  5 (Black Joker) / Card Value (Standard)",
        damageTypes: ["blight"],
        resolution: "CARDS"
      },
      healingConfig: {
        formula: "Card Value ï¿½ -  4 + Spirit (Red Joker)",
        healingType: "direct",
        resolution: "CARDS"
      },
      specialMechanics: {
    ...
    { id: "fate_weaver_jackpot_supreme",
      ...
      effectTypes: ["damage"],
      damageConfig: {
        formula: "Card Sum ï¿½ -  Multiplier (Pair: ï¿½ - 3, Triple: ï¿½ - 7)",
        damageTypes: ["blight"],
        resolution: "CARDS",
        cardConfig: {
          drawCount: 3,
          formula: "Card Sum ï¿½ -  Multiplier"
        },
        savingThrow: {
          ability: "agility",
          difficultyClass: 20,
      ...
      specialMechanics: {
        jackpot: {
          ...
          twoMatch: { multiplier: 3, description: "10d10 ï¿½ -  3 blight damage" },
          threeMatch: { multiplier: 7, description: "10d10 ï¿½ -  7 damage + Temporal Overload incapacitation for 1 round" }
        },
        threadsOfDestiny: {
    ...
    { id: "fate_weaver_empty_hand",
      ...
      // ===== NON-COMBAT / PROBABILITY-SIGHT (the one divination mode unique to Gambit) =====
      {
        ...
        "name": "Odds-Read",
        "description": "Read the probability landscape around a single planned action and see how the odds lay  â€”  if we go through that door, attack now, take this deal, lie to this guard. You receive a blunt likelihood for the most probable outcome: certain, likely, even-money, unlikely, or doomed. The threads will not tell you what to do, only where the weight of chance currently rests. Out of combat.",
        "level": 2,
        "spellType": "ACTION",
        "icon": "Utility/Utility",
        "typeConfig": {
