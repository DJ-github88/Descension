export const GAMBIT_DATA = {
  ...
  drall_fexric: {
    ...
    reframe: `Gambles in salvage, not gold. Rigged dice, weighted cards, scrap-built dealing machines. Every game in the <LoreLink termId="fexrick">Sump-Markets</LoreLink> is fixed, and the Drall Gambit is the one fixing it. The Karmic Debt builds differently  --  not from cosmic balance but from the accumulated resentment of every mark they have ever hustled. When the debt comes due, it comes from below.`,
    signatureAbility: {
      name: 'Sump-Rig',
      description: `Fortune Points are generated by rigging the game rather than gambling it; the Drall Gambit's dice, cards, and dealing machines are all fixed in advance, building Karmic Debt from the resentment of hustled marks rather than cosmic balance. The debt is personal, and when it comes due, the marks come to collect.`
    },
    currentCrisisAngle: `The Sump-Markets have grown wise to the hustlers, and the Drall Gambits are running out of fresh marks. Some have begun to gamble against each other  --  hustler versus hustler, both knowing the game is rigged but neither knowing how. The Sump-Hustler tradition is eating itself, and the resentment-debt is compounding.

The Drall did not adopt Merryn gambling  --  they independently discovered probability manipulation through salvage. But the first Drall Gambit, a sump-hustler named **Gear-Rat Jix**, did encounter a Merryn Gambit at Ironjaw Port during the Toll Wars and recognized the shared language. Jix is the reason Drall Gambits use cards  --  she stole a Merryn deck, replaced the salt-coral dice with weighted gear-teeth, and never looked back.`,
    signatureQuote: {
      ...
      speaker: 'Drall-Voss the Sump-Dealer',
      context: 'A Drall Gambit, caught with a rigged dealing-machine, addressing the crowd'
    }
  },
...
Jax walked into the Iceheart Sea to clear his debt in one final game. The storm-spirit has not been heard since. Sailors crossing that strait report hearing two voices in the wind, one that matches the old gale, and a second, lower one, laughing. The House's current leader, Harbor-Master Merr-Cael, kept the institution solvent for thirty years while its founders self-destructed, most famously through the Winter of Lost Wagers when three sea-captains wagered their entire fleets against each other and all three lost simultaneously. His consolidation of their debts into a permanent institutional share is taught to every apprentice as the Merr-Cael Precedent.`,
    ...
    quickOverview: {
      ...
      content: `**Who they are**: A wagering architect who treats probability as both a bet to be won and a tapestry to be rewoven. They fuse the gambler's raw fortune-siphoning with the cartomancer's precise destiny-weaving into a single devastating art  --  stolen luck in one hand, severed fate-threads in the other.

**The hook**: Nudge any d20 roll after you see it by spending Fortune Points, or hard-override it entirely by burning a banked Fate Reserve card. No other class wields both real-time luck nudging and absolute destiny control simultaneously  --  you can squeeze a failure into success or replace a fatal enemy crit with a face card you banked three turns ago.

**The cost**: You owe two collectors, and both are always calling. Every Fortune Point spent burns your mind with irreducible wyrd damage. Every card override deepens Karmic Debt, amplifying all incoming damage against you. Two collapse conditions  --  Cosmic Bankruptcy and Wyrd Collapse  --  can end you from either direction, and the universe always balances its ledgers.
