...
**The hook**: You have **real-time dice manipulation**: after any d20 is rolled (for you, an ally, or an enemy), you can spend Fortune to nudge the result up or down, or discard a banked Fate Reserve card to hard-override a critical failure into a triumphant success.

**The resource bar & costs**: Your resource bar consists of **Fortune** (generated through lucky strikes and risky bets) and your hand of **Fate Reserve Cards** (drawn each round). Spending Fortune lets you alter rolls in real time, but excessive fate-bending incurs **Karmic Debt**, increasing the damage you take if the house catches up to you.
...
**Bring one for**: Card-based mechanics, manipulating RNG, and having the power to literally turn a party-wiping critical failure into an encounter-winning critical hit.`,
    ...
    combatRole: {
      title: "Combat Role",
      content: "Probability architect and high-stakes gambler who wagers Fortune on rerolls and swaps d20 results with pre-drawn Fate Reserve cards."
    },
    playstyle: {
      title: "Playstyle & Turn 1 Flow",
      content: "**Your Turn 1 in Combat**:\n1. **Inspect Fate Hand**: Look at your pre-drawn Fate Reserve cards.\n2. **Wager Fortune**: Spend FP to nudge critical attack or save rolls (taking 1d4 self-damage per point).\n3. **Balance the Ledger**: Keep Karmic Debt below 13 and Fortune above 0 to prevent Wyrd Collapse."
    }
  },
...
* Lyra the Probability-Watcher: The cartomancer who witnessed her friends die in a hundred ways to find the one path where they lived. Now leads the radical Deck-Burners faction, seeking to destroy the Fates themselves.`
    ...
    currentCrisis: `The Gambit tradition faces a dual crisis. Jax is missing. His ship, the Last Wager, vanished from its berth in Merrowport. His first mate reports he was seen walking into the Iceheart Sea at midnight, fully clothed, with a smile on his face and a loaded die in his hand. The Gambits of Merrowport have formed a search party but suspect the truth: Jax walked into the sea to clear his debt with the storm-spirit in one final game. The storm-spirit has not been heard since the night Jax walked into the sea. Sailors who cross the strait where Jax made his final wager report hearing two voices in the wind  —  one that matches the old storm-gale, and a second, lower one, laughing. The Merryn say Jax did not lose. They say the game is still being played, and the sea is the table.
...
- Start combat with 1 Fortune and 0 Karmic Debt.
- Use Gambler spells (Lucky Strike, Lucky Toss, Dice Dart) to generate Fortune (generation is free; the cost comes when you spend them).
- Use Fate Weaver spells (Fate Reserve, Arcane Dirge) to draw and bank cards for hard overrides, generating Karmic Debt.
- Spend Fortune to nudge rolls (1d4 wyrd damage per point, irreducible).
...
**Free Generation**: You bank 2 Fortune  —  generating them costs nothing. The toll comes only when you spend them (Calculated Risk) or override a roll (Karmic Debt).
...
You spend 2 Fortune to nudge the roll to 14. Exact hit.
...
**Cosmic Bankruptcy**: 2d10 blight damage. 100 percent Spirit vulnerability for 2 rounds. You are bleeding from both ledgers now.`,
  ...
  resourceSystem: {
    title: "Fortune & Debt: The Loaded Deck",
    subtitle: "How Your Resource Works (Beginner's Guide)",
    description: `**1. What is it? (The Loaded Deck & Ledger)**
You manipulate probability through a dual currency:
- **Fortune (0–20)**: Luck tokens used to nudge dice and swap cards.
- **Debt (0–13)**: The cosmic ledger tracking borrowed probability.

**2. How do I build it?**
- Start combat with a pre-drawn hand of Fate Reserve cards and a pool of Fortune points.
- Earn Fortune when allies score natural 20s or enemies roll critical failures.

**3. How do I spend it & what is the catch?**
- Spend Fortune to adjust attack or saving throw rolls by +1/-1 per point, or swap an ally's failed roll with a pre-drawn high card.
- **The Catch (Karmic Collapse)**: Every borrowed point increases Karmic Debt. If Debt reaches **13** or Fortune drops to **0**, probability snaps back in a catastrophic Wyrd Collapse.`,
    ...
    cards: [
      ...
      },
      {
        ...
        details: "Generating Fortune costs NO health  —  only spending them (Calculated Risk) and overriding rolls (Karmic Debt) exact a toll. Your flesh is no longer the price; your mind and your debt-ledger are.",
      },
      {
    ...
    usage: {
      nudging: "Modify any d20 roll (attack, save, ability check) by plus or minus 1 per Fortune spent. Must be declared AFTER the roll is seen but BEFORE the outcome is narrated.",
  ...
  spells: [
    ...
    { id: "gambler_lucky_strike",
      ...
      specialMechanics: {
        ...
        gamblingGame: {
          gameType: "yahtzee",
          description: "Roll 4d12, pairs, triples, and quads multiply your damage and siphon Fortune.",
          resolution: "DICE",
    ...
    { id: "gambler_beginners_luck",
      ...
      description: "Whisper a desperate plea to the cosmic collector. Gain advantage on your next attack roll or saving throw within 1 round. Generates 1 Fortune.",
      level: 1,
      spellType: "ACTION",
      icon: "Psychic/Focused Mind",
      typeConfig: {
        ...
        effects: [
          {
            ...
            name: "Calculated Risk",
            description: "Suffer 1d4 wyrd damage per Fortune spent to nudge rolls.",
    ...
    { id: "gambler_double_or_nothing",
      ...
      specialMechanics: {
        fortunePoints: {
          ...
          description: "Spend Fortune to nudge the attack roll toward hitting (1d4 wyrd damage per point spent).",
        },
        gamblingGame: {
    ...
    { id: "gambler_hot_streak",
      ...
      resourceCost: {
        ...
        classResource: { type: "fortune", cost: 4 },
      },
      resolution: "NONE",
      effectTypes: ["buff"],
      buffConfig: {
    ...
    { id: "gambler_house_advantage",
      ...
      resourceCost: {
        ...
        classResource: { type: "fortune", cost: 5 },
      },
      resolution: "NONE",
    ...
    { id: "gambler_poker_face",
      name: "Poker Face",
      description: "Project an aura of absolute, impenetrable calm, becoming entirely immune to charm, fear, and mind-reading effects for 5 rounds. Costs 5 Fortune (5d4 wyrd damage) to activate.",
      level: 6,
      spellType: "ACTION",
    ...
    { id: "gambler_all_or_nothing",
      ...
      resourceCost: {
        ...
        classResource: { type: "fortune", cost: 6 },
      },
      resolution: "COINS",
      effectTypes: ["damage", "control"],
      damageConfig: {
    ...
    { id: "gambler_weighted_dice",
      ...
      resourceCost: {
        ...
        resourceTypes: ["mana"],
        resourceValues: { mana: 28 },
        classResource: { type: "fortune", cost: 7 },
      },
      resolution: "DICE",
      effectTypes: ["damage"],
      damageConfig: {
    ...
    { id: "gambler_high_roller",
      ...
      resourceCost: {
        ...
        classResource: { type: "fortune", cost: 8 },
      },
      resolution: "DICE",
      effectTypes: ["damage"],
      damageConfig: {
    ...
    { id: "fate_weaver_empty_hand",
      ...
      // ===== NON-COMBAT / PROBABILITY-SIGHT (the one divination mode unique to Gambit) =====
      {
        ...
        "resourceCost": {
          ...
          "classResource": { "type": "fortune", "cost": 1 }
        },
        "resolution": "NONE",
        "effectTypes": ["utility"],
        "utilityConfig": {
          ...
          "selectedEffects": [
            {
              ...
              "description": "Name one concrete action you are about to take; learn the likelihood of its most probable outcome (certain / likely / even-money / unlikely / doomed). Shows where chance currently rests, not hidden facts or the 'right' choice. Costs 1 Fortune (Debtor's Tax still applies).",
