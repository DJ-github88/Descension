 ...
 * inspired by Magicka's shifting spell crafting system.
 */
  ...
  sphereGenerationTable: {
   ...
   rows: [
    [
     ...
     "Arcane",
     "Raw Magic",
     "Arcane damage, disorientation, magical effects",
    ],
    [
     "2",
     "ember",
...
**Pro Tip for Physical Play**: Laminate the matrix table and use a dry-erase marker to circle your available combos each turn. This dramatically speeds up decision-making and helps new players learn the combinations faster.`,
  ...
  specs: [
   {
    ...
    weaknesses: [
     ...
     "Cannot wield chaos and mixed-element synergies as well",
 ...
 combinationMatrix: {
  ...
  entries: [
   ...
   },
   {
    ...
    effectDescription:
     "A beam of concentrated sacred light burns a single target and briefly blinds them.",
    flavorText:
   ...
   },
   {
    ...
    randomEffects: [
     ...
     },
     {
      name: "Arcane Storm",
      description:
       "Lightning arcs from you to 1d4 random targets within 30 feet, dealing arcane damage.",
      damageTypes: ["storm"],
   ...
   // ========================================
   // HOLY MIXED (6 combos)
   // ancestral power fused with mortal elements
   // ========================================
   {
    id: "holy_shadow",
    name: "Twilight",
    elements: ["sacred", "blight"],
   ...
   },
   {
    id: "holy_fire",
    name: "Solar Flare",
    elements: ["sacred", "ember"],
    damageTypes: ["ember", "ember"],
    targetType: "single",
    range: 60,
    primaryEffect: "damage",
    effectDescription:
     "A searing burst of sacred fire that burns body and soul alike.",
    flavorText:
     "The sacred sphere ignites the fire sphere like sunlight through a magnifying glass. What emerges is not merely fire, it is judgment given form, a lance of white-hot righteousness.",
   },
   {
    id: "holy_ice",
    name: "Aurora",
    elements: ["sacred", "rime"],
   ...
   },
   {
    id: "holy_nature",
    name: "Verdant Light",
    elements: ["sacred", "primal"],
    damageTypes: ["ember", "primal"],
    targetType: "single",
    range: 60,
    primaryEffect: "damage",
    effectDescription:
     "sacred light channels through nature, creating a beam of living radiance wrapped in thorny vines.",
    flavorText:
     "Light becomes life becomes weapon. Golden vines erupt from the sacred sphere, wrapped in crackling nature energy. They lash forward like a living whip, burning and binding.",
   },
   {
    id: "holy_healing",
    name: "Crucible of Sinew",
    elements: ["sacred", "storm"],
    damageTypes: ["ember"],
    targetType: "single_ally",
    range: 60,
   ...
   },
   {
    ...
    isChaosCombo: true,
    effectDescription:
     "sacred light refracted through chaos, the result ranges from miraculous to catastrophic.",
    flavorText:
   ...
   },
   {
    ...
    flavorText:
     "Frost + SPIos = the temperature equivalent of a rounding error. Reality's thermostat breaks.",
    randomEffects: [
     {
      name: "Flash Freeze",
      description:
 ...
 spells: [
...

  {
   ...
   damageConfig: {
    ...
    damageTypes: ["arcane"],
     resolution: "DICE",
    description:
     "The bolt strikes with precise arcane force, dealing direct arcane damage.",
   },
    ...
    effects: [
     {
      ...
      description:
       "Thorny vines wrap around your legs, immobilizing you. A strength check breaks free.",
      config: {
...

  {
   ...
   name: "Radiant Ward",
   description:
    "Create a permanent-seeming ward of sacred light around a target. The next time they would take damage, reduce it by half.",
   level: 5,
    ...
    rollableTable: {
     ...
     entries: [
      ...
      },
      {
       ...
       effect: "3d8+INT/2 arcane damage chains to 1d4 random targets within 30ft",
      },
     ],
    },
   },
...

  {
   ...
   name: "Prismatic Ward",
   description:
    "Fuse arcane, sacred, and nature spheres into a prismatic dome. Cleansing light washes over allies, removing harmful effects and shielding them from incoming damage.",
   level: 6,
   spellType: "ACTION",
   icon: "Radiant/Radiant Divinity",
...

  {
   ...
   description:
    "Nature and sacred spheres bloom into weapons of living wood and golden light. Target gains +2d6 damage on their next 3 attacks and +10ft movement speed.",
   level: 6,
   spellType: "ACTION",
   icon: "Nature/Growth",
  ...
  // ========================================
  {
   ...
   damageConfig: {
    ...
    triggerDescription:
     "Enemies within 10 feet of your departure point take arcane damage from the silence afterimage",
    areaShape: "circle",
...

  {
   ...
   description:
    "Launches fire, ice, nature, and sacred spheres simultaneously at a target area, creating a devastating prismatic explosion.",
   level: 7,
   spellType: "ACTION",
