...
export const ARCANONEER_DATA = {
  ...
  classResource: { type: "elemental_spheres", base: 0, max: 4, generationNote: "Generated by Elemental Sphere rolls (4d8 per round in combat). Each spell consumes spheres per its formula." },
