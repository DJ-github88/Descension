...
Draw the bow. Scent the spoor. The forest is silent, and you are its sharpest shadow. Strike before they know you are there.`,
    ...
    quickOverview: {
      ...
      content: `**What You Need to Know**: The Apex is an agile melee damage dealer who builds Quarry Marks through coordinated attacks with her beast companion â€” NOT from individual hits. Your glaive is deadly alone, but your true power comes from the pack.
...
4. **Spend marks** to extend chains, buff companion, or save for a devastating ultimate`,
    ...
    description: `The Apex is a master of close-range combat who wields the legendary Shadow Glaive, a weapon capable of chaining deadly strikes between multiple enemies. Accompanied by a loyal beast companion, the Apex excels at hit-and-run tactics, weaving through enemy lines with deadly grace. Through the Quarry Marks system, she builds power through the bond with her companion â€” Quarry Marks represent pack coordination, not individual prowess. Glaive hits alone generate no marks; it is the synchronized rhythm of hunter and beast that fills the reservoir. This dynamic class rewards tactical positioning, companion management, and the synergy between hunter and beast.`,
...
The key to mastering the Apex is generating and spending Quarry Marks efficiently. Marks are NOT generated by hitting enemies â€” they represent the bond between you and your companion. Generate marks through pack coordination:
...
You're not a single-target damage dealer. You're a CHAIN ATTACKER. When enemies group up, your Shadow Glaive becomes a weapon of mass destruction. One swing, four hits. And with Quarry Marks, you can extend chains even further, empower your companion, or unleash ultimate abilities. The key is positioningâ€”get enemies close together, then watch the shadow energy arc between them. And Fang isn't just a petâ€”he's a tactical asset. Attack when you need damage, Defend when you need protection. Together, you're unstoppable.`,
  ...
  resourceSystem: {
    ...
    description: `The Apex is a master of focus and coordination. Your core resource is **Quarry Marks** (0-5), silver-blue moonlight energy built through the bond between you and your beast companion. Solo glaive hits generate NOTHING â€” Quarry Marks are earned through pack coordination, not individual prowess. While your Shadow Glaive clears the field, your Quarry Marks are what turn your loyal companion from a pet into a lethal extension of your own will.`,
