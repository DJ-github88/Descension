...
export const TOXICOLOGIST_DATA = {
  ...
  subraceVariants: {
    ...
    drun_neth: {
      ...
      reframe: `The <LoreLink termId="neth">Withered</LoreLink>, the leaden-grey outcasts who severed their names from the First Contract, are the Toxicologist tradition's most paradoxical practitioners. The Withered were exposed to the craft through Vreken bog-chemists who sought refuge in the Deep-Quarter after the Keeper's Sanction came down on ichor-thieves. A Vreken Toxicologist named Mor-Velk the Wet taught the first Withered the principles of bog-reading as payment for sanctuary, and the Withered adapted the craft to their own condition: where the Vreken read the bog, the Withered read decay itself. Their own severed flesh, no longer preserved by Morvane's contract, hosts decomposition chemistry that no other subrace can safely study. A Withered Toxicologist distills from their own slow dissolution, and their poisons carry the Silence  -  a null-chemistry that leaves no trace in the Ledger, no signature Morvane can audit. The Nethien consider Withered Toxicologists a legal impossibility: they practice a taxable craft without existing as taxable entities.`,
      signatureAbility: {
        name: 'Null-Distillate',
        description: `Toxins are distilled from the Toxicologist's own decaying flesh, carrying the Silence that voids Morvane's contractual detection. Withered poisons are legally untraceable  -  the Ledger simply cannot register them as existing  -  and they bypass magical wards that key off First Contract signatures. The cost: each distillation accelerates the Withered's dissolution, spending their remaining half-life as reagent.`
      },
      currentCrisisAngle: `The changing fog does not reach the Deep-Quarter directly, but the fog-predators the Thalren distill are migrating deeper into the Frostwood to escape it, and their shifting biology is producing venoms the Withered cannot predict. Worse: the Silence that shields Withered chemistry from the Ledger is *deepening*  -  null-distillates are becoming too aggressive, eating through containment vessels, dissolving the very glass that holds them. Several Withered Toxicologists in the Deep-Quarter have lost their workshops to runaway null-spills that consumed everything including the floorboards. The Withered suspect the fog's changing chemistry and the deepening Silence are the same phenomenon  -  the world's contracts unraveling from both the natural and the supernatural ends  -  and they fear their craft is accelerating the dissolution faster than the fog ever could.`,
      signatureQuote: {
        ...
        speaker: 'Withered Vel-Hassik',
        context: 'A Withered Toxicologist, explaining her null-distillate to a horrified Nethien auditor who cannot file the evidence'
      }
    }
  },
  ...
  classResource: {
    ...
    base: 4,
    max: 10,
    secondaryResource: { type: "contraption_parts", max: 5 },
    ...
    culturalSpread: {
      ...
      vectors: [
        ...
        },
        {
          from: 'Thalren',
          to: 'Vreken',
          vector: `The Bryngloom is far from the Frostwood, but the Nethien contract-economy draws resources from every corner of Mythril. Thalren distillers who fell into debt to the Nethien (which most eventually did, given the cost of fog-predator-hunting equipment) were indentured to work the Bryngloom peat-fields alongside Vreken families serving their own generational debt. A Thalren debt-worker named Hael the Split-Hand, sentenced to twenty years of peat-cutting, began teaching the Vreken the principles of venom-distillation during the long nights in the bog-worker dormitories  -  not out of generosity, but because the Vreken knew the bog's alchemical moss better than any Thalren ever could, and Hael saw a way to pay off his contract faster by producing saleable distillates. The Vreken adapted Thalren techniques to bog-chemistry within a generation, producing toxins the Thalren had never imagined. Hael died in the bog before his debt was cleared. The Vreken remember his name.`
        },
        {
          from: 'Thalren',
          to: 'Trueborn Florae',
        ...
        },
        {
          from: 'Vreken',
          to: 'Withered',
          vector: `The Withered learned the craft from Vreken bog-chemists fleeing the Keeper's Sanction. When Mor-Velk the Wet began intercepting ichor shipments meant for Nethien contract-rituals, she knew the Ledger would eventually trace the theft. She sought refuge in the Deep-Quarter, where the Withered  -  legally non-existent, untraceable by contract-enforcement  -  offered her sanctuary. In exchange for protection, Mor-Velk taught the Withered everything she knew about bog-reading and alchemical distillation. The Withered adapted the craft to their own condition: their half-decayed flesh, no longer preserved by Morvane's contract, hosts decomposition chemistry that no living Toxicologist can replicate. The resulting null-distillates are the only poisons in Mythril that cannot be registered on the First Contract, making the Withered Toxicologists the most dangerous chemists Morvane has never heard of.`
        }
      ]
    },
    ranks: {
...
Toxicologists are viewed with extreme caution in <LoreLink termId="greymark_keep">Greymark Keep</LoreLink>, but their services are highly valued by scouts and hunters in the Reach. In the Bryngloom, Vreken Toxicologists operate illegally from the Peat-Crypts beneath Over-Shanty, hiding their distillates from Nethien revenue officers. In the Deep-Quarter, Withered Toxicologists produce null-distillates that the First Contract cannot register  -  a crime with no criminal, a transaction Morvane cannot audit.

**RACES & CULTURAL AFFILIATION**
The class is practiced by the Thalren humans, the <LoreLink termId="mimir">Tethered Mimir</LoreLink> (who learned by reverse-engineering the poisoned corpses that fell from Thalren canopy-traps), the Vreken of the Bryngloom (who adapted Thalren techniques to bog-chemistry after a debt-worker named Hael the Split-Hand taught them in exchange for alchemical moss), the Trueborn and Shorn Florae (who distill from their own thorn-blood), and the Withered (who learned from Vreken fugitives seeking sanctuary in the Deep-Quarter and adapted the craft to their own decaying flesh).
...
* **Mor-Velk the Wet**: A Vreken Venom-Pourer (in absentia) who taught the Withered the craft in exchange for sanctuary after the Keeper's Sanction came down on her ichor-thefts. She died in the Deep-Quarter three years ago; the Withered still maintain her laboratory.
