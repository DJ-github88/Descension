...
signatureAbility: {
 ...
 id : "augur",
  classResource: {
    ...
    base: 0,
    max: 20,
    dualPool: { positive: "benediction", negative: "malediction" },
    generationNote: "Generated by d20 rolls (Evens grant Benediction, Odds grant Malediction). Can also be harvested from fresh corpses/blood within 60ft.",
    mechanicsNote: "Benediction bolsters and wards allies; Malediction rots flesh and bends probability toward catastrophic failure."
  },
 name: "Augur",
...
**Bring one for**: Unmatched preemptive action economy, manipulating d20 outcomes, and playing a visceral seer whose prophecies guarantee your party's survival.`,
    ...
    combatRole: {
      title: "Combat Role",
      content: "Visceral haruspex and reactive probability prophet who stores Even d20 rolls as Benediction (defense/heals) and Odd d20 rolls as Malediction (curses/rot)."
    },
    playstyle: {
      title: "Playstyle & Turn 1 Flow",
      content: "**Your Turn 1 in Combat**:\n1. **Read Battlefield Gore**: Check for nearby bleeding targets; if none, execute `Blood Price` to seed your omen pool.\n2. **Store d20 Rolls**: Harvest incoming player and enemy die rolls into Benediction and Malediction pools.\n3. **Release Omens**: Spend stored tokens to bend enemy attack trajectories or grant guaranteed critical strikes to allies."
    }
  },
...
- Squishy Soothsayer: light protective gear and a fragile body � if a frontline reaches you, you fold fast.
...
* **Current State**: Malediction: 0/15 | Benediction: 0/5 | HP: 46/50 | Fighter untouched. The executioner cleaves nothing but shadow.`,
 ...
 resourceSystem: {
 title: "Omens: The Fate Ledger",
 subtitle: "How Your Resource Works (Beginner's Guide)",

 description: `**1. What is it? (The Fate Ledger)**
Omens are split into two pools harvested from every d20 rolled on the battlefield (by allies and enemies alike):
- **Boons (Even d20s)**: Defensive wards, healing portents, and guaranteed successes.
- **Banes (Odd d20s)**: Curses, rot afflictions, and forced enemy misses.

**2. How do I build it?**
- Automatically store Even and Odd d20 die results from nearby attacks and saving throws.
- Read fresh blood on wounded creatures (+1 Boon or Bane).
- If no dice have been rolled, cast Blood Price (self-inflict a minor wound to seed your omen pool).

**3. How do I spend it & what is the catch?**
- Spend stored Omens as instant reactions to turn an ally's near-miss into a critical strike or force an enemy boss to fail a lethal blow.
- **The Catch (Visceral Tax)**: If you enter combat with an empty Omen pool, you must pay blood to seed your fate ledger.`,
...
Fate demands resolution. If you hoard Benediction or Malediction without spending them, the unfulfilled paths twist inward. For every point of omen resource remaining at a long rest, you suffer 1 stack of Omen Debt. Each stack reduces all saving throws by 1 (max -10). The only way to cleanse Omen Debt is to complete a combat encounter where you successfully trigger at least three critical strikes or absolute evasions.`,
 ...
 { id : "augur_sign_of_protection",
  ...
  school: "ember",
  icon: "Radiant/Divine Blessing",
  tags: ["buff", "durability", "mitigation", "omen"],
  castTime: 1,
  castTimeType: "IMMEDIATE",
  },
  targetingConfig: {
 ...
 { id : "augur_hierophants_ward",
  ...
  school: "ember",
  icon: "Radiant/Radiant Golden Shield",
  tags: ["buff", "support", "durability", "omen"],
  castTime: 1,
  castTimeType: "IMMEDIATE",
  },
  targetingConfig: {
...
AUGUR_DATA.spells = AUGUR_DATA.exampleSpells;
