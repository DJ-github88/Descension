...
export const INQUISITOR_DATA = {
  ...
  classResource: {
    ...
    base: 0,
    max: 8,
    generationNote: "Generated by parrying, cold-iron strikes, and confronting supernatural spells/entities. Spent on anathema seals and truth interrogations.",
    mechanicsNote: "Authority dictates the binding power of inquisitorial edicts and cold-iron nullifications."
  },
  name: "Inquisitor",
  icon: "fas fa-gavel",
  color: "#8B0000",
...
**Relentless Purge**: Ripping curses, possessions, and crowd control from allies, though the process deals smashing damage to the ally
...
`,
  ...
  features: [
    { id : "inquisitor_training",
      name: "Authority",
      description:
        "You gain proficiency with light warding gear, medium reinforced gear, shields, simple weapons, martial weapons, and alchemist's supplies.",
      level: 1,
    },
    { id : "authority",
      name: "Authority",
  ...
  exampleSpells: [
    ...
    { id: "inq_detect_corruption",
      ...
      description: "Strike cold iron against your cuirass to emit a chime that reveals invisible Wyrd horrors, hidden illusion doors, and tainted objects within 40 ft.",
      level: 1,
      spellType: "ACTION",
   ...
   somaticText: "Channel inquisitor through gesture",
    ...
    { id : "inq_silver_blade",
      name: "Constricting Silver Binding",
      description:
   ...
   somaticText: "Channel anti-magic weakening through gesture",
    ...
    // ===== NON-COMBAT / EXORCIST & ANTI-MAGE UTILITY (the hunter of the supernatural, out of combat) =====
    { id : "inq_witch_sight",
      name: "Witch-Sight",
      description:
      ...
      typeConfig: { school: "arcane", icon: "Arcane/Spellcasting Aura", castTime: 1, castTimeType: "IMMEDIATE", tags: ["utility", "detection", "investigation", "exploration"] },
      targetingConfig: { targetingType: "self", rangeType: "self" },
      durationConfig: { durationType: "minutes", durationValue: 10, durationUnit: "minutes" },
      resourceCost: { resourceTypes: ["mana"], resourceValues: { mana: 4 }, actionPoints: 1, components: ["somatic"], somaticText: "Pry your lids wide; the cold iron behind them wakes" },
      resolution: "NONE",
      utilityConfig: { utilityType: "perception", selectedEffects: [ { id: "witch_sight_see", name: "Cold-Iron Sight", description: "For 10 minutes see active/recent magic, wards, possession, corruption, and the Wyrd-touched, plus the ash-trail of spells cast in the last hour. Iron and salt glow.", mechanicsText: "See magic/possession/corruption/wards + recent cast trails, 10 min." } ], power: "minor" },
      cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 },
      tags: ["utility", "detection", "investigation", "exploration", "anti magic"],
    },
    { id : "inq_null_salt_ward",
      ...
      typeConfig: { school: "arcane", icon: "Arcane/Angular Rune", castTime: 1, castTimeType: "MINUTES", tags: ["utility", "ward", "exploration", "rest", "anti magic"] },
      targetingConfig: { targetingType: "area", rangeType: "touch", rangeDistance: 0, areaType: "line" },
      durationConfig: { durationType: "permanent", durationValue: 0, durationUnit: "permanent" },
      resourceCost: { resourceTypes: ["mana"], resourceValues: { mana: 5 }, actionPoints: 1, components: ["somatic", "material"], somaticText: "Pour the null-salt in an unbroken line, murmuring the Vow" },
      resolution: "NONE",
      utilityConfig: { utilityType: "ward", selectedEffects: [ { id: "null_salt_ward_bar", name: "Salt Line", description: "An unbroken null-salt line bars minor spirits/summons/incorporeal undead, weakens spells crossing it, and blocks scrying/divination through it. Broken by anyone physically smudging the line.", mechanicsText: "Bar minor spirits/summons; weaken/block scrying across the line." } ], power: "moderate" },
      cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 },
      tags: ["utility", "ward", "exploration", "rest", "anti magic"],
    },
    { id : "inq_bind_interrogate",
      ...
      cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 },
      tags: ["utility", "divination", "investigation", "social", "binding", "anti magic"],
    },
    { id : "inq_exorcise_place",
      ...
      cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 },
      tags: ["utility", "exorcism", "exploration", "investigation", "anti magic"],
    },
