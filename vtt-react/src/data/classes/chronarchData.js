...
export const CHRONARCH_DATA = {
  ...
  overview: {
    ...
    quickOverview: {
      ...
      content: `**What You Need to Know**: The Chronarch manipulates time through two resources: Time Shards (generated by casting basic spells, max 10) and Temporal Strain (accumulated when using Temporal Flux abilities, max 10). You spend Time Shards to activate powerful time-manipulation abilities (freeze enemies, rewind damage, reposition allies), but each use adds Temporal Strain. Reach 10 Strain and you suffer Temporal Backlash—losing your next turn and taking damage. ⚠️ Even Temporal Step (movement) now adds +2 Strain — escape comes at a cost.
...
- **The Double-Sided Token**: Use a token that is Blue on one side and Red on the other. Flip it to show if you have used a Flux ability this turn yet (tracking your decay eligibility).`,
  ...
  spells: [
...

    {
      ...
      name: "Temporal Step",
      description:
        "Phase through a moment that was, moving with temporal speed. Dash up to 20 feet in a straight line, passing through enemies without provoking opportunity attacks. You must end in an unoccupied space. ⚠️ WARNING: Bending time to move strains the timeline — this spell costs 8 mana AND adds +2 Temporal Strain. Use sparingly.",
      level: 1,
      icon: "Arcane/Quick Step",
      spellType: "ACTION",
      ...
      typeConfig: {
        school: "arcane",
        icon: "Arcane/Quick Step",
        tags: ["movement", "displacement", "temporal_strain"],
        castTime: 1,
        castTimeType: "IMMEDIATE",
      },
      ...
      temporalStrainCost: 2,
      temporalStrainWarning: "Moving through time strains the timeline. This spell adds +2 Temporal Strain in addition to mana cost. At 10 Strain you suffer Temporal Backlash (lose next turn, 4d6 force damage).",
        ...
        selectedEffects: [
          {
            ...
            name: "Temporal Dash",
            description:
              "Dash up to 20 feet in a straight line, passing through enemies without provoking opportunity attacks",
            distance: 20,
      ...
      timeShardGenerate: 0,
      noTimeShardReason: "Temporal Step does not generate Time Shards — it is a temporal manipulation, not a basic spell.",
    ...
    },
    {
      ...
      name: "Temporal Anchor",
      description:
        "Your body is anchored to the current timeline. When you use 3 or more time-manipulation abilities in a single round, you become Slowed for 1 round as temporal backlash catches up. Time resents being pulled in too many directions at once.",
      level: 1,
      spellType: "PASSIVE",
      icon: "Arcane/Chrono",
      effectTypes: ["passive"],
    ...
    },
    {
      ...
      description:
        "Each time you cast a spell that manipulates time (rewind, stasis, acceleration, dilation), gain 1 Paradox stack. At 5 Paradox stacks, you take 2d6 force damage and all your cooldowns increase by 1 round. Paradox resets to 0 at the start of your next turn. The timeline punishes those who stretch it too far.",
      level: 3,
      spellType: "PASSIVE",
      icon: "Arcane/Chrono",
      effectTypes: ["passive"],
