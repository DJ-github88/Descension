 ...
 */
 ...
 id: "berserker",
  classResource: {
    ...
    base: 0,
    max: 100,
    generationNote: "Generated by taking damage, attacking, and suffering pain. Grants pain immunity at 21+ Rage.",
    criticalThresholds: { painImmunity: 21, frenzy: 60, burnout: 100 },
    mechanicsNote: "Reaching 100 Rage triggers Burnout, causing self-collapse and exhaustion. Must manage heat through Rage spenders."
  },
 name: "Berserker",
 icon: "fas fa-skull",
 role: "Damage",
...
**Agonizing Recoil**: Every level 1-10 ability requires a toll of flesh. Attacks generate Rage but inflict physical self-damage or agonizing self-debuffs. Violence is your only oxygen; if you go two full rounds without dealing melee damage, you enter **Pain Starvation**, causing your rage to turn inward and decay your mind.`,
 ...
 immersiveCombatExample: {
  ...
  content: `**The Setup**: You stand before an ironclad Golem in a decaying crypt. Your heart rate is normal, your Rage is at 0. Your greataxe is heavy, dragging in the dirt.
...
*The Golem cracks, granite sundering under a strike that should have been physically impossible for a mortal frame. You stand blind with fury, your heart hammering a tragic dirge.*`,
 ...
 },
 {
  ...
  description: "Toggle Calloused Hide (+2 Durability, build Rage on pain) or Boiling Veins (+1d4 ember/smashing damage, constant HP drain).",
 },
 {
  step: 4,
...
*Note: High-level overdrive masteries temporarily bypass instant burnout to allow access to higher thresholds.*`,
 ...
 specs: [
  ...
  weaknesses: [
   "Complete lack of defensive barriers or Durability preservation.",
 ...
 spells: [
    ...
    },
    {
      ...
      effectTypes: ["damage"],
      typeConfig: { school: "smashing", icon: "Slashing/Slashing Cleave", tags: ["reaction", "melee", "damage", "berserker"], castTime: 0, castTimeType: "IMMEDIATE" },
    ...
    },
    {
      ...
      description: "Charge through a 30ft line, striking all enemies in your path for slicing damage and ignoring all physical resistances and Damage Reduction (DR). Costs 30 Rage.",
      level: 7,
      spellType: "ACTION",
      icon: "Slashing/Slashing Cleave",
      effectTypes: ["damage"],
      typeConfig: { school: "slicing", icon: "Slashing/Slashing Cleave", tags: ["damage", "line", "pierce", "berserker"], castTime: 1, castTimeType: "IMMEDIATE" },
      targetingConfig: { targetingType: "line", rangeType: "self", areaSize: 30, targetRestrictions: ["enemy"] },
      resourceCost: { actionPoints: 2, resourceTypes: ["health"], resourceValues: { health: 10 }, classResource: { type: "rage", cost: 30 } },
      cooldownConfig: { cooldownType: "turn_based", cooldownValue: 2 },
 ...
 // ========================================
 {
  ...
  entries: [
   ...
   { range: { min: 6, max: 10 }, customName: "Savage Rent", effect: "Deal +1d6 smashing damage. You take 1d4 recoil." },
    ...
    { range: { min: 19, max: 20 }, customName: "Rage Meltdown", effect: "Apocalyptic swing. bypasses all Durability and DR. Deal +3d6 damage and gain +1d8 Rage. Take 2d4 recoil." },
  ],
  },
 },
  ...
  effects: [
   {
    id: "calloused_skin",
    name: "Calloused Skin",
    description: "Gain +2 Durability. Every time an enemy hits you with a melee attack, gain +1d4 Rage.",
    },
   {
 ...
 // ========================================
 {
  ...
  effects: [
   ...
   description: "All melee attacks deal +2d6 bonus ember/smashing damage. bypasses 50% of enemy Durability and DR.",
   mechanicsText: "Melee attacks deal +2d6 bonus ember/smashing damage and bypass 50% Durability and DR",
   statModifier: {
    stat: "damage",
    magnitude: "2d6",
    magnitudeType: "flat",
  ...
  triggers: [
   ...
   triggerType: "passive",
   action: "melee attacks deal +2d6 bonus ember/smashing damage and bypass 50% of enemy Durability and DR while active."
   },
   {
 ...
 // ========================================
 {
  ...
  effects: [
   ...
   id: "systemic_muscle_tear",
    name: "Systemic Tear",
    description: "Your muscular system begins to fail. Take 4d6 smashing damage and your Durability is reduced by 4 for 2 rounds.",
    mechanicsText: "Take 4d6 smashing damage and -4 Durability for 2 rounds",
    },
  ],
  durationType: "rounds",
  durationValue: 2,
  ...
  triggers: [
   ...
   name: "Systemic Rip",
   triggerType: "on_cast",
   action: "Take 4d6 physical self-damage and suffer -4 Durability for 2 rounds."
   }
  ]
  },
...

 {
  ...
  grantedAbilities: [
   ...
   description: "+4 Durability and +4 DR. Complete immunity to all conditions.",
   },
  ],
  },
