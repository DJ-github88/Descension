 ...
 */
 ...
 merryn_human: {
  ...
  reframe: `This is <LoreLink termId="skald">Lyris the Tide-Singer</LoreLink>'s tradition. The <LoreLink termId="skald">Merryn</LoreLink> storm-sailors discovered that certain rhythms synchronized a crew's physiology to wave and wind, sustained effort that would exhaust any other people within hours. A Merryn Minstrel's Cadence is not art; it is *maritime engineering*, the precise technical manipulation of bodies through sound. The stolen voice is the price, screaming fills the lungs with saltwater.`,
  signatureAbility: {
  name: 'Storm-Cadence',
 ...
 breaker_myrathil: {
  ...
  reframe: `The <LoreLink termId="myrathil">Breakers-Born</LoreLink>, the shore-dwelling diplomats of the Myrathil, conduct the *surf*, not the storm. Their Cadence is the rhythm of the tide-line, the negotiation between sea and shore. Where the Merryn command the deep water, the Breakers-Born mediate the boundary, and their sound-work is gentler, more diplomatic, and far more versatile on land.`,
  signatureAbility: {
  name: 'Tide-Cadence',
  description: `Cadences are strongest at the waterline, the literal boundary between sea and land, and degrade smoothly with distance from shore. A Breakers-Born Minstrel is the only variant effective *both* on water and inland, the natural diplomat of the tradition.`
  },
  currentCrisisAngle: `The silence has reached the surf, the Breakers-Born heard the deep sea go quiet first, through the tide-line they mediate. They have become the tradition's messengers, carrying the warning inland, but the shore-diplomats are realizing the silence is *spreading up the rivers*. Whatever silenced the sea is following the freshwater inland.`,
  signatureQuote: {
 ...
 river_myrathil: {
  ...
  reframe: `The <LoreLink termId="myrathil">River-Fed</LoreLink>, the inland swimmers who traded ocean-depth for freshwater mobility, conduct the *river*, not the tide. Their Cadence is current-speed, the pull of water over stone, and it is the only Minstrel variant that functions fully inland, far from any sea. They are the tradition's frontier, carrying the sound-work up the waterways into the heart of every continent.`,
  signatureAbility: {
  name: 'Current-Cadence',
  description: `Cadences are amplified by flowing freshwater and attenuated by still or salt water; a River-Fed Minstrel on a swift river is nearly as potent as a Merryn in a storm. On a lake or the open sea, they are the weakest variant, the wrong element entirely.`
  },
  currentCrisisAngle: `The silence is spreading up the rivers, and the River-Fed are the variant watching it advance in real time, each tributary going mute in sequence, upstream. Some River-Fed Minstrels have begun fleeing *downstream* toward the silent sea, reasoning that the source must be found before it reaches the headwaters. Others are fleeing further inland, toward the mountains, where the rivers are born, and where no Minstrel has ever played.`,
  signatureQuote: {
 ...
 deep_myrathil: {
  ...
  reframe: `The <LoreLink termId="myrathil">Deep-Born</LoreLink>, the abyssal pressure-forgers of the ocean trench, conduct frequencies no surface ear can parse. Their Cadence is subsonic, felt in the bone rather than heard, the deep-water pressure-wave made musical. A Deep-Born Minstrel is, to surface-dwellers, unsettling rather than beautiful: you do not hear them play so much as *vibrate* in sympathy.`,
  signatureAbility: {
  name: 'Pressure-Cadence',
  description: `Cadences operate below the threshold of hearing, as physical vibration; a Deep-Born Minstrel's effects bypass auditory resistance entirely and cannot be countered by silence or deafness. The cost is range, subsonic effects attenuate fast in shallow water or air.`
  },
  currentCrisisAngle: `The Deep-Born are the variant who know *what* silenced the sea, they felt it, in the deep, before anyone on the surface noticed. They will not say what they felt. The Deep-Born Minstrels have surfaced for the first time in centuries, and they are not performing. They are fleeing, and the look in their bioluminescent eyes is not artistic. Something in the abyss began to sing back.`,
  signatureQuote: {
 ...
 founder: {
  ...
  status: `Vanished, the same night the <LoreLink termId="iceheart-sea">Iceheart Sea</LoreLink> went silent. She traded her spoken voice for the storm's voice decades ago; screaming fills her lungs with saltwater. Her lute was recovered from the water with a final carving: she was looking for the note that shatters the old powers.`,
  note: `Lyris sang a sacred sea-symphony to calm the gales and the ocean mother stole her spoken voice in exchange. She founded the Tide-Choir to teach what the sea taught her. She is the only Minstrel the sea ever spoke to directly, and the sea has stopped speaking.`
 },
 currentLeader: {
 ...
 crisisConnection: `<LoreLink termId="mer-lyrisa">Mer-Lyrisa</LoreLink> is holding a collapsing Choir together while the silence spreads up the rivers (the River-Fed variant's crisis). She has forbidden deep-water performances and grounded the Deep-Born who fled the abyss, but she knows the silence is advancing, and that whatever caused it sang back to the Deep-Born in a voice that should not exist. Her only lead is Lyris's recovered lute and the carving about shattering old powers. She is considering playing the note.`
 },
...
* **Aurelius the Tide-Singer**: A Myrathil bard whose songs could resonate with the deep rifts, opening safe passages between drift-ice.`
 ...
 signatureQuote: {
  text: '"You think music is beauty. You are wrong. Music is resonance, the frequency at which things break. I have found the note that shatters ice. I am looking for the one that shatters the old powers."',
  speaker: 'Lyris the Tide-Singer',
...
**Your Action**: Cast "Borrowed Rhythm" on your party (3 mana, builder spell)
...
5. **Builder Spells**: Opening Chord (I(2)+V(1)), Harmonic Strike (III(2)+I(1)), Borrowed Rhythm (V(2)+VII(1)), Melancholy Melody (VI(2)+IV(1))
...
- Example: Cast "Borrowed Rhythm" (generates II) ? Place 1 light blue token in the II column
...
1. "I cast Borrowed Rhythm" (costs 4 mana, generates II)
...
**Turn 2**: Cast Borrowed Rhythm ? Add II token ? I(1), II(1)
...
**Why Minstrel Is Perfect for In-Person Play**: The class is built around accumulating and spending specific combinations of resources, which translates beautifully to physical tokens. Unlike abstract resources like mana, musical notes are discrete, countable, and combinable,perfect for tactile tracking. The act of building your note collection and then spending them in specific sequences mirrors the musical concept of building tension and resolving it, making the gameplay both mechanically satisfying and thematically immersive.`,
 ...
 specs: [
  ...
  description: `Battlechoir Minstrels are the war drummers of the battlefield, driving soldiers into a relentless rhythm with beats that bypass the conscious mind entirely. Their songs do not inspire courage; they strip away hesitation, morality, and restraint, leaving only the compulsion to fight. Every cadence they play amplifies ally lethality while grinding enemy morale into dust. They favor drums bound in beast hide and horns carved from the ribs of legendary creatures. The Battlechoir does not play music to uplift, they play to ensure that nothing on the receiving end survives.`,
  ...
  passiveAbilities: [
   ...
   description:
    "Your offensive cadences (Circle of Fifths, Phrygian Cadence, Neapolitan Sixth) grant all affected allies +2 to attack rolls for 2 turns. and, when an ally scores a critical hit while affected by your buffs, you generate 1 random musical note.",
  ...
  passiveAbilities: [
   ...
   {
   name: "Stolen Frequency",
   tier: "Specialization Passive",
   description:
    "Your healing cadences (Authentic Cadence, Picardy Third) heal for an additional 1d6 HP. and, whenever you heal an ally, you generate 1 Tonic (I) note. When using a Lute or Harp, healing is increased by an additional +2.",
   uniqueTo: "Soulsinger",
   },
  ],
 ...
 1: [
  ...
  "minstrel_sirens_calm",
  "minstrel_resonance_touch",
 ],
 2: [
  ...
  "minstrel_mnemonic_chord",
  "minstrel_rallying_anthem",
 ],
 3: [
 ...
 { id: "minstrel_opening_chord",
  name: "Opening Chord",
  description:
  "Strike a resonant chord torn from a dying key, the vibration rattling through your instrument and into reality itself, dealing sonic damage and harvesting foundational notes from the collision.",
  level: 1,
  spellType: "ACTION",
 ...
 { id: "minstrel_harmonic_strike",
  ...
  description:
  "Drive a resonant blow into your foe, the impact reverberating through bone and steel to wring mediant notes from the trembling air.",
  level: 1,
  spellType: "ACTION",
 ...
 { id: "minstrel_inspiring_rhythm",
  ...
  components: ["verbal", "somatic"],
  verbalText: "Inspiro!",
  somaticText: "Play borrowed rhythm",
  },
 ...
 { id: "minstrel_soothing_melody",
  name: "Stolen Frequency",
  description:
  "Play a frequency stolen from a dimension that never knew pain; for a moment the listeners forget their wounds as the melody burns away minor afflictions.",
  level: 3,
  spellType: "ACTION",
  ...
  components: ["verbal", "somatic"],
  verbalText: "Pax!",
   somaticText: "Play stolen frequency",
  },
 ...
 { id: "minstrel_resolving_strike",
  ...
  description:
  "Force the I-V progression to its inevitable conclusion, releasing a burst of sonic energy as the stolen frequencies snap into alignment.",
  spellType: "ACTION",
 ...
 { id: "minstrel_war_drum",
  name: "War Drum Beat",
  description: "Beat a stolen war-rhythm into the earth itself; the ground remembers the march of armies that no longer exist and transmits their violence upward.",
  spellType: "ACTION",
 ...
 { id: "minstrel_climactic_crescendo",
  ...
  description:
  "Build toward a peak that the previous reality never reached, its unfinished climax now yours to complete; leading tone and dominant notes flood in as the tension mounts.",
  level: 3,
  spellType: "ACTION",
 ...
 { id: "minstrel_plagal_cadence",
  name: "Plagal Cadence",
  description:
  "The 'Amen' progression, torn from a cathedral that collapsed into the sea; its sacred ascent grants allies swiftness and agility as the ghost of grace passes through them.",
  level: 4,
  spellType: "ACTION",
  icon: "Radiant/Radiant Warrior",
 ...
 { id: "minstrel_symphony_of_destruction",
  ...
  description:
  "Conduct a symphony assembled from the final moments of seven dying worlds; each movement unleashes a wave of sonic devastation, the collective death-rattle given form and direction.",
  level: 7,
  spellType: "ACTION",
 ...
 { id: "minstrel_song_of_heroes",
  ...
  description:
  "Perform a legendary ballad that empowers all allies with might stolen from a dying timeline, granting significant bonuses to attack and damage.",
  level: 7,
  spellType: "ACTION",
  icon: "Radiant/Divine Radiance",
 ...
 { id: "minstrel_dissonant_feedback",
  ...
  // ===== NON-COMBAT / BARDIC UTILITY (the Tide-Choir, out of combat) =====
  {
   ...
   "resourceCost": { "actionPoints": 1, "resourceTypes": ["mana"], "resourceValues": { "mana": 4 }, "components": ["verbal"], "verbalText": "A slow, tidal hum" },
   "resolution": "NONE", "effectTypes": ["utility"],
   "utilityConfig": { "utilityType": "social", "selectedEffects": [ { "id": "sirens_calm_soothe", "name": "Tide-Calm", "description": "For 10 minutes calm hostile/frightened creatures (beasts, crowds, the grieving) to tractable; advantage on Persuasion and Animal Handling. Breaks on any threat of violence.", "mechanicsText": "Calm hostility + advantage Persuasion/Animal Handling, 10 min." } ], "duration": 10, "durationUnit": "minutes", "power": "minor" },
   "cooldownConfig": { "cooldownType": "turn_based", "cooldownValue": 0 },
   "tags": ["utility","social","exploration","minstrel"]
  },
  {
   ...
   "resourceCost": { "actionPoints": 1, "resourceTypes": ["mana"], "resourceValues": { "mana": 4 }, "components": ["verbal","somatic"], "somaticText": "Press a knuckle to the surface and climb the note until it answers" },
   "resolution": "AUTOMATIC", "effectTypes": ["utility"],
   "utilityConfig": { "utilityType": "divination", "selectedEffects": [ { "id": "resonance_touch_ring", "name": "Ringing Truth", "description": "Shatter glass/ice/crystal, jar open a mundane lock, or detect hollow/false-wall/hidden spaces by their resonance. Reinforced or magical materials resist.", "mechanicsText": "Shatter brittle materials/open locks/reveal hollow spaces by resonance." } ], "power": "minor" },
   "cooldownConfig": { "cooldownType": "turn_based", "cooldownValue": 0 },
   "tags": ["utility","exploration","investigation","minstrel"]
  },
  {
   ...
   "resourceCost": { "actionPoints": 1, "resourceTypes": ["mana"], "resourceValues": { "mana": 7 }, "components": ["verbal","somatic"], "somaticText": "Fret the questioning chord and listen to what the dead frequencies remember" },
   "resolution": "NONE", "effectTypes": ["utility"],
   "utilityConfig": { "utilityType": "divination", "selectedEffects": [ { "id": "mnemonic_chord_lore", "name": "Resonant Lore", "description": "Receive a fragmentary answer to one history/magic/language/lore question from collective memory. Common knowledge comes clear; ancient or secret knowledge comes as half-heard fragments or riddles.", "mechanicsText": "One fragmentary lore answer from collective memory." } ], "power": "moderate" },
   "cooldownConfig": { "cooldownType": "short_rest", "cooldownValue": 1 },
   "tags": ["utility","divination","investigation","minstrel"]
  },
  {
  ...
  },
  {
   ...
   "targetingConfig": { "targetingType": "area", "rangeType": "self_centered", "areaType": "circle", "areaSize": 60 },
   "resourceCost": { "actionPoints": 1, "resourceTypes": ["mana"], "resourceValues": { "mana": 8 }, "components": ["verbal","somatic"], "somaticText": "Hammer out the showpiece, all flash and volume" },
   "resolution": "NONE", "effectTypes": ["utility"],
   "utilityConfig": { "utilityType": "social", "selectedEffects": [ { "id": "buskers_diversion_draw", "name": "All Eyes On Me", "description": "Draw all attention within 60 ft to your performance for 1 minute; allies gain one round of effectively-unnoticed movement (sneak/pickpocket/pick-lock/pass). Suspicious or hostile-alerted guards get a save; violence ends it instantly.", "mechanicsText": "Distract all onlookers 1 min; allies get 1 unnoticed round." } ], "duration": 1, "durationUnit": "minutes", "power": "moderate" },
   "cooldownConfig": { "cooldownType": "turn_based", "cooldownValue": 1 },
