export const SHAPER_DATA = {
  ...
  resourceSystem: {
    ...
    cards: [
      ...
      { title: "Structural Fragility", stats: "Permanent", details: "0 Armor. +50% Psychic. Rooted: Flux to 0, 1d10 necrotic/round." }
    ],
    generationTable: {
  ...
  specializations: {
    ...
    passiveAbility: {
      ...
      description: "All Shapers shift between 6 Shaping Forms, build Kinetic Flux, accumulate Body Toll. Opening shift free (Flux), +1 Body Toll. 0 Armor, +50% Psychic vulnerability."
    },
    specs: [
      {
        id: "spec_flow_master",
    ...
    { id: "shaper_structural_fragility", name: "Structural Fragility (Fatal Flaw)", description: "0 base Armor. +50% Psychic damage permanently. If Rooted/Grappled, Flux drops to 0 and take 1d10 Necrotic/round.", level: 1, spellType: "PASSIVE", icon: "Healing/Red Heart", typeConfig: { school: "physical", icon: "Healing/Red Heart", tags: ["passive", "fatal-flaw", "vulnerability"], castTime: 0, castTimeType: "PASSIVE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, components: ["somatic"] }, resolution: "NONE", effectTypes: ["debuff"], cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["passive", "fatal-flaw", "starter", "shaper"] },
