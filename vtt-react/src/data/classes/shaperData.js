...
Flux (0–10) measures biological momentum generated by flowing seamlessly between 6 martial stances (Bone Bastion, Centrifugal Fury, Sinew Spring, etc.). You have 0 Base Durability and rely entirely on active stance defense.
    ...
    choices: [
      {
        ...
        items: ["Twin Shaping Blades (1d8 slashing each, form-adaptive grips)", "Alchemical Binding Wrap (0 Durability, freedom of movement)", "Mutation Catalysts (3 doses)"],
        description: "Rapid dual-wield strikes to build Flux quickly."
      },
      {
        name: "Heavy Serrated Talon Path",
        icon: "Piercing/Piercing Thrust",
        items: ["Serrated Bone Talon (1d10 slashing/piercing, fuses with hand during shifts)", "Alchemical Binding Wrap (0 Durability)", "Stabilizing Catalysts (2 doses)"],
