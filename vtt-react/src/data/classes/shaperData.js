...
- **The Catch (Body Toll)**: Shifting stances too rapidly in a single round generates Body Toll, temporarily straining your physical frame.`,
  ...
  verbalText: "Let out a controlled breath as the form settles."
    ...
    { id: "shaper_stance_ataxic_flow", name: "Form: Ataxic Flow", description: "Adopt the fluid, evasive stance. Reknits tendons for lightning footwork. +2 Dodge, +10ft Movement Speed, advantage on Disengage checks. (Requires 2 Flux, adds +1 Body Toll).", level: 1, spellType: "ACTION", icon: "Nature/Wind Gust", typeConfig: { school: "smashing", icon: "Nature/Wind Gust", tags: ["stance", "buff", "mobility", "shaper"], castTime: 0, castTimeType: "FREE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, classResource: { type: "flux", cost: 2 }, components: ["somatic"] }, resolution: "NONE", effectTypes: ["buff"], buffConfig: { buffType: "statModifier", effects: [ { id: "ataxic_flow_active", name: "Ataxic Flow Stance", description: "+2 Dodge, +10ft Speed, Advantage on Disengage.", statModifier: { dodge: 2, speed: 10, disengage: "advantage" } } ], durationType: "continuous", concentrationRequired: false }, cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["stance", "mobility", "dodge", "shaper"] },
    { id: "shaper_stance_arterial_strike", name: "Form: Arterial Strike", description: "Adopt the predatory precision stance. Calcifies fingers and forearms into razor talons. +2 Attack Bonus, expanded Crit range (19-20), and bypasses 25% of target's DR and Durability on all strikes. (Requires 2 Flux, adds +1 Body Toll).", level: 1, spellType: "ACTION", icon: "Piercing/Piercing Thrust", typeConfig: { school: "smashing", icon: "Piercing/Piercing Thrust", tags: ["stance", "buff", "damage", "shaper"], castTime: 0, castTimeType: "FREE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, classResource: { type: "flux", cost: 2 }, components: ["somatic"] }, resolution: "NONE", effectTypes: ["buff"], buffConfig: { buffType: "statModifier", effects: [ { id: "arterial_strike_active", name: "Arterial Strike Stance", description: "+2 Attack, Crit on 19-20, bypasses 25% of target's DR and Durability.", statModifier: { attackBonus: 2, critThreshold: 19, drBypass: "25%" } } ], durationType: "continuous", concentrationRequired: false }, cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["stance", "damage", "crit", "shaper"] },
    { id: "shaper_stance_centrifugal_fury", name: "Form: Centrifugal Fury", description: "Adopt the sweeping whirlwind stance. Extends joints and ligaments for maximum kinetic momentum. +5ft Melee Reach; all melee strikes cleave adjacent targets for 50% damage. (Requires 3 Flux, adds +1 Body Toll).", level: 1, spellType: "ACTION", icon: "Slashing/Whirl", typeConfig: { school: "smashing", icon: "Slashing/Whirl", tags: ["stance", "buff", "aoe", "shaper"], castTime: 0, castTimeType: "FREE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, classResource: { type: "flux", cost: 3 }, components: ["somatic"] }, resolution: "NONE", effectTypes: ["buff"], buffConfig: { buffType: "statModifier", effects: [ { id: "centrifugal_fury_active", name: "Centrifugal Fury Stance", description: "+5ft Melee Reach, all melee attacks cleave adjacent foes.", statModifier: { reach: 5, cleavePercent: 50 } } ], durationType: "continuous", concentrationRequired: false }, cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["stance", "aoe", "reach", "shaper"] },
    { id: "shaper_stance_deadened_bastion", name: "Form: Deadened Bastion", description: "Adopt the stone-calcified bastion stance. Bones thicken into living granite shields. Gain +20 Temporary HP and +4 Durability (flat damage reduction), but movement speed is reduced by 10ft. (Requires 2 Flux, adds +1 Body Toll).", level: 1, spellType: "ACTION", icon: "Nature/Earth Shield", typeConfig: { school: "smashing", icon: "Nature/Earth Shield", tags: ["stance", "buff", "tank", "shaper"], castTime: 0, castTimeType: "FREE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, classResource: { type: "flux", cost: 2 }, components: ["somatic"] }, resolution: "NONE", effectTypes: ["buff"], buffConfig: { buffType: "statModifier", effects: [ { id: "deadened_bastion_active", name: "Deadened Bastion Stance", description: "+20 Temp HP, +4 Durability (flat damage reduction), -10ft Speed.", statModifier: { tempHp: 20, durability: 4, speed: -10 } } ], durationType: "continuous", concentrationRequired: false }, cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["stance", "tank", "defense", "shaper"] },
    { id: "shaper_stance_silence_predator", name: "Form: Silence Predator", description: "Adopt the shadow-stalking stance. Sinks into low posture with midnight-pigmented skin. Advantage on Stealth checks; first strike from concealment deals +2d6 bonus Blight damage. (Requires 3 Flux, adds +1 Body Toll).", level: 1, spellType: "ACTION", icon: "General/Stealth", typeConfig: { school: "blight", icon: "General/Stealth", tags: ["stance", "buff", "stealth", "shaper"], castTime: 0, castTimeType: "FREE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, classResource: { type: "flux", cost: 3 }, components: ["somatic"] }, resolution: "NONE", effectTypes: ["buff"], buffConfig: { buffType: "statModifier", effects: [ { id: "silence_predator_active", name: "Silence Predator Stance", description: "Advantage on Stealth, +2d6 bonus Blight damage on first strike.", statModifier: { stealth: "advantage", ambushBonus: "2d6" } } ], durationType: "continuous", concentrationRequired: false }, cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["stance", "stealth", "ambush", "shaper"] },
    { id: "shaper_stance_fluid_apex", name: "Form: Fluid Apex", description: "Adopt the master convergence stance. Harmonizes all 5 forms simultaneously. +1 bonus to all d20 rolls, +1 Flux generated per round, and free instant transitions between any form. (Requires 4 Flux, adds +2 Body Toll).", level: 3, spellType: "ACTION", icon: "Nature/Nature Primal", typeConfig: { school: "smashing", icon: "Nature/Nature Primal", tags: ["stance", "buff", "mastery", "shaper"], castTime: 0, castTimeType: "FREE" }, targetingConfig: { targetingType: "self", rangeType: "self" }, resourceCost: { actionPoints: 0, mana: 0, classResource: { type: "flux", cost: 4 }, components: ["somatic"] }, resolution: "NONE", effectTypes: ["buff"], buffConfig: { buffType: "statModifier", effects: [ { id: "fluid_apex_active", name: "Fluid Apex Stance", description: "+1 to all d20 rolls, +1 Flux per round, zero action cost to switch stances.", statModifier: { allRollsBonus: 1, fluxRegen: 1 } } ], durationType: "continuous", concentrationRequired: false }, cooldownConfig: { cooldownType: "turn_based", cooldownValue: 0 }, tags: ["stance", "mastery", "apex", "shaper"] },
...
{ id: "shaper_adaptive_morph",
  ...
  ,
    ...
    },
    {
      ...
      description: "Transcend the limits of mortal anatomy, dissolving into a colossal shifting titan of bone, sinew, and pure kinetic force for 4 rounds. Gain +8 DR, double movement speed, and 50 temporary HP. Spends 15 Flux.",
      level: 10,
      spellType: "ACTION",
      icon: "Nature/Nature Primal",
    ...
    },
    {
      ...
      description: "Encase yourself and all allies within 30 feet in an impervious cocoon of living amber and bone for 1 round. All affected allies are immune to all damage and negative status effects, and heal 40 HP upon emerging. Spends 15 Flux.",
      level: 10,
      spellType: "ACTION",
      icon: "Nature/Nature Primal",
