...
**Resource**: Arcane Energy Points / AEP (0–100 scale, generated by absorbing magical damage and draining enemy mana)
...
You're the ultimate ANTI-MAGE TANK. Enemy spells don't hurt you—they FEED you. Every fireball, every lightning bolt, every meteor is FUEL for your abilities. You absorbed a 75-damage disintegration ray and took ZERO damage. You intercepted a meteor to save your healer. You reflected a fireball back at its caster. You detonated 50 AEP of absorbed energy, killing two mages with their own magic. Against spellcasters, you're INVINCIBLE. You're not just a tank—you're a SPELL EATER.`
  ...
  resourceSystem: {
    ...
    description: `You are an arcane sponge. Incoming magical damage doesn't harm you—it fuels you. By converting hostile spells into Arcane Energy Points (AEP), you turn the enemy's greatest strengths into your own shields, reflections, and devastating force strikes.`,
    ...
    generationTable: {
      ...
      rows: [
        ['Magical Absorption (Base)', '+2 per dmg', 'Fire, Frost, Lightning, Necrotic, etc.'],
        ['Arcane Warden Bonus', '+3 per dmg', 'Enhanced efficiency for tank-focused spec'],
        ['Physical Conversion', '+1 per 2 dmg', 'Less efficient — kinetic force absorbs poorly'],
        ['Mana Drain (Melee Hit)', '+1 per mana', 'Drains mana equal to weapon damage dealt'],
...
**Phase 2: Shielding (21-60 AEP)**: Your active zone. You have enough buffer to absorb moderate spell bursts and still have reserves for reactions. Pre-emptively shield squishy allies (casters, rogues) before big enemy turns. Watch for telltale casting gestures and prime Reflective Barrier against the highest-damage enemy caster.

**Phase 3: Overcharged (61-100 AEP)**: Maximum threat. At 80+ AEP, Arcane Nova becomes fight-ending. Cluster enemies before detonating. If an enemy caster is still alive, hold 25+ AEP for Reflective Barrier — sending their own spell back with bonus damage is devastating. Consider whether detonating Nova or saving for reflection is the higher-value play.

**The Mana Drain Loop**: Your melee attacks steal mana from casters. Every stolen mana point = +1 AEP. Against caster-heavy encounters, you passively generate AEP while dealing damage. Prioritize caster targets — each melee hit starves them of resources while feeding yours.

**Overcharge Pro-Tip**: AEP does NOT decay between encounters. If you finish a fight at 70 AEP, you start the next one already in Phase 3. Communicate with your party — let them know you are charged and ready to absorb or reflect on their signal.`
    },
