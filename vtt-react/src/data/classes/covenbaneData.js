...
**Takeaway**: Against mundane enemies you're still a capable combatant — just without the extra debuffs, instant kills, and charge bonuses that make you devastating against evil casters.`
  ...
  resourceSystem: {
    ...
    cards: [
      {
        ...
        details: 'Your stored anti-magic potential. Charges are generated by engaging in the hunt (attacks, kills, and spells) and persist between encounters.'
      },
      {
        title: "Witch Hunter's Precision",
        stats: 'Level 2 Passive',
        details: 'Every 3rd weapon attack against an evil magic user deals 1d6 Radiant damage. This damage bypasses all resistance and immunity.'
      }
    ],
    ...
    generationTable: {
      ...
      rows: [
        ['Weapon Attack (Any target)', '+1', 'Reliable building through combat'],
        ['Cast Covenbane Spell', '+1', 'Low-level spells often pay for themselves'],
        ['Attack Marked Target', '+1 (Bonus)', 'Use Shadow Hunt to accelerate your power'],
        ['Defeat Evil Magic User', '+3', 'The ultimate reward for a successful hunt'],
        ['Defeat Any Other Enemy', '+1', 'Minor trophies from the battlefield']
      ]
    },

    usage: {
      momentum: 'Spend 3-6 charges to trigger Execution effects or massive Anti-Magic Zones. Against evil casters, these abilities often include instant-kill thresholds or silence effects.',
      flourish: "⚠️ Precision Marking: Always open with 'Shadow Hunt'. It grants advantage and double-charges your attacks, allowing you to reach your 6-charge ultimate in half the time."
    },
...
- **Radiant Dice**: Use a distinct color (like white or gold) for your radiant bonus damage so you can roll it alongside your main weapon damage.`
  ...
  features: [
    ...
    },
    {
      ...
      description: 'Every 3rd weapon attack against an evil magic user deals 1d6 radiant damage that bypasses resistance and immunity. This damage cannot be reduced by any means.',
      level: 2
    }
  ],
  ...
  exampleSpells: [
...

    {
      id: 'cov_hex_strike',
      name: 'Hex Strike',
      description: 'Imbue your weapon with disruptive hex energy. Your next melee attack deals +1d6 necrotic damage and generates 1 Hexbreaker Charge on hit. Against evil magic users, the damage increases to +1d8.',
      level: 1,
      spellType: 'ACTION',
      effectTypes: ['buff'],
      school: 'necrotic',
        ...
        effects: [
          {
            ...
            description: 'Next melee attack deals +1d6 necrotic damage (+1d8 vs evil magic users). Generates 1 Hexbreaker Charge on hit against any target.',
...

    {
      id: 'cov_silver_blade',
      name: 'Silver Blade',
      description: 'Coat your weapon in blessed silver for 1 minute. Attacks deal +1d4 radiant damage. Against evil creatures, attacks also bypass magical resistance.',
      level: 1,
      spellType: 'ACTION',
      effectTypes: ['buff'],
      school: 'radiant',
        ...
        effects: [
          {
            ...
            description: 'Weapon attacks deal +1d4 radiant damage. Against evil creatures, attacks also bypass magical resistance and immunity.',
...

    {
      ...
      description: 'Afflict a target with a sigil unraveling their magic for 1 minute. Spell attacks suffer -2 penalty and spell save DC drops by 1. Evil casters have disadvantage on concentration checks when taking damage.',
      level: 2,
      spellType: 'ACTION',
      effectTypes: ['debuff'],
      school: 'necrotic',
      ...
      debuffConfig: {
        ...
        effects: [
          ...
          },
          {
            ...
            description: 'Evil magic users have disadvantage on concentration checks when taking damage',
...

    {
      id: 'cov_silver_bolt',
      name: 'Silver Bolt',
      description: 'Launch a guided bolt of hardened silver light at a target within 60 feet. Deals 2d8 radiant damage. Against evil creatures, the bolt curves around cover and cannot be intercepted.',
      level: 2,
      spellType: 'ACTION',
      effectTypes: ['damage'],
      school: 'radiant',
...

    {
      ...
      description: 'Project a 10-foot dome of anti-magic light for 3 rounds. Enemy spellcasters inside must Con save DC 14 or their spells fail. Allies inside gain +2 to saves against magic.',
      level: 3,
      spellType: 'ACTION',
...

    {
      id: 'cov_silver_hex',
      name: 'Silver Hex',
      description: 'Brand a creature with a silver sigil that makes them vulnerable to radiant damage — all radiant damage from all sources is doubled. Evil magic users also suffer disadvantage on concentration checks when taking damage.',
      level: 4,
      spellType: 'ACTION',
      effectTypes: ['debuff'],
      school: 'radiant',
...

    {
      ...
      name: 'Spirit Shackle',
      description: 'Pin a target\'s shadow to the ground with anti-magic chains. The target is restrained for up to 1 minute (Spirit save DC 15 at end of each turn ends the effect). Attacks against the restrained target have advantage. Against evil magic users, the target is also silenced.',
      level: 4,
      spellType: 'ACTION',
      effectTypes: ['control'],
      school: 'shadow',
        ...
        effects: [
          {
            id: 'spirit_bind',
            name: 'Spirit Bind',
            description: 'Restrained. Speed reduced to 0. Attacks against target have advantage. Spirit save at end of each turn to break free. Silenced against evil magic users.',
            saveType: 'spirit',
            saveDC: 15,
...

    {
      ...
      description: 'Enter a state of magical perception for 1 minute. Gain +3 to attack rolls and +1d6 radiant damage on weapon attacks. Against evil magic users, your critical hit range expands to 19-20.',
      level: 4,
      spellType: 'ACTION',
      effectTypes: ['buff'],
      school: 'necrotic',
...

    {
      ...
      description: 'Channel Hexbreaker energy into a devastating melee strike. Deals 6d10 radiant damage to any target. Against evil magic users at 25 HP or lower, the target is instantly killed (Con save DC 16 negates). On kill, gain 2 charges.',
      level: 5,
      spellType: 'ACTION',
        ...
        effects: [
          {
            ...
            description: 'Instantly kill evil magic users at 25 HP or lower. On kill: gain 2 Hexbreaker Charges. Non-evil targets take damage only.',
            saveType: 'constitution',
            saveDC: 16,
            condition: 'death',
            duration: 1,
...

    {
      id: 'cov_hunters_net',
      name: 'Hunter\'s Net',
      description: 'Hurl a net of silver chains filling a 20ft radius. Targets are restrained and take 6d8 radiant damage (Strength save DC 16 negates). Against evil magic users, targets are also silenced and take 2d6 additional radiant each turn.',
      level: 5,
      spellType: 'ACTION',
...

    {
      ...
      name: 'Apex Predator',
      description: 'Transform into a Void Hunter for 5 rounds, existing partially in the void. Immune to non-magical damage, teleport to attack visible creatures for free, and ignore Armor from physical armor and magic shields.',
      level: 7,
      spellType: 'ACTION',
      ...
      transformationConfig: {
        ...
        grantedAbilities: [
          ...
          { id: 'ignore_defenses', name: 'Ignore Defenses', description: 'Attacks ignore Armor bonuses from physical armor and magical shields' }
        ]
      },
      tags: ['transformation', 'mobility', 'damage', 'shadowbane']
    },
...

    {
      ...
      description: 'Erase all magic in a 100ft radius permanently. Deals 18d6 necrotic damage (Cha save DC 20 negates), all spells and enchantments destroyed, and evil casters who fail lose spellcasting permanently.',
      level: 10,
      spellType: 'ACTION',
      effectTypes: ['damage', 'utility'],
      school: 'necrotic',
