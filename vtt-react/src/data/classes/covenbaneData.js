...
**Takeaway**: Against mundane enemies you're still a capable combatant — just without the extra debuffs, instant kills, and charge bonuses that make you devastating against evil casters.`
  ...
  resourceSystem: {
    ...
    description: `Hexbreaker Charges represent the Covenbane's accumulated anti-magic power, built through combat. Each charge is a fragment of stored energy, ready to be unleashed in devastating anti-magic abilities. Charges generate from hitting and defeating ANY enemy, with bonus charges against evil magic users.`,
...
**Charge Generation**:
- Deal weapon damage to any enemy: **+1 charge per hit**
- Cast Covenbane spells: **+1 charge per use**
- Defeat any enemy: **+1 charge**
- Defeat an evil magic user: **+3 charges** (replaces base)
...
- **Weapon Attacks**: Deal damage to any enemy (+1 per hit)
- **Anti-Magic Abilities**: Use Covenbane spells (+1 per use)
- **Marked Targets**: Attack targets marked by Shadow Hunt (+1 bonus)
- **Defeating Enemies**: Kill any enemy (+1 charge), kill evil magic users (+2 bonus charges)
...
**Building Charges**:
- **Weapon Attacks**: Deal damage to any enemy (+1 charge per hit)
- **Spell Usage**: Cast Covenbane spells (+1 charge per use)
- **Marked Targets**: Attack targets marked by Shadow Hunt (+1 bonus charge)
- **Defeating Enemies**: Kill any enemy (+1 charge), kill evil magic users (+3 charges total)
...
**Witch Hunter's Precision** (Level 2):
- Every 3rd weapon attack against an evil magic user deals 1d6 radiant damage
- This damage bypasses resistance and immunity

**Spell Design**:
- All Covenbane spells deal full damage to any target
- Bonus effects (debuffs, instant kills, charge refunds) only trigger against evil magic users
