...
Peak vengeance. High pursuit speed (+40ft to +50ft) and sufficient VP to execute ultimate abilities like Cage of Vengeance or enter the Avatar of Vengeance.`
  ...
  characterCreation: {
    ...
    startingStats: {
      ...
      durability: "3 (flat reduction) + Agility DR (max +2) (Iron Jailer Plate)",
    ...
    specs: [
      ...
      { id : "monolith",
        ...
        weaknesses: [
          ...
          "Catastrophic vulnerability to blight damage (+50% damage, dissolves Calcified Bulwark)",
          "Zero ranged capability and cannot chase fleeing enemies"
        ],
        passiveAbilities: [
          {
            ...
            icon: "Nature/Strangle",
            description: "When you spend Tension, convert the spent amount into temporary Calcified Bulwark (DR bonus, max +10). Calcified Bulwark decays by 2 at the start of each turn. You cannot be dragged by tethered targets while you have Calcified Bulwark active."
          }
        ]
      }
    ],
  ...
  exampleSpells: [
    ...
    { id : "warden_evasive_maneuvers",
      name: "Iron Brace",
      description: "When targeted by an attack, brace your plating and brace the chains. Gain a DR bonus. Whether the attack lands or misses, you gain 1 Tension by evading or absorbing the strike.",
      spellType: "REACTION",
      icon: "Utility/Parry",
      level: 1,
  ...
  verbalText: "Grind out a penitent oath between clenched teeth.",
    ...
    { id : "warden_spectral_strike",
      ...
      description: "Phase your chains slightly into the shadow realm, driving them through Durability and bone to deal direct blight damage to the target's internal organs.",
      spellType: "ACTION",
      icon: "Piercing/Night Dagger",
      level: 3,
      specialization: "universal",
      ...
      buffConfig: {
        ...
        effects: [
           { id : "ascendant_jailer_buff",
             ...
             description: "+3d8 damage and massive Durability and DR."
           }
        ]
      },
      cooldownConfig: { cooldownType: "turn_based", cooldownValue: 8 },
  ...
  verbalText: "Grind out a penitent oath between clenched teeth.",
    ...
    { id : "warden_justice_strikes",
      ...
      description: "Deliver a crushing chain slam to your tethered prey, shattering their Durability and DR and causing massive internal bleeding.",
      spellType: "ACTION",
      icon: "Slashing/Cross Slash",
      level: 9,
      specialization: "vengeance-seeker",
