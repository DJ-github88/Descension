...
**Bring one for**: Contagion warfare, spreading layered debuffs across whole groups of enemies, and watching entire encounters collapse under an inescapable pandemic.`,
    ...
    combatRole: {
      title: "Combat Role",
      content: "Mycelial laboratory host and disease cultivator who sows affliction seeds, escalates them through 3 stages, and detonates mature infections for necrotic bursts."
    },
    playstyle: {
      title: "Playstyle & Turn 1 Flow",
      content: "**Your Turn 1 in Combat**:\n1. **Plant Affliction Seeds**: Tag priority targets with `Ghost Spore Seed` or `Festering Boil`.\n2. **Escalate Infection Stages**: Cast category spells (Weaken, Torment, Decay) to advance stages from 1 to 3.\n3. **Harvest for Detonation**: Siphon mature 100-Virulence infections for catastrophic necrotic executions."
    }
  },
...
- **State**: Enemies obliterated. Virulence decays. Caster HP: 33/60.`,
 ...
 // Resource System
 resourceSystem: {
 title: "Virulence: The Greenhouse Culture",
 subtitle: "How Your Resource Works (Beginner's Guide)",
 description: `**1. What is it? (The Greenhouse Culture)**
Virulence (0–100) measures the maturity of symbiotic fungal and necrotic infections you cultivate across enemy ranks.

**2. How do I build it?**
- Plant affliction seeds on targets (+10 to +20 Virulence).
- Cast category spells (Weaken, Torment, Decay) to advance diseases through Stages 1, 2, and 3.

**3. How do I spend it & what is the catch?**
- Harvest mature Stage-3 infections (100 Virulence) for massive necrotic explosions that spread spores to adjacent enemies.
- **The Catch (Fire Sensitivity)**: Taking ember/fire damage burns away active cultures, reducing active infections by 1 stage and dropping Virulence by 25.`,
