...
**Pro Tip**: Use a small whiteboard for tracking active prophecies. Write each prophecy's range, target, and current tick count. The visual chaos of multiple active prophecies is part of the Doomsayer's identity.`
  ...
  exampleSpells: [
    // ===== LEVEL 1 SPELLS =====
    {
      ...
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d8', 'd6'], prophesied: '4d8 necrotic + weakened 2 rounds', base: '2d8 necrotic', outside: '1d8 necrotic to self' },
    ...
    },
    {
      ...
      prophecyRange: { diceTypes: ['d4', 'd4'], prophesied: '-3 to all rolls 2 rounds + 2d6 psychic', base: '-1 to all rolls 2 rounds + 1d6 psychic', outside: '1d4 psychic to self' },
    ...
    },
    {
      ...
      duration: { value: 0, unit: 'instant', concentration: false },
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d6', 'd6'], prophesied: '3d6 fire + 1d6 force + ignite (1d6/round for 2 rounds)', base: '2d6 fire', outside: '1d4 fire to self' },
    ...
    },
    {
      ...
      name: 'Omen of Ash',
      description: 'Place a creeping doom prophecy on a target that grows stronger each round. The longer it persists, the more Havoc it generates.',
      spellType: 'ACTION',
      icon: 'Void/Black Hole',
      school: 'Necromancy',
      level: 1,
      ...
      typeConfig: { castTime: 1, castTimeType: 'IMMEDIATE' },
      targetingConfig: { type: 'SINGLE', range: 30, rangeUnit: 'feet', requiresLineOfSight: true, allowFriendly: false, allowSelf: false },
      resourceCost: { actionPoints: 1, mana: 5, components: ['verbal', 'somatic'], description: '5 mana. Prophecy Range: d6 + d4. Grows +1d4/round.' },
      duration: { value: 3, unit: 'rounds', concentration: false },
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d6', 'd4'], prophesied: '2d6 necrotic + target takes 1d4 additional necrotic per round (cumulative, max 3d4) for duration', base: '1d6 necrotic', outside: '1d4 psychic to self' },
    ...
    // ===== LEVEL 2 SPELLS =====
    {
      ...
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d6', 'd4'], tickDamage: '1d6 necrotic/round', detonation: '4d8 necrotic + stunned 1 round on Prophesied, 2d8 on Base, 1d8 to self on Outside', havocPerTick: 1 },
      damageConfig: { formula: '1d6', elementType: 'necrotic', damageType: 'dot' },
    ...
    },
    {
      ...
      duration: { value: 0, unit: 'instant', concentration: false },
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d10', 'd8'], prophesied: '3d8 fire + 1d8 force to all + difficult terrain 3 rounds', base: '2d8 fire to all', outside: '1d6 fire to self' },
    ...
    },
    {
      ...
      name: 'Death Mark',
      description: 'Mark a target with a narrow but deadly prophecy. High risk, devastating Prophesied payoff.',
      spellType: 'ACTION',
      ...
      typeConfig: { castTime: 1, castTimeType: 'ACTION' },
      targetingConfig: { type: 'SINGLE', range: 30, rangeUnit: 'feet', requiresLineOfSight: true, allowFriendly: false, allowSelf: false },
      resourceCost: { actionPoints: 2, mana: 10, havoc: 1, components: ['verbal', 'somatic'], description: '10 mana + 1 Havoc. Narrow range: d4 + d4.' },
      duration: { value: 0, unit: 'instant', concentration: false },
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d4', 'd4'], prophesied: '6d8 necrotic + target cannot heal for 3 rounds', base: '3d8 necrotic', outside: '2d8 necrotic to self' },
    ...
    // ===== LEVEL 3 SPELLS =====
    {
      ...
      duration: { value: 0, unit: 'instant', concentration: false },
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d8', 'd6'], prophesied: '6d8 damage (split any between necrotic/fire/psychic) + target weakened', base: '4d8 damage', outside: '2d8 to self' },
    ...
    },
    {
      ...
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d8', 'd6'], tickDamage: '1d8 + 1d6 per round active (cumulative)', detonation: 'Base damage + accumulated bonus. Prophesied: double accumulated. Outside: half accumulated to self.', havocPerTick: 1 },
    ...
    },
    {
      ...
      duration: { value: 3, unit: 'rounds', concentration: true },
      resolution: 'DICE',
      prophecyRange: { diceTypes: ['d6', 'd6'], rainTable: ['1: 2d6 fire to all', '2: 2d6 necrotic to all', '3: 2d6 psychic to all', '4: 1d6 force + knocked prone', '5: Stunned 1 round', '6: Roll twice (prophesied auto-triggers)'], prophesied: 'Roll twice on table, apply both', base: 'Roll once', outside: 'Effects target self instead' },
    ...
    // ===== LEVEL 4-10: Abbreviated for space, same pattern =====
    {
      ...
      prophecyRange: { diceTypes: ['d6', 'd4'], prophesied: '8d10 necrotic + target cannot be healed for 5 rounds', base: '5d10 necrotic', outside: '3d10 to self' },
    ...
    },
    {
      ...
      duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'DICE',
      prophecyRange: { diceTypes: ['d10', 'd8'], prophesied: '6d8 fire + 3d8 necrotic to all + difficult terrain 5 rounds', base: '4d8 fire + 2d8 necrotic', outside: '2d8 to self' },
    ...
    // LEVEL 5
    {
      ...
      duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'DICE',
      prophecyRange: { diceTypes: ['d12', 'd8'], prophesied: '8d8 mixed (fire/necrotic/psychic/force) to all + stunned 1 round', base: '5d8 mixed to all', outside: '3d8 to self + stunned 1 round' },
    ...
    },
    {
      ...
      duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'DICE',
      effects: { primary: 'Detonate ALL active prophecies on target. Each prophecy deals its Prophesied damage regardless of range roll. If 3+ prophecies detonated, target is also paralyzed for 1 round.' },
      tags: ['damage', 'prophecy', 'requiem', 'detonate']
    },
    {
      id: 'doomsayer_doom_nova',
      name: 'Doom Nova',
      description: 'Create an expanding wave of prophetic doom that damages all enemies in a massive area centered on a point.',
      spellType: 'ACTION', icon: 'Fire/Fire Storm', school: 'Evocation', level: 5, specialization: 'cataclysm',
      typeConfig: { castTime: 1, castTimeType: 'ACTION' },
      targetingConfig: { type: 'AREA', range: 60, rangeUnit: 'feet', areaType: 'radius', areaSize: 40, requiresLineOfSight: true },
      resourceCost: { actionPoints: 3, mana: 26, havoc: 6, components: ['verbal', 'somatic'] },
      duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'DICE',
      prophecyRange: { diceTypes: ['d12', 'd10'], prophesied: '6d8 fire + 6d8 necrotic to all enemies in range', base: '4d8 fire + 4d8 necrotic', outside: '2d8 fire + 2d8 necrotic to self' },
      damageConfig: { formula: '4d8', elementType: 'fire', damageType: 'direct' },
      tags: ['damage', 'fire', 'necrotic', 'prophecy', 'cataclysm', 'area']
    },
    // LEVEL 6-10 (powerful spells following the same prophecy pattern)
    { id: 'doomsayer_cascade_doom', name: 'Cascade Doom', description: 'When a prophecy Prophesied, all targets in zone trigger secondary prophecy.', spellType: 'ACTION', icon: 'Fire/Fiery Arc', school: 'Evocation', level: 6, specialization: 'cataclysm', typeConfig: { castTime: 1, castTimeType: 'ACTION' }, targetingConfig: { type: 'AREA', range: 50, rangeUnit: 'feet', areaType: 'radius', areaSize: 25 }, resourceCost: { actionPoints: 2, mana: 30, havoc: 7, components: ['verbal', 'somatic'] }, duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'DICE', prophecyRange: { diceTypes: ['d10', 'd8'], prophesied: '8d8 fire + cascade 4d8 to secondary targets within 15ft', base: '5d8 fire', outside: '3d8 to self' }, damageConfig: { formula: '5d8', elementType: 'fire', damageType: 'direct' }, tags: ['damage', 'prophecy', 'cataclysm', 'area', 'cascade'] },
    { id: 'doomsayer_endbringer_finale', name: 'Endbringer\'s Finale', description: 'After 5+ rounds of combat, detonate all active prophecies with maximized effects.', spellType: 'ACTION', icon: 'Void/Falling Meteors', school: 'Evocation', level: 6, specialization: 'endbringer', typeConfig: { castTime: 1, castTimeType: 'ACTION' }, targetingConfig: { type: 'SPECIAL', range: 60, rangeUnit: 'feet' }, resourceCost: { actionPoints: 3, mana: 32, havoc: 8, components: ['verbal', 'somatic'] }, duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'AUTOMATIC', effects: { primary: 'Detonate ALL active prophecies. Each deals its Prophesied effect automatically (no range roll needed). Each prophecy generates double Havoc.' }, cooldownConfig: { type: 'long_rest', value: 1 }, tags: ['ultimate', 'prophecy', 'endbringer', 'detonate'] },
    { id: 'doomsayer_execution_prophecy', name: 'Execution Prophecy', description: 'Place a lethal prophecy on a low-HP target. Prophesied = instant death.', spellType: 'ACTION', icon: 'Necrotic/Necrotic Skull', school: 'Necromancy', level: 6, specialization: 'requiem', typeConfig: { castTime: 1, castTimeType: 'RITUAL' }, targetingConfig: { type: 'SINGLE', range: 30, rangeUnit: 'feet', requiresLineOfSight: true, allowFriendly: false, allowSelf: false }, resourceCost: { actionPoints: 3, mana: 30, havoc: 8, components: ['verbal', 'somatic', 'material'] }, duration: { value: 0, unit: 'instant', concentration: false }, resolution: 'SAVING_THROW', savingThrow: { ability: 'SPIRIT', dc: 'SPELL_DC', onSave: '8d10 necrotic damage instead', onFail: 'Target reduced to 0 HP if below 50% health' }, prophecyRange: { diceTypes: ['d4', 'd4'], prophesied: 'No save—target is reduced to 0 HP regardless of health', base: 'Spirit save as above', outside: '8d10 necrotic to self' }, cooldownConfig: { type: 'long_rest', value: 1 }, tags: ['ultimate', 'death', 'prophecy', 'requiem'] },
    // LEVEL 7
