...
export const UNIVERSAL_STARTING_ITEMS = [
  ...
  // Containers
  {
    ...
    subtype: 'BACKPACK',
    quality: 'common',
    description: 'Morren wagon-fort guilders favor such frames. A bog-preserved ironwood frame-pack, built to carry a ledger and a life across the Reach.',
...

  {
    ...
    subtype: 'POUCH',
    quality: 'common',
    description: 'Neth ledger-souls hook one to every belt. A small peat-tanned pouch that hooks to the belt. Most carry their name-ledger in it.',
  ...
  // Accessories
  {
    ...
    subtype: 'RING',
    quality: 'common',
    description: 'Stamped with a Neth market-mark of lineage. A plain iron band etched with a lineage-mark. Some swear it steadies the constitution.',
  ...
  // Camping & Survival Gear
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Morren wagon-fort tents are stitched the same. A two-soul tent of waxed frost-wool. Shelter enough to outlast a bog-storm.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A Morren caravaneer eats from one daily. A tin box with cup, plate, and ironwood spoon. Hot food is morale on the peat.',
  ...
  // Writing & Scholarly Supplies
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Neth cold-iron styluses cut fine and true. A quill-stylus for ledger-work. Scribe-sentinels carry three; the fog takes the first two.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Pressed for Neth contract-scrolls. A sheet of bog-cured vellum. Holds ink through fog and frost alike.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Morren caravan-traders trust these above the stars. A simple magnetic compass. In the Reach, some trust these more than their own fog-eaten memory.',
