...
export const UNIVERSAL_STARTING_ITEMS = [
  // Basic Weapons
  {
    ...
    subtype: 'DAGGER',
    quality: 'common',
    description: 'Hammered out in a Thrask bog-side smithy. Forged from a shard of bog-iron pulled from the mire of the Reach, this blade remembers the cold hand that last wielded it. A crude shank of bog-iron. The fog clings to it, and the cold with it.',
...

  {
    ...
    subtype: 'SWORD',
    quality: 'common',
    description: 'Carried by Greymark border-rangers along the Thrask patrols. An ironwood-hilted gladius, worn smooth by long roads across the Reach.',
    iconId: 'inv_sword_04',
  ...
  // Additional Weapons
  {
    ...
    subtype: 'AXE',
    quality: 'common',
    description: 'A Thrask wood-ward is never without one. A one-handed ironwood hatchet, balanced to throw. Splits skulls as readily as firewood.',
    iconId: 'inv_axe_02',
...

  {
    ...
    subtype: 'SHIELD',
    quality: 'common',
    description: 'A Thrask line-shield, banded against the bog. A banded ironwood shield. The wood of the Reach does not splinter easily.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A Thrask climber relies on three of these. A three-pronged bog-iron hook. Climbing out of a peat-shaft is a skill, not a hope.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Every Thrask climbing-belt carries a dozen. A bog-iron spike. The only thing between you and the bottom of a crevasse.',
...

  {
    ...
    subtype: 'LEATHER',
    quality: 'common',
    description: 'Thick-soled for the Thrask bog-patrols. High peat-tanned boots with ironwood soles. The mud of the Reach has swallowed lesser footwear.',
