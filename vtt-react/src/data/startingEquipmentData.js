...
export const UNIVERSAL_STARTING_ITEMS = [
  // Basic Weapons
  {
    ...
    subtype: 'DAGGER',
    quality: 'common',
    description: 'Hammered out in a Waste-Solari bog-side smithy. Forged from a shard of bog-iron pulled from the mire of the Reach, this blade remembers the cold hand that last wielded it. A crude shank of bog-iron. The fog clings to it, and the cold with it.',
...

  {
    ...
    subtype: 'SWORD',
    quality: 'common',
    description: 'Carried by Greymark border-rangers along the Waste-Solari patrols. An ironwood-hilted gladius, worn smooth by long roads across the Reach.',
    iconId: 'inv_sword_04',
...

  {
    ...
    subtype: 'STAFF',
    quality: 'common',
    description: 'Cut from a Schratling ironwood grove. A length of dense ironwood. Favored by scribes and pact-mages who walk the fog-lines.',
    iconId: 'inv_staff_13',
  ...
  // Basic Armor
  {
    ...
    subtype: 'LEATHER',
    quality: 'common',
    description: 'Tanned in the peat-vats of Vel-Keth Bayou. Boiled in peat-acid, this jerkin protects without slowing the wearer. Smokes faintly in the damp.',
...

  {
    ...
    subtype: 'CLOTH',
    quality: 'common',
    description: 'Woven in the ancestral mists of Bryngloom. Quilted rough wool treated against the damp. The cheapest defense against a cold that bites through plain cloth.',
  ...
  // Containers
  {
    ...
    subtype: 'BACKPACK',
    quality: 'common',
    description: 'Vreken wagon-fort guilders favor such frames. A bog-preserved ironwood frame-pack, built to carry a ledger and a life across the Reach.',
...

  {
    ...
    subtype: 'POUCH',
    quality: 'common',
    description: 'Nethien ledger-souls hook one to every belt. A small peat-tanned pouch that hooks to the belt. Most carry their name-ledger in it.',
  ...
  // Consumables
  {
    ...
    subtype: 'POTION',
    quality: 'common',
    description: 'Bottled in a Merrowport dockside apothecary. A vial of dark, peat-filtered tincture. Numbs pain and knits flesh, modestly. Tastes of bog and iron.',
...

  {
    ...
    subtype: 'FOOD',
    quality: 'common',
    description: 'Baked hard in Schratling hollow-tree ovens. Dense, resinous waybread of pine-nut and tallow. A thumb-sized piece lasts a day on the trail.',
  ...
  
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A common sight in the Vel-Keth Bayou peat-camps. A waxed leather flask. Holds a day of water, or something stronger to keep the cold out.',
    iconId: 'inv_drink_05',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Pitch-dipped in the Frostwood Reach pineries. A pitch-soaked torch. Burns an hour in the fog, the only warm light for a mile.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Twisted by Schratling bark-cordage spinners. Braided cord of ironwood-bast fiber. Sturdy enough to haul a body from a bog-shaft.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Sheared from the frost-flocks of the Reach. A roll of frost-wool felted against the cold. Sleep in the open is dangerous; this makes it less so.',
  ...
  // Accessories
  {
    ...
    subtype: 'RING',
    quality: 'common',
    description: 'Stamped with a Nethien market-mark of lineage. A plain iron band etched with a lineage-mark. Some swear it steadies the constitution.',
  ...
  // Additional Weapons
  {
    ...
    subtype: 'AXE',
    quality: 'common',
    description: 'A Waste-Solari wood-ward is never without one. A one-handed ironwood hatchet, balanced to throw. Splits skulls as readily as firewood.',
    iconId: 'inv_axe_02',
...

  {
    ...
    subtype: 'MACE',
    quality: 'common',
    description: 'Forged under Inquisitor horror-wards. A blunt mace of cold-iron. The Wyrd flinches from its touch; armor does not.',
    iconId: 'inv_mace_01',
...

  {
    ...
    subtype: 'POLEARM',
    quality: 'common',
    description: 'Hafted by Schratling ironwood-smiths. A seven-foot ironwood haft tipped with bog-iron. Reach is life in the fog.',
    iconId: 'inv_spear_01',
...

  {
    ...
    subtype: 'CROSSBOW',
    quality: 'common',
    description: 'Sighted along the Greymark fog-lines. A crank-drawn crossbow. Slower than a bow, but reliable when the fog hides your target.',
  ...
  // Additional Armor
  {
    ...
    subtype: 'MEDIUM',
    quality: 'common',
    description: 'Taken from a Reach frost-bear by a Greymark patrol. A crude mantle of thick frost-bear pelt. Reeks of the kill, but turns a claw.',
...

  {
    ...
    subtype: 'MEDIUM',
    quality: 'common',
    description: 'Riveted in a Schratling hollow-tree forge. Interlocking ironwood-rings over peat-tanned backing. Heavy, but the bog-forged links do not rust.',
...

  {
    ...
    subtype: 'SHIELD',
    quality: 'common',
    description: 'A Waste-Solari line-shield, banded against the bog. A banded ironwood shield. The wood of the Reach does not splinter easily.',
  ...
  // Additional Consumables
  {
    ...
    subtype: 'POTION',
    quality: 'common',
    description: 'Sold by Vreken hush-traders in crypt-light. A phial of bitter moss-ash distillate. Holds hush-spores and bog-venoms at bay for an hour.',
...

  {
    ...
    subtype: 'UTILITY',
    quality: 'common',
    description: 'Drawn from the peat-pits of Vel-Keth Bayou. A flask of thick bog-oil. Fuels a lantern, or greases a terrible death when lit and thrown.',
  ...
  // Additional Miscellaneous
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Tinned by the tending-clan of Sundale. Flint, bog-steel, and dried moss-tinder in a tin. Fire is life in a world that wants you cold.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A Waste-Solari climber relies on three of these. A three-pronged bog-iron hook. Climbing out of a peat-shaft is a skill, not a hope.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Packed by Greymark field-surgeons. A peat-tanned roll of moss-lint, bone-splints, and cold-water salves. Ten uses before the moss dries out.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Inquisitor cold-iron binding-issue. Cold-iron shackles for prisoners, or the Wyrd-touched. Comes with a key.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Bound for the chained scribes of the Frozen Archive. A bog-preserved book of blank vellum. For recording spells, oaths, or the names of the dead.',
  ...
  // Camping & Survival Gear
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Vreken wagon-fort tents are stitched the same. A two-soul tent of waxed frost-wool. Shelter enough to outlast a bog-storm.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Standard issue in every Reach waystation. A thick frost-wool blanket. The difference between waking and freezing in the small hours.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A Vreken caravaneer eats from one daily. A tin box with cup, plate, and ironwood spoon. Hot food is morale on the peat.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Cast in a Vel-Keth Bayou peat-camp foundry. A sturdy bog-iron pot for boiling waybread or rendering tallow over camp-coals.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Merrowport dock-children learn on these. An ironwood rod, braided sinew-line, and bone hooks. The Iceheart keeps giving, if you wait.',
  ...
  // Tools & Equipment
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Schratling bark-armorers shape wood with the same. A one-handed mallet for pitons and tent-stakes. Doubles as a bludgeon in a pinch.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Every Waste-Solari climbing-belt carries a dozen. A bog-iron spike. The only thing between you and the bottom of a crevasse.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Vreken crypt-runners swear by the prise. A bog-iron crowbar. Pries doors, crates, and the occasional sealed barrow.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A Reach night-watch lantern, hooded against the wind. A hooded iron lantern. Burns six hours on a pint of bog-oil; the shutters save the wick in wind.',
...

  {
    ...
    subtype: 'POTION',
    quality: 'common',
    description: 'Barreled in the Vel-Keth peat-camps. A pint of bog-oil for lanterns. Can also be lit and thrown in a pinch.',
  ...
  // Writing & Scholarly Supplies
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Nethien cold-iron styluses cut fine and true. A quill-stylus for ledger-work. Scribe-sentinels carry three; the fog takes the first two.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Mixed in the Frozen Archive scriptoriums. A small bottle of black peat-ink. Resists damp where common ink would run.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Pressed for Nethien contract-scrolls. A sheet of bog-cured vellum. Holds ink through fog and frost alike.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Aldren Thalreth chains every Archive volume so. A blank journal, chain-bound so it cannot be lost. In the Reach, your journal is your legal identity.',
  ...
  // Adventuring Gear
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Sold in the Atropolis market-marks. A hand-sized polished talsite plate. Reflects poorly, survives drops, and sees around fog-corners.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Inquisitor cold-iron binding-chains, sold by the link. Cold-iron links, sold by the foot. Holds prisoners, anchors traps, and turns the Wyrd.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'uncommon',
    description: 'Ground by Vreken memory-glass lens-cutters. A brass fog-glass. Cuts a mile of fog down to a hundred yards, on a clear hour.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Vreken caravan-traders trust these above the stars. A simple magnetic compass. In the Reach, some trust these more than their own fog-eaten memory.',
  ...
  // Clothing & Accessories
  {
    ...
    subtype: 'CLOTH',
    quality: 'common',
    description: 'Worn by every walker of the Reach fog-lines. A heavy waxed cloak of fog-grey wool. Turns rain, dulls the wind, and hides the wearer at a distance.',
...

  {
    ...
    subtype: 'LEATHER',
    quality: 'common',
    description: 'Thick-soled for the Waste-Solari bog-patrols. High peat-tanned boots with ironwood soles. The mud of the Reach has swallowed lesser footwear.',
...

  {
    ...
    subtype: 'LEATHER',
    quality: 'common',
    description: 'Frozen Archive scribes wear these in the deep-ice. Simple peat-tanned gloves. Protect the hands that hold the quill and the blade alike.',
  ...
  // Musical Instruments
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'A Revel Sylvan minstrel-hall keeps a rack of these. A simple flute carved from frost-elk bone. Minstrel-work, or just a tune against the silence.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Old Revel melodies still march to this drum. A small one-handed frame-drum of frost-bear hide. March-cadence and war-signal, in one.',
  ...
  // Miscellaneous Useful Items
  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Inquisitor chapels ring these to scatter the Wyrd. A small cold-iron bell. An alarm, or a ward; the Wyrd dislikes its tone.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Vreken crypt-light flickers from the same tallow. A tallow candle. Burns an hour. Cheaper than a torch, dimmer, and useless in wind.',
...

  {
    ...
    subtype: 'TRADE_GOODS',
    quality: 'common',
    description: 'Chained scribes of the Frozen Archive mark in this. A stick of pale bog-chalk for marking stone. Scribe-sentinels mark every turning; the fog unmarks the rest.',
    iconId: 'inv_stone_15',
...

  {
    ...
    subtype: 'BAG',
    quality: 'common',
    description: 'Vel-Keth peat-gatherers haul their cut in these. A large rough-woven sack of bog-hemp. Carries loose salvage, or a body, if it comes to that.',
