export const neth = {
 ...
 illustrationCaption: 'An elegant High Neth scribe in ghost-silk robes, paper-white skin with delicate porcelain lines, solid obsidian-black eyes, and a silver leaf circlet standing on an Atropolis canopy balcony.',
...
That was eight centuries ago. The First Contract still rests in the heart of Atropolis, visible through living heartwood like a fossil in amber. The Neth are still there, and they are still writing. Morvane is still watching, not as a spirit or predator, but as an ancient, unyielding sovereign of precedent with eternal patience and a perfect memory for breached terms. The Neth do not die; they renegotiate.`,
    quickFacts: [
...
The Neth operate from their grave-city Atropolis, a cathedral-grove woven into the canopy of the Gloom's oldest ironwood forest. They control the major trade outposts, Ironjaw Port on the Iceheart Sea, the Frostwood trade-embassy, the Sundale crossroads, because these outposts house copies of the First Contract. Without a copy nearby, the Neth begin the Fading: a slow unraveling of mind and body that ends in a pale-skinned husk with nothing left behind the eyes. Their trade empire is not built on ambition. It is built on necessity. They cannot leave the documents, so the documents must go wherever they go.`,
 ...
 variantDiversity: `The Neth are divided into three distinct lineages based on their ancestral bargain at the Well of Youth:
• High Neth (The Loyalists): Impossibly elegant with paper-white luminous skin, delicate porcelain lines creeping beneath temples, solid obsidian-black eyes, and silver leaf circlets. They inhabit Atropolis canopy spires in ghost-silk robes, governing the Sovereign Ledger.
• Pale Neth (The Conspirators): Cold-eyed outlaws with ashen-grey skin, short or braided silver-white hair, and solid obsidian eyes. Wearing dark leather smuggler coats with silver buckles, they operate out of foggy harbour stilt-docks, trading contraband crates and weighing illicit coin-weights on brass scales.
• Hallowed Neth (The Profane): Sleek, beautiful spirit conduits (zero zombie rot or decay) with smooth paper-white skin, glowing solid white eyes with white mana-burn tendrils, long vibrant red hair, and ink-black runic tattoos covering their neck and wrists. Wearing dark tattered monastic wraps, they live in rune-carved castle-monastery ruins, kneeling over ancient scrolls while holding a clay cup of water, yearning eternally for the lost sensation of taste.`,

 integrationNotes: {
 actionPointSystem: 'Neth abilities focus on contract-invocation, fate-weaving, and preservation. High Neth arcanoneers are spellcasters who convert mana into binding clauses. Hallowed Neth manipulate probability and require careful positioning. Pale Neth operate outside the pact entirely, immune to enforcement but unable to benefit from Neth social systems.',
 ...
 classCompatibility: 'The High Neth favor Arcanoneers, Animists, and Revenants, drawing upon the First Contract\'s authority to bind spells in legal script, channel ancestral spirits, and replicate Morvane\'s partial death. High Neth also produce Martyrs, those who have borne so many contractual obligations on behalf of others that their body has learned to convert suffering into sacred currency. The Hallowed Neth favor Gambit above all, utilizing their ability to perceive the obligation-web of the world to tilt the scales of probability. The Pale Neth favor Plaguebringers and False Prophets, operating outside Morvane\'s legal system to harness raw, non-contractual decay and manufactured revelation, the Pale Neth have no use for Morvane\'s law and everything to gain from weaponizing desperation.'
 },

 diasporaVariation: `The Neth diaspora is the most institutionally structured of any race: every outpost (Ironjaw Port, the Frostwood trade-embassy, the Sundale crossroads) houses a copy of the First Contract and a Neth garrison to tend it. Each outpost has developed a distinct character: Ironjaw-Port Neth are maritime-minded and feuding over tariff policy; the Frostwood-embassy Neth have grown fog-tolerant and keep dual journals (Sovereign Ledger and First Contract); the Sundale-crossroads Neth run the hottest (geothermal proximity slows the Fading) and are the most likely to Unravel. The High Neth-dominated outposts are rigid; the Hallowed Neth frontier-posts are fluid and experimental.`,
 meaningfulTradeoffs: 'Neth gain preservation and magical power through their pact with Morvane, but are tethered to physical copies of the First Contract, straying too far causes the Fading. The Unraveling offers freedom at the cost of self-destruction. Subrace flaws are binding: High Neth are bound by Morvane\'s authority and face harsh consequences for breach, Hallowed Neth break things they cannot see, and Pale Neth are legally non-existent.',
...
The Severing, the event that created the Pale Neth, occurred in the fourth century. Saren-Vel was a High Neth pact-caster of extraordinary power and increasingly visible Unraveling. She had lived long enough to feel the pact's weight as a cage, to understand that every contract she honored was another bar in the structure that held her frozen. Rather than let the Unraveling claim her, a slow, humiliating dissolution, she walked into the deepest part of the bog where the pact's authority thins and the preserving ichor runs pure. She carried a flame that consumed only ink, not paper. She burned her name from the First Contract itself.

When she walked out, she was still alive. Still pale-skinned. Still preserved. But the pact could no longer feel her, and she could no longer feel the pact. The silence where her name had been was so deep that every Neth within fifty miles felt the absence, like a held breath, like a missing heartbeat, like a word on the tip of the tongue that will not come. She was the first Pale Neth. She has not spoken a word in four hundred years, not because she cannot, but because what would she say, now that her words carry no weight?

The four centuries since the Severing have been defined by a slow, grinding tension between the three bloodlines. The High Neth consolidate power in Atropolis, refining contract-law into ever more precise instruments of control. The Hallowed Neth drift between the canopy and the outposts, reading the obligation-web, making their quiet bets on probability, never quite trusted and never quite controllable. The Pale Neth multiply in the shadows, not fast, but steadily, each Severing another name burned from the First Contract, another Neth who chose freedom at the cost of legal existence.
...
The pact holds. Morvane has never renegotiated the terms. But the oldest Neth, the ones who have returned seven times, ten times, fourteen times, report that Morvane's presence at the threshold feels different now. Colder. More distant. As if something else has its attention. As if the bargain is not the only one Morvane is honoring.
 ...
 {
  name: 'Saren-Vel',
  title: 'The First Pale Neth',
  portraitIcon: 'Undead/Icon3',
  backstory: `
Before she was the first Pale Neth, Saren-Vel was the most powerful High Neth pact-caster of her generation, a contract-lawyer and arcanist whose binding-clauses were so precise that Morvane itself had never found a loophole in her work. She drafted the trade-treaty that opened Ironjaw Port to the Solari. She wrote the inheritance-contract that resolved a three-century dispute between two competing High Neth bloodlines. She was, by any measure, the apotheosis of what a High Neth could become.
...
Saren-Vel did not disappear. She walked out of the First Contract Chamber, past the High Neth guards who could not touch her because no contract authorized them to, through the streets of Atropolis where Neth stared at her with expressions that had no precedent, and into the deep bog where the Pale Neth still gather. She has been seen periodically in the four centuries since, always at a distance, always silent, always watching something no one else can see. The Pale Neth revere her as their founder. The High Neth consider her the greatest legal crisis in Neth history, a person who exists outside the pact, and therefore outside the law, and therefore cannot be wrong about anything because "wrong" requires a standard she no longer acknowledges.
...
She has never spoken. No one knows if she still can.
 ...
 },
 {
  ...
  backstory: `
The Oracle of Atropolis is not a title. It is a person, always a High Neth, always female, always the eldest living Neth who has returned more times than any other. Lyra-Vel is the twelfth to hold the position. She has returned fourteen times: four illnesses, three accidents, five acts of violence, and two causes she refuses to disclose. Her death-count is the highest in recorded Neth history, and Morvane knows her voice.

Lyra-Vel does not read the future. She reads the First Contract, not the text, but the implications. She perceives the contract-graph the way Hallowed Neth perceive the obligation-web, but deeper, older, more structural. When a new contract is signed anywhere in the Neth trade network, she feels the shift in the pact's balance. When a contract is broken, she knows before the Debt-Revenant rises. When Morvane's attention wavers, as it has been doing, increasingly, in the last century, she is the first to notice.

The High Neth consult her before every major policy decision. She never tells them what to do. She tells them what the pact allows, what the pact forbids, and what the pact has never been asked before, and lets them draw their own conclusions. The youngest High Neth find her terrifying. The oldest High Neth find her comforting. Lyra-Vel herself finds both reactions mildly disappointing.
...
She has been writing a personal addendum to the First Contract for two hundred years, a document that no one else has been permitted to read. Some believe it is a record of every return, every threshold, every conversation with Morvane. Others believe it is a legal argument for the pact's dissolution, a case she is building so slowly that no one alive will see it filed. Lyra-Vel has never clarified. When asked, she says only: "Morvane has not asked me to stop writing."
 ...
 },
 {
  ...
  backstory: `
The most famous Hallowed Neth in Neth history made only one bet that anyone remembers, and he made it sixty-three years before Emberspire erupted.
...
Sixty-three years after his death, Emberspire erupted. The Neth trade-registry discovered, in the chaos of renegotiation, that the contingency clauses Orven-Sen had quietly inserted into three generations of warmth-resource contracts, clauses no one had noticed because no one read the fine print of a fined gambler's filing, were still legally active. The Neth saved an estimated four million gold-weight in renegotiation costs because a dead Hallowed Neth had been right sixty-three years ahead of schedule and had the patience to wait.
...
The bog is a sacred and terrifying place to the Neth. The High Neth refuse to enter it, not out of prohibition, but because the thinning pact-authority makes them feel physically ill, like a limb going numb, like forgetting a word they have used their whole life. The Hallowed Neth visit occasionally, to read the probability-web at its sparsest point and see what patterns emerge in the silence. The Pale Neth live here, or near here, small camps of the severed, sustained by foraging and hunting rather than the pact, trading with each other in a gift-economy that would appall any High Neth who witnessed it.

The exact spot where Saren-Vel performed the first Severing is unmarked. No one who has found it has ever described it. The Pale Neth who perform Severings here say that the flame must be prepared over at least a decade, extraction of pure annihilation, the inverse of the pact's preservation, and that the process is excruciating in a way that has nothing to do with pain. The name burns. The silence that follows is the first true silence the Neth has felt since birth. Most Pale Neth describe it as relief. A few describe it as grief.
  `
 },
 {
...
The second is the Unraveling. The number of Neth who have begun the Unraveling, breaking contracts in sequence, feeling the temporary freedom, inching toward dissolution, has tripled in the last fifty years. No one has published the statistics. The statistics exist; the Hallowed Neth can read them in the obligation-web, and the High Neth can find them in the Canopy-Ledger if they look. The cause is unclear. Some blame Morvane's distraction, a weaker pact is easier to break. Some blame the cultural stagnation, the young are rebelling because the old have been frozen for centuries and show no sign of thawing. Some blame the Severing itself, every name burned from the First Contract weakens the pact slightly, and there have been more Severings in the last century than in the three centuries before.

The third is the bloodline-fracture. The three subraces have always existed in tension, but that tension has been functional for eight centuries. Now it is becoming something else. The High Neth are consolidating power, they control the contract-halls, the trade delegations, the external diplomacy. The Hallowed Neth are withdrawing, fewer of them attend the contract-halls, fewer of them submit their probability-predictions for official record. The Pale Neth are multiplying, the Severing is becoming less rare, less stigmatized, more visible, and the High Neth have no legal mechanism to stop it because the Severing is not illegal. It simply removes the severer from legal existence, which makes prosecution impossible.

Somewhere in the deep bog, a Pale Neth elder, perhaps Saren-Vel herself, perhaps someone who has never spoken their name aloud, is preparing an argument. No one knows what it argues. No one knows to whom it is addressed. But the Hallowed Neth can feel it in the obligation-web: a new clause forming, a new contract being drafted, a new case being prepared. And the defendant has not yet been named.
 `,
...
The Neth do not love Morvane. They respect it the way a debtor respects a creditor who has been patient for eight hundred years. When a Neth returns from the threshold, pulled back from a near-death by the pact's preservation, they do not thank Morvane. They renegotiate their terms. A returned Neth owes a new clause in their life-contract: a restriction, an obligation, a promise they did not make but now must keep. The deaths are not gifts. They are loans, and the interest compounds.
 ...
 velun: {
  ...
  illustrationCaption: 'A High Neth male noble with solid black eyes and a silver circlet, wearing layered ghost-silk robes.',
  illustration2: '/assets/images/races/velun_illustration_2.png',
  illustration2Caption: 'A High Neth female noble with solid black eyes and long flowing silver hair with braided accents.',
  cultureIllustration: '/assets/images/races/velun_culture_birth.png',
  cultureIllustrationCaption: 'High Neth families and scholars gathered on a grand ironwood balcony looking out over misty canopy spires.',
  domesticIllustration: '/assets/images/races/velun_culture_education.png',
  domesticIllustrationCaption: 'Two High Neth scholars unrolling a massive ancient parchment scroll sealed with red wax over a contract-ledger in a gothic library.',
  visualDescription: `The inheritors of Morvane's authority carry the pact in their bearing. Like all Neth they are tall and slender, pale to the point of luminousness, with dark pool-like eyes, but a High Neth's eyes are often described as reflecting a contract-glyph spiraling slowly around the pupil that only they can see. Their colorless spider-silk hair is worn long under layered ghost-silk robes of pale, authoritative cut. Their chests do not visibly rise and fall with breath, the stilled mark of the pact made visible, and they move with the unhurried certainty of people whose every word may be enforced by a god.`,
  ...
  description: 'The original Neth bloodline, predating the Pale Neth Severing, in the fourth century of the Dimming. The inheritors of Morvane\'s authority. When a High Neth speaks the pact\'s words, the universe listens, their voice carries Morvane\'s cosmic weight, and their contracts are enforceable by the same entity that preserves their species. In exchange, their tongue is bound not to truth but to commitment: every promise they make, every statement of intent they utter, is a potential contract. Morvane does not care whether a High Neth speaks truth or falsehood; it cares whether the High Neth honors what was spoken. A lie that contradicts no prior commitment passes without notice. A promise broken, even one made casually, carries the full weight of the pact.',
  culturalBackground: `The High Neth trace their bloodline to the original scribes who presented the First Contract to Morvane, Vaelis the Scribe's direct descendants, generation by generation, clause by clause. They run Atropolis. They write the contracts that govern Neth society. They negotiate with the Solari, the humans, the Mimir, anyone who needs Neth preservation-craft or Neth memory-glass, and their negotiations are always, always binding.

High Neth children are educated in the contract-halls from the moment their pale skin stabilizes, usually around age five or six. They learn to read ancient scrolls and contract covenants before they learn to read spoken faces. They learn contract law before they learn ethics. They learn that every word they speak carries weight, and that weight accumulates, a careless promise at ten becomes a binding obligation at fifty, and Morvane does not distinguish between a child's protestation and an adult's oath.

A High Neth's power is their voice. When they invoke a clause aloud, a binding, a sealing, a cosmic enforcement, the pact responds. The air thickens. The light shifts. Everyone in the room feels Morvane's attention settle on the proceedings like a held breath. A High Neth who has perfected their craft can seal a contract with a single spoken sentence that no signatory can ever break, not without consequences that ripple across generations.

The flaw is inseparable from the gift. A High Neth's words carry weight: any statement made with intent becomes a potential contract, and Morvane enforces commitments rigorously. This does not mean they cannot lie. It means they think carefully before speaking, because a careless promise, a hypothetical casually offered, or a statement of intent uttered in passing may be treated by the pact as a binding clause. The oldest High Neth speak rarely. They choose every word like it costs them something, because it does. The youngest High Neth learn silence before they learn magic.

They view the Hallowed Neth with a mixture of admiration and unease, the Hallowed Neth see the web behind the text, the implications the High Neth cannot perceive, and that makes them useful and unpredictable. They view the Pale Neth with something closer to horror, the Pale Neth are what happens when a Neth decides the pact's weight is heavier than the silence, and the High Neth cannot process a choice that results in legal non-existence.`,
 ...
 kessen: {
  ...
  illustrationCaption: 'A Hallowed Neth male showing face markings, black neck runes, long red hair, and glowing white eyes.',
  illustration2: '/assets/images/races/hallowed_illustration_2.png',
  illustration2Caption: 'A Hallowed Neth female showing black runic neck tattoos, long red hair, and glowing white eyes.',
  cultureIllustration: '/assets/images/races/hallowed_culture_ruins.png',
  cultureIllustrationCaption: 'A Hallowed Neth scholar in a gothic library, studying an ancient book near leafy arches.',
  domesticIllustration: '/assets/images/races/hallowed_culture_altar.png',
  domesticIllustrationCaption: 'A Hallowed Neth scholar at a stone desk, studying magic scrolls while holding a simple drinking cup.',
  visualDescription: `The volatile spirit conduits. The Hallowed Neth possess a striking, smooth-skinned undead grace with a tall, slender silhouette. Their skin is a ghostly, smooth paper-white, marked by subtle glowing white mana-burn smudges around their solid white eyes and intricate, ink-black runic binding tattoos wrapping around their wrists and necks. Long, vibrant red hair falls over their shoulders. They wear elegant, tattered dark monastic wraps, and their hands drift with a soft, ghostly white mana mist.`,
  tooltipSummary: 'Smooth-skinned spirit conduits bound to abandoned castles and monasteries, hunting ancient texts to revert their undead curse.',
  description: 'The profane magi of the Well. Banished and punished for their bloodline\'s ancient sins—drinking raw, unshielded magic directly from the Well of Youth—the Hallowed Neth exist in a state of smooth-skinned, appealing undead grace. They gain no sensory pleasure or flavor from eating or drinking, consuming food and water purely for survival and sustenance, while deeply yearning for the living warmth they once knew.',
  culturalBackground: `Hallowed Neth society is a community of driven researchers occupying massive abandoned monasteries, forgotten castles, and ancient library outposts. Their capital is a colossal, slightly restored ruined monastery-fortress built around a vault of lost knowledge. Bound by ink-black runic tattoos to keep their spirits anchored, they relentlessly hunt and collect ancient texts, lost scrolls, and runic scriptures from across the world, seeking a way to cure their condition and revert their undead state so they can feel the pleasure of living once more.`,
  ...
  traits: [
  {
   ...
   effects: [
    ...
    description: 'Other creatures with supernatural perception, other Hallowed Neth, certain Wyrd-creatures, Morvane itself, can see the threads connecting you to your obligations. Your loyalties, your debts, your broken promises are visible in the web to anyone who knows how to look.',
 ...
 drun: {
  ...
  description: 'Founded in Year ~380 of the Dimming by Saren-Vel, who walked into the deepest bog with a flame that consumed only ink and burned her name from every active copy of the First Contract. The Pale Neth have been legally nonexistent for ~420 years. The inheritors of Morvane\'s silence. Through the Severing, a traumatic fire-ritual that burns their name from every active copy of the First Contract, the Pale Neth have removed themselves from the pact entirely. They are magic-resistant, debt-null, invisible to Morvane\'s enforcement. They are also legally non-existent: no property, no marriage, no testimony in a Neth court. Their freedom is absolute. Their vulnerability is absolute.',
  culturalBackground: `The Pale Neth were not meant to exist. The original pact made no provision for Neth who might wish to leave it, the terms were binding in perpetuity, and "per perpetuity," in Neth contract law, means "until Morvane releases you, and Morvane has never released anyone."
...
The Pale Neth live in hidden bay outposts and stilt-dock settlements across the Drun Fen. Operating like a syndicate of thieves and shadow-traders, their outposts are built from sturdy ironwood beams and stone warehouses on water-stilts. They operate out of the shadow of Neth law, running illegal trade networks, smuggling contract-relics, and making informal, trust-based promises that appall the High Neth. A Pale Neth who breaks a promise faces only the disappointment or violence of their syndicate, not Morvane's enforcement.

They serve as the Neth's shadow class: couriers across dead zones where the Archive-Tether doesn't reach, assassins who leave no mycelial trace, guides through the deep bog where no High Neth would survive the thinning pact-authority. They are the only Neth who can operate outside the trade network, because they carry a copy of the First Contract with their name still visible but the *connection* burned, the document acknowledges them without binding them. It is the closest thing to freedom the Neth have ever achieved.

The flaw is absolute. A Pale Neth is legally non-existent under Neth law. They cannot own property, anything they hold is, legally, abandoned. They cannot marry, no contract can bind them, and no contract will protect their partner. They cannot testify in a Neth court, their words carry no pact-weight, and a High Neth judge has no mechanism to evaluate testimony that is not backed by Morvane's authority. A Pale Neth can be killed without legal consequence, because no contract names them as protected.

They are also severed from the pact's preservation. A Pale Neth must eat, drink, and sleep like any warm-blood. They age, slowly, the pale skin dulls over centuries, the dark eyes fade, the Stillness no longer restores them. They are the only Neth who will eventually die of old age, and none have lived long enough yet to know how long that takes.

They view the High Neth with something between pity and contempt, the High Neth are powerful and trapped, and the Pale Neth remember what it felt like to be both. They view the Hallowed Neth with a strange, wistful recognition, the Hallowed Neth can see the Pale Neth in the obligation-web as *absences,* holes where a thread should be, and the Pale Neth can feel the Hallowed Neth watching. Neither speaks of this. Neither needs to.`,
  statModifiers: { agility: 2, intelligence: 1, spirit: -1 },
  traits: [
  {
   id: 'severed_drun',
   name: 'Severed',
    description: 'Advantage on saving throws against spells and magical effects, and immunity to Morvane\'s enforcement (the Debt-Revenant cannot target you, High Neth Clause of Binding cannot bind you, and the Unraveling cannot affect you). You suffer disadvantage on social checks with High Neth and, severed from the pact\'s preservation, must eat, drink, and sleep normally and will eventually age to death. (Your name is burned from every copy of the First Contract; the pact cannot feel, bind, or protect you.)',
   level: 1,
   ...
   effects: [
    {
     ...
     description: 'Advantage on saving throws against spells and magical effects. The pact cannot reach you, magic that would bind, enforce, or compel a High Neth or Hallowed Neth slides off you like water off still glass. and, you are immune to Morvane\'s enforcement mechanisms (the Debt-Revenant cannot target you, you cannot be bound by a High Neth\'s Clause of Binding, and the Unraveling cannot affect you).',
  ...
  },
  {
   ...
   effects: [
    ...
    description: 'You cannot give testimony in a Neth court. Your voice carries no pact-weight. Among the High Neth, your words are legally meaningless, you cannot serve as a witness, sign a contract, or testify to anything. Among non-Neth, this carries no penalty, but among the pact-bound, you are a silence where a voice should be.',
