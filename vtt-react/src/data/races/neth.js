...
The four centuries since the Severing have been defined by a slow, grinding tension between the three bloodlines. The Velun consolidate power in Atropolis, refining contract-law into ever more precise instruments of control. The Kessen drift between the canopy and the outposts, reading the obligation-web, making their quiet bets on probability, never quite trusted and never quite controllable. The Drun multiply in the shadows, not fast, but steadily, each Severing another name burned from the First Contract, another Neth who chose freedom at the cost of legal existence.
...
The Neth do not love Morvane. They respect it the way a debtor respects a creditor who has been patient for eight hundred years. When a Neth returns from the threshold, pulled back from a near-death by the pact's preservation, they do not thank Morvane. They renegotiate their terms. A returned Neth owes a new clause in their life-contract: a restriction, an obligation, a promise they did not make but now must keep. The deaths are not gifts. They are loans, and the interest compounds.
 ...
 velun: {
  ...
  illustrationCaption: 'A Velun Neth noble in layered, high-collared ghost-silk robes, standing before the arches of Atropolis.',
  illustration2: '/assets/images/races/velun_illustration_2.png',
  illustration2Caption: 'A Velun Neth noble holding an inscribed staff, straight silver-white hair flowing against gothic spires.',
  cultureIllustration: '/assets/images/races/velun_culture_birth.png',
  cultureIllustrationCaption: 'A Velun Neth parent using a silver stylus to write a birth-contract for a newborn child in a woven spider-silk crib.',
  domesticIllustration: '/assets/images/races/velun_culture_education.png',
  domesticIllustrationCaption: 'A Velun Neth elder educating a young, pale, hairless child on a glowing memory-glass tablet in a gothic library spire.',
...
They view the Kessen with a mixture of admiration and unease, the Kessen see the web behind the text, the implications the Velun cannot perceive, and that makes them useful and unpredictable. They view the Drun with something closer to horror, the Drun are what happens when a Neth decides the pact's weight is heavier than the silence, and the Velun cannot process a choice that results in legal non-existence.`,
 ...
 kessen: {
  ...
  illustrationCaption: 'A Kessen Neth seer holding a golden thread of probability with a gentle, knowing smile, dressed in green and gold robes.',
  illustration2: '/assets/images/races/kessen_illustration_2.png',
  illustration2Caption: 'A Kessen Neth seer displaying a manipulative, knowing smile with a network of threads webbed behind him.',
  cultureIllustration: '/assets/images/races/kessen_culture_gamble.png',
  cultureIllustrationCaption: 'A Kessen Neth gambler dealing glyph-inscribed cards at a stone table with a lantern, manipulating the threads of fate.',
  domesticIllustration: '/assets/images/races/kessen_culture_study.png',
  domesticIllustrationCaption: 'A Kessen Neth father teaching his young daughter how to weave glowing golden threads of probability in their cozy study room.',
  visualDescription: `The seers of probability and weavers of the obligation-web. The Kessen share the tall, pale frame of the Velun, but possess a more expressive, knowing, and playful countenance. They wear elegant robes of desaturated gold and dark green rather than rigid silk layers, and their long, delicate fingers move with a gambler's grace, teasingly holding and plucking glowing golden threads of fate. Their eyes possess a faint, calculating shimmer as they read the speculative futures of everyone around them, smiling at secrets not yet written.`,
  tooltipSummary: 'Ethereal seers and speculative weavers who play with the threads of probability, calculating fate with a knowing smile.',
  description: 'The seers of Lumia\'s legacy. Unlike the rigid, authoritative Velun Neth who enforce written contracts, the Kessen treat the universe as a speculative puzzle of probability. They trace the shimmering threads of the obligation-web with a knowing, playful curiosity, plucking and nudging variables to bend fate to their liking. Though their demeanor is less severe than the Velun, their manipulation of probability is absolute: they gamble with the future, knowing exactly which threads to pull to get what they want.',
  culturalBackground: `The Kessen are the Neth who play between the lines. While the Velun govern through formal contract law and rigid structures, the Kessen are oracle-calculators who treat fate like a game of chance and manipulation. They operate in high-end gambling dens, trade-halls, and archive spires, playing with cards marked with shifting silver probability glyphs. Kessen society encourages speculation and intellectual gamesmanship. They do not write the law; they calculate how to bend it, nudge variables, and play with the threads of promises. Their long fingers unconsciously twist and weave glowing golden threads of fate in the air, smiling at the private secrets of the past and future debts they see written on every soul. This playful, calculative nature makes them master negotiators, but beneath the smile lies a cold, mathematical manipulation: they know exactly what every thread is worth, and exactly who will pay when it snaps.`,
 ...
 drun: {
  ...
  illustrationCaption: 'A Drun Neth outcast portrait with short hair, dull grey-pale complexion, and weary, vigilant eyes, dressed in simple dark clothing.',
  cultureIllustration: '/assets/images/races/drun_culture_swamp.png',
  cultureIllustrationCaption: 'A Drun Neth ranger holding an iron spear, cautiously stalking through a dark, mossy bog in Bryngloom Forest.',
