...
The pact holds. Morvane has never renegotiated the terms. But the oldest Neth, the ones who have returned seven times, ten times, fourteen times, report that Morvane's presence at the threshold feels different now. Colder. More distant. As if something else has its attention. As if the bargain is not the only one Morvane is honoring.
 ...
 notableFigures: [
 {
  ...
  backstory: `
Before she was the first Pale Neth, Saren-Vel was the most powerful High Neth pact-caster of her generation, a contract-lawyer and arcanist whose binding-clauses were so precise that Morvane itself had never found a loophole in her work. She drafted the trade-treaty that opened Ironjaw Port to the Emberth. She wrote the inheritance-contract that resolved a three-century dispute between two competing High Neth bloodlines. She was, by any measure, the apotheosis of what a High Neth could become.
