export const vreken = {
 ...
 cardFlavor: 'Amber-eyed crypt-speakers who lived in phosphorescent darkness long before the sun perished above.',
 description: `**[The Lantern-Eyed Crypt-Speakers]**, *Leaning into the damp peat-stone of the Sunken Spire, a scout with wide, glowing amber eyes traces the bioluminescent trail of a fungal spore through the lightless catacombs.*

There were eyes in the Bryngloom Forest before the sun died. Before the Neth wrote their first contract. Before Keth-Amar's bargain rippled outward from Emberspire and froze the surface world solid. The Vreken were already there, tending their phosphorescent fungi in the deep bog-caves, navigating mycelial-lit darkness by the soft amber and silver of their own eyes. When the sun perished and the surface world joined their darkness, the Vreken were not surprised. They were not afraid. They were simply the only people in the world who had been living the life everyone else was about to inherit.`,
 icon: 'fas fa-eye',
 overview: `The Vreken were the Bryngloom Forest's first inhabitants. The Neth arrived later, with their bargains and ledger-debts, but the Vreken were already here, cultivating light in the cave-dark, reading the trails that living things leave behind when they forget they are being watched.

They are a compact people, standing between dwarf and human height, with wiry builds and long-fingered hands adapted to harvesting delicate fungal filaments from cavern walls. Their ears curl at the tips, not elven, not human, simply Vreken. Their most distinctive feature, the one that has haunted human folklore for centuries, is their eyes: they glow. A soft, steady bioluminescence, rust-amber among the Deep-Glow kin, silver-white among the Ghost-Mycelium kin. The light is not magic. It is biology, a trait evolved over millennia of navigating fungal-lit caverns where sunlight never reached. They do not see in darkness; they bring their own.

What they see is the trail: the residual luminescence left by passage. Footprints glow for hours. A recent death shimmers like heat-haze. Infection blooms beneath unbroken skin. The emotional heat of a lie flickers. The approaching weather is written in the air before it arrives. Other races rely on eyesight, but the Vreken rely on what the living leave behind. To their eyes, the world is a palimpsest of passage, every creature, every death, every truth written in light that only they can read.

The strigoi rumor is a human invention. They saw Vreken lantern-eyes flickering through bog-mist and assumed they were risen dead, "grave-lights" that appear where people are dying. The truth is simpler and stranger: the Vreken can see death-trails, and death-trails are bright to them. They arrive at the dying because they see the light going out from twenty miles away, not because they caused it. The humans of the Gloom never quite believed them, and the superstition follows the Vreken into regions that know them only by rumor.

They are not a cursed people. They are not transformed. They are a distinct species, older than the Neth, older than the noble families, older than the sun's death. Their lantern-eyes are their birthright. Their trail-sight is their inheritance. And their greatest tragedy, the Over-Lit, the ones who chased the fungal-hush too far and burned out from within, is not a flaw in the design. It is the cost of living with a light that never goes out.`,
...
The Inquisitors are the Vreken who hunt their own. When an Over-Lit progresses beyond recovery, when the hush has hollowed them out completely and they have become a danger to others, the Inquisitors are called. They are Marked Vreken who have trained their trail-sight to track their own kind. They are feared, respected, and deeply isolated. To kill a kinsman, even one already lost to the hush, is a burden that no Clean Vreken, those of the Deep-Glow bloodline, immune to the hush, can truly understand.
...
The Neth and the Vreken share the Bryngloom Forest and barely speak. The Neth view the Vreken as archaic, sentimental, a people who surround themselves with glowing dead relatives when they could be running a trade empire. The Vreken view the Neth as spiritually bankrupt, death is a transaction to them, not a continuation. Their relationship is functional: trade routes, shared borders, fungal-light exports to Neth grave-cities in exchange for bog-preserved goods and cold-iron tools. Neither defers to the other. Neither particularly wants to.
...
To the humans of the Bryngloom Forest, the Vreken are the grave-lights: lantern-eyed monks who live in upside-down cathedrals and sing to their dead. Their medicine is the best in the known world. Their price is reasonable. But being treated by a Vreken means lying on a stone slab in a mausoleum, ancestors glowing softly from every wall, while someone with too many joints and silver-glowing eyes reads the death-trail forming on your skin like a map of a road you haven't finished walking yet. It works. It is terrifying. And the humans come anyway, because the alternative is worse.`,
 ...
 classCompatibility: 'The Clean favor Animists, Inquisitors, and Wardens, utilizing their immunity to the fungal-hush and their steady rust-amber sight to channel ancestral spirits, purge corrupt presences, and track down those kin who have succumbed to the Over-Lit sickness. Plaguebringers arise from Clean who have studied the hush not to resist it but to weaponize it, turning fungal substrate against the enemies of the Bryngloom. The Marked favor Augurs, Revenants, and Apex, utilizing their highly sensitive Ghost-Mycelium sight to read death-trails from miles away, track quarry through the deepest subterranean paths, and interpret the final echoes of the departed.'
 },

 diasporaVariation: `Vreken diaspora is sparse but old, lantern-eyed crypt-speakers serve as death-workers and ancestral-consultants in every region's burial grounds. A Nordhalla-Vreken (serving the Frozen Archive's glacier-tombs) has adapted to the cold their southern kin cannot bear, their bioluminescence dimmed to a faint blue that the glacier-ice amplifies. A Sundale-Vreken is rare and grim, the volcanic heat distresses their fungal-bonded skin, and they cluster in the deep ash-tombs beneath the Ashen Escarpment. The Bryngloom remains the only region with a large Vreken population; elsewhere they are solitary practitioners, respected, avoided, and slowly losing their Root-Veil connection the further they roam.`,
 meaningfulTradeoffs: 'Vreken gain unparalleled sensory abilities through their lantern-eyes and trail-sight, but their bioluminescence makes stealth difficult and their proximity to death carries an emotional toll. The Marked and live with the constant threat of the Over-Lit addiction.',
 ...
 "id": "hush_vulnerability_vreken",
  ...
  "description": "Vulnerable to the Ghost-Mycelium fungal hush. Prolonged exposure or stress requires saves against the Hush addiction.",
  "level": 1,
 ...
 effects: [
  ...
  description: 'After experiencing a final heartbeat, the echo disorients you. You cannot take reactions until the end of your next turn as the death-moment reverberates through your fungal bond. and, you suffer 1 wyrd damage, the cost of carrying another\'s last breath in your own lungs.',
...
The strigoi myth, the belief that the Vreken are undead, that their lantern-eyes are grave-lights that drain the living, began in the fourth century after the sun's death. Human refugees, fleeing the increasingly hostile Freeze-Front, began settling the Bryngloom Forest's safer edges. They encountered the Vreken for the first time and immediately made the wrong connection: lantern-eyes in the dark, death-trails visible to Vreken senses but not human ones, Vreken healers arriving at dying settlements before news spread because they had seen the death-trails forming from twenty miles away. The humans assumed the Vreken were causing the deaths. The Vreken, unused to explaining their biology to people who could not perceive it, did not, could not, correct them. The rumor calcified into folklore. It still follows them into regions that have never seen a Vreken but have heard the stories.

The Over-Lit epidemic began in the fifth century. With the Neth's trade networks bringing surface goods into the Gloom for the first time, Vreken fungal exports became valuable currency. Harvest intensified. Exposure intensified. The first recorded case of the hush, a Marked Veil-Speaker named Aedris who pressed raw Ghost-Mycelium pulp to her eyes during a prolonged crypt-vigil and was found three days later, still glowing, still singing, but no longer able to recognize her own reflection, sent a tremor through Vreken society that has never fully settled. The Inquisition was founded within a decade of the first recorded Over-Lit case, in the fourth century of the Dimming. The Clean began their drift toward leadership positions during the fifth century, their biological immunity translating into political dominance.

The Vreken have never had a war. They have never had a king. They have never been conquered. The Bryngloom Forest is too deep, too dark, too labyrinthine for any surface army to navigate, and the Vreken themselves are too distributed, too entrenched in their crypt-cathedrals, too difficult to find. They are the only race in the Ethnologue that has survived without violence, without imperialism, without a great leader or a unifying crisis. Their history is not a record of battles. It is a record of light, who glowed, who dimmed, who over-lit, and who is still burning.
 `,
...
The Marked have never forgiven her. The Clean have never stopped citing her. Isara herself, according to the crypt-records, spent her final years in the Sunken Spire's deepest chamber, tending Aedris's eternal silver glow, and writing nothing at all.
 ...
 description: `The intellectual center of the Bryngloom Forest, where Vreken Inscriptors carve historical genealogies and trail-readings onto compressed fungal-wood tablets using glowing Ghost-Mycelium stylus-points. It is heavily controlled by the **Clean**, who enforce strict access regulations on the heretical or volatile Marked scholars, restricting them from reading the oldest ancestral archives.`
 },
 {
 name: 'The Over-Shanty',
 description: `At the edges of every cathedral-complex sits the Over-Shanty, a squalid shantytown of the **Over-Lit**, those Marked Vreken whose trail-sight has been burned away by spore-addiction (the hush). The shanties are a constant reminder of the physical and psychological toll of Vreken biology, heavily patrolled by the Inquisition who monitor kinsmen for the final hollowing.`
 }
 ],

 currentCrisis: `The central crisis is the fracturing of the unspoken Clean-Marked hierarchy. The **Marked** have begun the **Bright-Speaking**, a heretical political movement demanding scriptorium access and an end to the Clean's monopoly on leadership. Tensions are peaking as a Marked coven prepares to force entry into the deepest galleries of the Hollow-Scriptorium to prove the Over-Lit epidemic was engineered, while Neth merchants watch the instability, preparing to exploit any slip in the fungal-light trade.`,
...
Death rites are simple and grueling. The dying Vreken is carried to the nearest Sunken Spire and laid in the crypt-chamber that corresponds to their bloodline and generation. The Veil-Speakers wrap the body in a living fungal shroud, a sheet of cultivated Deep-Glow or Ghost-Mycelium, depending on the deceased's bloodline, and begin singing their name into the rotation. The body is not buried. It is not burned. It is left on the crypt-shelf, wrapped in its shroud, and the family trusts that the fungal bond will produce light for as long as the deceased's bloodline remembers them. A Vreken whose name is no longer sung goes dark. A Vreken whose name is sung every rotation for a thousand years continues to emit a faint, steady glow, the same color as their eyes in life, and just as difficult to look away from.
 ...
 tooltipSummary: 'Death-calmed crypt-speakers who have made peace with the brightening, moving through the world with steady deep-glow blood and untraceable silence.',
...
The Clean rarely leave the Bryngloom Forest. When they do, they travel in monastic vestments, dark cassocks with fungal-thread embroidery marking their bloodline and vocation, and their rust-amber eyes draw stares in human settlements, Neth trade-hubs, and Emberth forge-halls alike. The Clean are accustomed to being stared at. They are not accustomed to being doubted.`,
 ...
 name: 'Marked',
 illustration: '/assets/images/races/vreken_illustration.png',
 illustrationCaption: 'A compact Vreken monk in gothic monastic vestments with curled ear tips and glowing lantern-eyes.',
 tooltipSummary: 'Ghost-sighted beacon-carriers whose branded eyes blaze with amplified death-sight, tempting the Hush with every step they take.',
...
Marked children learn to read the trail before they learn to speak, their Ghost-Mycelium sight is active from birth, silver-white pinpoints flickering in the cradle. By the time a Marked child can walk, they are already tracking: the pet they lost, the parent who left, the trail of the Veil-Speaker who visited yesterday. They are taught to dim their eyes, a skill the Clean never need to practice, and most never fully master it. A Marked's lantern-eyes flicker with their emotions, flare with their anger, dim with their grief. They are the most honest people in the Bryngloom Forest, and the most exposed.
...
The Marked rarely serve as trade delegates or diplomatic envoys. Their eyes are too bright, they unsettle human merchants, make Neth negotiators uncomfortable, and remind the Emberth of something their Sun-Speakers have been prophesying for centuries but will not name. When a Marked leaves the Bryngloom Forest, it is because they have chosen to, and the choice marks them as someone who has accepted that the outside world will stare and flinch and reach for iron that does not burn them but still, somehow, hurts to look at.`,
 ...
 },
 {
  ...
  name: 'Root-Veil Echo',
  description: 'The Ghost-Mycelium bond that gives you superior trail-sight does not merely read the present, it echoes the recent past like a stone dropped in still water, the ripples visible long after the impact has vanished. Once per long rest, you may touch a surface in a location where events occurred within the last hour and experience an echo: you learn what creatures were present, their emotional states, and a shadow of their intent, enough to know whether they meant harm, whether they were fleeing, whether they were searching. The echo does not reveal faces or exact words, only the shape of what happened, written in the trail\'s own language. But every echo pulls at the root, you gain 1 level of Exhaustion after using this ability, a cost paid not by the body but by the fungal bond itself, which must regrow the tendril you burned to reach backward through time.',
  level: 1,
  icon: 'spell_shadow_deathanddecay',
  spellType: 'ACTION',
