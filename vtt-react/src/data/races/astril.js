...
Now the ritual continues. The Selunis-rite is performed every night in scattered moon-courtyards across Mythrill, and the Astril tend it with the devotion of a people paying a debt they can never repay. They brought the predator to this world. They will spend every night they have left making sure it does not finish what they started.
    ...
    subraces: {
        vashir: {
            ...
            illustrationCaption: 'A Vashir Astril portrait showing their unique segmented bone-ridges sweeping back from the brow and glowing violet eyes.',
            illustration2: '/assets/images/races/vashir_illustration_2.png',
            illustration2Caption: 'A Vashir Astril portrait variation highlighting a different bone-crest structure and traveler gear.',
            cultureIllustration: '/assets/images/races/vashir_culture_farm.png',
            cultureIllustrationCaption: 'A Vashir Astril farmer with sweeping segmented bone-crests tending to glowing moonlit bulb crops in the fields.',
            domesticIllustration: '/assets/images/races/vashir_culture_home.png',
            domesticIllustrationCaption: 'A Vashir Astril family displaying different bone-ridge shapes gathering for a meal inside their woven vine dome-house.',

            visualDescription: `The most physically grounded of the Astril, the Vashir carry Lumia's heritage in their athletic, earless frame. Segmented bone-ridges, acting like natural horns, sweep back from their brows over a hairless, sleek skull. Their smooth skin is a soft, dusty-blue, and their large pupil-less eyes glow with a soft violet light. They run cooler than any Mythrill-born people, and favor practical layered work-clothes stained with the soil of moonlit fields.`,
        ...
        silath: {
            ...
            illustrationCaption: 'A Silath Astril portrait showing their translucent pearlescent-white skin, quartz crystalline tiara, and nebula eyes.',
            illustration2: '/assets/images/races/silath_illustration_2.png',
            illustration2Caption: 'A Silath Astril portrait variation highlighting their starlight-filament hair and delicate quartz crest.',
            cultureIllustration: '/assets/images/races/silath_culture_study.png',
            cultureIllustrationCaption: 'Two short, star-hobbit-like Silath Astril scholars studying celestial maps on an observatory balcony.',
