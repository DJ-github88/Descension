...
The assassination economy is the shadow cast by this light. Kill an Astril, and their spirit may choose you. Murder a noble whose bloodline has carried the Dragon-Sign for twelve generations, broadcast your faith as they die, and if your belief is genuine enough — truly genuine, not performed — the Dragon enters you. The Synod, the ruling council of the oldest constellation-bloodlines, condemns this publicly and practices it privately. Every Astril of means maintains a cadre of spirit-guards: devout warriors whose primary function is to be more faithful than any potential assassin, ensuring the spirit goes to them instead. Every noble child is raised alongside a "companion of the blood" — a peer trained from infancy to believe harder, pray louder, glow brighter. The companions are not friends. They are insurance.

The spiritless — called the Unlit — are born without a constellation. No patterns. No whisper. No voice. Their skin is dark in every darkness, their faith produces no glow, their deaths release nothing. The Synod's doctrine holds them as cursed: souls too hollow to attract a spirit's attention, vessels too flawed to hold the divine. The Unlit themselves believe otherwise — they say the spirits simply passed them over, that emptiness is not failure, that a life without the whisper is not a life unlived. They serve in the margins: herders, couriers, midwives, morticians. They are the only Astril who can lie without their skin betraying them, and this makes them invaluable to the Synod's intelligence networks — and deeply, permanently distrusted by everyone else.
...
Throat-singing is their sacred art. Every Astril learns to produce multiple tones simultaneously — a low drone that soothes agitated spirits, a high overtone that carries across the steppe for miles, a harmonic blend that mimics the voice of the constellation within. Astril mothers throat-sing to their unborn children to help the infant spirit recognize its vessel. Astril mourners throat-sing at burial mounds to guide the departing spirit toward a worthy host. Astril assassins throat-sing as they work — the spirit cannot whisper over the sound of its own song.

Their relationship with the Emberth of Sundale is the deepest theological schism in the known world. The Emberth are Sol's chosen — sun-reverent forge-clans who received prophecy from the dying god before the binding. The Astril carry Sol's ministers — the court that served beneath the sun. Some Emberth revere the Astril as sacred: living relics of the celestial order, proof that Sol's court endured. Other Emberth despise them: the ministers fled while Sol was entombed, and a servant who abandons their sovereign deserves no sanctuary. Every Emberth forge-clan is split on this question. Every Astril who meets an Emberth does not know whether they will be embraced as a holy vessel or struck down as a living blasphemy.
...
And Keth-Amar — the predator, the hunger beneath Emberspire — knows the Astril exist. The spirits they carry are the ones that escaped. The predator has not forgotten. When its influence stirs — near a Sundered Monolith, near Emberspire's caldera, near Wyrd-creatures that serve it — Astril patterns writhe and recoil. The spirit remembers what ate its kin. The Astril are living detectors of the predator's presence. Some call this a gift. Others call it a beacon.`,
    ...
    integrationNotes: {
        ...
        classCompatibility: 'The Sylen favor Augurs (Seer specialization), Berserkers, Animists, Martyrs, and Minstrels because their total embrace of the constellation-spirit grants them wild premonitions, untamed physical fury, and the ability to channel celestial frequencies through song and sacrifice. The Muren, who suppress the spirit within, favor Wardens, Apex, Spellguards, False Prophets, and Animists, using strict mental discipline to build walls around the passenger, guard thresholds, and direct the trapped starlight into defensive arrays and ancestral bindings.'
    },
...
Now, centuries later, the Astril endure. The Luminarchy still rules. The Synod still schemes. The assassination economy still churns. The Unlit still wait in the margins for a spirit that may never come. And Keth-Amar — the predator, the hunger, the thing that ate their gods — still feeds beneath Emberspire, still growing stronger, still remembering that some of the constellations escaped.
    ...
    subraces: {
        ...
        muren: {
            ...
            tooltipSummary: 'Soul-fortress ascetics who learned to wall their presence and contain the spirit\'s overflow, suffering divine rejection for their fortress discipline.',
                        ...
                        effects: [
                            {
                                ...
                                description: 'While active: divine healing received is halved — the spirit resists what it perceives as further containment. Disadvantage on Persuasion checks — your muted presence seems hollow, untrustworthy, wrong.',
                                statusEffect: {
                                    level: 'moderate',
                                    description: 'The spirit resists divine light; your muted soul unsettles onlookers',
                                    healingModifier: { type: 'divine', magnitude: 0.5, magnitudeType: 'multiplier' },
                        ...
                        effects: [
                            {
                                ...
                                description: 'Divine and holy healing is halved — the spirit perceives holy energy as a cage and rejects it. Cannot benefit from Bardic Inspiration or morale effects — your walls are too thick, and inspiration cannot find purchase on a mind that has spent a lifetime refusing entry.',
                                statusEffect: {
                                    level: 'major',
                                    description: 'The spirit rejects divine light; your walls keep out inspiration as efficiently as they keep in the star',
                                    healingModifier: { type: 'divine', magnitude: 0.5, magnitudeType: 'multiplier' },
