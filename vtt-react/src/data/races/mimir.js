...
The Mimir share the Frostwood Reach with the Briaran — thorn-blooded descendants of the erased House Viridane who refused the Dark Bargains entirely. The two peoples coexist in the same mist-choked forests but rarely interact directly: the Briaran follow the old ways in the deepest ironwood groves, bound by fae contracts rather than mask-tradition, and regard the Mimir's fetch-bond as something between an alliance and an infection. The Mimir, for their part, view the Briaran's symbiotic thorns with wary recognition — another people who wear their bargains visibly, and who pay for their survival every day.`,
        ...
        integrationNotes: {
            ...
            classCompatibility: 'The Mask-Borne favor Animists, Augurs, and Lunarchs, using their inherited masks and canopy archives to channel ancestral spirits, read starlight portents, and commune with ancestral memories. The Mist-Woven favor Apex, Wardens, Shapers, and Spellguards, employing their physical agility and storm-glass masks to patrol cliff-borders and channel mist-concealment into defensive barriers. The Unwoven favor Toxicologists, Plaguebringers, Animists, and Harbingers, relying on deep-floor fungal poisons, homebrew remedies, and the desperate, maskless freedom of the valley floor to survive.'
        },
