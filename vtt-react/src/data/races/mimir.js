...
The art of mask-forging was lost during the Purge, when inquisitors burned the birthing chambers and killed the last Mask-Mothers who knew the craft. Every mask in existence is a relic. This scarcity created the Rupture — in the third century of the Dimming (~Year 240), triggered by the Wyrd incursion that destroyed the birthing chambers (~Year 220), when inheritance laws decreed that only first-born children could receive their mother's mask, the Mimir shattered into three subraces. The Mask-Borne claimed the canopy-holds and became aristocracy. The Mist-Woven were pushed to the mountain aeries and became sentinels. The Unwoven — those born without masks, or who lost them — drifted to the floor and became something else entirely.
