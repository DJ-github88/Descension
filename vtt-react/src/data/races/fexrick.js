export const fexrick = {
    // Naming convention: "Fexric" = singular collective noun (the race as a whole).
...
Their architecture is practical, exposed, and glowing. Nothing is hidden behind walls in a Fexric holdfast, because you might need to fix it. Pipes run openly along ceilings. Gears and valves are visible, accessible, and cleaned regularly. Elevator-cranks occupy the center of every major chamber. Ventilation shafts are wide enough to crawl through for maintenance, and narrow enough that nothing larger than a Fexric can follow. The holdfasts descend around geothermal vents in tiered galleries, lit by the orange glow of volcanic heat and the cold blue pulse of bioluminescent mineral deposits and alchemical indicator lights. The sound of hammering echoes through every level. The air moves, always. A Fexric holdfast with still air is a holdfast in crisis.`,
    ...
    integrationNotes: {
        ...
        classCompatibility: 'The Guild-Bound favor Arcanoneers, Spellguards, Chronarchs, and the sealed-alembic Pyrofiends, utilizing their formal education, precision gear-craft, and proprietary blueprints to bind spells in legal syntax, construct defensive arrays, manipulate temporal gears, and stabilize a furnace with grafted cooling valves and thermal thresholds. The Clan-Free favor Arcanoneers, Shapers, Gambit, and Plaguebringers, weaving volatile salvage into unsanctioned combination work and relying on alchemical runoff, homebrew nerve-grafts, and reckless improvisation to survive in the sump-markets outside the guild protections.',
    ...
    diasporaVariation: `The Fexric are the most widely diasporic non-human race because they built, and maintain, the geothermal infrastructure connecting every region. Clockwork Fexric guild-halls exist in every capital (Merrowport, Greymark, Atropolis, the Frozen Archive, Harath-Vault, Synod Hold), each staffed by Clockwork Fexric who have lived local for generations and speak the local tongue with a Fexric accent. These diaspora Clockwork Fexric are culturally flexible in a way the Frostmaw-pure Clockwork Fexric distrust. The Caustic Fexric clan-nomads roam between all regions on maintenance-circuits and are functionally a trans-national people, a Caustic Fexric speaks seven regional dialects and claims no capital.`,
...
Now the oldest machines are failing faster. The oral traditions are degrading. The Deep Alchemists have been quietly rebuilding their laboratories, and reports from the lower sumps suggest they have captured fresh Thrumm broodlings. The Orthodoxy debates endlessly and does nothing. The Guilds hoard their songs. The Clan-Free improvise with whatever the Guilds discard. The Fexric have been fighting the slow death of their world for so long that they have become what they fought: hollow maintainers of a machine they can no longer build, singing songs they no longer understand, creating monsters (the Groven, the Fexrick, the Deep Alchemists' next experiment) in the desperate hope that something new will save them from something old. The abyss they gazed into has been gazing back for centuries, and they have learned to recognize its face because it is their own. And somewhere in the oldest holdfast, the first turbine, the one that has been running for eight thousand years, has begun to make a sound that is not in any of the songs, and no one knows what it means.
    ...
    subraces: {
                ...
                },
                {
                    ...
                    buffConfig: {
                        ...
                        effects: [{
                            id: 'guild_secret',
                            name: 'Guild Secret',
                            description: 'Once per long rest, reaction to turn a failed mechanical check within 30ft into a success. The secret is spoken, other Clockwork Fexric will know you shared it.',
        ...
        drall: {
            ...
            description: 'The Caustic Fexric are Fexric outside the corporate guild system. Rather than adopting the rigid mechanical clockwork of the Clockwork Fexric, the Caustic Fexric specialize in unstable, fluid-based neural-alchemy and chemical improvisation. Their beards are wild, messy, and soot-stained, and their cybernetic replacements are custom-built alchemical grafts: chemical-injectors, pressurized glass retorts, and copper-valve distribution lines integrated directly into their bodies. They live in the deep sump-tunnels, salvaging the alchemical runoff discarded by the corporate holdfasts above.',

            culturalBackground: 'Caustic Fexric culture is built on survival chemistry and alchemical rebellion. They do not have the luxury of proprietary blueprints; they have bubbling flasks, glowing copper pipes, and unstable compounds. A Caustic Fexric workshop is a chaotic laboratory filled with glass retorts, glowing green and orange fluid-filled tubing, acid-stained tables, and hand-etched copper syringe kits. They share formulas freely, knowing that a single block in a ventilation line or a contaminated water filter could wipe out an entire community. They barter their alchemical serums, glow-lamps, and deep-cavern chemical components in the Sump-Markets in exchange for guild-made hardware. The Clan-Free Caustic Fexric swelled in numbers during the Contraction (Years 200-450) as failing geothermal systems collapsed holdfasts and forced Fexric out of the guild system. The Caustic Fexric have been the Fexric diaspora\'s improvising majority for over 400 years.',
            ...
            currentCrisis: 'The Sump-Markets are flooding, not with water, with Clockwork Fexric. As the guild system tightens its information lockdown around the dying turbines, disillusioned apprentices, disgraced journeymen, and expelled guild members descend into the sump-tunnels seeking Clan-Free shelter. The Caustic Fexric were never designed to absorb this many refugees. Their salvage-based economy is straining beyond capacity. Their improvisational repair techniques, never tested at industrial scale, are being asked to keep critical infrastructure running. And whispered rumors from the deepest sump-levels suggest that the Deep Alchemists, the same faction that created the Groven, have begun offering sanctuary to Caustic Fexric exiles in exchange for test subjects. The Caustic Fexric must decide whether to absorb the guild refugees, turn them away, or ally with the one faction every Fexric has sworn never to trust again.',
            traits: [
                {
                    id: 'jury_rig_drall',
                    name: 'Jury-Rig',
