...
The Guilds operate like neon-lit industrial syndicates. Membership is hereditary. Techniques are passed from elder to apprentice in strict oral tradition, never written, never shared outside the guild. A Guild-Bound Fexric's beard tells their entire professional history at a glance: copper wire for tinkering guilds, silver filament for alchemy guilds, braided leather for trap-craft guilds, gear-teeth woven in for each rank achieved, and fiber-optic indicators for high-level neural integrations. The Guilds hoard knowledge jealously, and a holdfast whose turbine fails will not receive help from a neighboring holdfast whose guild possesses the relevant maintenance song.
