...
The Groven are the children of the vats and the crags, humanoid troll-kin forged by Fexric alchemists from the ancient Thrumm. The Morgh answered their loss of heritage by building monumental stone peak castles, while the Ithran built thriving bridge-top market bazaars and suspended under-bridge settlements, governing trade across the mountain passes.`,
  icon: 'fas fa-gem',
  overview: 'The Groven are humanoid troll-kin indigenous to the snow-choked Cragjaw Peaks. Descended from the Thrumm and alchemically reshaped by the Fexric, the Morgh caste became stoic stone castle-builders, while the Ithran caste evolved into slender, dragon-scaled diplomats, toll-keepers, and bridge-market councilors who live in cantilevered under-bridge dwellings and cliffside stone settlements.',
  quickFacts: [
    'Humanoid troll-kin of the Cragjaw Peaks, divided into heavy stone-castle Morgh brutes and slender, dragon-scaled Ithran diplomats.',
    ...
    'Play a Groven to explore the legacy of a manufactured race: Ithran weighing trade tolls with balance scales, and Morgh defending monumental peak fortresses.'
  ],
  culturalBackground: 'Groven society is suspended in the vertical world of the Cragjaw Peaks. The Morgh inhabit high mountain peak castles, guarding fortified bridges against whiteout blizzards. The Ithran master a highly creative settlement architecture: while the roadways atop the Ancestor-Spans serve as bustling open-air market bazaars and toll-gates, Ithran families live in cantilevered stone-and-timber homes suspended directly beneath the massive bridge arches, anchored by iron cables and cantilevered beams. On land, Ithran cliffside villages cluster around the bridgeheads, connected by winding stone stairways and cable-gondolas. In Ithran markets, trade is negotiated with stone-bead ledgers and brass balance scales.',
  variantDiversity: 'The Groven are divided into two primary lineages: the Morgh Groven (a genderless, primal caste of heavily-muscled frost-dwelling stone warriors with slate-grey granite skin, stoic stone faces, and small subtle flint lower canine tusks, who build grand stone castles) and the Ithran Groven (a tall, slender dragon-scaled troll lineage with backward-curving crown horns, high sharp cheekbones, long pointed ears, and dreadlocks, who live in cantilevered under-bridge homes, run bridge-top markets, and weigh trade tolls).',
  integrationNotes: {
