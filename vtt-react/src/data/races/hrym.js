export const hrym = {
    ...
    description: `When the sun was torn from the sky and buried beneath the earth, the world did not freeze evenly. Some lands simply grew cold. The north grew merciless. In the howling, blinding-white tundra of Nordhalla — where the noble families bargained away summer itself to halt the grinding advance of the glaciers — a desperate people were forged from frost and famine. They are the Hrym, the Breath-Takers, and they have not felt warmth in eleven generations. Their breath freezes in southern heat. Their skin holds the cold like a wound that refuses to close — a permanent inheritance from the Hunger Pact, when starving refugees consumed their own dead during a blizzard that lasted three winters and the cold entered their bloodline through that first, terrible meal. They live now in the hollow bones of a dead civilization's capital — the Frozen Archive — a city flash-frozen mid-calamity before the Hrym were a people, its ancient machines still humming after ten thousand years without maintenance. They do not speak of parentage, for every Hrym birth drains the mother of warmth through the Milk-Grief, and asking "Who is your mother?" is asking "How did you kill her?" The south owes them blood-debts from wars they stopped acknowledging. The cold recognizes them as its own. It will not let them go.`,
    gradient: 'linear-gradient(135deg, #8B7355 0%, #A0522D 100%)',
    icon: 'fas fa-mountain',
    overview: `When the Keth-Amar devoured the sun and the 7 Noble Families dragged its dying embers underground to forge Emberspire, the north received no warmth. The bargain struck over Nordhalla was crueler than most: the glaciers would halt their grinding advance, but summer would never return to the northern peaks. Eternal winter. Eternal frost. The Hrym were not yet a people when this bargain was sealed. They were starving refugees — tattered human clans fleeing the advancing ice sheets, cornered in a blizzard that lasted three winters with no food and no mercy.

In that frozen hell, they made a choice that reshaped their bloodline forever. They consumed their own dead. The Hunger Pact, as it came to be known, was not an act of barbarism. It was the only arithmetic left when all other numbers had been erased. Through that first meal, the cold entered them — not as an affliction, but as a permanent tenant. It has lived in Hrym blood ever since, passed from mother to child through the Milk-Grief, an inherited hunger that can never be fully sated.

You can tell a Hrym at any distance. Their breath freezes even in southern heat — a constant crystalline plume that marks them like a brand. Their skin feels like stone left in shadow: cold to the touch, resistant to warmth, never quite alive. A Hrym handshake feels like gripping a corpse. The Emberth of Sundale find them unnerving — two peoples shaped by opposite extremes of the same catastrophe, one burned by volcanic fury, the other frozen by its absence.

Our children are born into a world where their first act is to take. The Milk-Grief kills more Hrym mothers than war, than winter, than every frost-beast in the wastes. The infant's inherited hunger drains the mother faster than her body can compensate. Within the first year, nearly half our mothers are dead. So we do not ask "Who is your mother?" That question means "How did you fail her?"

We live now in the Frozen Archive — a dead civilization's capital city, flash-frozen mid-calamity in some catastrophe that predates even the sun's theft. Its streets are paved with the bones of those who died before we were a people, its halls lit by machines that have not stopped humming in ten thousand years. We have learned to work some of its metals. We forge weapons from alloys we do not fully understand. But there are halls we do not enter. Doors that have never opened. A hum beneath the ice that changes pitch when something stirs deep below.

The Neth scholars of the Gloom Forest know some of our secrets — they trade knowledge for Archive access, the only outsiders we trust near the old machines. The southern kingdoms owe us blood-debts from the War of Thousand Screams that they have never fully paid. They sent grain, then stopped. Swords, then cheaper ones. Now they treat us with guilty hostility — the kind of rudeness that comes from knowing you owe someone and hoping they leave before you have to acknowledge it.

We view the volcanic eruption of Emberspire not as a miracle, but as an ecological threat. The heat that saved the south is melting our sacred glaciers. The frost lords stir again beneath the eternal ice. And somewhere deep in the Archive, a machine that has been humming for ten thousand years has changed its pitch. We do not know what this means. We are afraid to find out.`,
    ...
    meaningfulTradeoffs: 'Hrym gain exceptional forge-craft, runic preservation, and cold-adapted combat abilities, but their Hunger Pact imposes a relentless physical toll, their rune-scarring consumes personal memory, and their gelid-born physiology rejects warmth entirely. Every strength is a debt owed to ancestors who starved so their children could survive.',

    integrationNotes: {
        actionPointSystem: 'Hrym abilities focus on frost-enhanced melee, runic inscription, and cold-adapted endurance. Their traits emphasize physical resilience, craft-based magic, and the weight of ancestral debt.',
        backgroundSynergy: 'Hrym excel in backgrounds emphasizing survival, crafting, and stoic endurance. Their name-quest creates deep roleplay hooks around identity, legacy, and the defining act that will earn their missing syllable.',
        classCompatibility: 'Bloodhammer favor Berserker and Dreadnaught — frontline warriors whose rage and endurance channel the Hunger Pact directly. Rune Keepers favor Inscriptor, Augur, and Spellguard — scholars whose rune-craft preserves memory at physical cost. Frostbound favor Warden and Oracle — sentinels whose cold-adapted bodies and ancestral whispers make them implacable guardians.'
    },

    epicHistory: `When the sun was torn from the heavens and buried in the world's heart, Nordhalla received no warmth from the bargain. While Emberspire bled volcanic heat across Sundale, the northern noble family struck their own desperate deal with the Keth-Amar: halt the glaciers that threatened to crush their mountain keeps, and in exchange, surrender summer forever. The ice sheets stopped. The cold did not. And the scattered human clans who would become the Hrym were left to survive in a land where warmth itself had been traded away.

The Hunger Pact was born of arithmetic, not savagery. Three winters without thaw. Game frozen in mid-stride. The old and weak offered themselves first — a willing sacrifice, a final gift to their children. But the winters did not end, and soon the line between willing and desperate blurred beyond recognition. Those who consumed the flesh of their kin did not become monsters. They became something stranger: people in whom the cold had taken permanent residence, their blood forever carrying the memory of what survival had cost.

The First Breaking came before memory was written. Ancient frost lords descended from the eternal ice — some say they were the Wyrd's first attempt to occupy the folklore of a freezing people, given flesh by the terror of clans huddled around dying fires. For three generations, the northern keeps fell one by one. Castle walls shattered like glass. Armies froze in mid-charge. The frost lords did not kill with steel. They killed with the cold that had been the Hrym's only companion for centuries, turned now against them.

During the War of Thousand Screams, Hrym warriors held the Frostgate Pass alone while southern armies mustered behind them. The south had promised reinforcements. The reinforcements came late, under-equipped, and withdrew at the first killing frost. The Hrym died in the thousands — not to enemy blades, but to the cold that waited until they had killed every frost lord before turning on them. The survivors returned changed. Their skin held the pale mark of frost that never faded. Their eyes carried the weight of promises broken by people who lived where warmth still existed.

The Frozen Archive was discovered during this war — unearthed by retreating Bloodhammer berserkers who broke through a glacier wall and found themselves standing in streets paved with the bones of a civilization that died before the sun itself. The Archive was a gift and a curse: shelter from the frost lords, but at the cost of living among ghosts whose machines still hummed, whose doors still locked from the inside, whose lights still flickered in halls no Hrym had ever entered.

Now the darkness spreads across eastern lands and the Grand Alliance calls armies to face a new shadow — one born not of frost but of something older and more patient. The mountain passes stand undefended. The frost lords stir again beneath the ice, their patience that of creatures who know winter always returns. And the Hrym stand where they have always stood: alone, in the cold, the debts owed to them by the warm-lands still unpaid, the Archive humming beneath their feet, waiting for the day something finally stops working and cannot be fixed.`,
    ...
    currentCrisis: `The darkness spreading across the eastern lands is not the only threat stirring in the deep places of the world. The Grand Alliance has marched east, drawing warriors from every northern clan and leaving the Frostgate Pass defended by the elderly, the young, and the desperate. The forge-clans send their best fighters away, the Rune Keepers watch their libraries empty of anyone young enough to carry a blade, and the Frostbound — as always — are left to hold the outermost watch-posts alone.

Southern caravans probe the northern borders with increasing boldness. Their spies seek the Archive's secrets — the alloys no modern smith can replicate, the machines whose principles predate recorded history. The Neth scholars who once traded fairly now send emissaries with harder questions and softer threats. The warm-lands have always wanted what the Hrym possess. For the first time, they may believe they can take it.

Beneath the ice, the frost lords stir. These are not creatures of the Wyrd — not folklore given flesh by terrified whispers. They are older than the Wyrd, older than the sun's theft, older perhaps than the Archive itself. The Rune Keepers who have listened at the deepest glacial fissures report movements that match no known migration pattern. Something is waking. Something that the cold preserved rather than killed.

And somewhere in the deepest chamber of the Frozen Archive, a machine that has hummed at a constant frequency for ten thousand years has changed its pitch. The Rune Keepers do not know what this means. Varr Hold-Name, the oldest living Hrym and the only one to earn his full name while still breathing, has been seen standing outside the vault where he earned that name forty winters ago. He has not spoken of what was inside then. He is not speaking now. But his breath-frost carries the glyph of his completed name more frequently than it ever has — a pale mark hanging in the frozen air for six heartbeats before fading, again and again, as if the cold itself is trying to remind him of something he has been trying to forget.`,
...
When a Hrym earns their full name — the missing syllable finally revealed — their breath-frost briefly spells it in the air. The cold settles around them differently. They feel finished. Many earn their name on their deathbed. Some never earn it at all.`,
    ...
    subraces: {
        berserker: {
            id: 'bloodhammer_hrym',
            name: 'Bloodhammer',
            illustration: '/assets/images/races/bloodhammer_illustration.png',
            illustrationCaption: 'A Bloodhammer berserker with glowing red eyes, wielding a forged battleaxe in the Frozen Archive armory.',
            description: 'When the first Hrym ancestors walked the frozen halls of the Archive, they faced a choice: the forge-halls, the library-halls, or the outer wastes. The Bloodhammer ancestor chose the armories — halls of ancient forges, hammers that predated human memory, alloys no modern smith can replicate. Their hunger, inherited from the Pact, did not settle into quiet memory. It became rage — a furnace that runs on pain and answers every wound with a blow. Their muscles are built from swinging hammers through bone in the dim light of machines that have never stopped humming. Their scars map every fight survived, every enemy ended, every dawn duel fought with weapons that have never lost. When the fury takes them, their eyes burn red and their breath comes in visible gouts — even in the volcanic heat of Sundale, where Emberth traders step back involuntarily at the sight. They are the "purest" Hrym, the ones who believe survival meant fighting rather than thinking. But the rage takes its toll. Many Bloodhammer die young — not from enemy steel, but from hearts that give out under the strain of sustaining anger that was never meant to be permanent.',
            culturalBackground: `The Bloodhammer trace their descent to the ancestor who chose the Archive's armory — a hall of forge-remnants whose metals predate the sun's theft, whose hammers were shaped by hands that belonged to a civilization no living scholar can name. Their blood carries the Hunger Pact in its rawest form: not as a quiet ancestral memory, but as physical rage that surfaces when the body is pushed past its limits. The Emberth of Sundale, who survived the world's death by dwelling in volcanic caverns, share with the Bloodhammer a recognition of what it means to be remade by extremity. But where the Emberth adapted through patience and deep-earth industry, the Bloodhammer adapted through fury.

Before your sixteenth winter, you forge your own weapon — hammer or axe, the twin symbols of the clan. The forging happens in silence under the aurora, the metal quenched not in water but in snow that has never melted. Water is too warm. It would reject the steel. When the blade cools, you mark it with your own blood — a small cut across the palm, a few drops, enough for the weapon to know its owner. Only when it tastes an enemy's life does the ritual complete. The weapon becomes you. Every notch a memory. Every chip a story for the longhouse fire, told while the frost-fungus jars cast their pale blue light across faces that have forgotten what warmth feels like.

Bloodhammer society values strength above all. Honor is measured in kills counted, enemies crushed, songs sung where the ancestors can hear. Blood feuds are settled in dawn duels fought with weapons that have never lost. Insults are answered with steel. Mercy is shown only to those who have earned it through their own strength — a philosophy that makes them dangerous allies and terrifying enemies to the southern kingdoms who still owe them blood-debts.

They view the Rune Keepers as whisperers who hide behind spirits and old books while real warriors do the bleeding. They pity the Frostbound but refuse to acknowledge them as true Hrym — a gelid-born child born to a Bloodhammer mother is sent to the margins without ceremony, left at the edge of the longhouse where the warmth does not reach. The hunger does not make room for weakness. But the hunger also does not make room for regret, and some Bloodhammer elders, in their final winters, have been seen walking toward the Gelid-Caverns, toward the alcoves where the children they sent away still wait.`,
        ...
        skald: {
            id: 'rune_keeper_hrym',
            name: 'Rune Keeper',
            illustration: '/assets/images/races/runekeeper_illustration.png',
            illustrationCaption: 'A Rune Keeper skald, their flesh covered in faint glowing memory-runes, reciting lore in the Archive libraries.',
            description: 'When the first Hrym ancestors divided the Archive, one chose the library-halls — vast chambers of preserved memory-stones, glyphs from a civilization that died before the sun was stolen, machines that catalogued knowledge beyond comprehension. That ancestor\'s hunger did not become rage. It became an endless thirst for understanding — quieter than the Bloodhammer\'s fury, but no less insatiable. Rune Keepers mark their flesh with bone-needle runes that glow faintly in the dark, each rune a story learned, a secret kept, a debt owed to the dead. Their irises shift like dense script when they focus on a new thought. When they speak, the voices of dead scholars layer beneath their own words like harmonic undertones — and sometimes they quote texts they have never physically encountered, the knowledge bleeding through from ancestors who read the same runes centuries ago. The Neth scholars of the Gloom Forest seek them out for their scholarship, trading rare reagents and surface-world intelligence for access to the Archive\'s libraries. It is the only alliance the Hrym maintain with the warm-lands, and even this one is built on mutual recognition that some knowledge is too dangerous for those who have not paid for it in flesh.',
            culturalBackground: `The Rune Keepers trace their descent to the ancestor who chose the Archive's libraries — halls where knowledge was preserved in memory-stones that predate the sun's theft, in glyphs from a language no living tongue can pronounce, in machines that still catalogue and cross-reference long after their creators turned to dust. Their blood carries the Hunger Pact as a thirst for understanding that can never be satisfied.

Before their eighteenth winter, every Rune Keeper undertakes the vision quest — taken to frozen caves deep in the wastes where ice has never melted, left alone for days without food or fire. The cold strips away pretense. The hunger sharpens perception. When the visions come — and they always come, because the Archive's dead scholars still whisper through the memory-stones — the runes get carved into the apprentice's flesh with needles made from the bones of previous keepers. Each rune marks a story learned, a secret kept, a debt owed to the dead. The carving is slow, deliberate, and permanent. These runes do not fade. They grow deeper with age, scars piling up like pages in a book written in flesh.

Some Rune Keepers forget what warmth feels like. Others forget what it meant to love or hate — those memories traded to the Archive in exchange for knowledge it deemed of equal value. Yrsa Bone-Needle, the most senior Keeper alive, has forgotten her own mother's face. She cannot name her first child. She traded those memories willingly, and when asked about her past, she touches the rune on her left palm and says: "I paid for that already. It is gone."

Rune Keeper longhouses are libraries rather than armories — walls lined with bone-tablets, floors marked with runic circles that glow faintly in the dark, memory-stones that whisper if you know how to listen. They are the historians who keep records spanning millennia, the judges whose rulings carry the weight of ancestral precedent, the mediators who see disputes through dead eyes.

They view the Bloodhammer as necessary but ultimately doomed — the rage burns out, the body gives up, and what remains? The Rune Keepers preserve what outlasts flesh. They view the Frostbound with a complex mixture of pity and recognition. Both are marked by what the cold remade of them. But the Rune Keepers chose their transformation. The Frostbound were made.

The Neth scholars from the Gloom Forest occasionally visit their libraries — the only outsiders permitted near the Archive's memory-stones. This trust was earned through centuries of shared scholarship, a rare bridge between the frozen north and the undying swamps. The Neth understand what it means to trade warmth for survival. The Rune Keepers understand what it means to trade memory for knowledge. Between them, an unlikely kinship has formed — two peoples who gave up different things to the same cold world and recognized each other across the gap.`,
            ...
            traits: [
                {
                    ...
                    buffConfig: {
                        buffType: 'custom',
                        customDescription: 'Carve a rune into a surface. Choose one rune effect from the options below.',
                        effects: [
                            {
                                id: 'rune_carving_buff',
                                name: 'Runic Inscription',
                                description: 'Carve one rune — see options below.'
                            }
                        ],
                        durationValue: 1,
                        durationType: 'minutes',
                    ...
                    utilityConfig: {
                        ...
                        choiceConfig: {
                            mode: 'pick_one',
                            label: 'Choose One Rune',
                            note: 'Rune of Warding: 1 min. Rune of Wrath: next attack. Rune of Sight: max 2 active.',
                            options: [
                                { id: 'rune_of_warding', name: 'Rune of Warding', description: 'Carve a protective rune. Allies entering the 10ft zone gain protection from the next status effect. Lasts 1 minute.' },
                                { id: 'rune_of_wrath', name: 'Rune of Wrath', description: 'Enchant a weapon with frost. Next attack deals 2d8 frost damage and slows target 10ft for 1 round.' },
                                { id: 'rune_of_sight', name: 'Rune of Sight', description: 'Carve a scrying rune. See through it from up to 1 mile away. Maximum 2 active runes.' }
                            ]
                        },
                        selectedEffects: [{
                            id: 'runic_carving',
                            name: 'Rune Carving',
                            description: 'Carve a rune into a surface. The Archive remembers what you inscribed.'
                        }],
                        duration: 0,
                        durationUnit: 'instant',
                        power: 'moderate'
        ...
        icewalker: {
            id: 'frostbound_hrym',
            name: 'Frostbound',
            illustration: '/assets/images/races/frostbound_illustration.png',
            illustrationCaption: 'A Frostbound gelid-born exile with pale, ice-sculpted skin, standing inside the frozen Gelid-Caverns.',
            description: 'They were not a choice. The Frostbound are the gelid-born — infants who survived the Milk-Grief but emerged permanently colder, their body temperature never rising above glacial. A Bloodhammer mother dies nursing, the infant lives but stays cold. A Rune Keeper mother survives but the child is gelid-born — skin like stone, breath invisible, heartbeat once every ten seconds. These children were not celebrated. They were given to the margins. Left at the edges of longhouses. Sent to tend the farthest watch-fires where no one would have to look at them. Cast out by both Bloodhammer and Rune Keeper families who could not bear to keep a child that felt like a corpse, they formed their own culture from exile — not by choice, but by necessity. They built their shelters on glacier peaks where the wind never stops and the volcanic warmth of Emberspire barely reaches. They scouted the deepest wastes where even the frost lords hesitate to hunt. They guarded borders most Hrym could not even see. In the world\'s hierarchy of the unwanted, the Frostbound occupy a tier all their own — the children no one claimed, who claimed each other, who built a people from what everyone else threw away.',
            culturalBackground: `The sagas do not celebrate the Frostbound. They were never mentioned in the old songs. The gelid-born infants — those who survived the Milk-Grief but emerged permanently altered — were not a subrace at first. They were accidents. Mistakes. A Bloodhammer mother dies nursing, the infant lives but stays cold. A Rune Keeper mother survives but the child emerges with skin like stone and a heartbeat so slow that healers hold their breath between each pulse. These children were given to the margins — left at the edges of longhouses where the frost-fungus light barely reached, sent to tend the farthest watch-fires, given duties that kept them out of sight.

Over centuries, the outcast children found each other. They grew up together in the cold spaces between clan territories, then raised each other's children. A culture formed from exile — not by choice, but by necessity. They built their shelters on glacier peaks where even the Bloodhammer's rage could not sustain a body. They scouted the deepest wastes where no other Hrym could survive for more than a day. They guarded borders most Hrym could not even see — the outermost watch-posts, the glacial fissures, the places where the frost lords' scouts probed the edges of Hrym territory.

Every Frostbound spends three winters alone in the deepest wastes before they can take their place. This is not a survival test. It is a communion — the cold that made them what they are, finally acknowledged and accepted. Through generations of this rite, their bloodline has adapted in ways that border on the unnatural. Their flesh grows harder each winter. Cold tolerance becomes immunity. Bodies shaped by the land itself.

But it costs. Each generation tolerates warmth less. Their hardened flesh cracks in temperatures others find comfortable — the volcanic heat that the Emberth call home would kill a Frostbound within hours. Many cannot leave the north. The transformation is too complete. Warmth becomes poison. Skin cracks and bleeds. Lungs struggle with air that holds heat. They are being perfected by the cold, generation by generation, and the endpoint of that perfection is a question no one wants to answer.

They view the Bloodhammer with a kind of patient, geological disinterest. The Bloodhammer's rage burns hot and burns out. The Frostbound endure. They have been enduring since the first gelid-born infant was left at the edge of the longhouse and decided, wordlessly, to survive anyway. They view the Rune Keepers with recognition — both are marked by something that changed what it means to be human. But the Rune Keepers chose their transformation. The Frostbound were made.

At the deepest point of the Gelid-Caverns sits Nal First-Cold — the first gelid-born child to survive to adulthood, now over two centuries old, her body temperature so low that snow accumulates on her skin rather than melting. She does not speak. She communicates through frost-glyphs she exhales onto the cavern walls, centuries of them layered like sediment. Every Frostbound visits her once, to place a hand against her frozen cheek and feel what they themselves are slowly becoming. She does not acknowledge them. But the frost-glyph she exhales when each one leaves always carries their name — complete and finished, the missing syllable somehow known to her alone. The cold, it seems, completes what the clans left unfinished.`,
