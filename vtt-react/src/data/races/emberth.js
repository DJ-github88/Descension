...
Their society is a meritocracy of craft and endurance, not birth. Those who work longest, forge finest, endure deepest silence rise highest. The weak are not cast out, they are pitied, supported, given simpler work, because weakness in one clan-member shames the entire bloodline. The greatest terror in Emberth culture is not death. It is the slow, permanent cooling of the Sol\'s Breath, a dimming that has been observed, denied, concealed, and whispered about across three generations. The clan that currently holds the Sol\'s Breath has been lying about its health. The other clans are beginning to splinter. What happens when the last ember of Sol goes out is a question no Emberth knows how to answer.`,

  variantDiversity: `The Emberth are divided into two bloodlines based on where their ancestors sheltered during the underground exile: the Korr of the Deep-Vault, who chose to stay near the Sol\'s Breath core and train their bodies for absolute stillness as religious devotion, and the Thrask of the High-Vault, who chose to venture onto the frozen surface border in heavy insulating wraps, ranging the ashlands as scouts and messengers.`,
  ...
  integrationNotes: {
    ...
    classCompatibility: 'The Korr favor Martyrs and Spellguards because their deep-vault isolation and practice of the Vault-Breath align with absolute physical stillness and willing sacrifice, the quiet Sun-Speakers who interpret the Sol\'s Breath\'s silent dimming have long formalized suffering as spiritual currency. Spellguards emerge from Korr who have learned to absorb geothermal instability into their disciplined bodies. The Thrask favor Pyrofiends above all, using their surface-hardened bodies and surface mobility to harness raw lava-flow heat as a weapon. Thrask defaced their imperial marks to embrace the wild fury of the caldera, and some have made the obvious leap from volcanic heat to Scathrach\'s infernal offer.'
  },
...
When Sol was bound beneath the earth's crust, the Emberth were already underground. On the day of the binding, every Sun-Speaker in every clan received the same final image: an ember held in cupped hands. Then silence, a silence that has lasted since the age of the binding itself. The Emberth call that ember the Sol\'s Breath, and they have tended it through centuries of darkness, believing it to be Sol's last conscious fragment, the thread that connects their spirit's sleeping mind to the world it once nourished.
...
Thaeron belongs to the tending-clan, the bloodline currently entrusted with the Sol\'s Breath. He is the only living Emberth who has known for certain that the ember is dimming for more than fifty years. He has never told anyone. Not his apprentices. Not his clan-elders. Not the other forge-clans who demand transparency. His silence has preserved the Forge Accords through three generations of slow, incremental cooling. He believes, with the unshakeable certainty of a man who has spent six decades staring into dying fire, that revealing the truth would shatter Emberth civilization more completely than the dimming itself.
...
At the Vault's absolute center is **The Great Forge**, where oversized obsidian anvils are worked diligently by craftsmen who barely break a sweat under the unbearable heat. In the inner ring sits **The Harath-Chamber**, a massive monastic sanctuary of pure basalt where the **Korr Sun-Speakers** kneel in six-hour shifts, practicing the Vault-Breath in absolute silence around the **Sol\'s Breath**, the stone bowl containing the last eternal ember of Sol. The outer rings contain the residential sectors and the alchemical laboratories of the **Fexric**, who trade alchemical reagents and gear-work for Emberth obsidian.`
    },
    {
      name: 'The Shyr',
  ...
  currentCrisis: `
The Sol\'s Breath is dying, a truth the tending-clan (Korr) has concealed for three generations. The dimming has accelerated in the last decade, and the Sun-Speakers who attempted to speak openly were silenced. Those who remain have split into three camps:
...
The Solstice Vigil occurs once each year during the longest period of darkness. Every forge-clan extinguishes all flames except the Sol\'s Breath. The entire clan, from the eldest Sun-Speaker to the youngest child, sits in the Vault-Breath for twelve hours of uninterrupted silence, listening for Sol's voice in the ember. No one has heard anything for centuries. The Vigil continues because stopping it would mean admitting Sol is truly gone. At the Vigil's end, newborns receive their forge-marks from the heated stylus, and the clan's forges are relit from the Sol\'s Breath's flame, a ritual that binds every Emberth forge to the same source, the same vigil, the same silence.
...
Forge-trials settle disputes between clans. No Emberth may strike another Emberth in anger, this is the first clause of the Forge Accords, and violation means permanent exile. Disputes are instead resolved through competitions of craft, endurance, or stillness: who can forge the finest blade from raw obsidian, who can hold the Vault-Breath longest, who can recite the longest ancestor-lineage from memory without error. The nature of the trial is agreed upon by both parties. The loser accepts the verdict without appeal, because to dispute a forge-trial is to dispute the forge itself, and the forge is Sol's altar.
  ...
  subraces: {
    korr: {
      ...
      illustrationCaption: 'A Korr Emberth with charcoal skin, braided hair, and solid-black eyes, looking out with quiet focus as steam rises from a geothermal caldera vent behind him.',
      illustrations: [
        {
          src: '/assets/images/races/korr_illustration.png',
          caption: 'A Korr Emberth with charcoal skin, braided hair, and solid-black eyes, looking out with quiet focus as steam rises from a geothermal caldera vent behind him.'
        },
        {
          src: '/assets/images/races/korr_illustration_2.png',
          caption: 'Korr Emberth residents of both genders living in a subterranean gallery. Basalt cliff houses carved into the cave walls feature heavy cloth drapes, with copper geothermal heating pipes and steam conduits running throughout.'
        }
      ],
      visualDescription: `The fewest and the most deep-adapted. Korr skin is dark brown-beige, untouched by daylight, marked with the most elaborate ash-branding patterns of any Emberth bloodline, stark and crisp from centuries of proximity to the Sol\'s Breath. Their enormous solid-black eyes are enlarged to read faint heat in absolute darkness, and their metabolisms are so slow their pulses are barely perceptible. Their bodies are conditioned for absolute stillness: elongated air-conserving lungs, dense bone, and a bearing so motionless that a sitting Korr can be mistaken for a carved votive. They wear their dreadlocks long and their ash-cloths thick against a daylight that pains them.`,
      ...
      description: 'The fewest and the most isolated. Korr bodies are conditioned for absolute stillness, elongated lungs that conserve air, metabolisms so slow their pulses are barely perceptible, and solid black eyes enlarged to perceive the faint heat in absolute darkness. Their skin is dark brown-beige, untouched by daylight, marked with the most elaborate ash-branding patterns, stark and crisp from proximity to the Sol\'s Breath. They are contemplative, scholarly in their devotion, spending their lives deciphering the Sol\'s Breath\'s silence. They move like people who have forgotten why movement matters. Their Vault-Breath can extend to twelve hours, double the standard, and older Korr report that time itself feels different in the deep, that centuries pass like seasons, and that the silence of the Sol\'s Breath is a language they are still learning to translate.',
...
The current crisis is a Korr crisis. The tending-clan has concealed the Sol\'s Breath's dimming for three generations, and the Sun-Speakers are no longer unified. Some still believe Sol will speak again. Some believe the ember is Keth-Amar's tether and must be extinguished. Some, the Unwoven, have defaced their marks and left the Deep-Vault entirely. Thaeron, the eldest Korr, has told no one what he believes. He is still listening.`,
    ...
    thrask: {
      ...
      illustrationCaption: 'A Thrask Emberth badland-hunter crouching on a volcanic rock, insulated in thick ashy cloth wraps and a hood, with a stone-bladed spear on their back and small pointed ears exposed.',
      ...
      description: 'The most surface-adapted and the most mobile. Thrask bodies have shorn hair and are wrapped in heavy ash-insulating cloths against the cold of the open ashlands. Their skin is dark brown-beige, weathered from surface exposure, and their ash-branding marks are fainter, blurred at the edges from generational distance from the Sol\'s Breath. Their ash-filtering lungs are somewhat weaker than the Korr\'s, adapted for the thin, cold air of the surface border rather than the thick particulate of the Mid-Vault. They are the Emberth\'s connection to the surface, ranging the volcanic ashlands as scouts, messengers, and badland-hunters, mapping the thermal vents and carrying word between outposts. Leaner, faster, and more mobile than the Korr, they move like people who have forgotten why stillness was ever necessary.',
