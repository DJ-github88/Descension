...
When Sol was bound beneath the earth's crust, the Emberth were already underground. On the day of the binding, every Sun-Speaker in every clan received the same final image: an ember held in cupped hands. Then silence, a silence that has lasted since the age of the binding itself. The Emberth call that ember the Solbrand, and they have tended it through centuries of darkness, believing it to be Sol's last conscious fragment, the thread that connects their spirit's sleeping mind to the world it once nourished.
