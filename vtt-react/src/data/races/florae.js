export const florae = {
  ...
  description: `**[The Tree-Born Exiles of House Viridane]**, *In a sunlit pine grove, a friendly Florae ranger with gnarled oak branch-arms shares a berry with a red squirrel perched on his shoulder bough, his copper water-flask gleaming at his belt.*

There were seven houses that signed the Great Binding, and ours was the seventh: House Viridane. The histories — written by the six who broke, marched their firstborn to Keth-Amar, and then crowned House Morrath to hide the gap — will tell you otherwise. They will tell you seven houses marched north. They will not tell you that one of the seven said no. House Viridane refused. We did not march north.

While the other families heard Keth-Amar's whispers and prepared their children for the peaks, House Viridane heard a different voice, something watching from the mist, older than the Sun-Eater's hunger. It reached them before Keth-Amar could, offering a way that did not end with their children's blood on northern stone. They took it. They fled south through the Frostwood Reach while the sacrifice fires still burned for the other houses.

In the moonlit groves, starving and hunted, they fulfilled an ancient nature contract with the forest powers. In exchange for protection, their flesh was woven into living timber, transforming them into the Florae: charming, resilient treant-kin whose crude branch-arms, leafy crowns, and sap-filled veins carry the living proof of a lineage the world pretends never existed.`,
  icon: 'fas fa-tree',
  epicHistory: `There were seven houses that signed the Great Binding, and ours was the seventh: House Viridane. The histories — written by the six who broke, marched their firstborn to Keth-Amar, and then crowned House Morrath to hide the gap — will tell you otherwise. They will tell you seven houses marched north. They will not tell you that one of the seven said no. House Viridane refused. We did not march north.

While the other families heard Keth-Amar's whispers and prepared their children for the peaks, House Viridane heard a different voice, something watching from the mist, older than the Sun-Eater's hunger. It reached them before Keth-Amar could, offering a way that did not end with their children's blood on northern stone. They took it. They fled south through the Frostwood Reach while the sacrifice fires still burned for the other houses.

In the moonlit groves, starving and hunted, they fulfilled an ancient nature contract with the forest powers. In exchange for protection, their flesh was woven into living timber, transforming them into the Florae: charming, resilient treant-kin whose crude branch-arms, leafy crowns, and sap-filled veins carry the living proof of a lineage the world pretends never existed.`,
  overview: `The Florae are the transformed descendants of House Viridane, a people deeply attuned to nature like druids. Their arms are crude, natural tree boughs — oak, birch, willow, pine, or mountain rowan — that split into flexible twig-fingers that sprout fresh green leaves when hydrated. Small woodland creatures like squirrels, bluebirds, and chipmunks are naturally drawn to them, often nesting in their shoulder boughs.

They depend on fresh water to keep their timber limbs limber. A Florae carries a copper Hearth-Water Flask on their belt as their prized possession. When well-watered, their leaves bloom and their twig-fingers regrow quickly if damaged. If scorched by fire, their outer bark chars into smoldering embers — granting them temporary burning melee strikes, but making them desperate to douse themselves in water.

They do not write their history on paper; ink cannot hold their truth. Instead, they pass their past aloud, elder to child, carrying their identity in spoken chants and negative-space clothing. Every Florae coat features a blank rectangular patch where their noble house crest was unstitched after the world erased them.`,

  quickFacts: [
    'The transformed descendants of House Viridane, the 7th noble house that refused Keth-Amar\'s bargain and made an ancient fae-nature pact in the fog-shrouded groves.',
    'Their arms are crude, natural tree boughs (oak, birch, willow, pine) that sprout leaves when hydrated and regrow twigs over time. Small forest animals (squirrels, songbirds) naturally nest on their shoulders.',
    'Play a Florae to be a charming, nature-bound treant-kin adventurer. You carry a copper water-flask to keep your branches limber, resist physical harm through timber hide, and carry the weight of a house the world tried to erase.'
  ],

  culturalBackground: `Florae society is dedicated to tending trees and nurturing the forest. Their homes are built directly into colossal living ancient trees — cozy timber dwellings carved into massive tree trunks, connected by woven canopy bridges, suspended sun-lanterns, and rain-collecting basins.
...
Whether a Florae appears 'Wild' (unkempt with leafy crowns and mossy shoulders in deep groves) or 'Shorn' (pruned and manicured under high-collared traveler coats in human cities) is a matter of personal choice and lifestyle. Both carry the same warm heartwood core, the same copper water-flask, and the same blank unstitched Viridane crest patch.`,
  ...
  integrationNotes: {
    ...
    backgroundSynergy: 'Florae excel in backgrounds emphasizing survival, nature, herbalism, and guardianship. Their druidic connection creates rich roleplay hooks with woodland creatures and ancient groves.',
    classCompatibility: 'Florae make outstanding Animists, Apex trackers, Wardens, and Mages, combining natural treant resilience with fluid druidic magic and animal companions.'
  },
  ...
  baseTraits: {
    ...
    height: '5\'4" - 6\'4"',
    weight: '160-260 lbs',
    build: 'Crude tree-bough arms, carved wooden face, expressive amber eyes, leafy crown'
  },
  ...
  sharedTraits: [
        ...
        effects: [
          {
            id: 'timber_reach',
            name: 'Timber Reach',
            description: 'Unarmed strikes deal 1d6 + Str bludgeoning damage, and damaged twigs regrow when hydrated.',
            mechanicsText: 'Unarmed strikes deal 1d6 + Str bludgeoning damage; limb twigs regrow during short rests.'
          }
        ],
    ...
    },
    {
        ...
        effects: [
          {
            id: 'hydrated_limbs',
            name: 'Hydrated Limbs',
            description: 'Restores 1d8 + Con HP and grants +5 ft movement speed for 1 hour.',
            mechanicsText: 'Heal 1d8 + Con HP and gain +5 ft speed when drinking or dousing in fresh water.'
          }
        ],
      ...
      debuffConfig: {
        ...
        effects: [
          {
            id: 'fire_vulnerability_florae',
            name: 'Fire Vulnerability',
            description: '+25% vulnerability to fire damage.',
            mechanicsText: 'Take +25% damage from fire sources.'
          }
        ],
        durationValue: 0, durationType: 'permanent', durationUnit: 'permanent', canBeDispelled: false
      },
      ...
      cooldownConfig: { cooldownType: 'short_rest', cooldownValue: 2 }
    },
    {
      ...
      buffConfig: {
        ...
        effects: [
          {
            id: 'woodland_friendship',
            name: 'Woodland Friendship',
            description: 'Advantage on Nature and Animal Handling checks; small animals alert you to danger.',
            mechanicsText: 'Advantage on Nature and Animal Handling checks.'
          }
        ],
        durationValue: 0, durationType: 'permanent', durationUnit: 'permanent', canBeDispelled: false
      },
...
Their oral tradition is fierce and short-spoken. They keep the names of every house that broke the Great Binding, every house that marched its firstborn north, and they sing them only as warnings. A Viridian who leaves the deep groves does so as a partisan, carrying the refusal into the Ledgered world at great personal cost. The fog erodes them faster than it erodes the Oken, and they know it.`,
