...
Somewhere in the Treakous Oceanic Rift, where the waters plunge deeper than any living thing has measured, one of the 7 Sundered Monoliths rests in absolute darkness. The Myrathil know where it is. Deepling Listeners have hummed toward it for generations and received answers they do not share. What the shard whispers in the abyss, and what Mareth intends to do about it, is a secret kept by a people who have never needed the land's wars or the land's shards, and who may discover, very soon, that the land's problems have followed them into the deep.`,
    quickFacts: [
        ...
        'Amphibious and bioluminescent, their vein-colors shift with mood and atmospheric pressure. They breathe both air and sea, navigate by lunar pull, and cannot truly rest without submersion. Divided into Shoreling diplomats, Deepling mystics who hum into the abyss, and Riverling explorers who follow rivers inland.',
...
Clothing is layered: kelp-weave body-wraps as a base layer, a living fabric cultivated in submerged gardens, tightening when wet and breathing when dry. Over this, salvaged sailcloth robes, net-knot shawls laced with sea-glass beads, and waxed canvas storm-capes for rough weather. Jewelry is found and grown both: polished coral, sea-smoothed stone, living shell-grafts worn on the body. Every item tells a story.
...
Among themselves, the Myrathil are warm and direct. They are gullible and too honest at times, naive in the way of a people who have no concept of inheritance, ownership, or bloodline. They CAN lie; they are simply bad at it, because their culture values directness and has no framework for sustained deception. Their vein-colors shift with emotion, making them easy to read, but a skilled Myrathil can suppress the tell with effort. They are not lie-detectors. They are emotionally transparent people raised in a culture that never taught them to hide. They settle disputes by submerging together: arguments had floating in a tide pool resolve differently than arguments had on dry land. Their highest value is freedom, the right to drift where currents take them, to belong nowhere fully, to answer to no one but Mareth and each other.`,
    variantDiversity: 'The Myrathil are shaped by the water that births them. The Shore Myrathil spawn where waves hammer shore — mediators, traders, the face the world sees. The Deepling Myrathil spawn in open ocean — mystics and sea-herders who find land-folk exhausting. The Brook Myrathil spawn where freshwater meets salt — explorers and scouts who follow rivers inland and return with stories no other Myrathil could tell.',
    integrationNotes: {
      ...
      classCompatibility: 'Shore Myrathil favor Minstrels and Gambit, using their natural social fluency, performance skills, and comfort with risk to thrive in coastal taverns, trade hubs, and diplomatic circles. Deepling Myrathil favor Revenants, channeling their deep ocean connection to ancestral sea currents and the things that breathe in the pressure-dark below. Brook Myrathil favor Animists, utilizing their connection to fresh water systems and the spirit-traditions of the inland waterways.',
      landMotivation: 'Myrathil venture inland when their spawning beaches are threatened, when the sea-silence drives them from familiar coastlines, when the Sundered Monolith in the Treakous Rift hums a new frequency, or when land-folk dam rivers and steal Brook Myrathil spawn-sites. They have no land-claims and seek none — but the sea\'s problems have followed them upstream, and ignoring the land is no longer an option.'
    },
    diasporaVariation: `Myrathil diaspora follows the water. The Shore Myrathil hold the Iceheart coast; the Brook Myrathil have migrated up every major river system and established small enclaves in inland ports as far as the Sundrift Vale's edge and the Bryngloom's peat-waterways. A Bryngloom Brook Myrathil develops darker, bog-tinted bioluminescence and a tolerance for still water that coastal kin find unsettling. The Deepling Myrathil do not diaspora, they are trench-bound and surface only under the current crisis. Merrowport is the only true mixed Myrathil-Merryn city; elsewhere Myrathil are small river-enclaves, increasingly silent as the sea-silence spreads upstream.`,
    ...
    notableFigures: [
      {
        ...
        backstory: `
Saelith was the first Shoreling to walk into a human port and refuse to perform. When the poets wanted to write about her eyes, she asked them what they paid their last human subject. When a noble offered her rooms in his manor, she asked if the offer came with a collar. She was not angry, Myrathil are rarely angry, but she was direct in a way that land-folk found profoundly uncomfortable.
...
Saelith died old, nearly two hundred, floating in the tide pool where she was spawned. She refused to be buried on land. The tide took her body out, and three days later a gale spawned three new Myrathil on the same beach. No one who knew her believes that was a coincidence.
        `
      },
      {
        ...
        backstory: `
Ulvir was Deepling, spawned in open ocean during a moonless gale and not found by other Myrathil for nearly a month. He arrived on a floating village-raft already half-grown, speaking only in the low-frequency hum that Deepling use underwater. It took him a year to learn spoken language. His first words were: "The bottom is speaking."

What Ulvir heard in the abyss became the foundation of Deepling mysticism. He described voices, not spirits, not ancestors, but something older than both, something sleeping in the trenches where light has never reached. He taught other Deepling how to listen for these voices without losing themselves to them. Some of his students went too deep and never returned. Ulvir himself spent his last decades on a raft tethered over the deepest trench he could find, humming into the dark and listening for answers.

His teachings are controversial. Shoreling find them unsettling. Riverling dismiss them as deep-water delirium. But every Deepling Oracle traces their lineage of listening back to Ulvir, and every few generations another Myrathil comes up from a long dive with the same words: "It spoke again."
        `
      },
      {
...
Venn proved that Riverling could survive anywhere there was water, and her maps became the foundation for every Myrathil expedition inland. She died on her fifth expedition, somewhere in a mountain range she never finished naming, her body never found. Riverling still set out in her direction, hoping to complete her maps. None have.
        `
      }
    ],
    majorLocations: [
...
Salt-Hinge operates under the Accords Saelith wrote, and both sides enforce them. The Myrathil who live here permanently are mostly Shoreling. It is the place where young Riverling come to buy supplies before walking inland, and where old Riverling return to sell their maps.
        `
      }
    ],
    currentCrisis: `
...
The Shoreling want to negotiate, to establish treaties and accords with the land-kingdoms before the situation escalates. The Deepling want to disappear into the open ocean, to drift so far from shore that no land-folk ship could ever find them. The Riverling want to map every spawning site, every estuary, every brackish delta before it is destroyed, to preserve at least the knowledge of what was lost if the losses cannot be prevented.
...
The first words a Myrathil hears are their own name, spoken by whoever reaches them first. Myrathil names are not inherited, they are given fresh each time, chosen by the finder, based on something about the child or the spawning conditions. A child spawned under a full moon might be named Luneth. One spawned in a gale that tore ships apart might be named Brekka.

The first submersion is the most important ritual in a Myrathil's life. Within hours of spawning, the child is carried into the sea and submerged completely, not to drown, but to wake up. Myrathil breathe water as easily as air, but submersion triggers something deeper: their nervous system calms, their vein-colors stabilize, and they truly sleep for the first time. The submersion is done by the finder, who holds the child underwater and hums. Every Myrathil remembers their first submersion as a feeling, not a memory, the moment the world stopped being loud.

Adolescence is marked by the First Drift: a young Myrathil leaves their community and follows the coast or the current for a full season, alone, carrying only what they can float behind them. Some go inland. Some go deep. Some never come back, but most do, returning with stories, scars, and the right to speak at community gatherings. The First Drift is what turns a Myrathil child into a Myrathil adult.
...
The Tide-Sing occurs at spawning gales. When a storm approaches that carries the right pressure and the right wind, Myrathil gather on the nearest coast and sing, not to summon the storm, but to welcome whatever it brings. During the Tide-Sing, Myrathil do not speak in words. They hum. The harmonics layer and build until every Myrathil present is breathing in the same rhythm at the same moment. Mareth, they believe, can hear them. Sometimes the gale spawns a child. Sometimes it doesn't. Either outcome is accepted with the same quiet grace.
      ...
      prompts: [
        {
          id: 'witnessed',
          name: 'Witnessed',
          question: 'Someone was there when you stood up from the foam. A fisherman who helped you walk your first steps on sand. A terrified sailor who fled. Another Myrathil who stayed to name you. Whoever it was, their face was the first thing you saw. What is the nature of your bond to the one who saw you born?'
        },
        {
          id: 'second_storm',
          name: 'The Second Storm',
          question: 'Your spawning gale lasted the usual three days, but at the exact moment you opened your eyes, a second storm-front hit from the opposite direction. The collision spiked the waves into chaos, and during that chaos, something spoke. You do not remember what it said. But sometimes, in the moment just before you fall asleep, you almost do. What do you think the voice was?'
        },
        {
          id: 'silence',
          name: 'The Silence',
          question: 'Most Myrathil are born into howling wind and crashing surf. You were born into total calm. Your gale died the second your foam took shape. The sea went glassy-flat, the wind dropped to nothing, and you stood up in a world that had gone completely silent. Other Myrathil find this deeply unsettling. What do you think the silence meant?'
        },
        {
          id: 'drift',
          name: 'The Drift',
          question: 'You did not spawn on a shore. You formed from foam in the open water and drifted for days before you found land. You have no birth-coast. No spawning-beach to return to. Just open ocean all around and a vague sense that you are still drifting. How do you answer when asked where you are from?'
        },
        {
          id: 'twice_born',
          name: 'Twice-Born',
    ...
    subraces: {
      shoreling: {
        ...
        culturalBackground: 'Shoreling are the most visible Myrathil in the wider world. They maintain the trade posts from Salt-Hinge to the Frostwood Reach coast, negotiate with port authorities in cities that barely acknowledge their right to exist, and have developed a social fluency that other Myrathil find exhausting. They learn land-languages young, the tongues of Sundale, the trade-pidgins of the Iceheart Sea routes, the formal speech of Nethien merchants who have learned that a Myrathil trader is more reliable than a human one. Their camps are the most permanent, relatively speaking, and their kelp-weave tends toward the practical and presentable rather than the ceremonial. They are the Myrathil most likely to marry into land-settlements, most likely to have human friends, and most likely to wake up at night in a dry bed feeling the tide pull in two directions at once. When the Sundered Monolith in the Treakous Rift began its new resonance, it was Shoreling who carried the news to every Myrathil community along every coastline within a month. It is Shoreling who now carry the difficult questions: negotiate or retreat? Treaty or disappearance? Mareth is not answering. She has never answered directly. She only sends more storms.',
        statModifiers: {
          charisma: 2,
          agility: 1,
          constitution: -1
        ...
        traits: [
          {
            ...
            description: 'You gain Water Breathing and a +30 ft swim speed. Long resting in salt water for 4+ hours provides full HP recovery; long resting on land without submersion yields only half normal HP recovery. Mareth gave you lungs for air and gill-veins for water, but only the tide\'s weight lets you truly sleep.',
            level: 1,
              ...
              effects: [
                {
                  ...
                  mechanicsText: 'Grants the Water Breathing trait, permitting unhindered breathing in both air and water at all times.',
                  statModifier: {
                    stat: 'water_breathing',
                    magnitude: 1,
                ...
                },
                {
                  ...
                  mechanicsText: 'Adds a flat +30 ft to the creatures swim speed, making movement through water swift and natural.',
                  statModifier: {
                    stat: 'swim_speed',
                    magnitude: 30,
                    magnitudeType: 'flat'
            ...
            debuffConfig: {
              ...
              effects: [
                 {
                   id: 'surface_restlessness',
                   name: 'Surface Restlessness',
                   description: 'Long resting without at least 4 hours of salt-water submersion provides only half the normal HP recovery; full submersion provides full recovery.',
                   mechanicsText: 'Without at least 4 hours of salt-water submersion in a day, long resting restores only half normal HP; with submersion, full HP is restored.',
                   statusEffect: {
                     level: 'moderate',
                     description: 'Long resting without salt-water submersion provides half HP recovery. Full submersion for 4+ hours restores full HP.'
                   }
                 }
              ],
              durationValue: 0,
              ...
              effects: [
                {
                  id: 'storm_initiative',
                  name: 'Storm Surge',
                  description: '+2 Initiative during storm conditions (rain, gale, thunder, heavy sea). The storm is your element.',
                  mechanicsText: 'During storm conditions, this grants a flat +2 bonus to Initiative, reflecting the creature’s attunement to wild weather.',
                  statModifier: {
                    stat: 'initiative',
                    magnitude: 2,
                    magnitudeType: 'conditional'
                  }
                }
              ],
              durationValue: 0,
              ...
              selectedEffects: [
                {
                  id: 'weather_sense',
                  name: 'Weather Sense',
                  description: 'Always know the direction of the nearest major body of water. Can sense incoming storms up to 72 hours in advance, their direction, approximate intensity, and when they will arrive.'
                }
              ],
              duration: 0,
              durationUnit: 'permanent',
              ...
              effects: [
                {
                  ...
                  name: 'Emotional Currents',
                  description: '+1 to Insight and Persuasion checks. You read people like weather patterns.',
                  mechanicsText: 'Grants a +1 bonus to Insight and Persuasion checks, letting the creature read emotional currents like weather patterns.',
                  statusEffect: {
                    level: 'minor',
        ...
        traits: [
          {
            ...
            debuffConfig: {
              ...
              effects: [
                {
                  id: 'surface_restlessness_deep',
                  name: 'Surface Restlessness',
                  description: 'Cannot benefit from long rests unless submerged in salt water for at least 4 hours. Sleeping on land provides only half the normal HP recovery.',
                  mechanicsText: 'Without at least 4 hours of salt-water submersion in a day, the creature cannot benefit from a long rest; sleeping on land restores only half normal HP.',
                  statusEffect: {
                    level: 'severe',
                    description: 'True rest requires submersion in salt water. Land-sleep provides half HP recovery.'
                  }
                }
              ],
              durationValue: 0,
          ...
          },
          {
              ...
              effects: [
                {
                  ...
                  mechanicsText: 'While submerged, the creature gains Darkvision out to 60 ft, seeing in total darkness underwater.',
                  statusEffect: {
                    level: 'moderate',
                ...
                {
                  id: 'cold_resistance_deep',
                  name: 'Deep Cold',
                  description: '25% cold resistance while submerged. Deep water does not freeze, and neither do you.',
                  mechanicsText: 'While submerged, the creature gains 25% resistance to cold damage.',
                  statModifier: {
                ...
                },
                {
                  id: 'extended_breath',
                  name: 'Long Breath',
                  description: 'Can hold breath for 30 minutes. Your lungs were shaped by pressure.',
                  mechanicsText: 'The creature can hold its breath for 30 minutes before needing to breathe.',
                  statusEffect: {
                    level: 'moderate',
                    description: 'Hold breath 30 minutes'
                  }
                }
              ],
              durationValue: 0,
            ...
            debuffConfig: {
              ...
              effects: [
                {
                  id: 'land_sickness_deep',
                  name: 'Land-Sickness',
                  description: 'Every 12 hours spent continuously on land without submersion: -1 to all ability checks (cumulative, max -3). Resets immediately upon submersion in salt water. The deep does not release its children without taking something back.',
                  mechanicsText: 'For every 12 consecutive hours on land without submersion, the creature suffers a cumulative -1 penalty to all ability checks, up to a maximum of -3, resetting the moment it submerges in salt water.',
                  statusEffect: {
                    level: 'severe',
                    description: 'Accumulating -1 to all checks per 12hrs on land, max -3. Resets on submersion.'
                  }
                }
              ],
              durationValue: 0,
              ...
              effects: [
                {
                  id: 'resonant_hum',
                  name: 'Resonant Hum',
                  description: 'While humming actively (costs 1 AP to start, free to maintain), allies within 30ft gain +1 to Spirit and Intelligence saving throws. The hum is audible, stealth is impossible while active.',
                  mechanicsText: 'While actively humming, allies within 30 ft gain a +1 bonus to Spirit and Intelligence saving throws; the audible hum prevents stealth.',
                  statusEffect: {
                    level: 'minor',
                    description: '+1 to SPR/INT saves for allies within 30ft while humming'
                  }
                }
              ],
              durationValue: 1,
          ...
          },
          {
            ...
            debuffConfig: { debuffType: 'statusEffect', effects: [{                   id: 'surface_restlessness',
                  name: 'Surface Restlessness',
                  description: 'DC 10 Spirit save or no long rest benefit without 1hr salt-water submersion.',
                  mechanicsText: 'Without at least 1 hour of salt-water submersion, the creature must succeed on a DC 10 Spirit save or gain no benefit from a long rest.',
                  statusEffect: {
                    level: 'moderate',
                    description: 'Spirit save DC 10 to benefit from long rest without salt water.' } }], durationValue: 0, durationType: 'permanent', durationUnit: 'permanent', canBeDispelled: false },
            targetingConfig: { targetingType: 'self', rangeType: 'self_centered' },
            resourceCost: { actionPoints: 0, mana: 0, components: [] },
      ...
      riverling: {
        ...
        culturalBackground: 'Riverling are the explorers of Myrathil society, but they are also the bearers of the most urgent intelligence. When word of the Sundered Monolith\'s awakening in the Treakous Rift reached the delta camps, it was Riverling who connected it to what they had seen inland: other old magics stirring, ancient burial mounds humming in the Sundrift Vale, a murky pool in the Bryngloom Forest that had begun to glow with light that did not behave like light. They follow rivers inland, trading with land-settlements far from the coast, mapping territories no other Myrathil has seen. Their camps are temporary, their possessions are minimal, and their relationships with land-folk are the most genuine, they are the Myrathil most likely to have human friends rather than human collectors. They return to the delta or coast every few years to share their maps and stories at the Tide-Share. Some settle inland permanently, marrying into land-communities and raising children who have never seen the sea. These are mourned as lost by their kin, even while they are still alive and happy, Mareth\'s children who chose the land, and whom the land, in its own way, accepted. When the crisis over the spawning gales escalates, it will be the Riverling who carry the messages between the retreating Deepling and the negotiating Shoreling, as they have always carried the messages between worlds that do not speak the same language.',
        currentCrisis: 'The rivers are changing faster than any Riverling can map. The Great Silver River has dropped three feet in the last decade. Seasonal streams that have flowed since before the sun was buried are drying to gravel beds. Riverling who followed those streams inland, who built trading posts and lives far from the coast, are being forced to retreat \u2014 or to stay and watch the water vanish around them. The land-folk blame the volcanic winter shifting rainfall. The Deepling blame the Sundered Monolith in the Treakous Rift, its awakening pulling thermal currents in directions no one can predict. The Shoreling say nothing, because saying "we told you so" to a Riverling whose homeland is evaporating would be cruel. The Riverling are running out of rivers \u2014 and for the first time, asking whether Mareth ever intended them to go so far inland at all.',
        statModifiers: {
          agility: 2,
          intelligence: 1,
          spirit: -1
        ...
        traits: [
          {
            ...
            buffConfig: {
              ...
              effects: [
                ...
                {
                  id: 'freshwater_rest',
                  name: 'Freshwater Adaptation',
                  description: 'Can achieve full rest through submersion in freshwater rivers, lakes, and pools, not only salt water. The estuary that birthed you gave you wider waters.',
                  mechanicsText: 'The creature may achieve a full long rest by submerging in fresh OR salt water, not salt water alone.',
                  statusEffect: {
                    level: 'minor',
                    description: 'Full rest in fresh OR salt water'
                  }
                }
              ],
              durationValue: 0,
              ...
              effects: [
                {
                  ...
                  mechanicsText: 'Without submersion for at least 4 hours, the creature cannot benefit from a long rest; land sleep restores only half normal HP.',
                  statusEffect: {
                    level: 'severe',
                    description: 'True rest requires submersion. Land-sleep provides half HP recovery.'
                  }
                }
              ],
              durationValue: 0,
          ...
          },
          {
            ...
            buffConfig: {
              ...
              effects: [
                {
                  id: 'freshwater_immunity',
                  name: 'Brackish Blood',
                  description: 'Immune to negative effects from freshwater exposure that affect other Myrathil. Resistant to poison (25% damage reduction).',
                  mechanicsText: 'Grants immunity to freshwater-exposure effects that harm other Myrathil and 25% resistance to poison damage.',
                  statModifier: {
                ...
                },
                {
                  id: 'river_swim',
                  name: 'River Swimmer',
                  description: '+5ft movement speed when traveling along rivers or streams. You read currents the way others read roads.',
                  mechanicsText: 'While traveling along rivers or streams, the creature gains a flat +5 ft to its movement speed.',
                  statModifier: {
                    stat: 'movement_speed',
                    magnitude: 5,
                    magnitudeType: 'conditional'
              ...
              effects: [
                {
                  ...
                  mechanicsText: 'When more than 50 miles from any natural water source, the creature loses 1 point of Spirit.',
                  statusEffect: {
                    level: 'minor',
          ...
          },
          {
            ...
            description: 'The Riverling spend more time among land-folk than any other Myrathil, and they have learned to pull the sea inward when they need to pass unnoticed. You can retract your webbing completely, dim your vein-colors to near-invisibility, and still the restless tide in your movements until you look, briefly, almost human. It is uncomfortable, like holding your breath while awake, and you cannot maintain it forever. Mareth does not judge you for hiding. But she does not help, either.',
            level: 1,
              ...
              effects: [
                {
                  id: 'land_disguise',
                  name: 'Land Disguise',
                  description: 'Suppress visible Myrathil traits (webbing retracts, vein-colors dim, eyes appear more normal) for up to 1 hour. +2 to Deception and Stealth checks made to pass as a non-Myrathil during this time.',
                  mechanicsText: 'For up to 1 hour, the creature suppresses visible Myrathil traits and gains +2 to Deception and Stealth checks made to pass as a non-Myrathil.',
                  statusEffect: {
                    level: 'moderate',
                    description: 'Suppress Myrathil traits for 1hr. +2 Deception/Stealth to pass as non-Myrathil.'
                  }
                }
              ],
              durationValue: 1,
            ...
            debuffConfig: {
              ...
              effects: [
                {
                  id: 'suppression_penalty',
                  name: 'Suppressed Nature',
                  description: 'While Mask is active: lose all Swim Speed and Water Breathing bonuses from other traits. Prolonged use (more than 4 hours in a 24hr period) causes 1 level of Exhaustion.',
                  mechanicsText: 'While the Mask is active, the creature loses all Swim Speed and Water Breathing bonuses from other traits; more than 4 hours of use in 24 hours inflicts 1 level of Exhaustion.',
                  statusEffect: {
                    level: 'severe',
                    description: 'Lose swim speed and water breathing while active. Exhaustion after 4hrs use.'
                  }
                }
              ],
              durationValue: 1,
          ...
          },
          {
            ...
            description: 'Advantage on Intelligence (History) or Survival checks to recall geographical features of any freshwater system you have personally traveled, and once per long rest you may perfectly retrace any river route you swam within the last week (even if blinded or disoriented); you suffer Disadvantage on Knowledge checks for land-based geography. Riverling carry maps no one else draws \u2014 every river lived in your blood as currents, not memories, a flowing cartography that surfaces when you need it most, though the land-folk\'s maps still make no sense to someone who navigates by flow.',
            level: 1,
            icon: 'spell_nature_water',
            spellType: 'PASSIVE',
            effectTypes: ['buff', 'utility', 'debuff'],
            typeConfig: { school: 'primal', icon: 'spell_nature_water', tags: ['river', 'memory', 'navigation', 'passive'] },
            buffConfig: { buffType: 'custom', effects: [{ id: 'river_memory', name: 'River-Memory', description: 'Advantage on History/Survival for freshwater geography you have personally traveled. 1/long rest: perfectly retrace any river route swum within the last week.', mechanicsText: 'Grants advantage on Intelligence (History) or Survival checks for freshwater geography the creature has personally traveled, and once per long rest perfectly retraces a swum river route.', statModifier: { stat: 'survival', magnitude: 1, magnitudeType: 'advantage', conditions: { terrain: 'freshwater', requires: 'personal_travel' } } }], durationValue: 0, durationType: 'permanent', durationUnit: 'permanent', canBeDispelled: false },
            ...
            debuffConfig: { debuffType: 'statusEffect', effects: [{ id: 'land_map_blindness', name: 'Land-Map Blindness', description: 'Disadvantage on Knowledge checks relating to land-based geography, maps make no sense to someone who navigates by flow.', mechanicsText: 'Imposes disadvantage on Knowledge checks concerning land-based geography, as the creature navigates by currents rather than maps.', statModifier: { stat: 'knowledge', magnitude: 0, magnitudeType: 'disadvantage', conditions: { subject: 'land_geography' } } }], durationValue: 0, durationType: 'permanent', durationUnit: 'permanent', canBeDispelled: false },
            targetingConfig: { targetingType: 'self', rangeType: 'self_centered' },
            resourceCost: { actionPoints: 0, mana: 0, components: [] },
            cooldownConfig: { cooldownType: 'long_rest', cooldownValue: 1 }
          }
