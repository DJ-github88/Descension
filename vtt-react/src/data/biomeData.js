...
export const BIOMES = [
  ...
  },
  {
    ...
    encounterTable: [
      ...
      { range: [18, 18], type: 'social', label: 'Waste-Solari Badland Rangers', note: 'Water dispute.' },
  ...
  },
  {
    ...
    encounterTable: [
      ...
      { range: [15, 15], type: 'combat', label: 'Caustic Fexric Free-Clan Raid', note: 'Alchemical weapons, dark magic. May take prisoners.' },
