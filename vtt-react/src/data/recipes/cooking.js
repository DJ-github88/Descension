...
export const COOKING_RECIPES = [
  ...
  },
  {
    ...
    name: 'Spice Blend',
    profession: 'cooking',
    description: 'Blended to season Skald glacier-mead feasts. Blend various spices for enhanced flavor.',
    requiredLevel: 1,
  ...
  },
  {
    ...
    name: 'Cooked Meal',
    profession: 'cooking',
    description: 'A caravan-trail stew cut with Sundari ash-wine. Prepare a hearty cooked meal from fresh ingredients.',
    requiredLevel: 1,
