...
export const TAILORING_RECIPES = [
  {
    ...
    description: 'Woven on Minstrel Revel looms with Sylvan thread-of-song. Weave fine cloth from linen fiber.',
    requiredLevel: 0,
  ...
  },
  {
    ...
    name: 'Waxed Thread',
    profession: 'tailoring',
    description: 'Waxed for Mimir mistwoven cloaks that shed the marsh-fog. Treat thread with wax for durability and water resistance.',
    requiredLevel: 0,
  ...
  },
  {
    ...
    name: 'Leather Straps',
    profession: 'tailoring',
    description: 'A Martyr Sol\'s Breath-embroidered vestment binding. Cut and prepare leather into straps for binding.',
    requiredLevel: 0,
  ...
  },
  {
    ...
    profession: 'tailoring',
    description: 'Quilted after Martyr Sol\'s Breath-embroidered vestments against the cold. Weave cloth with insulating properties.',
    requiredLevel: 2,
