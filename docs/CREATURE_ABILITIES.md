# Mythrill Creature Abilities â€” Full Stat Blocks for All 140 Creatures

> Formatted for direct integration into `creatureData.js`.  
> Each block includes: dangerLevel, role, combat abilities, stats, and a signature ability.

---

## REGION 1: FROSTWOOD REACH (Germanic/Grimm + Celtic)

### 1. Schratling â€” B | Low
**Combat:** 35 HP. Compulsive Scribe (passive: cannot read, but compulsively rewrites any text within 10 ft, DC 12 SPI to resist). Peat-Ink Spit (ranged, +3 to hit, 1d4 psychic, target loses 1 trivial memory). Moss-Camouflage (+4 to stealth in forest). Vulnerable to fire.
**Stats:** STR 8, AGI 14, CON 10, INT 6, SPI 12, CHA 12 | HP 35, Mana 10, AP 3, Speed 30 | Resist: psychic 50
**Signature:** *Journal-Tangle* â€” Overnight, rewrites a household's journal entries. DC 13 SPI save or one party member loses a minor memory.

### 2. Tatzelvine â€” A | Medium
**Combat:** 75 HP. Serpent-Lunge (melee, reach 10 ft, +5 to hit, 2d6+3 slashing). Memory-Venom (passive: targets struck must DC 13 CON save or lose short-term memory of the last hour, causing confusion for 2 rounds). Branch-Grip (can move across canopy without provoking opportunity attacks). Vulnerable to fire.
**Stats:** STR 12, AGI 18, CON 12, INT 6, SPI 10, CHA 8 | HP 75, Mana 0, AP 4, Speed 35 (climb 30) | Resist: physical 25

### 3. Drudehaunt â€” A | High
**Combat:** 120 HP. Fog-Shroud (passive: continuously blurred, ranged attacks against her have disadvantage). Nightmare-Seal (targets a sleeping creature, DC 14 SPI save or paralyzed in nightmare; loses 3 memories on waking, dealing 2d8 psychic). Washbasin-Stare (AoE 15 ft, DC 13 SPI save or frightened for 3 rounds). Omen-Sight (passive: any creature that sees her washing loses a significant memory within 3 days). Vulnerable to radiant.
**Stats:** STR 8, AGI 14, CON 12, INT 12, SPI 18, CHA 14 | HP 120, Mana 50, AP 4, Speed 30 (hover) | Resist: cold 50, psychic 50
**Signature:** *The Sewn Mouth* â€” Her mouth is sewn shut with journal-cord. If the threads are cut, she releases a Keen (AoE 60 ft, DC 16 SPI or paralyzed with grief for 1d4 rounds).

### 4. Koboldknock â€” A | Low
**Combat:** 40 HP. coded-Tap (passive: taps walls in coded patterns; GM reveals nearby mineral veins or structural hazards). Rivet-Hammer (melee, +4 to hit, 1d6+2 bludgeoning). Fog-Seal (bonus action: hammers a crack shut, blocking fog from entering a 10-ft corridor for 1 hour). Toll-Demand ( demands a copper rivet; if refused, DC 12 SPI save or one item goes missing overnight). Vulnerable to fire.
**Stats:** STR 10, AGI 14, CON 14, INT 12, SPI 10, CHA 8 | HP 40, Mana 15, AP 3, Speed 25 | Resist: physical 50

### 5. Erlking's Hound â€” B | Medium
**Combat:** 80 HP. Leaf-Shift (passive: coat constantly regenerates; heals 5 HP per round in forest). Triple-Bark (3 barks over 3 rounds: Bark 1 = DC 12 SPI or frozen with terror 1 round; Bark 2 = DC 13 SPI or forget current location; Bark 3 = target voluntarily walks into deepest fog). Bark-Shriek (AoE cone 15 ft, 2d6 sonic, DC 13 CON or deafened 1 round). Vulnerable to fire.
**Stats:** STR 14, AGI 18, CON 12, INT 6, SPI 14, CHA 8 | HP 80, Mana 20, AP 4, Speed 40 | Resist: cold 50, physical 25

### 6. Nuckelmist â€” S | High
**Combat:** 180 HP. Path-Erasure (passive: any road or trail it walks is physically erased from the forest behind it â€” the spatial memory of the path is consumed). Blight-Aura (passive: 50-ft radius, all organic material rots; journal pages dissolve, wood blackens). Trample (melee, +7 to hit, 2d10+5 bludgeoning + target is knocked prone). Ink-Weep (ranged 30 ft, 3d6 psychic + DC 15 SPI save or lose one major memory). Disease-Breath (AoE cone 20 ft, DC 15 CON save or diseased: -2 to all checks for 24 hours). Vulnerable to radiant.
**Stats:** STR 20, AGI 14, CON 18, INT 6, SPI 16, CHA 10 | HP 180, Mana 60, AP 5, Speed 40 | Resist: cold 100, physical 50, poison 100
**Signature:** *The Erased Road* â€” After a Nuckelmist passes, the road it walked no longer exists. Maps update themselves. The path is gone. This is permanent.

### 7. Mossmaiden â€” B | Medium
**Combat:** 85 HP. Goat-Kick (melee, +5 to hit, 2d6+3 bludgeoning, DC 13 AGI or knocked back 10 ft). Blood-Milk Bargain (special: offers a wooden cup; DC 14 SPI to resist drinking; drinker is bound to her grove for 7 years but gains +4 CON). Seasonal-Camouflage (passive: moss-skin changes color with temperature, +6 stealth in forest). Herd-Ward (passive: nearby elk/moose are alerted to danger within 100 ft). Vulnerable to fire.
**Stats:** STR 12, AGI 16, CON 14, INT 10, SPI 14, CHA 16 | HP 85, Mana 30, AP 4, Speed 40 | Resist: cold 50

### 8. Fachanwatch â€” A | Medium
**Combat:** 100 HP. Ironwood-Club (melee, reach 10 ft, +6 to hit, 2d8+5 bludgeoning, DC 14 CON or stunned 1 round). Truth-Demand (special: blocks a mountain pass; each traveler must speak one genuine personal truth; liars are hurled into the ravine, DC 15 AGI to survive the fall). Fog-Anchor (passive: spatial memory is stabilized in 100-ft radius; fog cannot erase paths while it lives). Balanced-stance (immune to knockback, prone, and shove effects). Vulnerable to psychic.
**Stats:** STR 18, AGI 10, CON 18, INT 8, SPI 10, CHA 8 | HP 100, Mana 0, AP 3, Speed 25 | Resist: physical 50
...
### 15. Cu-Sithbane â€” A | Medium
**Combat:** 95 HP. Three-Bark-Hunt (3 rounds of escalating barks: Round 1, DC 13 SPI or frozen 1 round; Round 2, DC 14 SPI or forget current location; Round 3, target walks willingly into deepest fog â€” no save, DC 15 SPI to resist at the threshold). Fear-Drain (passive: feeds on the memory of fear; targets within 30 ft who have been frightened lose the emotional memory of fear permanently, becoming eerily calm). Moss-Touch (melee, +5 to hit, 2d6+3 cold damage). Green-Phosphor (passive: emits green bioluminescence, illuminating 20 ft). Vulnerable to fire.
**Stats:** STR 14, AGI 18, CON 14, INT 8, SPI 16, CHA 8 | HP 95, Mana 20, AP 4, Speed 45 | Resist: cold 50, psychic 50

### 16. Pixieglow â€” B | Low
**Combat:** 25 HP. Spore-Trail (passive: leaves a colored trail â€” gold = guides to safety, blue = leads in circles, red = leads to danger; player rolls DC 12 INT to determine color before following). Spore-Burst (AoE 5 ft, DC 12 CON or blinded 1 round). Glow-Pulse (bonus action: doubles light output, illuminating 40 ft). Vulnerable to cold.
**Stats:** STR 4, AGI 18, CON 8, INT 10, SPI 14, CHA 12 | HP 25, Mana 15, AP 3, Speed 30 (fly 25) | Resist: psychic 50

### 17. Selkibark â€” A | Medium
**Combat:** 80 HP. Bark-Shed (bonus action: sheds ironwood bark-skin, revealing luminous true form; gains +10 Speed and fly 30 but takes double damage). Amphibious (can breathe underwater, swim 40). Fog-Light (passive: true form emits pure fog-light that parts fog in a 20-ft radius). Grip-Bite (melee, +5 to hit, 1d8+3 piercing). Vulnerable to fire (bark-form takes double fire damage).
**Stats:** STR 12, AGI 16, CON 12, INT 10, SPI 16, CHA 14 | HP 80, Mana 30, AP 4, Speed 30 (swim 40) | Resist: cold 50, physical 25

### 18. Banshrond â€” B | High
...
### 20. Moorboggle â€” C | Medium
**Combat:** 70 HP. Amorphous (passive: immune to grapple, prone, and critical hits; can squeeze through any gap). Eye-Shift (bonus action: moves its two yellow eyes anywhere on its body; cannot be flanked). Memory-Drain (passive: 10-ft radius, DC 13 SPI each round or lose one minor memory; a household infested loses 3 generations of history per winter). Sinkhole (special: opens a temporary bog-sinkhole, DC 14 AGI or swallowed into a subterranean bog-pocket; escape requires DC 15 STR). Vulnerable to cold iron (iron weapons deal double damage).
**Stats:** STR 14, AGI 12, CON 16, INT 6, SPI 10, CHA 6 | HP 70, Mana 20, AP 4, Speed 25 | Resist: physical 50, cold 25

---

## REGION 2: NORDHALLA (Norse + Alpine)

### 21. Fossegrim-Ice â€” B | Medium
**Combat:** 70 HP. Ice-Fiddle (special: plays music that thaws brass mechanisms in the Frozen Archive; in combat, DC 14 SPI or charmed and compelled to dance for 3 rounds). Skate-Walk (can move across ice without penalty or breaking through). Ram-Skull-Bash (melee, +5 to hit, 2d6+3 bludgeoning). Goat-Bargain (special: teaches ice-fiddle for a goat sacrifice; if no goat available, the price increases to a memory). Vulnerable to fire.
**Stats:** STR 10, AGI 16, CON 12, INT 12, SPI 16, CHA 18 | HP 70, Mana 40, AP 4, Speed 35 (ice 45) | Resist: cold 100

### 22. Marepress â€” B | Medium
**Combat:** 85 HP. Nightmare-Crush (special: settles on a sleeping target's chest; DC 14 SPI or paralyzed in a nightmare, taking 2d6 psychic per round; the victim's dreams feed the Marepress, healing it for the same amount). Frost-Aura (passive: 10-ft radius, all non-cold-resistant creatures take 1d6 cold per round; frost patterns form on surfaces). Black-Ice-Hoofprint (passive: leaves black-ice hoofprints that cause DC 13 AGI or slip and fall prone). Vulnerable to fire.
**Stats:** STR 14, AGI 14, CON 16, INT 6, SPI 14, CHA 8 | HP 85, Mana 30, AP 4, Speed 30 | Resist: cold 100, physical 25

### 23. Klabatskerry â€” A | Low
**Combat:** 50 HP. Weeping-Omen (special: if it appears on deck and weeps, the ship has 7 hours before the ice cracks; this is always accurate). Caulk-Seal (bonus action: seals hull-cracks with frost-sealant stronger than tar; a ship it tends never sinks from ice-damage). Bell-Chest (passive: bell in chest rings softly when danger approaches; functions as an early-warning system within 100 ft). Mallet-Strike (melee, +4 to hit, 1d6+2 bludgeoning). Vulnerable to fire.
**Stats:** STR 10, AGI 16, CON 12, INT 10, SPI 14, CHA 8 | HP 50, Mana 20, AP 3, Speed 30 | Resist: cold 50

### 24. Krampuskin â€” A | High
**Combat:** 150 HP. Chain-Rattle (passive: the sound of its chains carries for miles; any creature who hears it and feels guilt takes -2 to all saves). Birch-Whip (melee, reach 15 ft, +6 to hit, 2d6+4 slashing + DC 14 CON or bleeding 1d6/round for 3 rounds). Sack-Capture (special: grappled target is stuffed into the frozen sack and sealed in a glacier-crevasse, preserved eternally; the victim is not dead but cannot escape without external rescue). Horn-Gore (melee, +7 to hit, 2d8+5 piercing). Vulnerable to fire.
**Stats:** STR 20, AGI 14, CON 18, INT 8, SPI 10, CHA 10 | HP 150, Mana 20, AP 5, Speed 35 | Resist: cold 100, physical 50

### 25. Perchtenmarch â€” S | High
**Combat:** 200 HP (collective). Procession-Sweep (AoE 100 ft, the entire procession passes through an area; all Wyrd-creatures are driven out for 1 month; all creatures in the area take 4d6 cold and must DC 16 SPI or flee in terror for 1 minute). Mask-Judgment (special: stops before each settlement; if the village has maintained hearth-fires and honored the dead, SchÃ¶nperchten leave gifts; if not, Schiachperchten attack â€” no one sleeps until they leave, DC 15 CON each hour or take 1d6 exhaustion damage). Mask-Crack (reaction: if a Percht's mask is cracked, that Percht dissolves into snow, reducing the procession's HP by 10). Vulnerable to fire (masks take double fire damage).
**Stats:** STR 16, AGI 14, CON 18, INT 10, SPI 20, CHA 12 | HP 200, Mana 80, AP 5, Speed 30 | Resist: cold 100, physical 50, psychic 50
**Signature:** *The Month-Clear* â€” A Perchtenmarch passing through a region clears ALL Wyrd-corruption for one full month. This is the only reliable Wyrd-suppression method in Nordhalla.

### 26. Helhest-Glacier â€” A | High
**Combat:** 130 HP. Three-Legged-Charge (melee, +7 to hit, 2d8+5 bludgeoning + DC 15 AGI or trampled). Plague-Aura (passive: 50-ft radius; the eldest and youngest in any settlement visited will die within the week, DC 15 CON to resist). Coffin-Hoof (passive: single hind-hoof sounds like a coffin-lid closing; creatures who hear it DC 14 SPI or frightened for 1 hour). Glacier-Anchor (passive: each Helhest anchors a section of the halted glaciers; if slain, that glacier begins to advance â€” the catastrophe House Skalvyr bargained to prevent). Vulnerable to radiant.
**Stats:** STR 18, AGI 16, CON 16, INT 6, SPI 14, CHA 8 | HP 130, Mana 30, AP 5, Speed 50 | Resist: cold 100, physical 25
**Signature:** *The Glacier's Chain* â€” Slaying a Helhest-Glacier unleashes the glacier it anchors. This is a campaign-level consequence.

### 27. Mylingfrost â€” C | Medium
**Combat:** 55 HP. Weight-Bearing (special: latches onto a traveler's back; starts at 20 lbs and increases by 20 lbs each round; if the carrier's STR check fails, they are crushed into the snow). Rune-Glow (passive: scratched name-runes glow, revealing the Myling's identity). Hearth-Release (special: if carried to a hearth-fire, the ice melts and the spirit is freed â€” resolving the encounter peacefully). Vulnerable to fire.
**Stats:** STR 4, AGI 10, CON 10, INT 6, SPI 14, CHA 8 | HP 55, Mana 20, AP 2, Speed 0 (attaches to carrier) | Resist: cold 100

### 28. Trollstone â€” B | Medium
...
### 39. Marmennill â€” A | Low
**Combat:** 45 HP. Oracle-Answer (special: if caught with a runic-bait line, answers 3 questions about the future in riddles so dense that interpretation takes years; after the third answer, dissolves into sea-water â€” the creature dies to share its knowledge). Harp-Song (AoE 40 ft, DC 13 SPI or dream-state, compelled toward the fjord-edge; whale-blubber earplugs negate). Bone-Harp-Bash (melee, +4 to hit, 1d4 bludgeoning â€” it is not a combat creature). Slippery (advantage on all escape/grapple checks). Vulnerable to lightning.
**Stats:** STR 6, AGI 16, CON 10, INT 16, SPI 16, CHA 14 | HP 45, Mana 30, AP 3, Speed 20 (swim 40) | Resist: cold 50

### 40. Havgammel â€” C | Medium *(NEEDS FULL REWORK)*
**Combat:** 90 HP. Form-Shift (bonus action: shifts between mermaid-form (guide ships to safety, bless catches) and serpent-form (create ice-floes that trap ships); the shift depends on observer intent â€” malicious intent triggers serpent-form). Scrimshaw-Necklace (passive: depicts drowning scenes; studying it reveals the location of sunken wrecks). Coin-Bargain (special: a silver coin tossed before casting nets yields overflowing harvests; pollution yields nets of carved bones). Vulnerable to lightning.
**Stats:** STR 12, AGI 14, CON 14, INT 10, SPI 14, CHA 16 | HP 90, Mana 30, AP 4, Speed 30 (swim 45) | Resist: cold 100

---

## REGION 3: SUNDALE & EMBERSPIRE (Mesopotamian + Egyptian)

### 41. Pazuzu-Gale â€” A | High
...
**Signature:** *The Sun-Devourer* â€” Its ecological imperative is to coil around and drain the Solbrand. This makes it not just a monster but an existential threat to the entire region's survival.

### 43. Anzu-Ember â€” A | High
**Combat:** 140 HP. Tablet-Thief (special: steals inscribed objects â€” clay tablets, runic carvings, forge-marks; a Thrask ranger whose clan-mark is stolen cannot prove their lineage). Talon-Dive (melee from air, +7 to hit, 2d8+5 slashing + target is knocked prone). Obsidian-Talon-Ignite (passive: talons are hot enough to ignite dry material on contact; melee attacks deal +1d6 fire). Rebirth-Cycle (passive: every 7 years, immolates itself in Emberspire's caldera and is reborn from ashes; during the 24-hour rebirth window, it is helpless). Golden-Crest-Flash (AoE 20 ft, DC 14 CON or blinded 1 round by the crest's radiance). Vulnerable to cold.
**Stats:** STR 16, AGI 20, CON 14, INT 12, SPI 16, CHA 10 | HP 140, Mana 30, AP 5, Speed 20 (fly 60) | Resist: fire 100, physical 25

### 44. Girtablilu â€” A | High
**Combat:** 135 HP. Gate-Challenge (special: guards volcanic temple entrances; demands the traveler answer one question about the Solbrand or the Dimming's history â€” it knows every answer, and lying is impossible in its presence). Pincer-Crush (melee, +6 to hit, 2d8+5 bludgeoning + DC 15 STR or grappled). Stinger-Venom (melee, reach 15 ft, DC 16 CON â€” paradoxically, in small doses this venom CURES Wyrd-sickness; in large doses, it kills). Vigilance-Stare (passive: its golden eyes radiate divine authority; DC 14 SPI or intimidated, unable to attack for 1 round). Vulnerable to cold.
**Stats:** STR 18, AGI 14, CON 18, INT 12, SPI 14, CHA 12 | HP 135, Mana 20, AP 4, Speed 30 | Resist: fire 75, physical 50

### 45. Ammit-Maw â€” A | High
**Combat:** 155 HP. Heart-Weigh (passive: can sense the moral "weight" of any creature within 100 ft; those burdened by Wyrd-corruption or broken oaths are detected and prioritized). Crocodile-Bite (melee, +7 to hit, 2d10+5 piercing). Smolder-Hide (passive: body literally smolders; melee attackers take 1d6 fire damage on contact). Erasure-Devour (special: consumed creatures have their NAMES erased from volcanic stone-records â€” this is the only force that can undo Emberth burn-mark inscriptions; the victim's identity is permanently destroyed). Lion-Charge (melee, +6 to hit, 2d6+4 bludgeoning + DC 15 AGI or knocked prone and pinned). Vulnerable to cold.
**Stats:** STR 20, AGI 12, CON 20, INT 8, SPI 14, CHA 8 | HP 155, Mana 20, AP 4, Speed 30 | Resist: fire 100, physical 50

### 46. Lamashtu-Wail â€” A | High
**Combat:** 140 HP. Child-Steal (special: absorbs children into her distended belly; the stolen are preserved in eternal torment, not digested â€” rescue is theoretically possible but requires breaching the belly). Copper-Weep (passive: breasts leak molten copper that pocks basalt; creates hazardous terrain dealing 1d6 fire per square). Donkey-Shriek (AoE 30 ft, DC 15 SPI or stunned 1 round). Pazuzu-Ward (passive: will not approach within 100 ft of a Pazuzu image carved on a door or worn as an amulet â€” this is a hard counter, not a save). Claw-Rake (melee, +6 to hit, 2d6+4 slashing). Vulnerable to cold.
**Stats:** STR 16, AGI 14, CON 18, INT 10, SPI 16, CHA 12 | HP 140, Mana 40, AP 5, Speed 30 | Resist: fire 100, physical 25

### 47. Bes-Brick â€” A | Low
**Combat:** 50 HP. Tambourine-Bang (AoE 20 ft, DC 13 SPI or Wyrd-creatures are frightened and must flee; laughing breaks enchantments â€” the sound itself is the weapon). Khopesh-Slash (melee, +5 to hit, 1d8+3 slashing). Sigil-Glow (passive: lapis-lazuli sigils glow when Wyrd-energy approaches within 50 ft, functioning as an alarm). Shatter-Sacrifice (special: when destroyed, explodes into protective clay-shards that embed Wyrd-warding sigils into nearby walls, creating a permanent 20-ft safe zone). Vulnerable to cold (clay becomes brittle).
**Stats:** STR 12, AGI 14, CON 14, INT 6, SPI 14, CHA 10 | HP 50, Mana 20, AP 3, Speed 25 | Resist: fire 100, physical 50
**Signature:** *The Sacrifice* â€” A Bes-Brick that shatters to protect children is considered the highest sacrifice in Emberth culture. The permanent warding it creates makes it strategically valuable.

### 48. Ifrit-Coal â€” A | High
**Combat:** 150 HP. Cobra-Glare (special: gaze ignites flammable material within 50 ft; any creature meeting its gaze DC 15 AGI or takes 3d6 fire and is set ablaze). Magma-Shape (bonus action: shapes molten rock with bare hands, creating barriers, weapons, or tools no mortal smith can replicate). Flame-Body (passive: melee attackers take 2d6 fire damage on contact). Coal-Hurl (ranged 40 ft, +6 to hit, 2d8 fire). Uraeus-Flare (the cobra-hood of flame flares wide when aggressive, illuminating 60 ft and blinding creatures in front â€” DC 14 CON or blinded 1 round). Vulnerable to cold (cold damage reduces its body temperature, lowering damage output by 25% per cold hit until it reheats).
**Stats:** STR 18, AGI 14, CON 18, INT 12, SPI 16, CHA 10 | HP 150, Mana 50, AP 5, Speed 35 | Resist: fire 100, physical 50

### 49. Ghul-Cinder â€” B | Medium
**Combat:** 75 HP. Invisible-Shift (bonus action: becomes completely invisible; only detectable by the faint smell of charred bone and the two floating green eyes â€” DC 14 INT (Perception) to spot the eyes). Fire-Bolt (ranged 30 ft, +5 to hit, 2d6 fire). Heat-Drain (passive: consumes residual warmth from ancient stone; infested ruins are cold to the touch, all thermal energy drained). Bone-Cloak-Split (special: when it opens its "mouth," the fabric splits vertically, revealing a furnace â€” cone 15 ft, 3d6 fire, DC 14 CON or continue burning). Vulnerable to cold.
**Stats:** STR 8, AGI 16, CON 12, INT 10, SPI 14, CHA 8 | HP 75, Mana 30, AP 4, Speed 30 | Resist: fire 100, physical 50

### 50. Gugalanna â€” C | Medium *(NEEDS REDESIGN)*
**Combat:** 120 HP. Ground-Breaker (passive: its hooves crack cooling lava into fracture-patterns that are actually navigation-maps â€” following Gugalanna tracks leads to stable ground). Magma-Charge (melee charge, +6 to hit, 2d8+5 bludgeoning + 1d6 fire, DC 15 AGI or trampled). Steam-Breath (AoE cone 15 ft, 2d6 fire/steam, DC 14 CON or blinded 1 round). Scarab-Purify (special: the scarab-shaped obsidian growth beneath its tongue can purify contaminated water â€” a single scarab cleanses an entire cistern of Wyrd-taint; killing the Gugalanna for it is considered sacrilege). Vulnerable to cold.
**Stats:** STR 20, AGI 12, CON 18, INT 6, SPI 10, CHA 8 | HP 120, Mana 0, AP 4, Speed 40 | Resist: fire 100, physical 50

### 51. Peri-Moth â€” A | Low
**Combat:** 30 HP. Wing-Roll (passive: at dawn, rolls its wings into a ball, collecting thermal energy; compresses it into golden "sun-seeds" â€” plantable in cold hearthstones to produce fire for a year). Golden-Glow (passive: emits warm golden light; creatures within 10 ft feel comforted, +2 to SPI saves). Runic-Prayer-Wings (passive: wings edged with Zoroastrian prayers in gold-dust; reading them grants temporary +4 to SPI for 1 hour). Proboscis-Touch (melee, +3 to hit, 1d4 radiant â€” heals 1d4 instead if target is allied). Vulnerable to cold.
**Stats:** STR 2, AGI 16, CON 8, INT 10, SPI 16, CHA 14 | HP 30, Mana 20, AP 3, Speed 10 (fly 30) | Resist: fire 50, radiant 100

### 52. Daeva-Shade â€” A | High
**Combat:** 115 HP. Truth-Eater (passive: feeds on spoken truth â€” every honest word within 50 ft weakens the speaker (-1 to all rolls per truthful statement) and strengthens the shade (+5 HP per truth consumed). In markets, where merchants lie, it starves). Light-Absorb (passive: its body is a three-dimensional hole in the world; all light that hits it simply ceases â€” it is visible only as a moving silhouette). Chaos-Beacon (passive: its presence attracts Wyrd-manifestations; within months of nesting, reality-breaches open nearby). Inverted-Gaze (passive: its eyes are inverted â€” bright pupils, dark whites; meeting its gaze DC 14 SPI or the creature learns your deepest secret). Chaos-Bite (melee, +6 to hit, 2d6+4 necrotic). Vulnerable to radiant (radiant damage is the only type that affects it normally; all other damage is reduced 75%).
**Stats:** STR 14, AGI 18, CON 14, INT 14, SPI 10, CHA 8 | HP 115, Mana 30, AP 4, Speed 40 | Resist: physical 75, cold 50, fire 50

### 53. Simurgh-Ash â€” A | High
**Combat:** 145 HP. Feather-Heal (special: a single feather laid on a wound heals broken bones and closes gashes within hours â€” 3d8+5 healing per use; the Simurgh is sapient and chooses who receives feathers). Ash-Nest-Stabilize (passive: areas near Simurgh nests have measurably fewer eruptions; its presence is a volcanic stabilizer). Ancient-Knowledge (passive: remembers the world before the Dimming; can share pre-sundering knowledge fragments with those it deems worthy â€” GM fiat). Wing-Buffet (AoE 30 ft, DC 15 AGI or knocked back 20 ft and prone). Talon-Strike (melee, +7 to hit, 2d8+5 slashing). Copper-Chime (passive: mane of copper-wire feathers chimes in wind; the sound is identifiable for miles, marking territory). Vulnerable to cold.
...
**Signature:** *The Monolith's Coil* — The Ketos-Leviathan may be trying to communicate with the Sundered Monolith. Defeating it might silence the Monolith's song — or make it much louder.
...
### 82. Kitsune-Guile — A | Medium
**Combat:** 100 HP. Nine-Tail-Illusions (passive: each of its nine tails contains a stored illusion; it can deploy one illusion per round — a phantom enemy, a false path, a clone of an ally). Fox-Fire (AoE 20 ft, +5 to hit, 1d8 fire + DC 13 SPI or charmed for 1 round). Shape-Shift (bonus action: takes the form of any person or animal; +6 to Deception checks). Chullachaqui-Tell (passive: one hind paw always faces backward — a tell that betrays its true nature). Illusion-Wall (special: can create a convincing illusionary wall that lasts 1 hour; creatures must DC 15 INT to disbelieve). Vulnerable to iron.
**Stats:** STR 10, AGI 18, CON 12, INT 16, SPI 16, CHA 14 | HP 100, Mana 40, AP 4, Speed 35 | Resist: psychic 50

### 83. Oni-Blizzard — B | High
**Combat:** 140 HP. Club-Smash (melee, +7 to hit, 2d8+5 bludgeoning + DC 15 CON or stunned 1 round). Aurora-Club (passive: club is made of compressed aurora-light; on critical hits, releases a flash that deals 2d8 radiant to all creatures in 20-ft radius). Blizzard-Rage (passive: gains +2 STR for each round of combat; the longer the fight, the stronger it gets). Iron-Maul (melee, +6 to hit, 2d6+4 bludgeoning, ignores 4 points of physical armor). Mountain-Toss (ranged 40 ft, +6 to hit, 3d6+5 bludgeoning — throws boulders). Vulnerable to fire.
**Stats:** STR 20, AGI 12, CON 18, INT 6, SPI 10, CHA 8 | HP 140, Mana 20, AP 5, Speed 30 | Resist: cold 100, physical 50

### 84. [CUT — Yuki-Onna already exists in bestiary. This slot should become a new creature.]
...
### 87. Kodama-Echo — A | Low
**Combat:** 30 HP. Echo-Voice (passive: repeats everything it hears with exactly a 7-second delay, creating a layered chorus across the peaks). Communication-Network (special: the Groven use clusters of Kodama-Echoes as a communication-system — shout a message toward a cluster, it bounces the sound across entire valleys; 100% reliable, no interception possible). Peak-Warden (passive: bound to a specific mountain-Apu; when the mountain is damaged, the Kodama wails — DC 14 SPI or all who hear it are driven to tears for 1 round). Quartz-Eyes (passive: sparkles in even dimmest light, revealing its position). Vulnerable to physical damage (if hit, it dissolves into a puff of snow and reappears 10 ft away after 1 round).
...
| 82 | Banshee-Root | Graiawood | Wail-of-death |
| 89 | Zhen-Echo | Graiawood | Mirror-image |
| 96 | Selkie-Bond | Emberspire | Skin-bond |
| 101 | Almas-Ridge | Sundry Vale | Silent-Witness |
| 104 | Burkhan-Wind | Sundry Vale | Sacred-site guardian |
| 108 | Bai-Ze-Omen | Sundry Vale | Living-bestiary |
| 109 | Zilant-Wing | Sundry Vale | Wing-song |
| 113 | Khor-Buzzard | Sundry Vale | Vigilante vulture |
| 119 | Bura-Stormkin | Sundry Vale | Wind-warrior |
| 120 | Tengri-Spark | Sundry Vale | Last star of hope |
| 127 | Fenrir-Cub | Bryngloom Forest | Growing power |
| 130 | Garmr-Hellbound | Bryngloom Forest | Gate-watcher |
| 132 | Gullinbursti-Golden | Bryngloom Forest | Golden boar |
| 134 | Ratatoskr-Skullsplit | Bryngloom Forest | Chatter-split |
| 136 | Nott-KissofNight | Bryngloom Forest | Night-kiss |
| 137 | Kvidur-LyingVoice | Bryngloom Forest | Truth-reversal |
| 138 | Huginn-EyeofThought | Bryngloom Forest | Thought-mirror |
...
| 16 | Onibaba-Flame | Ashlands | Fan-fire + witch-fire |
| 17 | Jorogumo-Weave | Ashlands | Web-silk + venom |
| 18 | Tsukimogami | Ashlands | Possessed objects |
| 23 | Naga-Queen | Sundale | Coil-crush + venom |
| 24 | Chindi-Spider | Sundale | Black-web + curse |
| 25 | Perchtenmarch | Sundale | Mask-force + fear |
| 26 | Nachtmahr | Sundale | Nightmare-riding |
| 28 | Nukakaviu | Duskmere | Blood-drink + charm |
| 29 | Apa-Apa | Duskmere | 100-hands + grab |
| 30 | Adze-Firefly | Duskmere | Firefly-form + vampirism |
| 31 | Pele-Kiss | Duskmere | Lava-kiss + burn |
| 32 | Ahuizotl | Duskmere | Tail-hand grab + drown |
| 34 | Grai-Swirl | Sundale | Web-whip + paralysis |
| 35 | Cuelebre-Stag | Sundale | Acid-spit + wing-wind |
| 37 | Skogsrå-Pine | Sundale | Branch-hair + fear |
| 39 | Vila-Whirl | Sundale | Dance-fight + weather |
| 40 | Havgammel | Sundale | Wave-crush + ice |
| 41 | Huldra-Forge | Glitterdeep | Music-lure + forge |
| 42 | Tatzelwurm-Dust | Glitterdeep | Dust-storm + poison |
| 43 | Salamander-Ember | Glitterdeep | Fire-aura + immunity |
| 44 | Mymecolony | Glitterdeep | Acid-spray + swarm |
| 46 | Mahaha-Tickle | Duskmere | Tickle-death |
| 47 | Bunyip-Snout | Duskmere | Bone-club + drowning |
| 49 | Grootslang | Duskmere | Diamond-hoards + water |
| 50 | Ninki-Nanka | Duskmere | Neck-stretch + venom |
| 51 | Kraken-Prime | Glitterdeep | Ink-cloud + whirlpool |
| 52 | Leviathan-Fragment | Glitterdeep | Water-control + tide |
| 53 | Sea-Eater | Glitterdeep | Flesh-melt + venom |
| 54 | Scylla-Reef | Glitterdeep | Tentacle-drag + whirlpool |
| 55 | Chimera-Ruined | Graiawood | Three-heads + fly |
| 56 | Basilisk-Gaze | Graiawood | Petrifying gaze |
| 57 | Medusa-Veil | Graiawood | Snake-hair + petrify |
| 58 | Wyvern-Clutch | Graiawood | Tail-sting + fly |
| 59 | Kur-Pit | Graiawood | Pit-trap + poison |
| 61 | Kyzylorda | Glitterdeep | Snake-venom + swarm |
| 62 | Mamlambo | Glitterdeep | River-mind-control |
| 63 | Pakeku-Bait | Graiawood | Bait-steal + lure |
| 64 | Abatwa-Ant | Graiawood | Ant-mount + micro-war |
| 65 | Impundulu-Eye | Graiawood | Lightning-summon + charm |
| 66 | Tokoloshe-Stream | Glitterdeep | Invisibility + water |
| 68 | Gbahali | Graiawood | Armor-hide + charge |
| 69 | Inkanyamba | Graiawood | Snake-storm + flood |
| 70 | Grootslang-Cave | Graiawood | Diamond-treasure + guard |
| 71 | Ninki-Nanka-Water | Graiawood | Neck-stretch + water |
| 73 | Skalds-Lute | Graiawood | Music-lure + fire |
| 74 | Jorogumo-Bow | Graiawood | Web-silk + charm |
| 75 | Abatwa-Ant | Graiawood | Ant-mount + micro-war |
| 76 | Zhen-Echo | Graiawood | Mirror-image + charm |
| 79 | Menehune-Craft | Graiawood | Tool-use + craft |
| 81 | Buggane-Root | Graiawood | Tree-strike + fear |
...
| 91 | Tsuchigumo-Vein | Graiawood | Venom-fang + web |
| 92 | Tsukimogami-Lantern | Emberspire | Lantern-lure + fire |
| 93 | Guo-Fire | Emberspire | Ghost-fire + drain |
...
| 102 | Tulpar-Phantom | Sundry Vale | Sky-memory + stardust |
| 103 | Erlik-Judge | Sundry Vale | Soul-judgment |
| 105 | Nian-Stampede | Sundry Vale | Red-fear + fire |
| 106 | Jiangshi-Steppe | Sundry Vale | Talisman-control |
| 111 | Nang-Khan | Sundry Vale | Lightning-cavalry |
| 112 | Gu-Hon | Sundry Vale | Coin-skeletal army |
| 114 | Tengri-Wind | Sundry Vale | Shape-shift + ride |
| 116 | Qoraigarash | Sundry Vale | Gemstone-scales + storm |
| 117 | Ajina-Shadow | Sundry Vale | Shadow-form + entropy |
| 122 | Ereshkigal-Bride | Bryngloom Forest | Lament-weave + shroud |
| 124 | Lamassu-Fortress | Bryngloom Forest | Divine guardian |
| 125 | Pabilsag-Wheel | Bryngloom Forest | Lion-scorpion + venom |
| 126 | Utukku-Feverish | Bryngloom Forest | Fever-touch + disease |
| 128 | Jormungandr-Ring | Bryngloom Forest | World-circle + tide |
| 129 | Nidhogg-Bonecrunch | Bryngloom Forest | Root-gnaw + venom |
| 131 | Sleipnir-Ghost | Bryngloom Forest | Eight-legs + dimensional |
| 133 | Andvari-Goldblood | Bryngloom Forest | Gold-curse + ring |
| 139 | Upir-Root | Bryngloom Forest | Blood-network + control |
| 140 | Sirin-Song | Bryngloom Forest | Soul-song + death-prophecy |

## HIGH DANGER

| # | Creature | Region | Key Ability |
|---|----------|--------|-------------|
| 103 | Erlik-Judge | Sundry Vale | Ancestor-judgment |
| 118 | Lu-Wu Mountain | Sundry Vale | Nine heads, nine seasons |
| 121 | Anzu-Thunderwing | Bryngloom Forest | Storm-body + divine theft |
| 123 | Humbaba-Ward | Bryngloom Forest | Cedar-forest guardian |
| 124 | Lamassu-Fortress | Bryngloom Forest | Divine commandment |
| 128 | Jormungandr-Ring | Bryngloom Forest | World-circle + tsunamis |
| 129 | Nidhogg-Bonecrunch | Bryngloom Forest | Root-gnaw + regeneration |
| 130 | Garmr-Hellbound | Bryngloom Forest | Underworld gate-watcher |
| 131 | Sleipnir-Ghost | Bryngloom Forest | Dimensional gallop |
| 135 | Rat-Father-Ragnarok | Bryngloom Forest | Death-eater + plague |
| 139 | Upir-Root | Bryngloom Forest | Blood-network + control |
...
## Creature-to-JSON Conversion

To convert these abilities into the creatureData.js format, use this template:
...
`js
{
  ...
  combatStrings: {
    attack: 'Tentacle-Harpoon (melee, +6, 2d8+4 piercing)',
    special: 'Lung-Venom: +5, 3d6 poison, DC 14 CON or paralyzed',
    passive: 'Tide-Bound: Cannot be summoned more than 100 ft from tide-line',
  },
  abilities: [
    { name: 'Tentacle-Harpoon', type: 'attack', effect: 'melee, +6, 2d8+4 piercing' },
    { name: 'Lung-Venom', type: 'attack', effect: '+5, 3d6 poison, DC 14 CON or paralyzed 3 rounds' },
    { name: 'Tide-Bound', type: 'passive', effect: 'Cannot be summoned more than 100 ft from tide-line' },
  ]
}
`
...
- **Mythrill STR/AGI/CON/INT/SPI/CHA** ranges from 4 (terrible) to 20+ (godlike)
- **HP ranges**: Low (30-60), Medium (60-120), High (120-250)
- **Mana ranges**: Low (0-20), Medium (20-60), High (60-100)
- **AP ranges**: Low (3), Medium (3-4), High (4-5)
- **Speed ranges**: Low (10-30), Medium (25-45), High (35-60)
- **Resistances**: 25% (weak), 50% (moderate), 75% (strong), 100% (immune)
- **Damage notation**: XdY+Z (e.g., 2d8+4 = two 8-sided dice + 4 modifier)
- **DC saves**: DC 12-18, usually vs AGI, CON, or SPI

## Campaign Integration

- **Low danger**: 1-3 creatures, designed for first encounters
- **Medium danger**: 3-6 creatures, designed for mid-game challenges
- **High danger**: 6-10 creatures, designed for boss encounters
- **Legendary**: 10+ creatures, designed for climactic battles

## Elemental Affinity

- **Frostwood**: Cold, poison, physical
- **Ashlands**: Fire, cold, necrotic
- **Sundale**: Physical, lightning, cold
- **Duskmere**: Poison, necrotic, cold
- **Glitterdeep**: Poison, physical, lightning
- **Graiawood**: Psychic, necrotic, radiant
- **Emberspire**: Necrotic, fire, psychic
- **Bryngloom Forest**: Lightning, necrotic, radiant
