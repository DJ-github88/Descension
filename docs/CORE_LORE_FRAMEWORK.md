...
* **The Sister Moon (The Slumbering Buffer):** Sol's sister is frozen solid in orbit to act as a thermal
  ...
  that never quickened. Her slow dreams leak into the world as both Rime Magic and the void-adapted lunar
  parasites that Lunarchs bond. **Keth Amar nested in her unquickened shell during its long approach**,
  and the harm it did there is why her dreams are no longer entirely her own.
* **Keth Amar (The Cosmic Predator):** An ancient, highly intelligent cosmic apex predator — a species as
  much as an individual — obsessed with consuming Sol. It tracks the scent of unhatched celestial deities
  across space. Blocked from physical entry by Aethil's atmospheric vigilance (§1.3).
* **Divine Non-Intervention Law & Flight:** Celestial Deities forfeit their divine Celestial Status if they
  directly descend to touch or alter a mortal realm. Both parents paid this price willingly:
  * **Aethil (The Father)** sacrificed his absolute divine status to **anchor the celestial barrier** around
    Mythrill's atmosphere — the outer shield against direct cosmic invasion. He is the ward, and he is
    still holding it.
  * **Aex (The Mother)** sacrificed her divine form to **entomb and protect Sol within the molten core**,
...
### 1.7 The Whisper-Cult: The Masked Acolytes
* **The 7th House (Masked Acolytes):** Not a house at all. The Acolytes are **Keth Amar's whisper-cult** —
...
* **Why Mortal Records Contradict Each Other (canon framing):** During the Whispered Purge, **Keth Amar
  impersonated Aethil** — appearing to the Solari, Storm, and Rime houses as the divine father, promising
  warmth and stellar apotheosis. This is why large parts of the written record describe Aethil not as
  Sol's father but as *"no spirit, no ancestor, no will — the universe's mechanism of consequence."*
  **That description is Keth Amar's self-portrait, transcribed by scribes who thought they were quoting a
  god.** Aethil *is* the patron of oaths and consequence — the one who witnesses every Bloodline Pact —
  but he is a person, he is Sol's father, and he is still holding the sky.
  * Corollary: the retired father-name **Aelden** and the hyphenated spelling **Keth-Amar** survive in
    older codices, contract-law, and regional liturgy. They are in-world archaisms, not canon variants.
    New writing uses `Aethil` and `Keth Amar`.
...
* ❌ **SCRAPPED:** The Augurs' 41% doom prediction accuracy being tied to Sol's shell/security breakdown.
  (Prediction interference is caused by temporal friction and chronological dissonance, not Sol's shell
  integrity).
...
* **The Incident:** Dug too deep in the mountains and uncovered an ancient Primordial God's vault/engine.
  They stole from it and tapped into its core to power their technology, cursing their bloodline with
  erratic twitching, manic paranoia, and an insatiable urge to build and tweak.
...
* **Key Factions & Strongholds:**
  * **House Skalvyr & King-Jarl Halvar "Járn-Tand" Skalvyr:** The royal seat at Frosthold Citadel; builder
    of the Sunder-Wall.
...
2. **Frostwood Reach:** Attack memory, identity, and records while exposing the Unwritten's concealment.
...
The Freeze is not weather. It is the market's founding condition: everything scarce is warm, and everything
warm is owned.

* **What People Eat:** Open-field agriculture is dead. The world is fed from the **vent-terraces** —
  geothermal step-farms clinging to the warm zones: Cragjaw's cooling terrace-tiers, the Sundrift warm
  valleys, the Bryngloom bog-paddies, the Frostwood steam-gardens. Grain is grown in the warm belt, pressed
  into travel-biscuit, and shipped cold. The Iceheart storm-lanes never freeze, so the sea still gives:
  fish, whale-oil, and the mammoth herds of the far north give hide, tallow, and meat. Whoever holds a vent
  holds a breadbasket; the Cragjaw terraces are cooling, and that is a countdown, not a trend.
* **What Everything Runs On — Aex Shards:** The glowing fragments of the Mother's broken aegis are the only
  portable heat that cannot be besieged. A fist-sized shard warms a hall; a keystone-shard warms a city
  district. Shards do not burn out — they **fade**: roughly a finger-width of glow a year under heavy use,
  faster when worked hard. A fully dark shard is called **sunk**, and sunk shards are how the great hoards
...
* **Who Holds What:** House-controlled shard hoards (the old bloodline keystones above all); the
  **Icechamber Syndicate**'s coal-grain-mammoth vertical in Nordhalla, which also farms the Sunder-Wall's
  gate-tariffs; the Brine-Bond Syndicate's storm-lane shipping tolls; the Steam-Line Cartel's pipe-heat
  monopoly in Cragjaw; the Dawn Vigil's shard-indulgence traffic (they pay in absolution and salt); and the
  Neth, who hold no warmth at all but hold the ledger everyone else must settle on.
* **The Ripple Rule for GMs:** Every warm thing in the world is already claimed, priced, and taxed.
  Adventurers do not find heat; they take it from someone who was counting on it.
