...
3. **Read the World Lore** in `vtt-react/src/data/rulesData.js` under the `'world-lore'` category. The race MUST be anchored into the existing mythos: the sun's theft, the Cosmic Warden, Emberspire's eruption, the 7 Noble Families' bargains, the 7 Campaign Shards, the Wyrd's folkloric infestation, and the specific region where this race originates. Every race should feel like it was forged by this world's specific catastrophe — not a generic fantasy species that could exist anywhere.
...
- The `overview` field is the deep-lore first-person text — make it immersive and voice-driven, explicitly referencing the world's history (the sun's death, Emberspire, the relevant regional dark bargain, the Campaign Shards, and where this race fits in the cosmic timeline)
