...
const CreatureLibrary = ({ onEdit }) => {
  ...
  // Debug: Log the library state
  useEffect(() => {
    console.log('CreatureLibrary mounted');
    console.log('Library state:', library);
    console.log('Number of creatures in library:', library.creatures.length);
    console.log('Creatures in library:', library.creatures);
    console.log('Number of creatures in store:', creatureStore.creatures.length);
    console.log('Creatures in store:', creatureStore.creatures);
  }, [library, creatureStore]);

  // Filter and sort creatures
  const filteredCreatures = sortCreatures(
  ...
  const handleDuplicateCreature = (creatureId) => {
    ...
    if (creatureToDuplicate) {
      const duplicatedCreature = {
        ...
        dateCreated: undefined, // Will be set to now
        lastModified: undefined // Will be set to now
      };
            ...
            <>
              ...
              <div className="creature-cards-container">
                {filteredCreatures.map(creature => (
                  ...
                  >
                    <LibraryStyleCreatureCard creature={creature} />
