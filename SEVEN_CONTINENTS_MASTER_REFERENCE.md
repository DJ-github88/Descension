...
- **Races & subraces here:** **Thalren humans** (archivists, the Ledgered ruling caste); **Arch Mimir** (canopy aristocrats, ancestral masks); **Smooth-Skinned Briaran** (passing as human, run the ink-trade); small **Skald** trader enclave at Skald's Landing.
- **Factions:** House Thalreth, Scribe-Cartel (ink/parchment monopoly), Mist-Sentinels, Ironwood Palisade Wardens, Scribe-Sentinels.
- **Settlements:**
  - **City:** Greymark Keep (~1,200; capital; Sovereign Ledger; the High Hearth's 800-yr flame).
  - **Settlements:** Scribes' Tower (hollowed ironwood), Mirror Mere (Arch Mimir lake-village), Greythorn Copse (joint Thalren–Briaran fort), Skald's Landing (river trade post), Meadowglen Crossing (waystation to Sundale).
...
- **Geography:** sub-arctic, 8-week summer; granite tundra, glacial moraine, sparse twisted ironwood.
- **Races & subraces here:** **Stone-Tribal humans** (frontier folk); **Skald expatriates** (Greymark Northwatch garrison + the Stone-Speakers tending monoliths); **Jutul raiders** (giant troll-kin of the deep wastes — rumored, rarely confirmed).
...
- **Races & subraces here:** **Fractured Mimir** (maskless, carrying glowing Motes); **the Forgotten** (undocumented outcasts stripped by the Sovereign Ledger); **Unshorn Briaran** refugees (thorn-cloaked).
...
**Region-wide:** **Briaran** (House Viridane's descendants) live hidden in moonlit groves where the fog thins; the erasure hides them from Keth-Amar.
...
- **Races & subraces here:** **Rime-Born** (Hunger Pact survivors, stone-shadow skin); **Frostbound** (blue-skinned infants who survived the Frost-Tithe — carry Keth-Amar's attention, dwell in Gelid-Caverns); **Corvani** (raven-marked subfolk, fate-bonded to Corvid Fate-Spirits, eyries in mile-high ice); **Skald** royal clans.
- **Factions:** House Skalvyr (royal seat), Skald Keepers (glacier archivists).
- **Settlements:**
...
- **Geography:** cold-temperate maritime; black granite fjords, sea-cliffs, harbor towns.
- **Races & subraces here:** **Skald humans** (Fastboende settled loyalists; subfolk divisions: Bloodhammer warriors, Rune Keeper scholars); **Merryn** expatriate traders; **Corvani** messengers.
- **Factions:** Icechamber Syndicate (trade monopoly), Fastboende clan confederations, Skald Keepers, Bloodhammer Clan.
- **Settlements:**
  - **Settlements:** Fjord-Gate (stone-doored harbor), Bloodhammer Sump (volcanic forge-crater), Eldonholm (Skald fishing town), Vargtor (wolf-circle watchtower), Vespera's Perch.
...
- **Geography:** milder, sea-moderated, geothermally warmed; black-sand beaches, sea-cliffs, hot-springs.
- **Races & subraces here:** **Skald humans**; **Merryn traders**; **Fredløse** (outlaw nomad clans); the only place **Frostbound** mix openly with warm-bloods.
- **Factions:** Skald navy, Fredløse clans, Xardin's Trading Company, **Cult of Forgotten Shadow** (clandestine Void-heat research), Cleansing of the Hearth (persecutes Animists).
- **Settlements:**
...
- **Races here:** none resident — Emberth Watchers & pilgrims only.
...
- **Settlements:**
  ...
  - **✦ Minor:** Hot-Spring Terrace Village, Oasis-Grove Farmstead, Salt-Pans Fishing Camp, Wharf-Dealer's Row, Sun-Shrine Mile, Cinder Strait.
- **Landmarks:** Meadowglen (breadbasket), Warmheath.
- **Creatures & Wyrd:** Crystal-Stag (radiant Glitterwood-edge beast).
- **Intricacies:** the Dawn Vigil struggles to control this wealthy, trade-connected ring.

### 3D · The Glitterwood *(forested half-island / peninsula)*
- **Geography:** warm, humid, sheltered by a mountain spine; crystal-rich soil, ancient broadleaf forest, hidden valleys.
- **Races & subraces here:** **the Risen** (old Emberth-faith revivalists); **Smooth-Skinned exiles** (old Solvan nobility who fled); hermits who abandoned the Dawn Vigil.
- **Factions:** the Risen, Free Glitterwood Council.
- **Settlements:**
...
### 4B · The Shard-Window Storm-Belt *(western perpetual-cyclone open sea)*
- **Geography:** perpetual cyclone, lightning, salt-rain; open sea, storm-vortexes, shipwrecks.
- **Races & subraces here:** Merryn pirates; **Stormspeakers** (animist cult on the rim).
- **Factions:** Merryn Pirate Confederacy, Stormspeakers.
- **Landmarks:** **The Shard-Window** (3-mile storm-vortex over a Monolith; rim shrine), Wraithsound (inlet speaking in drowned voices).
- **✦ Minor:** Stormspeaker's Rim-Shrine, Drowned-Fleet Graveyard, Myriad-Haunt, Eye-Crossing.
- **Creatures & Wyrd:** **Storm-Wraith**, **Myriad** (wraith-storm-spirits).
...
- **Races & subraces here:** Merryn pirates; Exiled Neth; Tide-Speakers (animist holdouts); Mer-Court emissaries.
- **Factions:** Pirate-Queen of Saryreach, Mer-Court.
- **Settlements:**
...
- **Geography:** sub-alpine, wind-blasted, snow-veiled; chasms, hanging-bridges, mid-altitude valleys.
- **Races & subraces here:** **Groven** (alchemically-forged from Thrumm blood; stone-scales, tusks, tufted tails) — **Morgh** (heavy-scaled laborers/warriors) & **Ithran** (fine-scaled diplomats/toll-keepers) & **Murmur-Blooded** (mixed-caste outcast bridge-tenders); Tessen patrols.
- **Factions:** Groven bridge-clans (Vat-Breakers' Guild), Tessen military, Rope-Garrisons.
- **Settlements:**
  - **Settlement:** Deepchasm Keep (Tesshan fortress over a massive fissure).
  - **✦ Minor:** Ithran Toll-Post Village, Cliff-Andene Hanging-Terrace, Murmur-Blood Bridge-Tender Hut, The Broken-Span, Knor's Wind-Throat.
- **Landmarks:** **The Spans** (Groven bone-bridge shanty-towns — the region's icon), The Ancestor-Gaps, The Great Gorge (seven bone-spans), Alley of Knor.
- **Ruins:** Stag's Rest Moraine.
- **Creatures & Wyrd:** **Chasm-Stalker** (nests in Span supports), **Tengu-Crows** (raven goblins stealing voices).
- **Intricacies:** Rope-Garrisons cut bridges at first sign of unrest — isolating entire keeps.
...
- **Settlements:**
  ...
  - **✦ Minor:** Scrap-Sump (Drall capital), Blue-Bite Tunnels, Reticulation Vault-Camp, Deep-Alchemist Shaft, Toxic-Spore Hollow, Steam-Pipe Grid.
- **Landmarks:** Sump Galleries, Iron Ravine.
- **Ruins:** **The Lost Brood Vats** (Deep Alchemists' labs; sealed 800 yrs; the Feral Brood may be alive inside).
- **Creatures & Wyrd:** **Scrab** (multi-legged Sump horror), **Toxic Spore-Horror**, Lost-Brood Remnant.
- **Intricacies:** the Deep Alchemists never stopped — Thrumm children stolen long ago are still being reshaped in the deep vats.
...
- **Races & subraces here:** **Ordan humans** (nomadic horse-riders, throat-singers; **Mounted** elite vs **Unmounted** underclass); **Sky-Singer** hermits (persecuted Animists).
- **Factions:** House Ordavan, Mounted clan confederations, Sky-Singers (persecuted).
- **Settlements:**
...
- **Landmarks:** Ancestor Mounds (vast barrow network, each hums a unique note), Nova's Heath, The Moundwatch.
- **Creatures & Wyrd:** **Almas** (living memory of the Vale), **Mound-Eater**.
- **Intricacies:** the **Unlit Veil** (Astril intelligence network) actually rules from behind the Synod.
...
- **Settlements:**
  ...
  - **✦ Minor:** Peat-Edge Ford Hamlet, Thermal-Bore Sinkhole, Neth-Scribe Outpost.

### 6E · Blizzard Bluff *(northern highland bluff & frontier passes)*
- **Geography:** sub-arctic, perpetual wind, deep winter snow; high bluffs, cairn-marked passes.
- **Races & subraces here:** Ordan frontier clans; visiting Thalren patrols (from Frostwood).
- **Factions:** Ordan March Wardens.
- **Landmarks:** Blizzard Bluff (the Snow-Tooth).
- **✦ Minor:** Sentry-Yurt Post, Wind-Neck Pass, Frostwood-Thalren Meeting-Stones.
- **Creatures & Wyrd:** Zud.
...
- **Settlements:**
  ...
  - **✦ Minor:** Lantern-Eye Way, Marked-Vrekin Rim-Slum, Veil-Speaker Chant-Hall, Pale-Moonlight Floor.
- **Landmarks:** Fangmere Grove (Vreken ancestral bones in roots).
- **Ruins/Tombs:** The Crypt of Aedris (the First-Lit's preserved/Lichborne form).
- **Creatures & Wyrd:** **Lichborne Aedris**, Wist.
- **Intricacies:** the **Marked Vreken** (silver-eyed, volatile Ghost-Mycelium strain) are segregated into Over-Shanties at the Spire's rim.
...
- **Intricacies:** the Inquisition purged the Swamp-Singers; bark-carved fae-contracts predate the Neth.

### 7E · The Great Mere *(central lake with forested islands)*
- **Geography:** damp, mild, island microclimates; open lake, forested islands, peat-bog shore.
...
- **Settlements:**
  ...
  - **✦ Minor:** First-Contract Signing-Hollow, Threshold-Shrine Hermitage, Hush-Quiet Zone.
- **Intricacies:** the Root-Veil connects every ironwood root continent-wide; the First Contract was signed here.

---
---

# RACE COMPENDIUM — EVERY RACE & SUBRACE, AND WHERE EACH LIVES

### HUMANS (7 regional subcultures — the connective tissue of the economy)
| Subrace | Home continent | Subregions present | Notes |
|---|---|---|---|
...
| **Briaran** (thorn-blooded; House Viridane's descendants) | **Unshorn** (thorn-cloaked) · **Smooth-Skinned** (pass as human) | Frostwood Reach (hidden) | Unshorn → moonlit groves/Drowned Fens; Smooth-Skinned → Ironheart Vales edge |
| **Emberth** (forge-clans; cold-bodied) | **Korr** (deep-vault priests) · **Thrask** (surface rangers) | Sundale | Korr → Ashen Fringe (Harath-Vault inner); Thrask → Ashen Fringe surface |
| **Myrathil** (sea-foam born; biolum, webbed) | **Breakers-Born/Shore** · **Deep-Born** · **River-Fed/Brook** | Iceheart Sea | Breakers → Merrow Archipelago; Deep → Deepwell Trench; River-Fed → estuaries |
| **Neth** (pact-bound non-breathers) | **High/Loyalists** · **Pale/Conspirators (cold undead)** · **Hallowed/Profane** | Bryngloom Forest | High → Canopy-Heart (Atropolis); Pale → Peat-Wastes/Sunken Basin; Hallowed → Root-Veil shrines |
| **Vreken** (lantern-eyed) | **Clean** (amber-eyed) · **Marked** (silver-eyed, Ghost-Mycelium) | Bryngloom Forest | Clean → Sunken Basin (inner crypts); Marked → Sunken Basin rim (Over-Shanties) |
| **Astril** (Star-Carried; constellation-skin) | **Sylen/Vashir** (open-spirit) · **Muren/Silath** (suppressed) · **Unlit** (no spirit; can lie) | Sundrift Vale | Sylen/Muren → Starfall Basin/Ancestor Wolds; Unlit → Unlit Knoll (spies) |
| **Groven** (alchemically-forged from Thrumm) | **Morgh** (heavy) · **Ithran** (fine) · **Murmur-Blooded** (outcast) | Cragjaw Peaks | Morgh → Iron Sumps/deep; Ithran → Gorge-Web bridges; Murmur → bridge-tender outposts |
| **Fexrick** (goblinoid engineers) | **Kethrin** (guild) · **Drall** (clan-free) | Cragjaw Peaks | Kethrin → Iron Sumps (Gearworks Gulch high); Drall → Scrap-Sump |
...
| **Fredløse** (Skald outlaw nomads) | — | Nordhalla | Ember-Tide Coast |
| **Jutul** (frost-giants) | — | Frostwood (Frostfang) · Nordhalla · Cragjaw (Skirmour's Crag) | deep wastes/high peaks |
| **Icewhisper Coven / Berg-Witches** | — | Iceheart Sea | Frozen-Flows |
| **Stormspeakers** (animist cult) | — | Iceheart Sea | Shard-Window Storm-Belt (rim) |
| **Mer-Court** (animist emissaries) | — | Iceheart Sea | Saryreach Isles (Tide-Court Cove) |
...
**Land/portage routes:** Velling Pass / Meadowglen Crossing (Frostwood↔Sundale) · Skald's Landing (Frostwood↔Nordhalla) · Morren's Bogpost (Bryngloom↔Sundrift) · **The Ancestor-Spans** (only Cragjaw crossing) · The Sunder-Wall (Nordhalla migration choke) · The Ironwood Palisade (Frostwood border) · The Toll-Dikes (Bryngloom) · The Ashen Escarpment (Sundale border).
**Sea routes:** Cinder Strait (Sundale↔Iceheart via Ember Lagoon + Basalt Shyr) · Iceheart Sea lanes (every region; policed by Board of Trade) · The Unfreezing Booms (Mereval ironclad channels).
**Hidden passages:** Lost Brood Vats (Fexric shaft) · Subterranean Vault (beneath Frostmaw — Monolith) · Star Caves (lava-tubes) · Wraithfen · Tide-Court Cove (twice-daily) · Root-Veil Scriptorium (Morvane's permission).

---

# CANON STATUS & OPEN ITEMS
...
- **Outstanding (separate refactor):** the race **code-IDs** still use `florae`/`solari` internally (display "Briaran"/"Emberth" in this doc) — a ~20-file rename, not yet done.
