...
| **COS-m9** | `lore.json:4530` (`the_fredlose`) | "Fredlose is **Old Nord** for 'the lawless,'" and `the_deck_born` etc. use "**De Hesteborne**" / "**De Hestelose**" (Old Norse-style). Real-world language analogs; LORE_STYLE_GUIDE §6.5B warns against real-world myth/linguistic references. |
